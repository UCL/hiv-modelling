...
ods rtf file = 'C:\Users\rmjlja9\Documents\GitHub\hiv-modelling\Malawi\graphs_20251210.doc' startpage=never;
...
proc export data=icer_sums
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20251210_out\icer_sums.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
...
proc export data=icer_sums_2049
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20251210_out\icer_sums_2049.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
