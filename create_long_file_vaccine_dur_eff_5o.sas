...
data b.k_vaccine_m_fpc_b_dur_eff_5o;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_vaccine_m_fpc_b_dur_eff_5o; 
by run cald option;
run;
...
set b.k_vaccine_m_fpc_b_dur_eff_5o ;
...
merge b.k_vaccine_m_fpc_b_dur_eff_5o sf;
by run ;
...
data    b.l_vaccine_m_fpc_b_dur_eff_5o_y; set y;  
