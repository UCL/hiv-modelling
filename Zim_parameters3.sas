...
* sw_trans_matrix;   		%sample(sw_trans_matrix, 1 2 3, 0.10 0.65 0.25);
...
* effect_sw_prog_6mtest;    %sample_uniform(effect_sw_prog_6mtest, 0.15 0.30);*consider changing in core as this is now lower than core and Zim should have one of the better programs;
