...
load("/Users/sf124046/Library/CloudStorage/Box-Box/1.sapphire_modelling/calibration/SynthesisHTN_103.RData")
...
df_netdaly_paramsbase <- df_netdaly_params %>% filter(cost_cat == "Total costs 200% of base") 
