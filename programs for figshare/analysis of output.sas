...
dead_ddaly_odabe = s_dead_ddaly_oth_dol_adv_birth_e * sf_2020 * 12 * discount_adj ; 

ddaly_mtct = s_ddaly_mtct * sf_2020 * 12  * discount_adj ;

ddaly_non_aids_pre_death = s_ddaly_non_aids_pre_death * sf_2020 * 12  * discount_adj ; 
...
dcost_child_hiv  = s_dcost_child_hiv * sf_2020 * discount_adj * 12 / 1000; 
