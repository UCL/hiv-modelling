...
rbm=4;
ch_risk_diag = 9/13; 
ch_risk_diag_newp = 5/6; 
ych_risk_beh_newp = .99; 
ych2_risk_beh_newp = 1.0; 
ych_risk_beh_ep = 1.0; 
eprate=0.1; 
newp_factor= 6.5; 
p_rred_p = 0.20; 
...
fold_tr_newp = 0.3; 
super_infection = 0; 
res_trans_factor_nn = 0.60 ; 
res_trans_factor_ii = 1; 
rate_loss_persistence = 0.04; 

rate_loss_nnres_pmtct_maj = 0.75;  rate_loss_nnres_pmtct_min = rate_loss_nnres_pmtct_maj; 
...
mean_sqrtcd4_inf=27.5 ; 
fxx = 1.0; 
gxx=1.0;
fold_incr_who3 = 5;
fold_decr_hivdeath=0.25; 
...
prob_loss_at_diag = 0.4; 
prob_lossdiag_adctb = 0.05; 
prob_lossdiag_who3e = 0.15; 
...
add_eff_adh_nnrti = 0.10; 
altered_adh_sec_line_pop = 0.05; 
adh_effect_of_meas_alert = 0.7; 
pir_higher_potency=1; 
adh_nnrti_p5_if_ltp5 = 1;
poorer_cd4rise_fail_nn = -6; 

sd_cd4 = 1.2;
sd_measured_cd4 = 1.7; 
rate_int_choice = 0.01; 
prob_supply_interrupted=0.003; 
prob_supply_resumed=0.8; 
rate_loss_acq_nnm_offart = 0.05; 

prob_nnresmaj_sd_nvp=0.35;
prob_nnresmaj_dual_nvp=0.045; 
fold_change_tams_risk=1; 
fold_change_151_risk=1; 
add_cd4_loss_nactive_low = 0;  
is_red_activity=0; 
sd_patient_cd4_rise_art= 0.2; 
clinic_not_aw_int_frac=0.6; 
prob_cd4_meas_done=0.85; 
prob_vl_meas_done=0.50; 
prob_who3_diagnosed=0.50; 
prob_who4_diagnosed=0.80;
incr_rate_int_low_adh = 1; 
prob_return_adc = 0.8; 
...
sv_secondline = 1;
switch_for_tox = 0; 
higher_newp_less_engagement = 0; 
ntd_risk_dol = 0.0022; 
zero_3tc_activity_m184 = 0; 
zero_tdf_activity_k65r = 0; 
hard_reach=0; 

* PREP;
 
annual_testing_prep=0.25; 
hivtest_type=3; 
eff_adh_prep=0.95; 
factor_prep_adh_older=0.5;  
rate_test_onprep=1.00; 
pr_prep_b=0.75; 
prob_prep_restart=1.00; 

prob_prep_visit_counsel=0; 
tot_yrs_prep=0;
prob_prep_restart_choice=0.10; 
prepuptake_sw=0.50; 
prepuptake_pop=0.20;
pop_wide_tld_prob_egfr=0.5; 
...
sw_newp_lev_1_1 = 0.9  ; sw_newp_lev_1_2 = 0.08 ; sw_newp_lev_1_3 = 0.015  ; sw_newp_lev_1_4 = 0.004 ; sw_newp_lev_1_5 = 0.001 ; 
sw_newp_lev_2_1 = 0.5  ; sw_newp_lev_2_2 = 0.48 ; sw_newp_lev_2_3 = 0.015  ; sw_newp_lev_2_4 = 0.004 ; sw_newp_lev_2_5 = 0.001 ; 
sw_newp_lev_3_1 = 0.05 ; sw_newp_lev_3_2 = 0.05 ; sw_newp_lev_3_3 = 0.80  ; sw_newp_lev_3_4 = 0.095 ; sw_newp_lev_3_5 = 0.005 ; 
sw_newp_lev_4_1 = 0.05 ; sw_newp_lev_4_2 = 0.05 ; sw_newp_lev_4_3 = 0.50  ; sw_newp_lev_4_4 = 0.39 ; sw_newp_lev_4_5 = 0.01 ; 
...
r_head_start_cla = 0.03;  
p_head_stops_cla = 0.6 ;
...
***** Sexual behaviour;
* base_rate_sw; r=uniform(0);  if 0 <= r < 0.33 then base_rate_sw = 0.001 ;   if 0.33 <= r < 0.67 then base_rate_sw = 0.0015;   
							  if 0.67 <= r   then base_rate_sw = 0.0020; 
...
* p_rred_p; r=uniform(0); if r < 0.20 then p_rred_p = 0.1; if 0.20 <= r < 0.40 then p_rred_p = 0.3; if 0.40 <= r < 0.60 then p_rred_p = 0.5; 
			if 0.60 <= r < 0.80 then p_rred_p = 0.7;   if 0.80 <= r  then p_rred_p = 0.9;  		
* p_hsb_p; 	r=uniform(0); if r < 0.33 then p_hsb_p = 0.05; if 0.33 <= r < 0.67 then p_hsb_p = 0.1; if 0.67 <= r then p_hsb_p = 0.2;
* newp_factor;  newp_factor = 1; 
...
* ych_risk_beh_newp;  r=uniform(0); if r < 0.33 then ych_risk_beh_newp = 0.90; if 0.33 <= r < 0.67 then ych_risk_beh_newp = 0.85;
						 if 0.67 <= r        then ych_risk_beh_newp = 0.80; 
...
* exp_setting_lower_p_vl1000; exp_setting_lower_p_vl1000 = 0; 
						r=uniform(0); if r < 0.20 then do; 
						exp_setting_lower_p_vl1000 = 1; 
						external_exp_factor = 1 + uniform(0); external_exp_factor = round(external_exp_factor,0.01); 
...
* fold_change_w; r=uniform(0); if r < 0.05 then fold_change_w = 1; if 0.05 <= r < 0.10 then fold_change_w = 1.25; 
					if 0.10 <= r then fold_change_w = 1.5; if 0.70 <= r then fold_change_w = 2; 
* fold_change_yw; fold_change_yw = fold_change_w * 1.333;  fold_change_yw = round(fold_change_yw, 0.01); 
...
* rate_testanc_inc; r=uniform(0); if  r < 0.33 then rate_testanc_inc = 0.030; if 0.33 <= r < 0.66   then rate_testanc_inc = 0.050; if 0.66  <= r then rate_testanc_inc = 0.1; 

* incr_test_rate_sympt; r=uniform(0); if r < 0.2 then incr_test_rate_sympt = 1.05 ; if 0.2 <= r < 0.4 then incr_test_rate_sympt = 1.10; 
						if 0.4 <= r < 0.6 then incr_test_rate_sympt = 1.15; if 0.6 <= r < 0.8 then incr_test_rate_sympt = 1.20;	if 0.8 <= r then incr_test_rate_sympt = 1.25; 
...
* fxx;		r=uniform(0);  if r < 0.2 then fxx = 0.7; if 0.2 <= r < 0.4 then fxx = 0.85; if 0.4 <= r < 0.6 then fxx = 1.0; if 0.6 <= r < 0.8 then fxx = 1/0.85 ; if 0.8 <= r then fxx=1/0.7; 
* gxx;		r=uniform(0);  if r < 0.33 then gxx = 1.0; if 0.33 <= r < 0.67 then gxx = 1.5;  if 0.67 <= r  then gxx = 2.0; 

***** linkage, retention, monitoring, loss, return, interruption of art and restrating, art;

* adh_pattern; r=uniform(0);  if  r < 0.05 then adh_pattern=98 ;if 0.05 <= r < 0.10 then adh_pattern=105; if 0.10 <= r < 0.20 then adh_pattern=101; 
				if 0.20 <= r < 0.25 then adh_pattern=99; if 0.25 <= r < 0.40 then adh_pattern=1;   if 0.40 <= r < 0.55 then adh_pattern=2;   
				if 0.55 <= r < 0.70 then adh_pattern=3;   if 0.70 <= r < 0.85 then adh_pattern=4; if 0.85 <= r  then adh_pattern=5; 

* higher_newp_with_lower_adhav;
				r=uniform(0); higher_newp_with_lower_adhav = 0; if r < 0.2 then higher_newp_with_lower_adhav = 1;
* sw_lower_art_adh;
				r=uniform(0); sw_lower_art_adh = 0; if r < 0.2 then sw_lower_art_adh = 1;
...
* rate_int_choice;  r=uniform(0);  if r < 0.20 then rate_int_choice = 0.001; if 0.20 <= r < 0.30 then rate_int_choice = 0.005; 
			...
			if 0.6 <= r < 0.8  then rate_int_choice = 0.02;	 if 0.8  <= r        then rate_int_choice = 0.03 ;
...
* rel_onart_la_drugs;  * note this influences rate of return also;  
						r=uniform(0); rel_onart_la_drugs = 1;  if r < 0.33 then rel_onart_la_drugs = 0.5; if r > 0.67 then rel_onart_la_drugs = 2;

* rate_return;  r=uniform(0); if 0.0 <= r < 0.25 then rate_return = 0.05; if 0.25 <= r < 0.5  then rate_return = 0.10; 
			                                            if 0.5 <= r < 0.75 then rate_return = 0.25 ;	if 0.75 <= r then rate_return = 0.5; 
...
* prob_vl_meas_done; r=uniform(0); prob_vl_meas_done=0.7 ; if   r < 0.33 then prob_vl_meas_done=0.1 ; if 0.67 <= r  then prob_vl_meas_done=1.00; 
...
* greater_disability_tox;  r=uniform(0); greater_disability_tox = 0; if r < 0.1 then greater_disability_tox = 1;
...
* higher_newp_less_engagement; r=uniform(0); if r < 0.2 then higher_newp_less_engagement = 1; 
...
* pr_res_dol;		pr_res_dol=0.03; 
* higher_rate_res_dol ;  r=uniform(0); higher_rate_res_dol = 0; if r < 0.1 then higher_rate_res_dol = 1; if higher_rate_res_dol=1 then pr_res_dol=0.1;
* rel_rate_res_cla_dol;  r=uniform(0); rel_rate_res_cla_dol = 2.0;  if r < 0.1 then rel_rate_res_cla_dol = 1.5;
...
* dol_efa_cla_rla_potency;	r=uniform(0); if r < 0.5 then dol_efa_cla_rla_potency = 1.5 ; if r >= 0.5 then dol_efa_cla_rla_potency = 2;

* cla_time_to_lower_threshold_g;		r=uniform(0); if r < 0.33 then cla_time_to_lower_threshold_g = 1 ;
									if 0.33 <= r < 0.67 then cla_time_to_lower_threshold_g = 2 ; if r >= 0.67 then cla_time_to_lower_threshold_g = 3 ;
...
* circ_inc_rate; r=uniform(0); if r < 0.20 then circ_inc_rate = 0.001 ; if 0.20 <= r < 0.4  then circ_inc_rate = 0.002; if 0.4 <= r < 0.6 then 
				circ_inc_rate = 0.003;  if 0.60 <= r < 0.70  then circ_inc_rate = 0.01;  if 0.70 <= r  < 0.80  then circ_inc_rate = 0.03 ;
				if 0.80 <= r  < 0.90  then circ_inc_rate = 0.05 ;if 0.90 <= r  then circ_inc_rate = 0.07;
...
cost_zdv_a=(0.060/4)*1.2;
cost_3tc_a=(0.017/4)*1.2; 
cost_ten_a=(0.028/4)*1.2; 
cost_taf = (0.018/4)*1.2;
cost_nev_a=(0.027/4)*1.2;    
cost_efa_a=(0.025/4)*1.2; 
cost_rla_a=(0.050/4)*1.2; 
cost_lpr_a=(0.152/4)*1.2;                     
cost_taz_a=(0.185/4)*1.2;  
cost_dol_a=(0.020/4)*1.2;   
cost_cla_a=(0.050/4)*1.2; 
...
prep_drug_cost = (0.050 * 1.2) / 4 ; 
prep_drug_cost_tld = (0.070 * 1.2) / 4 ; 
cost_prep_clinic = 0.010; 
cost_prep_clinic_couns = 0.010; 
...
r_swi_rla_ras = 1 - (1 - r_swi_rla_ras )**(1/3) ;
...
r_swi_cla_head = 1 - (1 - r_swi_cla_head )**(1/3) ;
...
r_ras_start_rla = 1 - (1 - r_ras_start_rla  )**(1/3) ;
...
r_head_start_cla = 1 - (1 - r_head_start_cla )**(1/3) ;
p_head_stops_cla = 1 - (1 - p_head_stops_cla  )**(1/3) ;
...
e=uniform(0);
if 0.0 <= e < inc1    then age1=-67+uniform(0)*12;   
...
if 15 <= age1 < 18 and life_sex_risk ge 2 and e < 0.040 then sw1=1;
if 18 <= age1 < 20 and life_sex_risk ge 2 and e < 0.040 then sw1=1;
if 20 <= age1 < 25 and life_sex_risk ge 2 and e < 0.020 then sw1=1;
if 25 <= age1 < 40 and life_sex_risk ge 2 and e < 0.010 then sw1=1;
...
if sw1 = 1 then do;
e=uniform(0); if age1 > 30 then e=e*0.99; 
...
newp1 = newp1/3;  newp1=round(newp1,1);
...
if newp1 ge 1 then ever_newp=1;
...
incidence1549m =. ;
r_incidence_1549 =. ;
ratio_prev_age2529w_overall =. ;
mtct_prop =. ;
p_onart_vl1000 =. ;
p_vg1000 =. ;
p_ai_no_arv_c_nnm_  =. ;
prop_w_giving_birth_this_per =. ;
prop_w_1549_sw =. ;
...
e=uniform(0); 
if cla_time_to_lower_threshold_g = 1 then do;
if e < 0.70 then cla_time_to_lower_threshold = 0.25 ; if 0.70 <= e < 0.90 then cla_time_to_lower_threshold = 0.5 ; if 0.90 <= e        then cla_time_to_lower_threshold = 1 ; 
end;
if cla_time_to_lower_threshold_g = 2 then do;
if e < 0.33 then cla_time_to_lower_threshold = 0.25 ; if 0.33 <= e < 0.67 then cla_time_to_lower_threshold = 0.5 ; if 0.67 <= e        then cla_time_to_lower_threshold = 1 ; 
end;
if cla_time_to_lower_threshold_g = 3 then do;
if e < 0.10 then cla_time_to_lower_threshold = 0.25 ; if 0.10 <= e < 0.30 then cla_time_to_lower_threshold = 0.5 ; if 0.30 <= e        then cla_time_to_lower_threshold = 1 ; 
end;
...
array sti{8} sti&g-sti&h;              
array age{8} age&g-age&h;
array nip{8} nip&g-nip&h;
array hiv{8} hiv&g-hiv&h;
array v{8} v&g-v&h;
array onart{8} onart&g-onart&h;
array registd{8} registd&g-registd&h;
array tested{8} tested&g-tested&h;
array adc{8} adc&g-adc&h;  
array primary{8} primary&g-primary&h; 
...
if t ge 2 and caldate{t-1} < 2070.0  and dead{t-1} ne 1 and dead{t-1} ne .  then caldate{t}=caldate{t-1} + (1/12);
...
newp_tm2 = max(0,newp_tm1); if t ge 2 then newp_tm1 = max(0,newp{t-1});  
...
if 2019.99 < caldate{t} < 2020.01 then reg_option = 104;

option = &s;


if option = 1 then do; end; 

if option = 2 then do; 
 	if         _u1 < 0.25 then option = 20 ; 
 	if 0.25 <= _u1 < 0.75 then option = 22 ;
 	if 0.75 <= _u1        then option = 24 ;
end;

reg_option_tm1 = reg_option;
...
if caldate{t} ge 2020 then do;
if option ge 1 and date_clarla_eligible_20 = . then date_clarla_eligible_20 = caldate{t};
if option ge 1 and value_last_vm > 3 and date_clarla_eligible_22 =. then date_clarla_eligible_22 = caldate{t};
if option ge 1 and sv=1 and date_clarla_eligible_24 =.  then date_clarla_eligible_24 = caldate{t};
end;

if reg_option in (501) then flr=3;
...
if reg_option in (101 102 103 104 105 106 107 109 110 111 112 113 114 115 116 117 118 119 501 ) then do; 
eff_pr_switch_line=initial_pr_switch_line; eff_prob_vl_meas_done=initial_prob_vl_meas_done; end; 

if reg_option in (101 102 103 104 107 110 113 116 501 ) then art_monitoring_strategy=150;
...
if date_start_testing lt caldate{t} le 2015  then do;
	...
	test_rate_who3 = min(0.7,test_rate_who3*incr_test_rate_sympt); 
end;	
...
if t ge 2 then do;
if caldate{t} > 2016 and 10 le age{t-1} lt 15 then prob_circ = (2019-mc_int)*circ_inc_rate;
if caldate{t} > 2016 and 15 le age{t-1} lt 20 then prob_circ = (2019-mc_int)*circ_inc_rate * 0.5;
if caldate{t} > 2016 and 20 le age{t-1} le 50 then prob_circ = (2019-mc_int)*circ_inc_rate * 0.25;
end;
...
birth_circ=0;new_mcirc=0; 
u=uniform(0);
if t ge 2 and 0.249 <= age{t-1} <= 0.251 and gender=1 then do;	
...
if t ge 2 and caldate{t} >= mc_int > . and gender=1 and registd{t-1} ne 1  and mcirc ne 1  and hard_reach ne 1 then do; 
...
u=uniform(0); if u < rate_want_no_more_children  then want_no_more_children = 1; 
end;
...
if t ge 2 then age{t}=age{t-1} + (1/12);


if age{t} < 15 then do; hiv{t}=.; goto xx55; end;


if t ge 2 and 15 <= age{t} < 65 and death=. then do;
...
if t ge 2 and  sti{t-1}=0 then  do; 
	d=uniform(0);  if d < (newp{t-1} * rate_sti) then sti{t}=1;
end;
if t ge 2 and sti{t-1}=1 then  do;
	d=uniform(0);  if d < (newp{t-1} * rate_persist_sti) then sti{t}=1;
end;
...
if gender=1 then do;								   
		 if          r_s_newp >= 10   then rred_balance = 0.01 ;
	else if   4 <= r_s_newp <  10  then rred_balance = 0.3 ;
	else if   2 <= r_s_newp <  4  then rred_balance = 0.4 ;
	else if   1.5 <= r_s_newp < 2 then rred_balance = 0.5 ;
	else if   1.25 <= r_s_newp <  1.5  then rred_balance = 0.6 ;				 
	else if   1.05  <  r_s_newp <  1.25  then rred_balance = 0.7 ;
	else if  1/1.25 <= r_s_newp < 1/1.05  then rred_balance = 1/0.7 ;
	else if  1/1.5 <= r_s_newp < 1/1.25  then rred_balance = 1/0.6 ;
	else if  1/2 <= r_s_newp  < 1/1.5  then rred_balance = 1/0.5 ;
	else if  1/4 <= r_s_newp < 1/2  then rred_balance = 1/0.4 ;											 	
	else if  1/10 <= r_s_newp < 1/4  then rred_balance = 1/0.3 ;											 	
	else if  1/10 >= r_s_newp   then rred_balance = 1/0.01 ;													   
end;
else if gender=2 then do;												   		 	   
		 if          r_s_newp >= 10   then rred_balance = 1/0.01 ;
	else if   4 <= r_s_newp <  10  then rred_balance = 1/0.3 ;
	else if   2 <= r_s_newp <  4  then rred_balance = 1/0.4 ;
	else if   1.5 <= r_s_newp < 2 then rred_balance = 1/0.5 ;
	else if   1.25 <= r_s_newp <  1.5  then rred_balance = 1/0.6 ;				 
	else if   1.05  <  r_s_newp <  1.25  then rred_balance = 1/0.7 ;
	else if  1/1.25 <= r_s_newp < 1/1.05  then rred_balance = 0.7 ;
	else if  1/1.5 <= r_s_newp < 1/1.25  then rred_balance = 0.6 ;
	else if  1/2 <= r_s_newp  < 1/1.5  then rred_balance = 0.5 ;
	else if  1/4 <= r_s_newp < 1/2  then rred_balance = 0.4 ;											 	
	else if  1/10 <= r_s_newp < 1/4  then rred_balance = 0.3 ;											 	
	else if  1/10 >= r_s_newp   then rred_balance = 0.01 ;
end;


rred_ep = 1 ; if ep{t-1} = 1 and conc_ep ne . then rred_ep = conc_ep ;  
...
if       newp{t-1}=0  then do;  s1=0.995;  s2=0.005;  s3=0.005;  s4=0.00005; end;
if newp{t-1} = 1  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.00005; end;
if 2  <= newp{t-1}<4 then do;  s1=0.03;  s2=0.07;  s3=0.90;  s4=0.00025; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.05;  s4=0.9500; end;
end;
if sex_beh_trans_matrix_m=2 then do;
if       newp{t-1}=0  then do;  s1=0.98;  s2=0.01 ;  s3=0.01 ;  s4=0.00025; end;
if newp{t-1} = 1  then do;  s1=0.98;  s2=0.01;  s3=0.01;  s4=0.00025; end;
if 2  <= newp{t-1}<4 then do;  s1=0.05;  s2=0.15;  s3=0.80;  s4=0.00125; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.20;  s4=0.8000; end;
end;
if sex_beh_trans_matrix_m=3 then do;
if       newp{t-1}=0  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.0005 ; end;
if newp{t-1} = 1  then do;  s1=0.93;  s2=0.05;  s3=0.02;  s4=0.0005 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.0025 ; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.40;  s4=0.6000; end;
end;
if sex_beh_trans_matrix_m=4 then do;
if       newp{t-1}=0  then do;  s1=0.995;  s2=0.005;  s3=0.005;  s4=0.0001 ; end;
if newp{t-1} = 1  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.0001 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.03;  s2=0.07;  s3=0.90;  s4=0.0005  ; end;
if 4 <= newp{t-1}    then do;  s1=0.04;  s2=0.04;  s3=0.09;  s4=0.8300; end;
end;
if sex_beh_trans_matrix_m=5 then do;
if       newp{t-1}=0  then do;  s1=0.98;  s2=0.01 ;  s3=0.01 ;  s4=0.005  ; end;
if newp{t-1} = 1  then do;  s1=0.98;  s2=0.01;  s3=0.01;  s4=0.0005 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.05;  s2=0.15;  s3=0.80;  s4=0.0025 ; end;
if 4 <= newp{t-1}    then do;  s1=0.025;  s2=0.06;  s3=0.17;  s4=0.7500; end;
end;
if sex_beh_trans_matrix_m=6 then do;
if       newp{t-1}=0  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.001 ; end;
if newp{t-1} = 1  then do;  s1=0.93;  s2=0.05;  s3=0.02;  s4=0.001 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.005  ; end;
if 4 <= newp{t-1}    then do;  s1=0.04;  s2=0.08;  s3=0.21;  s4=0.6700; end;
end;
if sex_beh_trans_matrix_m=7 then do;
if       newp{t-1}=0  then do;  s1=0.995;  s2=0.005;  s3=0.005;  s4=0.000025; end;
if newp{t-1} = 1  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.000025; end;
if 2  <= newp{t-1}<4 then do;  s1=0.03;  s2=0.07;  s3=0.90;  s4=0.000125; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.05;  s4=0.9500; end;
end;
if sex_beh_trans_matrix_m=8 then do;
if       newp{t-1}=0  then do;  s1=0.98;  s2=0.01 ;  s3=0.01 ;  s4=0.000125; end;
if newp{t-1} = 1  then do;  s1=0.98;  s2=0.01;  s3=0.01;  s4=0.000125; end;
if 2  <= newp{t-1}<4 then do;  s1=0.05;  s2=0.15;  s3=0.80;  s4=0.000625; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.20;  s4=0.8000; end;
end;
if sex_beh_trans_matrix_m=9 then do;
if       newp{t-1}=0  then do;  s1=0.95;  s2=0.03;  s3=0.02;  s4=0.00025 ; end;
if newp{t-1} = 1  then do;  s1=0.93;  s2=0.05;  s3=0.02;  s4=0.00025 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.00125 ; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.40;  s4=0.6000; end;
end;
if sex_beh_trans_matrix_m=10 then do;
if       newp{t-1}=0  then do;  s1=0.90;  s2=0.06;  s3=0.04;  s4=0.0005 ; end;
if newp{t-1} = 1  then do;  s1=0.99;  s2=0.005;  s3=0.005;  s4=0.0005 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.0025 ; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.40;  s4=0.6000; end;
end;
if sex_beh_trans_matrix_m=11 then do;
if       newp{t-1}=0  then do;  s1=0.90;  s2=0.06;  s3=0.04;  s4=0.001 ; end;
if newp{t-1} = 1  then do;  s1=0.99;  s2=0.005;  s3=0.005;  s4=0.001 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.005  ; end;
if 4 <= newp{t-1}    then do;  s1=0.04;  s2=0.08;  s3=0.21;  s4=0.6700; end;
end;
if sex_beh_trans_matrix_m=12 then do;
if       newp{t-1}=0  then do;  s1=0.90;  s2=0.06;  s3=0.04;  s4=0.00025 ; end;
if newp{t-1} = 1  then do;  s1=0.99;  s2=0.005;  s3=0.005;  s4=0.00025 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.20;  s2=0.20;  s3=0.60;  s4=0.00125 ; end;
if 4 <= newp{t-1}    then do;  s1=0.00;  s2=0.00;  s3=0.00;  s4=1.0000; end;
end;
if sex_beh_trans_matrix_m=13 then do;
if       newp{t-1}=0  then do;  s1=0.75;  s2=0.15;  s3=0.10;  s4=0.0005 ; end;
if newp{t-1} = 1  then do;  s1=0.99;  s2=0.005;  s3=0.005;  s4=0.0005 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.90;  s2=0.05;  s3=0.03;  s4=0.02   ; end;
if 4 <= newp{t-1}    then do;  s1=0.90;  s2=0.05;  s3=0.03;  s4=0.02  ; end;
end;
if sex_beh_trans_matrix_m=14 then do;
if       newp{t-1}=0  then do;  s1=0.75;  s2=0.15;  s3=0.10;  s4=0.001 ; end;
if newp{t-1} = 1  then do;  s1=0.99;  s2=0.05;  s3=0.02;  s4=0.001 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.95;  s2=0.03;  s3=0.01;  s4=0.01   ; end;
if 4 <= newp{t-1}    then do;  s1=0.95;  s2=0.03;  s3=0.01;  s4=0.0100; end;
end;
if sex_beh_trans_matrix_m=15 then do;
if       newp{t-1}=0  then do;  s1=0.75;  s2=0.15;  s3=0.10;  s4=0.00025 ; end;
if newp{t-1} = 1  then do;  s1=0.93;  s2=0.05;  s3=0.02;  s4=0.00025 ; end;
if 2  <= newp{t-1}<4 then do;  s1=0.80;  s2=0.10;  s3=0.05;  s4=0.05    ; end;
if 4 <= newp{t-1}    then do;  s1=0.80;  s2=0.10;  s3=0.05;  s4=0.05  ; end;
end;
...
s2=s2*rred; s3=s3*rred*rred; s4=s4*rred*rred*rred;

cu1=s1;cu2=cu1+s2;cu3=cu2+s3;cu4=cu3+s4; a=uniform(0);
if            a < cu1/cu4 then do; newp{t}=0; end; 
if cu1/cu4 <= a < cu2/cu4  then do; e=uniform(0); newp{t}=1; end;
											
if cu2/cu4 <= a < cu3/cu4 then do; e=uniform(0); if e < 0.35 then newp{t}=2; if 0.35 <= e < 0.56 then newp{t}=2; if 0.56 <= e < 0.73 then newp{t}=2; 
					if 0.73 <= e < 0.86 then newp{t}=2; if 0.86 <= e < 0.95 then newp{t}=3; if 0.95 <= e then newp{t}=3; end;
if cu3/cu4 <= a < cu4/cu4 then do; if e < 0.60 then newp{t}=3 ; if 0.60 <= e < 0.80 then newp{t}= 5; if 0.80 <= e < 0.90 then newp{t}=7 ; 
					if 0.90 <= e < 0.95 then newp{t}=8 ; if 0.95 <= e < 0.99 then newp{t}=10; if 0.99 <= e then newp{t}=12; end;
...
if sex_beh_trans_matrix_w=1 then do;
	if       newp{t-1}=0   then do;  s1=0.995;  s2=0.005; end;
	if 1  <= newp{t-1}     then do;  s1=0.99;  s2=0.01; end;
end;
if sex_beh_trans_matrix_w=2 then do;
	if       newp{t-1}=0   then do;  s1=0.995;  s2=0.005; end;
	if 1  <= newp{t-1}     then do;  s1=0.98;  s2=0.02; end;
end;
if sex_beh_trans_matrix_w=3 then do;
	if       newp{t-1}=0   then do;  s1=0.995;  s2=0.005; end;
	if 1  <= newp{t-1}     then do;  s1=0.95;  s2=0.05; end;
end;
if sex_beh_trans_matrix_w=4 then do;
	if       newp{t-1}=0   then do;  s1=0.995;  s2=0.005; end;
	if 1  <= newp{t-1}     then do;  s1=0.85;  s2=0.15; end;
end;
if sex_beh_trans_matrix_w=5 then do;
	if       newp{t-1}=0   then do;  s1=0.995;  s2=0.005; end;
	if 1  <= newp{t-1}     then do;  s1=0.75;  s2=0.25; end;
end;
if sex_beh_trans_matrix_w=6 then do;
	if       newp{t-1}=0   then do;  s1=0.99;  s2=0.01; end;
	if 1  <= newp{t-1}     then do;  s1=0.99;  s2=0.01; end;
end;
...
if sex_beh_trans_matrix_w=11 then do;
	if       newp{t-1}=0   then do;  s1=0.98;  s2=0.02; end;
	if 1  <= newp{t-1}     then do;  s1=0.99;  s2=0.01; end;
end;
...
if cu1/cu2 <= a < cu2/cu2  then do; 
	...
	if e < 0.30 then newp{t}=1; 		if 0.30 <= e < 0.50 then newp{t}=1; 	if 0.50 <= e < 0.65 then newp{t}=1; 
	if 0.65 <= e < 0.77 then newp{t}=1; 	if 0.77 <= e < 0.86 then newp{t}=2; 	if 0.86 <= e < 0.92 then newp{t}=2; 
	if 0.92 <= e < 0.96 then newp{t}=2; if 0.96 <= e < 0.98 then newp{t}=3; 	if 0.98 <= e then newp{t}=3; 
	end;	
end;
...
if t ge 2 and newp{t-1} = 0 then do;
	...
	if e < sw_newp_lev_1_1 then newp{t}=0;
	...
	if sw_newp_lev_1_1+sw_newp_lev_1_2 <= e < sw_newp_lev_1_1+sw_newp_lev_1_2+sw_newp_lev_1_3 then do; q=uniform(0); newp{t} = 6 + (q*34); newp{t} = round(newp{t},1);	 end;
	if sw_newp_lev_1_1+sw_newp_lev_1_2+sw_newp_lev_1_3 <= e < sw_newp_lev_1_1+sw_newp_lev_1_2+sw_newp_lev_1_3+sw_newp_lev_1_4 then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if sw_newp_lev_1_1+sw_newp_lev_1_2+sw_newp_lev_1_3+sw_newp_lev_1_4 <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); 
 newp{t}=newp{t}/3; newp{t} = round(newp{t},1);  end;
end;

if  t ge 2 and 1 <= newp{t-1} <= 6/3 then do;
															  
	if e < sw_newp_lev_2_1 then newp{t}=0;
	if sw_newp_lev_2_1 <= e < sw_newp_lev_2_1+sw_newp_lev_2_2 then do; q=uniform(0); 
		if q < 0.7 then newp{t}=1; if 0.7 <= q < 0.8 then newp{t}=2; if 0.8 <= q < 0.9 then newp{t}=3; if 0.9 <= q < 0.95 then newp{t}=4;    
		if 0.95 <= q < 0.98 then newp{t}=5; if 0.98 <= q       then newp{t}=6;    
	end;
	if sw_newp_lev_2_1+sw_newp_lev_2_2 <= e < sw_newp_lev_2_1+sw_newp_lev_2_2+sw_newp_lev_2_3 then do; q=uniform(0); newp{t} = 6 + (q*34); newp{t} = round(newp{t},1);	 end;
	if sw_newp_lev_2_1+sw_newp_lev_2_2+sw_newp_lev_2_3 <= e < sw_newp_lev_2_1+sw_newp_lev_2_2+sw_newp_lev_2_3+sw_newp_lev_2_4 then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if sw_newp_lev_2_1+sw_newp_lev_2_2+sw_newp_lev_2_3+sw_newp_lev_2_4 <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); 
 newp{t}=newp{t}/3;newp{t} = round(newp{t},1);  end;
end;

if  t ge 2 and 7/3 <= newp{t-1} <= 40/3 then do;
																  
	if e < sw_newp_lev_3_1 then newp{t}=0;
	if sw_newp_lev_3_1 <= e < sw_newp_lev_3_1+sw_newp_lev_3_2 then do; q=uniform(0); 
		if q < 0.7 then newp{t}=1; if 0.7 <= q < 0.8 then newp{t}=2; if 0.8 <= q < 0.9 then newp{t}=3; if 0.9 <= q < 0.95 then newp{t}=4;    
		if 0.95 <= q < 0.98 then newp{t}=5; if 0.98 <= q       then newp{t}=6;   
	end;
	if sw_newp_lev_3_1+sw_newp_lev_3_2 <= e < sw_newp_lev_3_1+sw_newp_lev_3_2+sw_newp_lev_3_3 then do; q=uniform(0); newp{t} = 6 + (q*34); newp{t} = round(newp{t},1);	 end;
	if sw_newp_lev_3_1+sw_newp_lev_3_2+sw_newp_lev_3_3 <= e < sw_newp_lev_3_1+sw_newp_lev_3_2+sw_newp_lev_3_3+sw_newp_lev_3_4 then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if sw_newp_lev_3_1+sw_newp_lev_3_2+sw_newp_lev_3_3+sw_newp_lev_3_4 <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); 
 newp{t}=newp{t}/3;newp{t} = round(newp{t},1);  end;
end;

if  t ge 2 and  41/3 <= newp{t-1} <= 130/3 then do;
 
	if e < sw_newp_lev_4_1 then newp{t}=0;
	if sw_newp_lev_4_1 <= e < sw_newp_lev_4_1+sw_newp_lev_4_2 then do; q=uniform(0); 
		if q < 0.7 then newp{t}=1; if 0.7 <= q < 0.8 then newp{t}=2; if 0.8 <= q < 0.9 then newp{t}=3; if 0.9 <= q < 0.95 then newp{t}=4;    
		if 0.95 <= q < 0.98 then newp{t}=5; if 0.98 <= q       then newp{t}=6;    
	end;
	if sw_newp_lev_4_1+sw_newp_lev_4_2 <= e < sw_newp_lev_4_1+sw_newp_lev_4_2+sw_newp_lev_4_3 then do; q=uniform(0); newp{t} = 6 + (q*34); newp{t} = round(newp{t},1);	 end;
	if sw_newp_lev_4_1+sw_newp_lev_4_2+sw_newp_lev_4_3 <= e < sw_newp_lev_4_1+sw_newp_lev_4_2+sw_newp_lev_4_3+sw_newp_lev_4_4  then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if sw_newp_lev_4_1+sw_newp_lev_4_2+sw_newp_lev_4_3+sw_newp_lev_4_4  <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); 
 newp{t}=newp{t}/3; newp{t} = round(newp{t},1);  end;
end;

if  t ge 2 and  130/3 <  newp{t-1} then do;

	if e < sw_newp_lev_5_1 then newp{t}=0;
	if sw_newp_lev_5_1 <= e < sw_newp_lev_5_1+sw_newp_lev_5_2 then do; q=uniform(0); 
		if q < 0.7 then newp{t}=1; if 0.7 <= q < 0.8 then newp{t}=2; if 0.8 <= q < 0.9 then newp{t}=3; if 0.9 <= q < 0.95 then newp{t}=4;    
		if 0.95 <= q < 0.98 then newp{t}=5; if 0.98 <= q       then newp{t}=6;  
	end;
	if sw_newp_lev_5_1+sw_newp_lev_5_2 <= e < sw_newp_lev_5_1+sw_newp_lev_5_2+sw_newp_lev_5_3 then do; q=uniform(0); newp{t} = 6 + (q*34); newp{t} = round(newp{t},1);	 end;
	if sw_newp_lev_5_1+sw_newp_lev_5_2+sw_newp_lev_5_3 <= e < sw_newp_lev_5_1+sw_newp_lev_5_2+sw_newp_lev_5_3+sw_newp_lev_5_4 then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if sw_newp_lev_5_1+sw_newp_lev_5_2+sw_newp_lev_5_3+sw_newp_lev_5_4 <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); 
 newp{t}=newp{t}/3;
newp{t} = round(newp{t},1);  end;
end;

 if age{t} > 30 then newp{t} = min(10,newp{t});
...
e=uniform(0);
if 0.95 <= rred_rc < 1.00 then do;if e < rate_newp0_rred_rc then newp{t}=0; end;
if 0.90 <= rred_rc < 0.95 then do;if e < 2 * rate_newp0_rred_rc then newp{t}=0; end;
if 0.80 <= rred_rc < 0.90 then do;if e < 3 * rate_newp0_rred_rc then newp{t}=0; end;
if 0.70 <= rred_rc < 0.80 then do;if e < 4 * rate_newp0_rred_rc then newp{t}=0; end;
if 0.00 <= rred_rc < 0.7 then do;if e < 5 * rate_newp0_rred_rc then newp{t}=0; end;
end;
...
if gender=1 then do;
  ...
  if t ge 3 and registd{t-1} ne 1 and epdiag{t-2}=0  and epdiag{t-1} =  1 then e=e/(ch_risk_diag**(1/3)); 
  if t ge 3 and registd{t-2} ne 1 and registd{t-1}=1 and epdiag{t-1} ne 1 then e=e/(ch_risk_diag**(1/3));
...
if t ge 2 and newp{t} ge 1 then ever_newp=1;
...
if -75 <= d_hiv_epi_wm < -20 then ep_incidence_factor_m = ep_incidence_factor_m * 2.5;  
if -200 <= d_hiv_epi_wm < -75 then ep_incidence_factor_m = ep_incidence_factor_m * 3.5;
...
if -75 <= d_hiv_epi_mw < -20 then ep_incidence_factor_w = ep_incidence_factor_w * 2.5; 
if -200 <= d_hiv_epi_mw < -75 then ep_incidence_factor_w = ep_incidence_factor_w * 3.5;  
...
if ep{t}=1 then do; epmono=0;
	...
	if epmono=1 and epi{t} ne 1 then do;
		if hiv{t}=1 then do;  
 			...
 			if       .  <  v{t-1} < 2.7 then rep = max(0,( 1 - (1 - tr_rate_undetec_vl)**(1/3) )+(0.000025/3*normal(0)));
 			else if 2.7 <= v{t-1} < 3.7 then rep = max(0,(( 1 - (1 - 0.01)**(1/3) )*fold_tr)+(0.0025/3*normal(0))); 
 			else if 3.7 <= v{t-1} < 4.7 then rep = max(0,(( 1 - (1 - 0.03)**(1/3) )*fold_tr)+(0.0075/3*normal(0)));
 			else if 4.7 <= v{t-1} < 5.7 then rep = max(0,(( 1 - (1 - 0.06)**(1/3) )*fold_tr)+(0.015/3*normal(0))); 
 			else if        v{t-1} >=5.7 then rep = max(0,(( 1 - (1 - 0.10)**(1/3) )*fold_tr)+(0.025/3*normal(0)));  
 			if primary{t-1}=1 		    then rep = max(0,( 1 - (1 - tr_rate_primary)**(1/3) )+(0.075/3*normal(0)));
...
if epi{t}=1 then do;
	...
	epart{t}=0; if epdiag{t}=1 then do; 
...
if pregnant=1 then do;  
	if a < prob_anc then do; 
		...
		if ever_tested ne 1 then do; ever_tested=1; date1test=caldate{t}; newp_lasttest_tested_this_per = newp_lasttest; newp_lasttest=0;end;
         u=uniform(0); if registd{t}=1 and tested{t} ne 1 and u<0.7 then do; tested_anc_prevdiag=1; end;
    end;
end;


  if t ge 2 and gender=2 and dt_lastbirth=caldate{t}-(1/12) and tested{t-1}=1 then do; 
...
if t ge 2 and (registd{t} ne 1) and hard_reach=0 then do;
	...
	if sw{t-1}=1 and newp{t-1} ge 1 then prep_elig=1; if prep_ever=1 and sw{t}=1 and newp{t}=1 then prep_elig=1; 
	end;

	if prep_strategy=2 then do;
	if sw{t-1}=1 and newp{t-1} ge 1 then prep_elig=1; if prep_ever=1 and sw{t}=1 and newp{t} ge 1 then prep_elig=1; 
...
if registd{t} ne 1 and caldate{t} ge (date_start_testing+3.5) and tested{t} ne 1 then do;
	...
	if t ge 2 and sw_test_6mthly=1 and sw{t}=1 and (caldate{t}-dt_last_test >= 0.5 or dt_last_test=.) then do; 
...
if t ge 4 and caldate{t} ge date_prep_intro and registd{t} ne 1 and prep_elig=1 then do;
	...
	if prep_ever=1 and dt_prep_s ne caldate{t} and (tested{t} ne 1 or (tested{t}=1 and (hiv{t}=0 or (hiv{t}=1 and unisensprep > sens_vct)))) then do; * may17;
		if prep_tm1 = 1 then do; 
			...
			if tested{t}=1 then do; 
				...
				r=uniform(0); 
				if r < prob_prep_restart then do; prep=1; dt_prep_e=caldate{t}; continuous_prep_use=1/12; dt_prep_c=caldate{t}; end;  
				end;
			end;
		end; 
	end;
...
if pop_wide_tld = 1 and registd{t} ne 1 and ( prep_elig = 1 or ( ever_newp = 1 and ever_tested ne 1 ) ) then do;  

	if prep_ever ne 1 then do;  

 			r=uniform(0);   if (prep_willing_pop=1 or  (sw{t}=1 and prep_willing_sw=1 )) and r < ( 1 - (1 - prob_prep_pop_wide_tld)**(1/3) ) then do ;

			prep   =1; pop_wide_tld_prep=1;  prep_ever=1; dt_prep_s=caldate{t}; dt_prep_e=caldate{t};
			end;
	end;

	if prep_ever = 1 and dt_prep_s ne caldate{t} then do;  
...
if caldate{t} ge date_prep_intro and registd{t} ne 1 and prep_elig=1 and pop_wide_tld ne 1 then do;
	...
	if prep   =1 then do;
		...
		if tested{t}=1 then do;
			visit_prep=2;
			if r < prob_prep_visit_counsel then visit_prep=3; 
		end;
...
r=uniform(0); if r < pop_wide_tld_prob_egfr then visit_prep=2; 
end;
...
if prep = 1 then do;
	adh{t}=adhav_pr + adhvar*normal(0);  if adh{t} gt 1 then adh{t}=1; 
...
rt103m=.;  rt181m=.;  rt190m=.; rt101m=.; rt138m=.; rt188m=.;    rt65m=.;  rt184m=.;  rt151m=.; tam=.;  pr32m=.; pr33m=.; pr46m=.; pr47m=.;  pr50lm=.; pr50vm=.; 
pr54m=.;   pr76m=.;   pr82m=.;   pr84m=.;  pr88m=.;   pr90m=.;  inprim=.; insm=.;
rt103m_p=.;  rt181m_p=.;  rt190m_p=.; rt101m_p=.; rt138m_p=.; rt188m_p=.;  rt65m_p=.;  rt184m_p=.;  rt151m_p=.;  tam_p=.;  pr32m_p=.;  pr33m_p=.;  pr46m_p=.;  pr47m_p=.; 
pr50lm_p=.;  pr50vm_p=.;  pr54m_p=.;   pr76m_p=.;  pr82m_p=.;   pr84m_p=.;   pr88m_p=.; pr90m_p=.;  inprim_p=.;  insm_p=.;
...
if t ge 2 and nip{t} gt 0 then do;
	d=1;do until (d gt nip{t});
		...
		if                   a < cu_1/cu_6 then do; risk_nip = max(0,(( 1 - (1 - tr_rate_undetec_vl)**(1/3) )*fold_tr_newp)+(0.000025/3*normal(0))); vl_source=1; s_prop_rm=s_prop_vlg1_rm; end; *new for prep;
		else if cu_1/cu_6 <= a < cu_2/cu_6 then do; risk_nip = max(0,(     ( 1 - (1 - 0.01)**(1/3) )     *fold_tr*fold_tr_newp)+(0.0025/3*normal(0)));       vl_source=2; s_prop_rm=s_prop_vlg2_rm; end; *new for prep;
		else if cu_2/cu_6 <= a < cu_3/cu_6 then do; risk_nip = max(0,(( 1 - (1 - 0.03)**(1/3) )*fold_tr*fold_tr_newp)+(0.0075/3*normal(0)));       vl_source=3; s_prop_rm=s_prop_vlg3_rm; end; *new for prep;
		else if cu_3/cu_6 <= a < cu_4/cu_6 then do; risk_nip = max(0,(( 1 - (1 - 0.06)**(1/3) )*fold_tr*fold_tr_newp)+(0.015/3*normal(0)));        vl_source=4; s_prop_rm=s_prop_vlg4_rm; end; *new for prep;
		else if cu_4/cu_6 <= a < cu_5/cu_6 then do; risk_nip = max(0,(( 1 - (1 - 0.10)**(1/3) )*fold_tr*fold_tr_newp)+(0.025/3*normal(0)));        vl_source=5; s_prop_rm=s_prop_vlg5_rm; end; *new for prep;
		else if cu_5/cu_6 <= a < cu_6/cu_6 then do; risk_nip = max(0,(( 1 - (1 - tr_rate_primary)**(1/3) )*fold_tr_newp)+(0.075/3*normal(0)));       vl_source=6; s_prop_rm=s_prop_vlg6_rm; end; *new for prep;



		  rt184m_p=0; tam_p=0;   rt65m_p=0;  rt151m_p=0; rt103m_p=0;  rt181m_p=0;  rt190m_p=0;  rt101m_p=0; rt138m_p=0; rt188m_p=0; 
		  pr32m_p=0;  pr33m_p=0;  pr46m_p=0;  pr47m_p=0;  pr50lm_p=0;  pr50vm_p=0;  pr54m_p=0;  
		  pr76m_p=0;  pr82m_p=0;  pr84m_p=0;  pr88m_p=0;  pr90m_p=0;   inprim_p=0;   insm_p=0;
		  mut_p=.;
		  ...
		  f=1;do until ((f=10) or (mut_p ge 1));  
				...
				g=uniform(0);
				if g < s_prop_rt184m  then rt184m_p=1;
	
				g=uniform(0);
				if g < s_prop_rt65m  then rt65m_p=1;
	
				g=uniform(0);
				if g < s_prop_rt151m  then rt151m_p=1;

				g=uniform(0);
				if g < s_prop_rt103m then rt103m_p=1;

				g=uniform(0);
				if g < s_prop_rt181m then rt181m_p=1;

				g=uniform(0);
				if g < s_prop_rt101m then rt101m_p=1;

				g=uniform(0);
				if g < s_prop_rt138m then rt138m_p=1;

				g=uniform(0);
				if g < s_prop_rt188m then rt188m_p=1;

				g=uniform(0);
				if g < s_prop_rt190m then rt190m_p=1;

				g=uniform(0);
				if g < s_prop_pr32m  then pr32m_p=1;

				g=uniform(0);
				if g < s_prop_pr33m  then pr33m_p=1;

				g=uniform(0);
				if g < s_prop_pr46m  then pr46m_p=1;

				g=uniform(0);
				if g < s_prop_pr47m  then pr47m_p=1;

				g=uniform(0);
				if g < s_prop_pr50lm  then pr50lm_p=1;

				g=uniform(0);
				if g < s_prop_pr50vm  then pr50vm_p=1;

				g=uniform(0);
				if g < s_prop_pr54m  then pr54m_p=1;

				g=uniform(0);
				if g < s_prop_pr76m  then pr76m_p=1;

				g=uniform(0);
				if g < s_prop_pr82m  then pr82m_p=1;

				g=uniform(0);
				if g < s_prop_pr84m  then pr84m_p=1;

				g=uniform(0);
				if g < s_prop_pr88m  then pr88m_p=1;

				g=uniform(0);
				if g < s_prop_pr90m  then pr90m_p=1;

				g=uniform(0);
				if g < s_prop_inprim  then inprim_p=1;

				g=uniform(0);
				if g < s_prop_insm  then insm_p=1;

				mut_p = tam_p + rt184m_p + rt65m_p + rt151m_p + rt103m_p + rt181m_p + rt190m_p  + rt101m_p + rt138m_p + rt188m_p
				+ pr32m_p + pr33m_p + pr46m_p + pr47m_p + pr50lm_p + pr50vm_p + pr54m_p 
				+ pr76m_p + pr82m_p + pr84m_p + pr88m_p + pr90m_p  + inprim_p  + insm_p;
		...
		if gender=2 and       age{t} >= 20 then risk_nip = risk_nip * fold_change_w;  
		if gender=2 and 15 <= age{t} <  20 then risk_nip = risk_nip * fold_change_yw;  
		if sti{t}=1                        then risk_nip = risk_nip * fold_change_sti;  
		if gender=1 and mcirc   =1         then risk_nip = risk_nip * 0.4;  
		if prep   =1 then do; 
			if rt184m_p ne 1 and rt65m_p ne 1 and tam_p<3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p ne 1 and tam_p>=3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p ne 1 and tam_p<3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p=1 and tam_p<3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p ne 1 and tam_p>=3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p=1 and tam_p>=3 then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1  then risk_nip = risk_nip * (1-(adh{t} * 0.50 * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1 and (inprim_p ne 1 and pop_wide_tld_prep=1)  then risk_nip = risk_nip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1 and inprim_p = 1 and pop_wide_tld_prep=1  then risk_nip = risk_nip * (1-(adh{t} * 0.5 * eff_adh_prep));
		...
		a=uniform(0); if a < risk_nip then do;
		    if hiv{t}=1 then do;
    		if onart{t} ne 1 then s_infection=1;  
			end;
			if hiv{t}=0 then do;
				vl_source_inf = vl_source;
			    infected_primary=0;infected_vlsupp=0;
			    hiv{t}=1; infected_newp=1; infected_ep=0; infection=caldate{t};
				...
				infected_prep=1; infected_prep_source_prep_r=0; if (tam_p + rt184m_p + rt65m_p) ge 1 then infected_prep_source_prep_r=1; 
				end;
			end;
			goto xx77;
		end;
...
d=uniform(0);
if epi{t}=1 then do;  
 	if epvls{t}=1    then do;   risk_eip = max(0,( 1 - (1 - tr_rate_undetec_vl)**(1/3) )+(0.000025/3*normal(0)));   vl_source=1;   	s_prop_rm=s_prop_vlg1_rm;   end;
 	if epvls{t} ne 1 then do;
 		if epi{t-1}=0 then do;   risk_eip = max(0,( 1 - (1 - tr_rate_primary)**(1/3) )+(0.075/3*normal(0)));   ep_primary=1;   vl_source=6;	  s_prop_rm=s_prop_vlg6_rm;   end;* infection in primary;
 		if epi{t-1}=1 then do;   risk_eip = max(0,(( 1 - (1 - 0.05)**(1/3) )*fold_tr)+(0.0125/3*normal(0)));   vl_source=4;   s_prop_rm=s_prop_vlg4_rm;   end;
 	end;
	...
	if gender=2 and age{t} <  20 then risk_eip = risk_eip * fold_change_yw;
	if gender=2 and age{t} ge 20 then risk_eip = risk_eip * fold_change_w;  
	if sti{t}=1                  then risk_eip = risk_eip * fold_change_sti;  
	if gender=1 and mcirc   =1   then risk_eip = risk_eip* 0.4;  

		if prep   =1 then do; 
			if rt184m_p ne 1 and rt65m_p ne 1 and tam_p<3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p ne 1 and tam_p>=3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p ne 1 and tam_p<3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p=1 and tam_p<3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p ne 1 and tam_p>=3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p ne 1 and rt65m_p=1 and tam_p>=3 then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1  then risk_eip = risk_eip * (1-(adh{t} * 0.50 * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1 and (inprim_p ne 1 and pop_wide_tld_prep=1)  then risk_eip = risk_eip * (1-(adh{t} * eff_adh_prep));
			if rt184m_p=1 and rt65m_p=1 and inprim_p = 1 and pop_wide_tld_prep=1  then risk_eip = risk_eip * (1-(adh{t} * 0.5 * eff_adh_prep));
	...
	if b < risk_eip then do;
		...
		if hiv{t}=1 then do;
    		...
    		s_infection=0; if onart{t} ne 1 and b < risk_eip then s_infection=1;  
		end;
	goto xx77;
	end;
end;
...
if infection = caldate{t} then age_infection = age{t};


xx77:   
if hiv{t}=1 then do;

		rt103m=rt103m_p;  rt181m=rt181m_p;  rt190m=rt190m_p;   rt101m=rt101m_p;  rt138m=rt138m_p;  rt188m=rt188m_p; 
		rt65m=rt65m_p;  rt184m=rt184m_p;  rt151m=rt151m_p;  tam=tam_p;
		pr32m=pr32m_p;    pr33m=pr33m_p;    pr46m=pr46m_p;    pr47m=pr47m_p;  pr50lm=pr50lm_p;
		pr50vm=pr50vm_p;  pr54m=pr54m_p;    pr76m=pr76m_p;    pr82m=pr82m_p;  pr84m=pr84m_p;  pr88m=pr88m_p;  pr90m=pr90m_p; 
		inprim=inprim_p;  insm=insm_p;
	
		if prep    ne 1 then do;
			if tam ge 1 then do; u=uniform(0); if u < 0.5  then tam = 0 ; end; * may17;
			if rt184m= 1 then do; u=uniform(0); if u < 0.8  then rt184m=0; end;
			if rt65m = 1 then do; u=uniform(0); if u < 0.8  then rt65m =0; end; 
		end;
        if rt151m= 1 then do; u=uniform(0); if u < 0.5 then rt151m=0; end; 

		if rt103m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt103m=0; end;
		if rt181m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt181m=0; end;
		if rt101m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt101m=0; end;
		if rt138m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt138m=0; end;
		if rt188m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt188m=0; end;
		if rt190m = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_nn then rt190m=0; end;

		if pr32m = 1 then do; u=uniform(0); if u < 0.5 then pr32m=0; end;
		if pr33m = 1 then do; u=uniform(0); if u < 0.5 then pr33m=0; end;
		if pr46m = 1 then do; u=uniform(0); if u < 0.5 then pr46m=0; end;
		if pr47m = 1 then do; u=uniform(0); if u < 0.5 then pr47m=0; end;
		if pr50lm = 1 then do; u=uniform(0); if u < 0.5 then pr50lm=0; end;
		if pr50vm = 1 then do; u=uniform(0); if u < 0.5 then pr50vm=0; end;
		if pr54m = 1 then do; u=uniform(0); if u < 0.5 then pr54m=0; end;
		if pr76m = 1 then do; u=uniform(0); if u < 0.5 then pr76m=0; end;
		if pr82m = 1 then do; u=uniform(0); if u < 0.5 then pr82m=0; end;
		if pr84m = 1 then do; u=uniform(0); if u < 0.5 then pr84m=0; end;
		if pr88m = 1 then do; u=uniform(0); if u < 0.5 then pr88m=0; end;
		if pr90m = 1 then do; u=uniform(0); if u < 0.5 then pr90m=0; end;

		if inprim = 1 then do; u=uniform(0); if u < 0.2*res_trans_factor_ii then inprim=0; end; * jun18;
...
if (s_hiv1564  <= 0) and caldate{t}=startyr and newp{t} >= newp_seed and d < 0.8   and infection=.  then do; 
		...
		tam=0;   rt103m=0; rt181m=0; rt190m=0;   rt101m=0;  rt138m=0;  rt188m=0;
		rt184m=0; rt151m=0; rt65m=0;  pr32m=0; pr33m=0; pr46m=0; pr47m=0;  pr50lm=0; 
		pr50vm=0; pr54m=0;  pr76m=0;  pr82m=0;  pr84m=0;  pr88m=0;  pr90m=0;  inprim=0; insm=0;
end;
...
array visit{8} visit&g-visit&h; 
array lost{8} lost&g-lost&h; 

array linefail{8} linefail&g-linefail&h; 
array tcur{8} tcur&g-tcur&h; 
array artline{8} artline&g-artline&h;
array toffart{8} toffart&g-toffart&h; 
...
array resumec{8} resumec&g-resumec&h; 

array nod{8} nod&g-nod&h; 
array nonuc{8} nonuc&g-nonuc&h;


array nactive{8} nactive&g-nactive&h;
array newmut{8} newmut&g-newmut&h; 


array c_totmut{8} c_totmut&g-c_totmut&h;  
array e_totmut{8} e_totmut&g-e_totmut&h;  
...
array who3_{8} who3_&g-who3_&h; 
array who4_{8} who4_&g-who4_&h; 
...
patient_cd4_rise_art=exp(sd_patient_cd4_rise_art*normal(0));  
...
c_rttams=max(0,tam);
c_rt184m= max(0,rt184m);
c_rt151m = max(0,rt151m);
c_rt65m = max(0,rt65m);
c_pr32m=max(0,pr32m);
c_pr33m=max(0,pr33m);
c_pr46m=max(0,pr46m);
c_pr47m=max(0,pr47m);
c_pr50vm=max(0,pr50vm);
c_pr50lm=max(0,pr50lm);
c_pr54m=max(0,pr54m);
c_pr76m=max(0,pr76m);
c_pr82m=max(0,pr82m);
c_pr84m=max(0,pr84m);
c_pr88m=max(0,pr88m);
c_pr90m=max(0,pr90m);
c_rt101m= max(0,rt101m);
c_rt103m= max(0,rt103m);
c_rt138m= max(0,rt138m);
c_rt181m= max(0,rt181m);
c_rt188m= max(0,rt188m);
c_rt190m= max(0,rt190m);
c_inprim=max(0,inprim);
c_insm=max(0,insm);
...
c_pr88m_inf=c_pr88m;
c_pr90m_inf=c_pr90m;
c_rt101m_inf=c_rt101m;
c_rt103m_inf=c_rt103m;
c_rt138m_inf=c_rt138m;
c_rt181m_inf=c_rt181m;
c_rt188m_inf=c_rt188m;
c_rt190m_inf=c_rt190m;
c_inprim_inf=c_inprim;
c_insm_inf=c_insm;
...
if c_rt101m = 1 or c_rt103m=1 or c_rt138m = 1 or c_rt181m=1 or c_rt188m = 1 or c_rt190m=1 or c_rt65m=1 or c_rt184m=1 or c_rttams >= 1 
or c_prm_inf=1 or c_inprim=1 or c_insm=1 or c_rt151m then c_rm_inf=1 ; else c_rm_inf=0;
...
if e_rt101m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1 then r_efa=0.75;  if e_rt103m=1 then r_efa=1.00; 
if e_rt101m=1 or e_rt138m=1 or e_rt188m=1 or e_rt190m=1 then r_nev=0.75;  if e_rt103m=1 or e_rt181m=1 then r_nev=1.00; 
if e_rt101m=1 or e_rt138m=1 or e_rt188m=1 or e_rt190m=1 then r_rla=0.75;  if e_rt103m=1 then r_rla=0.25;  

if nnrti_res_no_effect = 0.75 then do ;r_efa = min(0.25,r_efa);r_rla = min(0.25,r_rla); end;
if nnrti_res_no_effect = 1 then do ;r_efa = 0 ; r_rla = 0 ; end;
	...
	if e_insm=1 then r_dol=0.25; if e_inprim=1 and e_insm=0 then r_dol=0.75; if e_inprim=1 and e_insm=1 then r_dol=1.0;


	if e_insm=1 then r_cla=0.25; if e_inprim=1 and e_insm=0 then r_cla=0.75; if e_inprim=1 and e_insm=1 then r_cla=1.0;
...
if t ge 2 then do; 
	...
	if hivtest_type=4 then do;
		u=uniform(0);
		if primary{t}=1 and tested{t}=1 and u lt sens_primary_ts1m then do;
...
o_zdv=0;o_nev=0;o_lpr=0;o_taz=0;o_efa=0;o_rla=0;o_cla=0;
end;
...
registd{t}=registd{t-1}; lost{t}=lost{t-1};
	...
	if t ge 2 and onart{t}=1 then tcur{t}=tcur{t-1} + (1/12) ;
	
	if t ge 2 and prep   =1 then tcur{t}=tcur{t-1} + (1/12) ;
	...
	o_rla_tm3=o_rla_tm2; o_rla_tm2=o_rla_tm1; o_rla_tm1=o_rla;  p_rla_tm1=p_rla;f_rla_tm1=f_rla; t_rla_tm1=t_rla;r_rla_tm1=r_rla;
    ...
    o_cla_tm3=o_cla_tm2; o_cla_tm2=o_cla_tm1; o_cla_tm1=o_cla;  p_cla_tm1=p_cla;f_cla_tm1=f_cla; t_cla_tm1=t_cla;r_cla_tm1=r_cla;
	...
	mr_rla_tm1=mr_rla; if tss_rla ge 0 and o_rla_tm1=0 then tss_rla = tss_rla+(1/12);
	...
	mr_cla_tm1=mr_cla; if tss_cla ge 0 and o_cla_tm1=0 then tss_cla = tss_cla+(1/12);

	if p_cla = 1 and tss_cla = cla_time_to_lower_threshold > . then cla_time_since_below_low_thresh = 0;
	if p_cla = 1 and tss_cla > cla_time_to_lower_threshold > . then cla_time_since_below_low_thresh = cla_time_since_below_low_thresh + 1/12;
	...
	e_rt101m_tm2=e_rt101_tm1;	e_rt101m_tm1=e_rt101m;
	e_rt103m_tm2=e_rt103_tm1;	e_rt103m_tm1=e_rt103m;
	e_rt138m_tm2=e_rt138_tm1;	e_rt138m_tm1=e_rt138m;
	e_rt181m_tm2=e_rt181_tm1;	e_rt181m_tm1=e_rt181m;
	e_rt188m_tm2=e_rt188_tm1;	e_rt188m_tm1=e_rt188m;
	...
	e_inprim_tm2=e_inprim_tm1;	e_inprim_tm1=e_inprim;
	...
	c_rt101m_tm2=c_rt101_tm1;	c_rt101m_tm1=c_rt101m;
	c_rt103m_tm2=c_rt103_tm1;	c_rt103m_tm1=c_rt103m;
	c_rt138m_tm2=c_rt138_tm1;	c_rt138m_tm1=c_rt138m;
	c_rt181m_tm2=c_rt181_tm1;	c_rt181m_tm1=c_rt181m;
	c_rt188m_tm2=c_rt188_tm1;	c_rt188m_tm1=c_rt188m;
	...
	c_inprim_tm2=c_inprim_tm1;	c_inprim_tm1=c_inprim;
	c_insm_tm2=c_insm_tm1;		c_insm_tm1=c_insm;

	sx=uniform(0);
	if super_infection=1 then do;
		if s_infection=1 and sx<0.2 then do;
			c_rt101m=max(rt101m,c_rt101m);c_rt103m=max(rt103m,c_rt103m);c_rt138m=max(rt138m,c_rt138m);
			c_rt181m=max(rt181m,c_rt181m);c_rt188m=max(rt188m,c_rt188m);c_rt190m=max(rt190m,c_rt190m);
			c_inprim=max(inprim,c_inprim); c_insm=max(insm,c_insm);
			c_rttams= max(c_rttams,tam); c_rt184m= max(rt184m,c_rt184m);
			c_rt151m= max(rt151m,c_rt151m); c_rt65m= max(rt65m ,c_rt65m); 
			c_pr32m=max(pr32m,c_pr32m);c_pr33m=max(pr33m,c_pr33m);
			c_pr46m=max(pr46m,c_pr46m);c_pr47m=max(pr47m,c_pr47m);
			c_pr50vm=max(pr50vm,c_pr50vm);c_pr50lm=max(pr50lm,c_pr50lm);c_pr54m=max(pr54m,c_pr54m);
			c_pr76m=max(pr76m,c_pr76m);c_pr82m=max(pr82m,c_pr82m);c_pr84m=max(pr84m,c_pr84m);
			c_pr88m=max(pr88m,c_pr88m);c_pr90m=max(pr90m,c_pr90m);
			c_inprim=max(inprim,c_inprim);		 c_insm=max(insm,c_insm);

			if tam=1 or rt103m=1 or rt181m=1 or rt190m=1 or rt101m=1 or rt138m=1 or rt188m=1
			or rt184m=1 or rt151m=1 or rt65m=1 or pr32m=1 or pr33m=1 or pr46m=1 or 
			pr47m=1 or pr50lm=1 or pr50vm=1 or pr54m=1 or pr76m=1 or pr82m=1 or pr84m=1 or pr88m=1 or pr90m=1 or inprim=1 or insm=1 then  
			super_i_r=1; 
			if rt101m=1 or rt103m=1 or rt138m=1 or rt181m=1 or rt188m=1 or rt190m=1 then super_nnm=1; 
		end;
	end;
...
elig_test_who4=0;elig_test_who3=0;elig_test_tb=0;elig_test_who4_tested=0;elig_test_tb_tested=0;elig_test_who3_tested=0;
	...
	if hiv{t}=1 and tested{t}=1 and registd{t-1} ne 1 and prep_falseneg ne 1 then do;	
		unisens=uniform(0);		
		if t ge 3 and unisens lt sens_vct then do; 
			...
			d=uniform(0);  
			if      adc{t-1} ne 1 and who3_event{t-1} ne 1 and ((caldate{t} - date_most_recent_tb) > 0.5 or (caldate{t} - date_most_recent_tb)=.)  
			and onart{t-1} ne 1 and pop_wide_tld_prep ne 1 then do;
...
if registd{t}=1 and registd{t-1}=0 and onart{t}=1 and pop_wide_tld_prep=1 then do; pop_wide_tld_prep = 0; prep = 0;  end;
    ...
    if o_cla = 1 and o_rla=1  then e_rate_return = e_rate_return / rel_onart_la_drugs;
	...
	if registd{t}=1 and (pregnant=1 or . < caldate{t} - dt_lastbirth <= 1) and art_initiation_strategy in (3,9,10) then do;
 	...
 	if t ge 2 then do;
 		pr_x4_shift=(10**v{t-1})*0.0000004;   s=uniform(0);   if s < ( 1 - (1 - pr_x4_shift)**(1/3) ) then do;   x4v{t}=1;   date_x4=caldate{t};   end;
 	end;
	...
	if t ge 2 and prep    ne 1 then do;
		...
		if naive{t}=1 or (naive{t-1}=1 and tcur{t}=0) or (toffart{t} gt 1/12) then do;
			vc{t-1}=(gxx*0.02275 + (0.05 * normal(0)))+ ((age{t-1}-35)*0.00075);
	...
	if t ge 3 and prep    ne 1 then do;
		...
		if naive{t}=1 or (naive{t-1}=1 and tcur{t}=0) or (toffart{t} gt 0 and 0 <= c{t-1}-cmin{t-1} < 300) or (toffart{t} gt 0
		and (resumec{t-1}=1 or resumec{t-2}=1)) then do;

			if v{t-1} < 3 then ccsqr{t-1}=+0.000*fxx+(sd_cd4*normal(0));
			if 3 <= v{t-1} < 3.5 then ccsqr{t-1}=-0.022*fxx+(sd_cd4*normal(0));
			if 3.5 <= v{t-1} < 4 then ccsqr{t-1}=-0.085*fxx+(sd_cd4*normal(0));
			if 4 <= v{t-1} < 4.5 then ccsqr{t-1}=-0.40*fxx+(sd_cd4*normal(0));
			if 4.5 <= v{t-1} < 5 then ccsqr{t-1}=-0.40*fxx+(sd_cd4*normal(0));
			if 5 <= v{t-1} < 5.5 then ccsqr{t-1}=-0.85*fxx+(sd_cd4*normal(0));
			if 5.5 <= v{t-1} < 6 then ccsqr{t-1}=-1.30*fxx+(sd_cd4*normal(0));
			if 6.0 <= v{t-1} then ccsqr{t-1}=-1.75*fxx+(sd_cd4*normal(0));


			if x4v{t-1}=1 then ccsqr{t-1}=ccsqr{t-1}-0.25;

  ccsqr{t-1} = ccsqr{t-1} / 3;
...
res_test=.;
	...
	and naive{t}=1 and visit{t}=1 and (date_latest_cm = . or (caldate{t} - date_latest_cm) > 0.25) and w < prob_cd4_meas_done then do;
	...
	if t ge 3 and  time0 = . then do;
		...
		if art_initiation_strategy=1 then do; 
			if t ge 3 and visit{t}=1 and naive{t-1}=1 and art_intro_date <= caldate{t} and who4_{t-1}=1 then do;
				if (who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then u=u/2;
		...
		if art_initiation_strategy=2 then do;
			if t ge 3 and visit{t}=1 and naive{t-1}=1 and art_intro_date <= caldate{t} and (who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) 
			then do; 
				if (who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then u=u/2;
				if u < eff_pr_art_init then time0=caldate{t};
				if dt_first_elig=. then dt_first_elig=caldate{t};end;
		...
		if hiv_monitoring_strategy=2 and art_initiation_strategy=4 then do;
			...
			(. < cm    < 200 or . < cm_tm1  < 200 or . < cm_tm2  < 200 or who4_{t-1}=1  or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then do;
				if (who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then u=u/2;
		...
		if hiv_monitoring_strategy=2 and art_initiation_strategy=5 then do;
			...
			or who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then do;
				if (who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then u=u/2;
				if dt_first_elig=. then dt_first_elig=caldate{t};
				if u < eff_pr_art_init then time0=caldate{t};
			end;
		...
		if hiv_monitoring_strategy=2 and art_initiation_strategy in (6 9) then do;
			if t ge 4 and visit{t}=1 and naive{t-1}=1 and art_intro_date <= caldate{t} and
			(. < cm    < 350 or . < cm_tm1  < 350 or . < cm_tm2  < 350 or who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then do;
				if dt_first_elig=. then dt_first_elig=caldate{t};
		...
		if hiv_monitoring_strategy=2 and art_initiation_strategy = 10 then do;  
			if t ge 4 and visit{t}=1 and naive{t-1}=1 and art_intro_date <= caldate{t}  and
			(. < cm    < 500 or . < cm_tm1  < 500 or . < cm_tm2  < 500 or who4_{t-1}=1 or 0 <= (caldate{t} - date_most_recent_tb) <= 0.5) then do;
				if dt_first_elig=. then dt_first_elig=caldate{t};
			...
			if anc=1 and naive{t}=1 and uu < prob_pmtct then do;
				if time0=. then do;
					if caldate{t} le 2010.5 then do;
						on_sd_nvp=1; 
						if u < prob_nnresmaj_sd_nvp then do; c_rt181m=1; nn_res_pmtct=1; e_rt181m=1; end;
					end;
					else if 2010.5 <= caldate{t} < 2012.5 then do;   
						on_dual_nvp=1; 
						if u < prob_nnresmaj_dual_nvp then do; c_rt181m=1; nn_res_pmtct=1; e_rt181m=1; end;
					end;
				end;
			end;
		end;
...
if onart{t} ne 1 and toffart{t} >= 0 and (p_cla ne 1 or cla_time_since_below_low_thresh > 0) then do;

	if t ge 4 and (0 <= toffart{t} <= 0.25 or (0 <= cla_time_since_below_low_thresh <= 0.25) ) then do;
 ...
 cc{t-1} = cc{t-1} / 3; 
	...
	if t ge 4 and (0.25 < toffart{t} <= 0.5 or (0.25 < cla_time_since_below_low_thresh <= 0.5)) and resumec{t-1} ne 1 then do;
...
cc{t-1} = cc{t-1} / 3;
	...
	if (0.5 < toffart{t} <= 0.75  or (0.5 < cla_time_since_below_low_thresh <= 0.75)) and t ge 4 and (resumec{t-1} ne 1 and resumec{t-2} ne 1) then do;
 ...
 cc{t-1} = cc{t-1} / 3;
	...
	c_200_gt_nad=0;if t ge 3 and (toffart{t} gt 0  or (0 < cla_time_since_below_low_thresh)) and c{t-1}-cmin{t-1} > 300 then do;
 ...
 cc{t-1} = cc{t-1} / 3;
	...
	if stop_tox    ne 1 then do; 
	   ...
	   if pregnant=1 then prointer = prointer/100; 
		if tcur{t} ge 1 then prointer=prointer/2;
		if o_cla = 1 and o_rla=1 then prointer = rel_onart_la_drugs * prointer;
 
		if higher_newp_less_engagement = 1 and t ge 2 and newp{t-1} > 1 then prointer = prointer * 1.5; 
...
if t ge 2 and prep_tm1 =1 and prep   =0 and registd{t} ne 1 and onart{t}=1 then interrupt{t}=1;	
	...
	and restart{t-1}=0 and visit{t}=1 and onart{t-1}=1 then do; 
		...
		if o_rla_tm1=1 then do;  mr_rla=1;tss_rla=0; end;
		...
		if o_cla_tm1=1 then do;  mr_cla=1;tss_cla=0; end;
		o_zdv=0; o_3tc=0; o_efa=0; o_dar=0; o_ten=0;
		o_lpr=0; o_taz=0; o_dol=0; o_nev=0; o_rla=0; o_cla=0;
...
if interrupt{t}=1 then do; 
    ...
    if o_cla = 1 and o_rla=1  then e_rate_restart = e_rate_restart / rel_onart_la_drugs;
	...
	if t ge 2 and restart{t}=1 then do;
		...
		o_cla=mr_cla_tm1;
			...
			if reg_option     in (501) then do; 
			o_efa=0; o_nev=0; o_dol=0; o_taz=0; o_lpr=0; o_dar=0; o_zdv=0; o_3tc=0; o_ten=0; o_cla=1; o_rla=1;
			end;

	
			if restart_res_test=1 then do;
			res_test=1;
    		if  (c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1) and (o_efa=1 or o_nev=1) then do; o_ten=1; o_3tc=1; o_dol=1;o_efa=0 ; o_nev=0; end;
    		end;
...
o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_lpr=0;o_taz=0;o_efa=0;o_dol=0;o_cla=0;o_rla=0;
...
if reg_option in (501) then flr=3;
	...
	if flr=3 then do; o_cla=1; o_rla=1; end;

    if base_res_test=1 then do;  res_test=1;
    if  (c_rt101m=0 and c_rt103m=0 and c_rt138m=0 and c_rt181m=0 and c_rt188m=0 and c_rt190m=0)  then do;  o_ten=1; o_3tc=1; o_efa=1; end;
    if  (c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1)  then do;    o_ten=1; o_3tc=1; o_dol=1;o_efa=0; end;
    end;
...
if reg_option in (105 106) and o_dol=1 and linefail{t-1}=1 and line2=0 and start_line2=1 then start_line2=.; 
	...
	if reg_option in (501 ) and f_cla=1 and o_cla=1 and o_taz ne 1 and o_lpr ne 1 and (p_taz=1 or p_lpr=1) then do;
		if t ge 2  and interrupt{t}=0 and visit{t}=1 then do;   
			q=uniform(0); if q < e_pr_switch_line then restart_pi_after_cla_fail=1;
		end;
	end;
	...
	if reg_option in (9999) and linefail{t-1}=2 and (f_dol=1 and f_3tc=1 and f_zdv=1) then do; 
 ...
 if reg_option in (104 118) and linefail{t-1}=2 and (f_dol=1 and f_3tc=1 and f_ten=1) then do;
...
if reg_option in (501 ) and linefail{t-1}=2 and (f_cla=1) then do;

		if t ge 2 and linefail{t-1}=2 and onart{t-1}=0 and restart{t}=1 and visit{t}=1 then do;
			restart_pi_after_cla_fail=1; 
		end;
...
if reg_option in (103 104 110 111 114 116 117 118 119) and linefail{t-1}=2 and (f_dol=1) then do;  
...
no_recent_vm_gt1000=0; if onart{t}=1 and artline{t}=1 and (sv=1 or (time_since_last_vm_gt3 = . or time_since_last_vm_gt3 > 0.75)) then no_recent_vm_gt1000=1;
recent_vm_gt1000=0; if onart{t}=1  and artline{t}=1 and (0 <= time_since_last_vm_gt3 <= 0.5) then recent_vm_gt1000=1;
	...
	if  reg_option in (501)  and onart{t-1} = 1 and interrupt{t}=0  and transition_to_cla_done ne 1	then do;
		o_efa=0; o_nev=0; o_dol=0; o_taz=0; o_lpr=0; o_dar=0; o_zdv=0; o_3tc=0; o_ten=0; o_cla=1; o_rla=1;
		if o_dol_tm1 =1 then tss_dol=0;if o_3tc_tm1 =1 then tss_3tc=0;if o_ten_tm1 =1 then tss_ten=0;if o_zdv_tm1 =1 then tss_zdv=0;
		if o_nev_tm1 =1 then tss_nev=0;if o_taz_tm1 =1 then tss_taz=0;if o_lpr_tm1 =1 then tss_lpr=0;if o_dar_tm1 =1 then tss_dar=0;
		if o_efa_tm1 =1 then tss_efa=0;
		transition_to_cla_done = 1; date_transition_to_cla_done=caldate{t};
	end;


	if  reg_option in (501) and 
		((option in  (21 22) and 22.9 < age{t} < 23.1) or
		(option = 23 and adhav gt 0.8) or
		(option in (25 26) and sw{t} ne 1))
		and onart{t-1} = 1 and o_cla_tm1 = 1 and interrupt{t}=0  and transition_cla_to_dol_done ne 1	then do;
		reg_option = 104; 
		o_efa=0; o_nev=0; o_dol=1; o_taz=0; o_lpr=0; o_dar=0; o_zdv=0; o_3tc=1; o_ten=1; o_cla=0; o_rla=0;
		tss_cla=0;tss_rla=0; 
		transition_cla_to_dol_done = 1; date_transition_cla_to_dol=caldate{t};
	end;
...
if caldate{t} ge 2020.5 and art_monitoring_strategy=1500 and (o_dol ne 1 or linefail{t} ge 1) then art_monitoring_strategy=150; 
	...
	if o_cla = 1 then cla_time_since_below_low_thresh = .;
...
if prep=0 and switch_for_tox = 1 then do;
	...
	x7: end;
            ...
            s=uniform(0); if t ge 2  and interrupt{t}=0 and o_ten_tm1=1 and (c_neph_tm1=1 and s lt r_swi_ten_neph) then do;
                  sw_toxicity{t}=1;
	...
	s=uniform(0);  if t ge 2  and interrupt{t}=0 and o_dol_tm1=1 and (c_cns_tm1=1 and s < r_swi_dol_cns) then do; 
		sw_toxicity{t}=1;
...
start_line2_this_period=.;
	...
	if art_intro_date <= caldate{t} < 2010.5 and (f_efa=1 or f_nev=1) then do;
			o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_lpr=0;o_taz=0;o_efa=0;o_dol=0;o_dar=0;o_cla=0; o_rla=0;
			o_3tc=1;
	...
	if caldate{t} >= 2015 and (f_efa=1 or f_nev=1)  and reg_option in (103 110 111 114 116 117 119) then do; * aug18;
 	...
 	if caldate{t} >= 2015 and f_dol=1 and reg_option in (102 103 104 113 115 116 117 118 119) then do;
			o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_taz=0;o_taz=0;o_efa=0;o_dol=0;o_dar=0;o_cla=0; o_rla=0;
			o_3tc=1;
			if f_taz=0 and t_taz=0 then o_taz=1;
 	...
 	if reg_option in (501) and f_cla=1 then do;
			o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_taz=0;o_taz=0;o_efa=0;o_dol=0;o_dar=0;o_cla=0; o_rla=0;
			o_3tc=1;
			if f_taz=0 and t_taz=0 then o_taz=1;
			if o_taz=0 and (t_nev=0 and f_nev=0) then o_nev=1;
...
vv66:
	if t ge 2 then do;
			...
			if o_rla_tm1=1  and o_rla=0 then do;  tss_rla=0; end;
			if o_lpr_tm1=1  and o_lpr=0 then do;  tss_lpr=0; end;
			if o_dol_tm1=1  and o_dol=0 then do;  tss_dol=0; end;
			if o_cla_tm1=1  and o_cla=0 then do;  tss_cla=0; end;
	end;
end;
...
if choose_line3=1  then do;
	...
	o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_lpr=0;o_dar=0;o_efa=0;o_dol=0;o_taz=0;o_cla=0; o_rla=0;
		o_dar=1; o_dol=1;
...
if restart_pi_after_cla_fail=1  then do;  
...
if reg_option in (105 106) then art_monitoring_strategy = 153; 
	nod{t}=o_zdv+o_3tc+o_ten+o_nev+o_dar+o_lpr+o_taz+o_efa+o_dol+o_rla+o_cla;
	...
	if o_rla=1 then p_rla=1;
	if o_cla=1 then p_cla=1;
...
if o_rla=1 and p_rla_tm1 ne 1 then date_start_rla = caldate{t};
if o_cla=1 and p_cla_tm1 ne 1 then date_start_cla = caldate{t};
if o_taz=1 and p_taz_tm1 ne 1 then date_start_taz = caldate{t};

if o_cla=1 and o_cla_tm1 ne 1 then date_last_start_cla = caldate{t};


	if t ge 2 and onart{t-1}=1 and (prep ne 1 or adh{t} = .) then do; 
	...
	if adhav_increase_due_to_alert=. and v_alert_perm_incr_adh=1 and caldate{t} >= date_v_alert > .  then do;
		...
		r=uniform(0); if c_tox{t-1}=1 and r < 0.5 then adh{t}=adh{t}-red_adh_tox;

		if o_zdv = 1 or o_taz = 1 or o_lpr = 1 then adh{t} = adh{t} - red_adh_multi_pill ;

		if t ge 3 and (0 <= (caldate{t} - date_most_recent_tb) <= 0.5 or adc{t-1}=1) then adh{t}=adh{t}- red_adh_tb_adc ;

	f=uniform(0);
	if o_lpr=1 or o_taz=1 or o_dar=1 then  f=f/10;  
	if f < 0.010   then adh{t} = adh{t} - 0.6;   
...
if sw_lower_art_adh = 1 then do;
if gender=2 and sw{t}=1 and adh{t} > 0.8 and e < 0.3 then do; r=uniform(0); adh{t}=0.65; if r < 0.33 then adh{t}=0.1; end;
end;
...
if t ge 2 then adhmin{t}=min(adh{t},adhmin{t-1});
	...
	if t ge 2 and 1  < tcur{t-1} <= 3  and patient_cd4_rise_art > 1 then pt_cd4_rise_art = patient_cd4_rise_art / 1.25;
	if t ge 2 and 3  < tcur{t-1} < 5  and patient_cd4_rise_art > 1 then pt_cd4_rise_art = patient_cd4_rise_art / 4;
	if t ge 2 and 5  <= tcur{t-1} and patient_cd4_rise_art > 1 then pt_cd4_rise_art = patient_cd4_rise_art / 12;  
...
if adh{t} gt 1 then adh{t}=1;
		...
		if t ge 2 and tcur{t-1}=0 and caldate{t} = yrart + (1/12) then adh_in_first_period_onart = adh{t};
...
if current_adh_dl > . then do;

	if t ge 2 and nactive{t-1} ge 3 then do;

 		if 0 <= tcur{t-1} < 1/12 then do;
 			 if current_adh_dl >= 0.8 then do;   v{t}=vmax{t-1}-(3.0/3)+(sd_v_art*normal(0));   vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+180);    newmut{t-1}= 0.002*((v{t}+v{t-1})/2);  end;   
 			 if 0.5 <= current_adh_dl < 0.8 then do;   v{t}=vmax{t-1}-(2.0/3)+(sd_v_art*normal(0));   vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );   newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			 if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.5/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
 		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
 			 if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(3.0/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+180);  newmut{t-1}= 0.002*((v{t}+v{t-1})/2);  end;   
 			 if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-(2.0/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );  newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			 if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.5/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
 		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
 			 if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-3.0+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+180);  newmut{t-1}= 0.002*((v{t}+v{t-1})/2);  end;   
 			 if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-2.0+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );  newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			 if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			 cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
 		end;
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			 or (0.5 <= caldate{t} - date_last_start_cla   and v{t-1} ge 4) )  and t ge 2 then do;

			if        current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=v_min_art+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 ); newmut{t-1}= 0.002*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 <  0.8 and current_adh_dl >= 0.8 then do; v{t}=1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 ); newmut{t-1}= 0.002*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}= 1.2 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}= 1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-2.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+7.5 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.1*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.1*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.1*((v{t}+v{t-1})/2); end;
	
		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4) or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}=v_min_art+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};   * oct 2014;
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30); newmut{t-1}=  0.002*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=1.2+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};* ie risk of rebound;
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 ); newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};* ie almost certain rebound;
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 2.75 then do;
  		if 0 <= tcur{t-1} < 1/12 then do;
 			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(2.6/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
  		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+80);   newmut{t-1}= 0.01*((v{t}+v{t-1})/2);  end;   
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-(1.6/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );  newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.4/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+4 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
 			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-(2.6/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+80);  newmut{t-1}= 0.01*((v{t}+v{t-1})/2);  end;    
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-(1.6/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );  newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.4/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+4 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do;
 			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-2.6+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+80);  newmut{t-1}= 0.01*((v{t}+v{t-1})/2);  end;    
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.6+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30 );  newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+4 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2);  end;
 		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}= 1.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
 			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.8+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+4.5 ); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
 			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.15*((v{t}+v{t-1})/2); end;

		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}=v_min_art+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+28); newmut{t-1}= 0.01*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=1.2+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}=0.18*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.18*((v{t}+v{t-1})/2);  end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 2.5  then do;
 		if 0 <= tcur{t-1} < 1/12 then do;
 		if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-(2.2/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+40);   newmut{t-1}= 0.03*((v{t}+v{t-1})/2);   end;
 			if 0.5 <= current_adh_dl < 0.8 then do;  v{t}=vmax{t-1}-(1.2/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 );  newmut{t-1}=0.2*((v{t}+v{t-1})/2);   end;
 			if current_adh_dl < 0.5 then do;    v{t}=vmax{t-1}-(0.3/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2);   end;
 		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
		if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-(2.2/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+40);  newmut{t-1}= 0.03*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-(1.2/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 );  newmut{t-1}=0.2*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.3/2)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2);   end;
 		end;
 		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
 			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-2.2+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+40); newmut{t-1}= 0.03*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do;  v{t}=vmax{t-1}-1.2+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 );  newmut{t-1}=0.2*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2);   end;
 		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			...
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=1.8+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+0 ); newmut{t-1}= 0.2 *((v{t}+v{t-1})/2); end;

 			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}= 1.2+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+25); newmut{t-1}= 0.03*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= 1.2 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie risk of rebound;
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie almost certain rebound;
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 2.25  then do;
		if 0 <= tcur{t-1} < 1/12 then do;
  			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-(1.8/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+35);   newmut{t-1}= 0.05*((v{t}+v{t-1})/2);   end;
 			if 0.5 <= current_adh_dl < 0.8 then do;  v{t}=vmax{t-1}-(1.1/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20 );   newmut{t-1}=0.25*((v{t}+v{t-1})/2);   end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.25/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+2 );   newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.25*((v{t}+v{t-1})/2);  end;
 		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
  			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-(1.8/2)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+35);  newmut{t-1}= 0.05*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do;  v{t}=vmax{t-1}-(1.1/2)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20 );  newmut{t-1}=0.25*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.25/2)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+2 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);   if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.25*((v{t}+v{t-1})/2);  end;
 		end;
 			if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
  			if current_adh_dl >= 0.8 then do;  v{t}=vmax{t-1}-1.8+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+35);   newmut{t-1}= 0.05*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do;  v{t}=vmax{t-1}-1.1+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20 );   newmut{t-1}=0.25*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;    v{t}=vmax{t-1}-0.25+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+2 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.25*((v{t}+v{t-1})/2); end;
 		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=1.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}= 1.4 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}= 1.4 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.35+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-2  ); newmut{t-1}= 0.2 *((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.25 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.25+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2);  end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.25+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.2*((v{t}+v{t-1})/2);  end;

		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}= 1.4+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+23); newmut{t-1}= 0.08*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= 1.6 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie risk of rebound;
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}=0.25*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.25+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie almost certain rebound;
		    cc{t-1}=cd4_art_adj+(-15.5 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.25*((v{t}+v{t-1})/2); end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 2  then do;
 		if 0 <= tcur{t-1} < 1/12 then do;
		 	if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - (1.5/3)+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1}; 
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30); newmut{t-1}= 0.1*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}= vmax{t-1} - (0.9/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 );  newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;   v{t}=vmax{t-1}-(0.2/3)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+1 );  newmut{t-1}=0.05*((v{t}+v{t-1})/2);  if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
 		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
		 	if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - 1.5/2+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1}; 
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30);  newmut{t-1}= 0.1*((v{t}+v{t-1})/2);  end;
 			if 0.5 <= current_adh_dl < 0.8 then do; v{t}= vmax{t-1} - (0.9/2)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 );  newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
 			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-(0.2/2)+(sd_v_art*normal(0));  vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+1 );   newmut{t-1}=0.05*((v{t}+v{t-1})/2);   if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
 		end;
 		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
 			if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - 1.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+30); newmut{t-1}= 0.1*((v{t}+v{t-1})/2); end;
 			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= vmax{t-1} - 0.9+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+15 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
 			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
 		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+1 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
 		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
 			...
 			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=2.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+21 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 2.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+7.5); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 2.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+7.5); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); end;

 			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=2.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+7 ); newmut{t-1}= 0.3 *((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-4.5 ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-4.5 ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;

		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-2.5+(sd_v_art*normal(0));
	...
	if t ge 2 and nactive{t-1} = 1.75  then do;
		if 0 <= tcur{t-1} < 1/12 then do;
			if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - (1.25/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+25); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= vmax{t-1} - (0.8/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-(0.15/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-1 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - (1.25/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+25); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= vmax{t-1} - (0.8/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-(0.15/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-1 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
			if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}= vmax{t-1} - 1.25+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+25); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}= vmax{t-1} - 0.8+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.15+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-1 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=2.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+19 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+1.5 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+1.5 ); newmut{t-1}= 0.10*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-2.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+4); newmut{t-1}= 0.3 *((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 1.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-6 ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-1.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-6 ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.15+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end; *may17;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.15+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16.5); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		 	if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.15+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16.5); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;

		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-2.0+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+19); newmut{t-1}= 0.15*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-1.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
	...
	if t ge 2 and nactive{t-1} = 1.5  then do;
		if 0 <= tcur{t-1} < 1/12 then do;
 			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.9/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.6/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-3 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do;  
 			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.9/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.6/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-3 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
			if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
 			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.9+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+20); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-3 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3  ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-4.5 ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-4.5 ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
	
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 1.5 + (sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+0 ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.8 + (sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.8 +(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.10+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.10+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.10+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		...
		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			...
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-1.4+(sd_v_art*normal(0));
			cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 ); newmut{t-1}= 0.2*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
		    cc{t-1}=cd4_art_adj+(-10); newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
			cc{t-1}=cd4_art_adj+(-17); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2);  end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 1.25  then do;
		if 0 <= tcur{t-1} < 1/12 then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.8/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+17); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.5/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.05/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-6 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.8/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+17); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.5/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.05/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-6 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
			if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.8+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+17); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+8  ); newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-6 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.3*((v{t}+v{t-1})/2); end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.15+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-5  ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-7  ); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 1.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-7.5); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.9 + (sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-9 ); newmut{t-1}= 0.35*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.65+ (sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11.5); newmut{t-1}= 0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.65+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11.5); newmut{t-1}= 0.35*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17.5); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.35*((v{t}+v{t-1})/2);  end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17.5 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;

		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-1.15+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(-5); newmut{t-1}= 0.3*((v{t}+v{t-1})/2); end;
		 	if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
		    cc{t-1}=cd4_art_adj+(-12 ); newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
		    cc{t-1}=cd4_art_adj+(-17 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.35*((v{t}+v{t-1})/2); end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 1  then do;
		if 0 <= tcur{t-1} < 1/12 then do;
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.7/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13); newmut{t-1}= 0.4*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.4/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 ); newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2);  end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.7/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13); newmut{t-1}= 0.4*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.4/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 ); newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2);  end;
		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+13); newmut{t-1}= 0.4*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5 ); newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2);  end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.9+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-9  ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.9+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-9  ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.9+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-9  ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
	
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-0.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.4 *((v{t}+v{t-1})/2); end;
	
			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
		end;

		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.9+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(-9 ); newmut{t-1}= 0.4*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie risk of rebound;
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; * ie almost certain rebound;
			cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.4*((v{t}+v{t-1})/2); end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 0.75 then do;
		if 0 <= tcur{t-1} < 1/12 then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.55/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.25/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 ); newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.55/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.25/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 ); newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.55+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+10 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.25+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+3 ); newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.75+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-10.5 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}= 0.45 *((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}=vmax{t-1} - 0.7+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-11 ); newmut{t-1}= 0.45 *((v{t}+v{t-1})/2); end;
	
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-0.55+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-12.5 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.35+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-14.5 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2);  end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2);  end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
		...
		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.75+(sd_v_art*normal(0));
		    cc{t-1}=cd4_art_adj+(-10.5); newmut{t-1}= 0.45*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
		    cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}=0.45*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1}; 
		    cc{t-1}=cd4_art_adj+(-17 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.45*((v{t}+v{t-1})/2);  end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 0.5 then do;
		if 0 <= tcur{t-1} < 1/12 then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.4/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.1/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+0 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-12 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.4/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.1/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+0 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-12 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+5); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(pt_cd4_rise_art*+0 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-12 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
			...
			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-12 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.5+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
	
			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}= vmax{t-1}- 0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
		...
		if (tcur{t-1} ge 0.5 and v{t-1} lt 4)  or (caldate{t} - date_last_start_cla >= 0.5 and v{t-1} lt 4) then do;
		 	if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.6+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-12); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.1+(sd_v_art*normal(0)); vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2);if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);  end;
		end;
	end;
	...
	if t ge 2 and nactive{t-1} = 0.25 then do;
		if 0 <= tcur{t-1} < 1/12 then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.3/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
    		cc{t-1}=cd4_art_adj+(-2); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.05/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-7 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/3)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=1/12 or (0 <= caldate{t} - date_last_start_cla <= 1/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-(0.3/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
    		cc{t-1}=cd4_art_adj+(-2); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-(0.05/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-7 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+(0.1/2)+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
		end;
		if tcur{t-1}=2/12 or (caldate{t} - date_last_start_cla = 2/12) then do; 
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
    		cc{t-1}=cd4_art_adj+(-2); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-7 ); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}+0.1+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-13 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
		end;
		...
		if  (0.25 <= tcur{t-1} < 0.5 or (tcur{t-1} >= 0.5  and v{t-1} ge 4) or (0.25 <= caldate{t} - date_last_start_cla < 0.5) 
 			...
 			if current_adh_dl_tm1 >= 0.8 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.4+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-14 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.35+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-14.5); newmut{t-1}= 0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl >= 0.8 then do; v{t}= vmax{t-1}- 0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-16 ); newmut{t-1}= 0.25*((v{t}+v{t-1})/2); end;

			if current_adh_dl_tm1 >= 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.3+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-15 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2);  end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and 0.5 <= current_adh_dl < 0.8 then do; v{t}= vmax{t-1}- 0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
 			cc{t-1}=cd4_art_adj+(-17.5 ); newmut{t-1}= 0.5*((v{t}+v{t-1})/2);  end;
			if current_adh_dl_tm1 < 0.5 and 0.5 <= current_adh_dl < 0.8 then do; v{t}=vmax{t-1} - 0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-17.5 ); newmut{t-1}= 0.25*((v{t}+v{t-1})/2);  end;

			if current_adh_dl_tm1 >= 0.8 and  current_adh_dl < 0.5 then do; v{t}=vmax{t-1}-0.00+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);end;
			if 0.5 <= current_adh_dl_tm1 < 0.8 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.00+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);end;
			if current_adh_dl_tm1 < 0.5 and current_adh_dl < 0.5 then do; v{t}=vmax{t-1}+0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
		    cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}= 0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then newmut{t-1}=0.5*((v{t}+v{t-1})/2);end;
		end;
	...
	if t ge 2 and nactive{t-1}=0 then do;
			if current_adh_dl >= 0.8 then do; v{t}=vmax{t-1}-0.2+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-15); newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if 0.5 <= current_adh_dl < 0.8 then do;v{t}=vmax{t-1}-0.05+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-17 );newmut{t-1}=0.5*((v{t}+v{t-1})/2); end;
			if current_adh_dl < 0.5 then do;  v{t}=vmax{t-1}-0.0+(sd_v_art*normal(0));vc{t-1}=v{t}-v{t-1};
			cc{t-1}=cd4_art_adj+(-18 ); newmut{t-1}=0.05*((v{t}+v{t-1})/2); if (o_nev=1 or o_efa=1 or o_rla=1) then 
...
if t ge 2 then c{t}=c{t-1}+cc{t-1}; 
	...
	if t ge 2 then do;
		...
		if started_prep_hiv_test_sens and prep=1 then newmut{t-1}=newmut{t-1}*0.33; 
	...
	if pregnant=1 and hiv{t}=1 and t ge 2 then do; 
		...
		if 3 < v{t} <= 4 then u=u*5;
		if 4 < v{t} <= 5 then u=u*2;
		if 5 < v{t} then u=u*1;
		if . < caldate{t}-yrart <= 0.75 and onart{t}=1 then u = u * 10 ; 
		if u < rate_birth_with_infected_child then do; 
			...
			if c_rt184m_tm1=1 or c_rttams_tm1=1  or c_rt65m_tm1=1 or c_rt103m_tm1=1 or c_rt181m_tm1=1 or c_rt190m_tm1=1 or c_rt101m_tm1=1 or
			c_rt138m_tm1=1 or c_rt188_tm1=1
			...
			or c_inprim_tm1=1   or c_insm_tm1=1 then child_with_resistant_hiv=1;
	...
	if t ge 2 and d lt newmut{t-1} then do;
		...
		if o_ten_tm1=1 and o_zdv_tm1=0  and c_rt65m_tm1=0 then do; 
			m=uniform(0); if m lt rate_res_ten then c_rt65m=1; end; 


		if o_nev_tm1=1  then do;
			cx=uniform(0); if c_rt181m ne 1 and cx < 0.4 then c_rt181m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.1 then c_rt101m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.1 then c_rt103m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.1 then c_rt188m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.1 then c_rt190m=1;
		end;
	
		if o_efa_tm1=1 then do;
			cx=uniform(0); if c_rt103m ne 1 and cx < 0.6 then c_rt103m=1;
			if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 then do;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.05 then c_rt101m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.05 then c_rt181m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.05 then c_rt188m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt103m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and c_rt190m ne 1 and cx < 0.05 then c_rt190m=1;
			end;
		end;

		if o_rla_tm1=1 then do;
			cx=uniform(0); if c_rt101m ne 1 and c_rt138m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and cx < 0.2 then c_rt101m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt138m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and cx < 0.2 then c_rt138m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt138m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and cx < 0.2 then c_rt181m=1;
			cx=uniform(0); if c_rt101m ne 1 and c_rt138m ne 1 and c_rt181m ne 1 and c_rt188m ne 1 and cx < 0.2 then c_rt188m=1;
		end;


        if o_lpr_tm1=1 then do;
            cx=uniform(0); if cx < 0.01 then c_pr32m=1;
            cx=uniform(0); if cx < 0.02 then c_pr46m=1;
			cx=uniform(0); if cx < 0.01 then c_pr47m=1;
			cx=uniform(0); if cx < 0.02 then c_pr54m=1;
			cx=uniform(0); if cx < 0.02 then c_pr76m=1;
            cx=uniform(0); if cx < 0.02 then c_pr82m=1;
         end;

		if o_dar_tm1=1  then do;
			cx=uniform(0); if cx < 0.01 then c_pr50vm=1;
			cx=uniform(0); if cx < 0.01 then c_pr54m=1;
			cx=uniform(0); if cx < 0.01 then c_pr76m=1;
			cx=uniform(0); if cx < 0.01 then c_pr84m=1;
		end;

		if o_taz_tm1=1  then do;
			cx=uniform(0); if cx < 0.03 then c_pr50lm=1;
			cx=uniform(0); if cx < 0.03 then c_pr84m=1;
			cx=uniform(0); if cx < 0.03 then c_pr88m=1;
		end;

		if o_dol_tm1=1 then do; 
		pr_res_dol=0.03; if higher_rate_res_dol=1 then pr_res_dol=0.1;
			cx=uniform(0); if cx < pr_res_dol then c_inprim=1;  
			cx=uniform(0); if cx < pr_res_dol then c_insm=1;
		end;

		if o_cla_tm1=1 or (p_cla = 1 and current_adh_dl_tm1 > .) then do; 
			cx=uniform(0); if cx < pr_res_dol * rel_rate_res_cla_dol then c_inprim=1;  
			cx=uniform(0); if cx < pr_res_dol * rel_rate_res_cla_dol then c_insm=1;
		end;
...
c_totmut{t}=c_rt184m+c_rttams+c_rt65m+c_rt151m+c_rt_101m+c_rt103m+c_rt138m+c_rt181m+c_rt188m+c_rt190m
	+c_pr32m+c_pr33m+c_pr46m+c_pr47m+c_pr50vm+c_pr50lm+c_pr54m+c_pr76m+c_pr82m+c_pr84m+c_pr88m+c_pr90m+c_inprim+c_insm;
...
c_totmut_pi=c_pr32m+c_pr33m+c_pr46m+c_pr47m+c_pr50vm+c_pr50lm+c_pr54m+c_pr76m
	...
	if interrupt{t}=1 and o_efa_tm1=1 and (c_rt103m_tm1=0 and c_rt181m_tm1=0 and c_rt190m_tm1=0 and c_rt101m_tm1=0 and c_rt188_tm1=0) 
	then do;
		cx=uniform(0); if cx lt 0.018 then c_rt103m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt181m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt190m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt181m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt188m=1; 
	end;

	if interrupt{t}=1 and o_nev_tm1=1 and (c_rt103m_tm1=0 and c_rt181m_tm1=0 and c_rt190m_tm1=0 and c_rt101m_tm1=0 and c_rt188_tm1=0) 
	then do;
		cx=uniform(0); if cx lt 0.018 then c_rt181m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt103m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt101m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt188m=1; 
		cx=uniform(0); if cx lt 0.003 then c_rt190m=1; 
	end;
	...
	acq_mut=0;    if e_totmut{t} lt 1 and (c_rt184m=1 or c_rttams ge 1 or c_rt65m=1 or c_rt151m=1 or c_rt103m=1 or c_rt181m=1 or c_rt190m=1
				 or c_rt101m=1 or c_rt138m=1 or c_rt188m=1
	 			or c_pr32m=1 or c_pr33m=1 or c_pr46m=1 or c_pr47m=1 or c_pr50vm=1 or c_pr50lm=1 
				or c_pr54m=1  or c_pr76m=1 or c_pr82m=1 or c_pr84m=1 or c_pr88m=1 or c_pr90m=1 or c_inprim=1 or c_insm=1)  then do; 
				acq_mut=1; dt_acq_mut=caldate{t}; end;
	if c_rt184m=1 then e_rt184m=1;
	if t ge 2 and c_rttams >= 1 then e_rttams=max(c_rttams,e_rttams_tm1);
	if c_rt65m=1 then e_rt65m=1 ;
	if c_rt101m=1 then e_rt101m=1 ;
	if c_rt103m=1 then e_rt103m=1 ;	
	if c_rt138m=1 then e_rt138m=1 ;	
	if c_rt181m=1 then e_rt181m=1 ;
	if c_rt188m=1 then e_rt188m=1 ;
	...
	if c_inprim=1 then e_inprim=1 ;
	if c_insm=1 then e_insm=1 ;
	e_totmut{t}=e_rt184m+e_rttams+e_rt65m+e_rt151m+e_rt103m+e_rt181m+e_rt190m+e_rt101m+e_rt138m+e_rt188m
	+e_pr32m+e_pr33m+e_pr46m+e_pr47m+e_pr50vm+e_pr50lm+e_pr54m+e_pr76m
	+e_pr82m+e_pr84m+e_pr88m+e_pr90m+e_inprim+e_insm;


    e_nnmut=.;
    e_nnmut=e_rt103m+e_rt181m+e_rt190m+e_rt101m+e_rt138m+e_rt188m;
	...
	if caldate{t} > yrart > . then do;
		...
		a=uniform(0);if c_rt101m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0) and (tss_rla ge 1/12 or p_rla=0)
		and a < rate_loss_acq_nnm_offart then c_rt101m=c_rt101m_inf;

		a=uniform(0);if c_rt103m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0)  and (tss_rla ge 1/12 or p_rla=0)
		and a < rate_loss_acq_nnm_offart then c_rt103m=c_rt103m_inf;

		a=uniform(0);if c_rt138m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0)  and (tss_rla ge 1/12 or p_rla=0)
		and a < rate_loss_acq_nnm_offart then c_rt138m=c_rt138m_inf;

		a=uniform(0);if c_rt181m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0) and (tss_rla ge 1/12 or p_rla=0)
		and a < rate_loss_acq_nnm_offart then c_rt181m=c_rt181m_inf;

		a=uniform(0);if c_rt188m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0)  and (tss_rla ge 1/12 or p_rla=0)
		and a < rate_loss_acq_nnm_offart then c_rt181m=c_rt188m_inf;

		a=uniform(0);if c_rt190m=1 and (tss_efa    ge 1/12 or p_efa=0) and (tss_nev    ge 1/12 or p_nev=0)  and (tss_rla ge 1/12 or p_rla=0)
		...
		a=uniform(0);if c_inprim ge 1 and (tss_dol ge 1/12 or p_dol=0) and (p_cla=0 or (p_cla=1 and . < current_adh_dl < lower_cla_threshold)) and a < rate_loss_acq_iim_offart then c_inprim=c_inprim_inf;
		a=uniform(0);if c_insm ge 1 and (tss_dol ge 1/12 or p_dol=0) and (p_cla=0 or (p_cla and . < current_adh_dl < lower_cla_threshold)) and a < rate_loss_acq_iim_offart then c_insm=c_insm_inf;
...
x=uniform(0); if c_rt101m_inf = 1 and naive{t}=1 and c_rt101m=1 and x < rate_loss_persistence then c_rt101m=0;
x=uniform(0); if c_rt138m_inf = 1 and naive{t}=1 and c_rt138m=1 and x < rate_loss_persistence then c_rt138m=0;
x=uniform(0); if c_rt188m_inf = 1 and naive{t}=1 and c_rt188m=1 and x < rate_loss_persistence then c_rt188m=0;
...
x=uniform(0); if c_inprim_inf = 1  and naive{t}=1 and c_inprim=1 and x < rate_loss_persistence then c_inprim=0;
x=uniform(0); if c_insm_inf = 1  and naive{t}=1 and c_insm=1 and x < rate_loss_persistence then c_insm=0;



x=uniform(0);if c_rt181m=1 and                   c_rt181m_inf=0 and p_nev ne 1 and p_efa ne 1 and x < rate_loss_nnres_pmtct_maj then c_rt181m=0;
x=uniform(0);if c_rt181m=0 and e_rt181m=1 and c_rt181m_inf=0 and p_nev ne 1 and p_efa ne 1 and x < rate_loss_nnres_pmtct_min then e_rt181m=0;
	...
	if e_rt181m=1 and (o_nev=1 or o_efa=1 or rla=1) then do; c_rt181m=1; end;
	if e_rt190m=1 and (o_nev=1 or o_efa=1) then do; c_rt190m=1; end;
	if e_rt101m=1 and (o_nev=1 or o_efa=1 or rla=1) then do; c_rt101m=1; end;
	if e_rt138m=1 and (rla=1) then do; c_rt138m=1; end;
	if e_rt188m=1 and (o_nev=1 or o_efa=1 or rla=1) then do; c_rt188m=1; end;
	...
	if e_inprim=1  and (o_dol=1 or o_cla=1) then c_inprim=1;
	if e_insm=1  and (o_dol=1 or o_cla=1) then c_insm=1;


u_vfail1_this_period=0;  
if t ge 2 and v{t} gt log10(1000) and caldate{t} ge yrart+0.50 and ((onart{t}=1 and tcur{t} ge 0.5) ) 
...
if t ge 2 and o_dol=1 and tcur{t} ge 0.5 and uvfail_dol ne 1 then do;
...
and 0.5 <= caldate{t}-date_who3_4_event_switch_eval <= 1.0 then do;
	...
	if vm    gt log10(1000) then do; 
		if date_v_alert=. and (o_zdv=1 or o_3tc=1 or o_ten=1 or o_nev=1 or o_efa=1 or o_lpr=1 or o_taz=1 or o_dar=1 or o_dol=1) 
																		then date_v_alert=caldate{t};
...
if t ge 2  and visit{t}=1 and art_monitoring_strategy=9 and (artline{t}=1 or int_clinic_not_aw=1) and linefail{t-1}=0 then do;
		...
		if (  
		(mod(tcur{t},0.5)=0 and tcur{t} ge 3)
		or 
		(int_clinic_not_aw=1 and caldate{t}-yrart ge 1 and mod(toffart{t},0.5)=0 )
		) then do; 
			s=uniform(0); 
		...
		if (tcur{t} in (1,1.5,2,2.5) or (int_clinic_not_aw=1 and 0 < caldate{t}-yrart < 3 and toffart{t} in (0.5,1,1.5,2,2.5))) then do; 
...
if t ge 2 and visit{t}=1 and art_monitoring_strategy=10 and (artline{t}=1 or int_clinic_not_aw=1) and linefail{t-1}=0 then do;
		...
		if (
		(mod(tcur{t},0.5)=0 and tcur{t} ge 3) 
		or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1 and mod(toffart{t},0.5)=0 ))  and (date_cd4_switch_eval = . or caldate{t}-date_cd4_switch_eval > 0.5)
		...
		if vm_format=4 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=4;  end;
			...
			vl_cost_inc = 1; 
			if vm gt log10(1000) then do;
				date_cd4_switch_eval=caldate{t}; date_last_vlm_g1000 = caldate{t};		if date_v_alert=. and (o_zdv=1 or o_3tc=1 or o_ten=1 or o_nev=1 or o_efa=1 or o_lpr=1 or o_taz=1 or o_dar=1 or o_dol=1) 
																		then date_v_alert=caldate{t};
			end;
			conf_measured_c=.;
		end;
		if (tcur{t} in (1,1.5,2,2.5) or (int_clinic_not_aw=1 and 0 < caldate{t}-yrart < 3 and toffart{t} in (0.5,1,1.5,2,2.5)))
...
and restart{t} ne 1 and restart{t-1} ne 1  and (caldate{t} - date_transition_from_nnrti >= 0.5 or date_transition_from_nnrti =.) and t ge 2 then do;  
	if (caldate{t}-yrart >= 0.5 and time_since_last_vm=.) or (0.999 < caldate{t}-yrart < 1.001) or (time_since_last_vm >= 0.75) or  (0.25 <= caldate{t}-date_vl_switch_eval <= 1.00 and 
	...
	if o_dol=1 and (0.249 < caldate{t} - date_conf_vl_measure_done < 0.251 and . < vm_format <= 2 and value_last_vm gt log10(vl_threshold)) then o_dol_2nd_vlg1000 = 1;

	if (caldate{t}=date_conf_vl_measure_done and vm_format in (3,4) and vm gt log10(vl_threshold)) or
	(0.249 < caldate{t} - date_conf_vl_measure_done < 0.251 and . < vm_format <= 2 and value_last_vm gt log10(vl_threshold))
	then do;
			linefail{t}=1;r_fail=c_totmut{t}; cd4_fail1=c{t}; vl_fail1=v{t}; d1stlfail=caldate{t}; 
				if o_zdv=1 then f_zdv=1;
				if o_3tc=1 then f_3tc=1;
...
and restart{t} ne 1 and restart{t-1} ne 1 and (caldate{t} - date_transition_from_nnrti >= 0.5 or date_transition_from_nnrti =.) and t ge 2 then do;  
	...
	or
	(0.249 < caldate{t} - date_conf_vl_measure_done < 0.251 and . < vm_format <= 2 and value_last_vm gt log10(vl_threshold) and adh{t-1} > 0.8)
	) 
	then do;
			linefail{t}=1;r_fail=c_totmut{t}; cd4_fail1=c{t}; vl_fail1=v{t}; d1stlfail=caldate{t}; 
				if o_zdv=1 then f_zdv=1;
...
if reg_option in (501) and o_cla=1 and p_taz=1 and (f_cla_tm1 ne 1 and f_dol_tm1 ne 1) and restart{t} ne 1 and restart{t-1} ne 1 and t ge 2 then do; 
	if (time_since_last_vm >= 0.75) and (caldate&j - date_conf_vl_measure_done >= 1 or date_conf_vl_measure_done=.) 
and (caldate{t} - date_transition_from_pi >= 0.5 or date_transition_from_pi =.)
then do; 
		s=uniform(0);  date_last_vm_attempt=caldate&j;	if s < eff_prob_vl_meas_done then do; 
	...
	if o_cla=1 and (0.249 < caldate{t} - date_conf_vl_measure_done < 0.251 and . < vm_format <= 2 and value_last_vm gt log10(vl_threshold)) then o_cla_2nd_vlg1000 = 1;
...
if adh{t-1} < 0.8 and r_dol_tm1 > 0 then o_dol_2nd_vlg1000_dolr1_adh0 = 1;
if adh{t-1} >= 0.8 and r_dol_tm1 > 0 then o_dol_2nd_vlg1000_dolr1_adh1 = 1;
if adh{t-1} < 0.8 and r_dol_tm1 = 0 then o_dol_2nd_vlg1000_dolr0_adh0 = 1;
if adh{t-1} >= 0.8 and r_dol_tm1 = 0 then o_dol_2nd_vlg1000_dolr0_adh1 = 1;
end;
...
if res_test_6m_if_vlg1000=1 and t ge 2 then do;  
	...
	if visit{t}=1 and 
	(0.4999 < caldate{t} - yrart < 0.5001 and ( onart{t} = 1 or int_clinic_not_aw=1 )) then do;s=uniform(0);	if s < eff_prob_vl_meas_done then do; 
		if vm_format=1 then do; vm = max(0,v{t}+(normal(0)*0.22)); vm_type=1; end;
		if vm_format=2 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=2;  end;
		if vm_format=3 then do; vm = max(0,v{t}+(normal(0)*0.22));  vm_type=3;  end;
		if vm_format=4 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=4;  end;
	...
	vl_cost_inc = 1; end;
			if vm gt log10(1000) then do; res_test=1; 		if date_v_alert=. and (o_zdv=1 or o_3tc=1 or o_ten=1 or o_nev=1 or o_efa=1 or o_lpr=1 or o_taz=1 or o_dar=1 or o_dol=1) 
																		then date_v_alert=caldate{t};end;
			if ((o_nev=1 or o_efa=1 or (int_clinic_not_aw=1 and (mr_nev=1 or mr_efa=1))) 
			and (c_rt103m=1 or c_rt181m=1 or c_rt190m=1 or c_rt101m=1 or c_rt138m = 1 or c_rt188m=1) ) and vm gt log10(1000) then do;
...
if e_rt101m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1 then r_efa=0.75;  if e_rt103m=1 then r_efa=1.00; 
if e_rt101m=1 or e_rt138m=1 or e_rt188m=1 or e_rt190m=1 then r_nev=0.75;  if e_rt103m=1 or e_rt181m=1 then r_nev=1.00; 
if e_rt101m=1 or e_rt138m=1 or e_rt188m=1 or e_rt190m=1 then r_rla=0.75;   
...
if nnrti_res_no_effect = 1 then do ;r_efa = 0 ; r_rla = 0 ; end;
	...
	nactive{t}=nod{t}-((o_zdv*r_zdv)+(o_3tc*r_3tc)+(o_ten*r_ten)
	                  +(o_dar*r_dar)+(o_efa*r_efa)+(o_nev*r_nev)+(o_taz*r_taz)+(o_lpr*r_lpr)+(o_dol*r_dol)+(o_cla*r_cla)+(o_rla*r_rla));
	...
	if dol_efa_cla_rla_potency = 1.5 then do;
	if o_dol=1 then nactive{t}=nactive{t}+ (0.5*(1-r_dol));
	if o_efa=1 then nactive{t}=nactive{t}+ (0.5*(1-r_efa)); 
	if o_cla=1 then nactive{t}=nactive{t}+ (0.5*(1-r_cla)); 
	if o_rla=1 then nactive{t}=nactive{t}+ (0.5*(1-r_rla)); 
	end;

	if dol_efa_cla_rla_potency = 2 then do;
	if o_dol=1 then nactive{t}=nactive{t}+ (1-r_dol);
	if o_efa=1 then nactive{t}=nactive{t}+ (1-r_efa);
	if o_cla=1 then nactive{t}=nactive{t}+ (1-r_cla);
	if o_rla=1 then nactive{t}=nactive{t}+ (1-r_rla);
	end;

	if onart{t} ne 1 and current_adh_dl > . then do;
		if dol_efa_cla_rla_potency = 1.5 then nactive{t} = 1.5 * (1-r_cla);
		if dol_efa_cla_rla_potency = 2 then nactive{t} = 2 * (1-r_cla);
	end;
	...
	if (nod{t}=0 and current_adh_dl = .) then nactive{t}=.;

	if res_drug=. then do;
		if r_zdv >= 0.5 or  r_3tc  >= 0.5 or  r_dar >= 0.5 or   r_efa >= 0.5 or r_nev >= 0.5 or r_rla >= 0.5 or r_cla >= 0.5 or 
		r_ten >= 0.5 or r_lpr ge 0.5  or r_taz ge 0.5 or   r_dol >= 0.5 or r_cla >= 0.5 then res_drug=caldate{t};
	end;


	res_1stline_startline2=.;
	if caldate{t}=date_line2 > . then do;
	res_1stline_startline2=0; if r_zdv >= 0.5 or r_3tc  >= 0.5 or  r_efa >= 0.5 or r_nev >= 0.5 or r_rla >= 0.5 or r_cla >= 0.5 or 
	...
	c_nau=0;
	r=uniform(0); if . < caldate{t}-yrart < 1 then r=r/5.0; 
	...
	if t ge 3 and (o_nev=1 and 0 <= caldate{t}-date_start_nev <= 0.5 and r < r_ras_start_nev ) then c_ras=1;
	if t ge 3 and (o_rla=1 and 0 <= caldate{t}-date_start_rla <= 0.5 and r < r_ras_start_rla ) then c_ras=1;
	...
	if t ge 2 and o_efa=1 then do;
		if c_cns_tm1=0 and r < r_cns_start_efa and tcur{t} < 1 then c_cns=1;
		if c_cns_tm1=1 then c_cns=1; if c_cns_tm1=1  and tcur{t} < 1 and r < p_cns_stops_efa then c_cns=0;
		if c_cns_tm1=1 then c_cns=1; if c_cns_tm1=1  and tcur{t} >= 1 and r < p_cns_stops_efa / 2 then c_cns=0;
	end;
	rr=uniform(0);
	if t ge 2 and o_dol=1 then do;  
		if c_cns_tm1=0 and rr < (r_cns_start_dol) and tcur{t} < 1 then c_cns=1;
		if c_cns_tm1=1 then c_cns=1; if c_cns_tm1=1  and tcur{t} < 1 and rr < p_cns_stops_dol then c_cns=0;
		if c_cns_tm1=1 then c_cns=1; if c_cns_tm1=1  and tcur{t} >= 1 and rr < p_cns_stops_dol / 6 then c_cns=0; 	end;
	...
	c_hep=0;
	r=uniform(0);
	if  o_nev=1 and tcur{t} <= 0.5 and r < r_hep_start_nev then c_hep=1;
	
	c_otx=0;
	r=uniform(0);
	if . < caldate{t}-yrart < 1 then r=r/1.5; 
	if onart{t}=1 and r < r_otx_start then c_otx=1;

	c_ane=0;
	r=uniform(0); if . < caldate{t}-yrart < 1 then r=r/1.5; 
	...
	c_head=0;
	d=uniform(0); if . < caldate{t}-yrart < 1 then d=d/1.5; 
	if t ge 2 and o_zdv=1 and c_head_tm1 =0 and d < r_head_start_zdv then c_head=1;
	if t ge 2 and o_cla=1 and c_head_tm1 =0 and d < r_head_start_cla then c_head=1;
	if o_zdv=1 and c_head_tm1=1 then c_head=1; if c_head_tm1=1 and r < p_head_stops_zdv then c_head=0;
	if o_cla=1 and c_head_cla=1 then c_head=1; if c_head_tm1=1 and r < p_head_stops_cla then c_head=0;
	...
	or c_hep = 1 or c_dia = 1 or c_otx = 1 or c_neph = 1 then c_tox{t}=1;
	...
	if caldate{t} ge 2015 and visit{t}=1 and d < 0.8 then pcp_p{t}=1;
	...
	if t ge 2 and dead{t}=0 then do; 
		...
		who3_risk  = 1 - exp (-(1/12)*who3_rate);
...
f=uniform(0);
		...
		if t ge 3 and art_monitoring_strategy = 1 and f < prob_who3_diagnosed then do;
					if ((artline{t}=1 and tcur{t} ge 1) or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1)) and . < caldate{t}-date_last_who3 < 1 
		...
		if t ge 3 and art_monitoring_strategy=2  and f < prob_who3_diagnosed then do;
				if ((artline{t}=1 and tcur{t} ge 1) or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1)) and . < caldate{t}-date_last_who3 < 1 and linefail{t-1}=0 then do; 
			s=uniform(0);s=s/0.8;  if s < eff_prob_vl_meas_done then do; 
		if vm_format=1 then do; vm = max(0,v{t}+(normal(0)*0.22)); vm_type=1; end;
		if vm_format=2 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=2;  end;
		if vm_format=3 then do; vm = max(0,v{t}+(normal(0)*0.22));  vm_type=3;  end;
		if vm_format=4 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=4;  end;
	...
	vl_cost_inc = 1;
		...
		if t ge 3 and art_monitoring_strategy = 3 and f < prob_who3_diagnosed  then do;
				if ((artline{t}=1 and tcur{t} ge 1) or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1)) and . < caldate{t}-date_last_who3 < 1 and linefail{t-1}=0 and 
	...
	vl_cost_inc = 1;
		...
		if artline{t}=1 and tcur{t} ge 1 and linefail{t-1}=0 then date_last_who3=caldate{t};
		if artline{t}=2 and tcur{t} ge 1 and linefail{t-1}=1 then first_who3_line2=1;


			who3_{t}=1;who3_date=caldate{t}; if date_first_who3 = . then date_first_who3 = caldate{t}; cd4_who3_=c{t};timewho3_=who3_date-caldate1;
			y=uniform(0); if y < 0.2 then do; tb{t}=1; if tb_date=. then tb_date=caldate{t}; date_most_recent_tb = caldate{t}; end;
 ...
 riskx = 1 - exp (-(1/12)*rate);

		x2=uniform(0); if x2 le riskx then do;
			adc{t}=1; if dateaids=. then dateaids=caldate{t}; 
...
f=uniform(0);
			...
			if t ge 3 and art_monitoring_strategy = 1  and f < prob_who4_diagnosed  then do;
					if ((artline{t}=1 and tcur{t} ge 1) or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1)) and linefail{t-1}=0 then do;
						linefail{t}=1;r_fail=c_totmut{t}; cd4_fail1=c{t}; vl_fail1=v{t}; d1stlfail=caldate{t}; 
				if o_zdv=1 then f_zdv=1;
				if o_3tc=1 then f_3tc=1;
				if o_ten=1 then f_ten=1;
	...
	vl_cost_inc = 1;
		...
		if t ge 3 and art_monitoring_strategy = 3  and f < prob_who4_diagnosed then do;
				if ((artline{t}=1 and tcur{t} ge 1) or (int_clinic_not_aw=1 and caldate{t}-yrart ge 1)) and linefail{t-1}=0 
...
if vm ne . then do; latest_vm = vm; date_latest_vm=caldate{t}; end;
	...
	dead_6m_onart=.;dead_12m_onart=.;dead_24m_onart=.;dead_36m_onart=.;
		...
		if visit{t}=1 and (sv ne 1 or (. < adh{t} < 0.8 and onart{t}=1)) then do; 	
			incr_death_rate_tb_ = incr_death_rate_tb / 1.5; incr_death_rate_adc_ = incr_death_rate_adc / 1.5; 
		end;     

		if t ge 2 and (0 <= (caldate{t} - date_most_recent_tb) <= 0.5) and who4_{t} = 0 then hiv_death_rate = hiv_death_rate*incr_death_rate_tb_;
 ...
 dwho4_rix = 1 - exp (-(1/12)*hiv_death_rate);
		x3=uniform(0);
		if x3 le dwho4_rix then do;
  ...
  ac_deathrix = 1 - exp(-(1/12)*ac_death_rate); 
	...
	if cm   =. then time_since_last_cm = time_since_last_cm + (1/12);
   ...
   cost_rla=0;if o_rla=1 then cost_rla=cost_rla_a;     	
   ...
   cost_dar=0;if o_dar=1 then cost_dar=cost_dar_a;   			
	...
	cost_cla=0; if o_cla=1 then cost_cla=cost_cla_a;
...
if start_line2_this_period=1 then cost_switch_line=cost_switch_line_a;
    ...
    (o_lpr*cost_lpr) + (o_dar*cost_dar)+ (o_taz*cost_taz)+ (o_efa*cost_efa)+ (o_rla*cost_rla)+ (o_dol*cost_dol)+ (o_cla*cost_cla);
...
if visit{t}=1 then do; vis_cost=vis_cost_a; full_vis_cost=vis_cost_a; end;
...
if prep=1 and pop_wide_tld_prep ne 1 then do;
	...
	cost_prep = prep_drug_cost ;  cost_prep_ac_adh=cost_prep*adh{t}; 
	if visit_prep = 1 then cost_prep_visit = cost_prep_clinic / 2; 
...
if pop_wide_tld_prep = 1 then do;
	...
	cost_prep = prep_drug_cost_tld ;  cost_prep_ac_adh=cost_prep*adh{t}; 
	if visit_prep = 1 then cost_prep_visit = cost_prep_clinic / 2; 
	if visit_prep = 2 then cost_prep_visit = cost_prep_clinic; 
	if visit_prep = 3 then cost_prep_visit = cost_prep_clinic+cost_prep_clinic_couns;
end;
...
if dead{t}=. then do;
	...
	o_efa=.;o_lpr=.;o_taz=.;o_dol=.;o_rla=.;o_cla=.;
	cmin{t}=.;
	p_zdv=.;p_3tc=.;p_dar=.;p_ten=.;p_cla=.;p_rla=.;
	p_efa=.;p_lpr=.;p_taz=.;p_dol=.;
	f_zdv=.;f_3tc=.;f_dar=.;f_ten=.;f_cla=.; f_rla=.;
	f_efa=.;f_lpr=.;f_dol=.;
	c_rt184m=.;c_rttams=.;c_rt65m=.;c_rt103m=.;c_rt181m=.;c_rt190m=.;c_rt151m=.;c_pr32m=.;c_pr47m=.;c_rt101m=.;c_rt138m=.;c_rt188m=.;
	c_pr33m=.;c_pr46m=.;c_pr54m=.;c_pr76m=.;c_pr50vm=.;c_pr50lm=.;c_pr82m=.;c_pr84m=.;c_pr88m=.;c_pr90m=.;c_inprim=.;c_insm=.;
	e_rt184m=.;e_rttams=.;e_rt65m=.;e_rt103m=.;e_rt181m=.;e_rt190m=.;e_rt151m=.;e_pr32m=.;e_pr47m=.;
	e_pr33m=.;e_pr46m=.;e_pr54m=.;e_pr76m=.;e_pr50vm=.;e_pr50lm=.;e_pr82m=.;e_pr84m=.;e_pr88m=.;e_pr90m=.;e_inprim=.;e_insm=.;
	e_rt101m=.;e_rt138m=.;e_rt188m=.;
	r_zdv=.;r_3tc=.;r_dar=.;r_ten=.;
	r_efa=.;r_lpr=.;r_dol=.;r_cla=.;r_rla=.;
	t_zdv=.;t_3tc=.;t_dar=.;t_taz=.;t_cla=.;t_rla=.;
	...
	acq_rt65m=.;acq_rt184m=.;acq_mut=.;
	time_acq_rt65m=.;time_acq_rt184m=.;time_acq_mut=.;time_stop_prep=.;
...
nnewp_l4p=0;
nnewp_l4p=(newp&j+newp&x+newp&a+newp&b);
...
npgt1conc_l4p_1524m=0;if gender=1 and 15 <= age&j < 25 then npgt1conc_l4p_1524m=conc;
npgt1conc_l4p_1524w=0;if gender=2 and 15 <= age&j < 25 then npgt1conc_l4p_1524w=conc;
npgt1conc_l4p_2549m=0;if gender=1 and 25 <= age&j <=49 then npgt1conc_l4p_2549m=conc;
npgt1conc_l4p_2549w=0;if gender=2 and 25 <= age&j <=49 then npgt1conc_l4p_2549w=conc;
npgt1conc_l4p_5064m=0;if gender=1 and 50 <= age&j < 65 then npgt1conc_l4p_5064m=conc;
npgt1conc_l4p_5064w=0;if gender=2 and 50 <= age&j < 65 then npgt1conc_l4p_5064w=conc;

npgt1conc_l4p_1519m=0;if gender=1 and 15 <= age&j < 20 then npgt1conc_l4p_1519m=conc;
npgt1conc_l4p_1519w=0;if gender=2 and 15 <= age&j < 20 then npgt1conc_l4p_1519w=conc;


npge1_l4p_1564m=0;if gender=1 and 15 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1564m=1;
npge1_l4p_1524m=0;if gender=1 and 15 <= age&j < 25 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1524m=1;
npge1_l4p_2534m=0;if gender=1 and 25 <= age&j < 35 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_2534m=1;
npge1_l4p_3544m=0;if gender=1 and 35 <= age&j < 45 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_3544m=1;
npge1_l4p_4554m=0;if gender=1 and 45 <= age&j < 55 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_4554m=1;
npge1_l4p_5564m=0;if gender=1 and 55 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_5564m=1;
npge1_l4p_1564w=0;if gender=2 and 15 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1564w=1;
npge1_l4p_1524w=0;if gender=2 and 15 <= age&j < 25 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1524w=1;
npge1_l4p_2534w=0;if gender=2 and 25 <= age&j < 35 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_2534w=1;
npge1_l4p_3544w=0;if gender=2 and 35 <= age&j < 45 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_3544w=1;
npge1_l4p_4554w=0;if gender=2 and 45 <= age&j < 55 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_4554w=1;
npge1_l4p_5564w=0;if gender=2 and 55 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_5564w=1;


npge2_l4p_1564m=0;if gender=1 and 15 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1564m=1;
npge2_l4p_1524m=0;if gender=1 and 15 <= age&j < 25 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1524m=1;
npge2_l4p_2534m=0;if gender=1 and 25 <= age&j < 35 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_2534m=1;
npge2_l4p_3544m=0;if gender=1 and 35 <= age&j < 45 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_3544m=1;
npge2_l4p_4554m=0;if gender=1 and 45 <= age&j < 55 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_4554m=1;
npge2_l4p_5564m=0;if gender=1 and 55 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_5564m=1;
npge2_l4p_1564w=0;if gender=2 and 15 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1564w=1;
npge2_l4p_1524w=0;if gender=2 and 15 <= age&j < 25 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1524w=1;
npge2_l4p_2534w=0;if gender=2 and 25 <= age&j < 35 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_2534w=1;
npge2_l4p_3544w=0;if gender=2 and 35 <= age&j < 45 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_3544w=1;
npge2_l4p_4554w=0;if gender=2 and 45 <= age&j < 55 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_4554w=1;
npge2_l4p_5564w=0;if gender=2 and 55 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_5564w=1;


npge10_l4p_1564m=0;if gender=1 and 15 <= age&j < 65 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_1564m=1;
npge10_l4p_1524m=0;if gender=1 and 15 <= age&j < 25 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_1524m=1;
npge10_l4p_2534m=0;if gender=1 and 25 <= age&j < 35 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_2534m=1;
npge10_l4p_3544m=0;if gender=1 and 35 <= age&j < 45 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_3544m=1;
npge10_l4p_4554m=0;if gender=1 and 45 <= age&j < 55 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_4554m=1;
npge10_l4p_5564m=0;if gender=1 and 55 <= age&j < 65 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_5564m=1;
npge10_l4p_1564w=0;if gender=2 and 15 <= age&j < 65 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_1564w=1;
npge10_l4p_1524w=0;if gender=2 and 15 <= age&j < 25 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_1524w=1;
npge10_l4p_2534w=0;if gender=2 and 25 <= age&j < 35 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_2534w=1;
npge10_l4p_3544w=0;if gender=2 and 35 <= age&j < 45 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_3544w=1;
npge10_l4p_4554w=0;if gender=2 and 45 <= age&j < 55 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_4554w=1;
npge10_l4p_5564w=0;if gender=2 and 55 <= age&j < 65 and (nnewp_l4p ge 10 or (nnewp_l4p=9 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge10_l4p_5564w=1;


npge50_l4p_1564m=0;if gender=1 and 15 <= age&j < 65 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_1564m=1;
npge50_l4p_1524m=0;if gender=1 and 15 <= age&j < 25 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_1524m=1;
npge50_l4p_2534m=0;if gender=1 and 25 <= age&j < 35 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_2534m=1;
npge50_l4p_3544m=0;if gender=1 and 35 <= age&j < 45 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_3544m=1;
npge50_l4p_4554m=0;if gender=1 and 45 <= age&j < 55 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_4554m=1;
npge50_l4p_5564m=0;if gender=1 and 55 <= age&j < 65 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_5564m=1;
npge50_l4p_1564w=0;if gender=2 and 15 <= age&j < 65 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_1564w=1;
npge50_l4p_1524w=0;if gender=2 and 15 <= age&j < 25 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_1524w=1;
npge50_l4p_2534w=0;if gender=2 and 25 <= age&j < 35 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_2534w=1;
npge50_l4p_3544w=0;if gender=2 and 35 <= age&j < 45 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_3544w=1;
npge50_l4p_4554w=0;if gender=2 and 45 <= age&j < 55 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_4554w=1;
npge50_l4p_5564w=0;if gender=2 and 55 <= age&j < 65 and (nnewp_l4p ge 50 or (nnewp_l4p=49 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge50_l4p_5564w=1;

newpge1_l4p_1529m=0;if gender=1 and 15 <= age&j < 30 and (newp&j ge 1 or newp&x ge 1 or newp&a ge 1 or newp&b ge 1) then newpge1_l4p_1529m=1;
newpge1_l4p_1529w=0;if gender=2 and 15 <= age&j < 30 and (newp&j ge 1 or newp&x ge 1 or newp&a ge 1 or newp&b ge 1) then newpge1_l4p_1529w=1;

npge2_l4p_1844m=0;if gender=1 and 18 <= age&j < 45 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1844m=1;
npge2_l4p_1844w=0;if gender=2 and 18 <= age&j < 45 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1844w=1;
npge2_l4p_1549m=0;if gender=1 and 18 <= age&j < 50 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1549m=1;
npge2_l4p_1549w=0;if gender=2 and 18 <= age&j < 50 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1549w=1;
...
if gender=2 and sw&j=1 then do;
	if 15 le age&j lt 65 then sw_1564=1;
	...
	sw_newp=newp&j;
	if 15 le age&j lt 25 then sw1524_newp=newp&j;
end;
...
npge1_l4p_1564_hivpos=0;if hiv&j=1 and 15 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1564_hivpos=1;
npge2_l4p_1564_hivpos=0;if hiv&j=1 and 15 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1564_hivpos=1;

npge1_l4p_1564_hivdiag=0;if hiv&j=1 and registd&j=1 and 15 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1564_hivdiag=1;
npge2_l4p_1564_hivdiag=0;if hiv&j=1 and registd&j=1 and 15 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1564_hivdiag=1;

npge1_l4p_1564_hivneg=0;if hiv&j=0 and 15 <= age&j < 65 and (nnewp_l4p ge 1 or (nnewp_l4p=0 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge1_l4p_1564_hivneg=1;
npge2_l4p_1564_hivneg=0;if hiv&j=0 and 15 <= age&j < 65 and (nnewp_l4p ge 2 or (nnewp_l4p=1 and (ep&j=1 or ep&x=1 or ep&a=1 or ep&b=1))) then npge2_l4p_1564_hivneg=1;
...
if date_cd4_l200 = . and . < c&j < 200 then date_cd4_l200 = caldate&j; 
...
if caldate&j = death > . and hiv&j=1  and rdcause=1 then do;
if . < tcur&j <= 0.5 then art_dur_l6m_dead=1;
if 0.5 < tcur&j then art_dur_g6m_dead=1;
end;

if . < tcur&j <= 0.5 then art_dur_l6m=1;
if 0.5 < tcur&j then art_dur_g6m=1;
...
mcirc_1519m=0;new_mcirc_1519m=0;if gender=1 and 15 le age&j lt 20 then do; mcirc_1519m=mcirc; new_mcirc_1519m=new_mcirc; vmmc1519m=vmmc; end;
mcirc_2024m=0;new_mcirc_2024m=0;if gender=1 and 20 le age&j lt 25 then do; mcirc_2024m=mcirc; new_mcirc_2024m=new_mcirc; vmmc2024m=vmmc; end;
mcirc_2529m=0;new_mcirc_2529m=0;if gender=1 and 25 le age&j lt 30 then do; mcirc_2529m=mcirc; new_mcirc_2529m=new_mcirc; vmmc2529m=vmmc; end;
mcirc_3034m=0;new_mcirc_3034m=0;if gender=1 and 30 le age&j lt 35 then do; mcirc_3034m=mcirc; new_mcirc_3034m=new_mcirc; vmmc3034m=vmmc; end;
mcirc_3539m=0;new_mcirc_3539m=0;if gender=1 and 35 le age&j lt 40 then do; mcirc_3539m=mcirc; new_mcirc_3539m=new_mcirc; vmmc3539m=vmmc; end;
mcirc_4044m=0;new_mcirc_4044m=0;if gender=1 and 40 le age&j lt 45 then do; mcirc_4044m=mcirc; new_mcirc_4044m=new_mcirc; vmmc4044m=vmmc; end;
mcirc_4549m=0;new_mcirc_4549m=0;if gender=1 and 45 le age&j lt 50 then do; mcirc_4549m=mcirc; new_mcirc_4549m=new_mcirc; vmmc4549m=vmmc; end;
mcirc_50plm=0;new_mcirc_50plm=0;if gender=1 and       age&j ge 50 then do; mcirc_50plm=mcirc; new_mcirc_50plm=new_mcirc; vmmc50plm=vmmc; end;
...
i_v1_newp=0; i_v2_newp=0; i_v3_newp=0; i_v4_newp=0; i_v5_newp=0; i_v6_newp=0; 
	...
	rm_&j=0; if hiv1564=1 and (c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 or c_rt65m=1 or c_rt184m=1 or c_rt151m=1 or c_rttams >= 1 
	or c_pr32m=1 or c_pr33m=1 or c_pr46m=1 or c_pr47m=1 or c_pr50vm=1 or c_pr50lm=1 or c_pr54m=1  or c_pr76m=1 
	or c_pr82m=1 or c_pr84m=1 or c_pr88m=1 or c_pr90m=1 or c_inprim=1 or c_insm=1) then rm_&j=1;
	
	rme_&j=0; if hiv1564=1 and (e_rt101m=1 or e_rt103m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1 or e_rt65m=1 or e_rt184m=1 or e_rt151m=1 or e_rttams >= 1 
	or e_pr32m=1 or e_pr33m=1 or e_pr46m=1 or e_pr47m=1 or e_pr50vm=1 or e_pr50lm=1 or e_pr54m=1  or e_pr76m=1 
	or e_pr82m=1 or e_pr84m=1 or e_pr88m=1 or e_pr90m=1 or e_inprim=1 or e_insm=1) then rme_&j=1;

	iime_&j=0; if hiv1564=1 and (e_inprim=1 or e_insm=1) then iime_&j=1;

	nnme_&j=0; if hiv1564=1 and (e_rt101m=1 or e_rt103m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1) then nnme_&j=1;
	
	nnme_w_=0; if hiv1564=1 and gender=2 and (e_rt101m=1 or e_rt103m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1) then nnme_w_=1;
	nnme_m_=0; if hiv1564=1 and gender=1 and (e_rt101m=1 or e_rt103m=1 or e_rt138m=1 or e_rt181m=1 or e_rt188m=1 or e_rt190m=1) then nnme_m_=1;

	pime_&j=0; if hiv1564=1 and (e_pr32m=1 or e_pr33m=1 or e_pr46m=1 or e_pr47m=1 or e_pr50vm=1 or e_pr50lm=1 or e_pr54m=1  
	...
	if rm_&j=1 then do;
		...
		rt101m_&j=0;  if c_rt101m=1  then rt101m_&j=1;
		rt103m_&j=0;  if c_rt103m=1  then rt103m_&j=1;
		rt138m_&j=0;  if c_rt138m=1  then rt138m_&j=1;
		rt181m_&j=0;  if c_rt181m=1  then rt181m_&j=1;
		rt188m_&j=0;  if c_rt188m=1  then rt188m_&j=1;
		rt190m_&j=0;  if c_rt190m=1  then rt190m_&j=1;
		nnm_&j=0;  
		if c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 then nnm_&j=1;

		rt184m_&j=0;if c_rt184m=1 then rt184m_&j=1;
		rt151m_&j=0;if c_rt151m=1 then rt151m_&j=1;
		rt65m_&j=0; if c_rt65m=1  then rt65m_&j=1;
		pr32m_&j=0; if c_pr32m=1  then pr32m_&j=1;
		pr33m_&j=0; if c_pr33m=1  then pr33m_&j=1;
		pr46m_&j=0; if c_pr46m=1  then pr46m_&j=1;
		pr47m_&j=0; if c_pr47m=1  then pr47m_&j=1;
		pr50vm_&j=0; if c_pr50vm=1  then pr50vm_&j=1;
		pr50lm_&j=0; if c_pr50lm=1  then pr50lm_&j=1;
		pr54m_&j=0; if c_pr54m=1  then pr54m_&j=1;
		pr76m_&j=0; if c_pr76m=1  then pr76m_&j=1;
		pr82m_&j=0; if c_pr82m=1  then pr82m_&j=1;
		pr84m_&j=0; if c_pr84m=1  then pr84m_&j=1;
		pr88m_&j=0; if c_pr88m=1  then pr88m_&j=1;
		pr90m_&j=0; if c_pr90m=1  then pr90m_&j=1;
		pim_&j=0; 
		if pr32m_&j=1 or pr33m_&j=1 or pr46m_&j=1 or
		pr47m_&j=1 or pr50vm_&j=1 or pr50lm_&j=1 or 
		pr54m_&j=1 or pr76m_&j=1 or pr82m_&j=1 or pr84m_&j=1  or pr88m_&j=1 or
		pr90m_&j=1 then pim_&j=1;
		inprim_&j=0;  if c_inprim=1  then inprim_&j=1;
		insm_&j=0;  if c_insm=1  then insm_&j=1;
		inm_&j=0;   if inprim_&j=1 or insm_&j=1 then inm_&j=1;
	end;
	...
	if primary&j=1 then do; 
		...
		i_184m=c_rt184m;
		i_65m=c_rt65m;
		if c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 then i_nnm=1;
		if c_inprim=1 or c_insm=1 then i_im=1;  
		i_rm&j=rm_&j; 
	end;

	if c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 or c_rt65m=1 or c_rt184m=1 or c_rttams >= 1 or c_rt151m=1
	or c_pr32m=1  or c_pr33m=1 	or c_pr46m=1  or c_pr47m=1 or c_pr50vm=1 or c_pr50lm=1 or c_pr54m=1 
	or c_pr76m=1  or c_pr82m=1  or c_pr84m=1  or c_pr88m=1 or c_pr90m=1  or c_inprim=1   or c_insm=1
	...
	if primary&j=1 then do; r_&j=0;
		...
		or r_dar >= 0.5 or r_lpr >= 0.5  or r_taz >= 0.5 or r_dol >= 0.5 or r_rla >= 0.5 or r_cla >= 0.5 then r_&j=1;
	end;
	...
	if caldate&j=yrart >. then do;
		...
		if c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 then nnm_art=1;
		...
		m184_art=c_rt184m; 
		if c_inprim=1 or c_insm=1 then im_art = 1;
		r_art=0;
		if r_zdv  >= 0.5 or r_efa  >= 0.5 or r_nev  >= 0.5 or r_ten  >= 0.5 or r_3tc  >= 0.5 
		or r_dar >= 0.5 or r_lpr >= 0.5 or r_taz >= 0.5 or r_dol >= 0.5 or r_pla >= 0.5 or r_cla >= 0.5 then r_art=1; 
...
if prep   ne 1 then do;
	...
	if onart&j = 1 and tcur&j > 0.5 then onart_gt6m = 1;
	if onart_gt6m=1 then vl1000_art_gt6m= vl1000;

	onart_gt6m_iicu=.;vl1000_art_gt6m_iicu = .; 
	if ((onart&j = 1 and tcur&j > 0.5) or (int_clinic_not_aw = 1 and caldate&j - yrart > 0.5)) then onart_gt6m_iicu =1;
...
vl1000_art_gt6m_sw=.;  onart_gt6m_sw=.;
...
if 15 <= age&j < 20 then do;
	if gender = 1 then do; 
	onart_gt6m_iicu_m_1519_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_m_1519_ = vl1000_art_gt6m_iicu;
	end;

	if gender = 2 then do; 
	onart_gt6m_iicu_w_1519_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_w_1519_ = vl1000_art_gt6m_iicu;
	end;
end;
if 15 <= age&j < 25 then do;
	...
	if gender = 1 then do; 
	onart_gt6m_iicu_m_1524_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_m_1524_ = vl1000_art_gt6m_iicu;
	end;

	if gender = 2 then do; 
	onart_gt6m_iicu_w_1524_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_w_1524_ = vl1000_art_gt6m_iicu;
	end;

end;

if 15 <= age&j < 23 then do;
	onart_gt6m_iicu_1522_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_1522_ = vl1000_art_gt6m_iicu;
end;

if . < adhav < 0.8 then do;
	onart_gt6m_iicu_adhav_l_	= onart_gt6m_iicu;
	vl1000_art_gt6m_iicu_adhav_l_ = vl1000_art_gt6m_iicu;
end;
...
if sw&j = 1 then do;
	onart_gt6m_sw		    = onart_gt6m; 
	vl1000_art_gt6m_sw		= vl1000_art_gt6m;
end;


onart_vlg1000=0; if onart&j=1 and vl1000=0 then onart_vlg1000=1;

if onart&j=1 and vl1000=0 and tcur&j ge 0.5 then ever_onart_gt6m_vlg1000=1;
if onart&j=1 and vm > log10(1000) and tcur&j ge 0.5 then ever_onart_gt6m_vl_m_g1000=1;

onart_gt6m_vlg1000=0; if ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and v&j >= log10(1000)  and caldate&j ge yrart+0.5 > . then onart_gt6m_vlg1000=1;

r_onart_gt6m_vlg1000=0; if (onart&j=1 and tcur&j ge 0.5) and vl1000=0 and caldate&j ge yrart+0.5  > . then r_onart_gt6m_vlg1000=1;
...
if infected_prep=1 then do;
	...
	if primary_r_prep=0 then ever_i_nor_prep=1;
end;
...
if infected_prep=1 and primary&j=1 then do;
	primary_prep=1; 
	primary_r_prep=c_rm_inf; 
	ever_i_nor_prep=0;
	if primary_r_prep=1 then i_r_prep=1;
	if primary_r_prep ne 1 then ever_i_nor_prep=1; 
end;
...
if primary_prep=1 and started_prep_in_primary_e ne 1 then do;
	...
	if rt184m_p = 1 then prepinfect_rt184m_p=1;
	if rt65m_p = 1 then prepinfect_rt65m_p=1;
	if tam_p >= 1 then prepinfect_tam_p=1;
	if (rt184m_p+rt65m_p+tam_p) >= 1 then prepinfect_prep_r_p=1;
	if inprim_p >= 1 then prepinfect_inprim_p=1;
	...
	if c_rt65m_inf >= 1 then prepinfect_rt65m=1;
	if c_rt184m_inf = 1 then prepinfect_rt184m=1;
	if c_inprim_inf = 1 then prepinfect_inprim=1;
...
cur_res_prep_drug_tld=0; if (e_rttams + e_rt184m + e_rt65m + e_inprim + e_insm) ge 1  then cur_res_prep_drug_tld=1;
...
cur_res_efa_vlg1000=0; if c_rt101m=1 or c_rt103m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1 then cur_res_efa_vlg1000=1; * may17 h;
cur_res_rla_vlg1000=0; if c_rt101m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 then cur_res_rla_vlg1000=1; * may17 h;
cur_res_dol_vlg1000=0; if c_insm=1 or c_inprim=1 then cur_res_dol_vlg1000=1;
cur_res_cla_vlg1000=0; if c_insm=1 or c_inprim=1 then cur_res_cla_vlg1000=1;
...
if prep_tm2 ne 1 and prep_tm1=1 and tested&j=1 then do; test_period1_on_prep =1; test_period1_on_prep_pos=0; if caldate&j = date1pos then test_period1_on_prep_pos=1; end;
...
if &j > 4 and prep=1 and (. < caldate&j-dt_last_test < 1) then n_test_prev_4p_onprep=sum(tested&j,tested&x,tested&a,tested&b);
...
if infected_prep=1 and i_r_prep ne 1  then do;
	...
	time_acq_mut    = caldate&j -infection; if acq_mut=1     then time_acq_mut   = dt_acq_mut   -infection;

	if time_from_infection=0.25 then do;
		acq_rt65m_3_prep =c_rt65m; acq_rt184m_3_prep=c_rt184m; acq_mut_3_prep=rm_&j;
	end;
	else if time_from_infection=0.5 then do;
		acq_rt65m_6_prep =c_rt65m; acq_rt184m_6_prep=c_rt184m; acq_mut_6_prep=rm_&j;
	end;
	else if time_from_infection=0.75 then do;
		acq_rt65m_9_prep =c_rt65m; acq_rt184m_9_prep=c_rt184m; acq_mut_9_prep=rm_&j;
	end;
	else if time_from_infection=1 then do;
		acq_rt65m_12_prep =c_rt65m; acq_rt184m_12_prep=c_rt184m; acq_mut_12_prep=rm_&j;
	end;
	else if time_from_infection=1.5 then do;
		acq_rt65m_18_prep =c_rt65m; acq_rt184m_18_prep=c_rt184m; acq_mut_18_prep=rm_&j;
	end;
...
if t ge 4 and (tested&j=1 or tested&x=1 or tested&a=1 or tested&b=1) then do;
	if gender=1 then do;
		if 15 le age&j lt 50 then tested_4p_m1549_=1; 
		if 15 le age&j lt 20 then tested_4p_m1519_=1; 
		if 20 le age&j lt 25 then tested_4p_m2024_=1;
		if 25 le age&j lt 30 then tested_4p_m2529_=1;
		if 30 le age&j lt 40 then tested_4p_m3039_=1;
		if 40 le age&j lt 50 then tested_4p_m4049_=1;
		if 50 le age&j lt 65 then tested_4p_m5064_=1;
	end;
	else if gender=2 then do;
		if 15 le age&j lt 50 then tested_4p_w1549_=1;
		if 15 le age&j lt 20 then tested_4p_w1519_=1;
		if 20 le age&j lt 25 then tested_4p_w2024_=1;
		if 25 le age&j lt 30 then tested_4p_w2529_=1;
		if 30 le age&j lt 40 then tested_4p_w3039_=1;
		if 40 le age&j lt 50 then tested_4p_w4049_=1;
		if 50 le age&j lt 65 then tested_4p_w5064_=1;
		if sw&j=1       		 then tested_4p_sw=1;
...
if gender=1 then do;
	...
	if sw&j = 1 		   then do;  ever_tested_sw   =ever_tested; diag_sw   =registd&j; onart_sw   =onart&j;vs_sw=vl1000; end;
...
onart_gt6m_nnres_vlg1000=0; if ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and vl1000=0 and (c_rt101m=1 or c_rt103m=1 or c_rt138m=1 or c_rt181m=1 or c_rt188m=1 or c_rt190m=1)  and caldate&j ge yrart+0.5 > .
then onart_gt6m_nnres_vlg1000=1;
onart_gt6m_pires_vlg1000=0; if ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and vl1000=0 and (c_pr32m=1 or c_pr33m=1 
...
onart_gt6m_res_vlg1000=0; if ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and vl1000=0 and rm_&j=1  and caldate&j ge yrart+0.5  > . then onart_gt6m_res_vlg1000=1;
...
o_zdv_tox = 0; if o_zdv = 1 and c_tox&j = 1 then o_zdv_tox = 1;
o_3tc_tox = 0; if o_3tc = 1 and c_tox&j = 1 then o_3tc_tox = 1;
o_ten_tox = 0; if o_ten = 1 and c_tox&j = 1 then o_ten_tox = 1;
o_taz_tox = 0; if o_taz = 1 and c_tox&j = 1 then o_taz_tox = 1;
o_lpr_tox = 0; if o_lpr = 1 and c_tox&j = 1 then o_lpr_tox = 1;
o_efa_tox = 0; if o_efa = 1 and c_tox&j = 1 then o_efa_tox = 1;
o_rla_tox = 0; if o_rla = 1 and c_tox&j = 1 then o_rla_tox = 1;
o_nev_tox = 0; if o_nev = 1 and c_tox&j = 1 then o_nev_tox = 1;
o_dol_tox = 0; if o_dol = 1 and c_tox&j = 1 then o_dol_tox = 1;
o_cla_tox = 0; if o_cla = 1 and c_tox&j = 1 then o_cla_tox = 1;
o_tle_tox = 0; if tle = 1 and c_tox&j = 1 then o_tle_tox = 1;
o_tld_tox = 0; if tld = 1 and c_tox&j = 1 then o_tld_tox = 1;
o_zld_tox = 0; if zld = 1 and c_tox&j = 1 then o_zld_tox = 1;
o_zla_tox = 0; if zla = 1 and c_tox&j = 1 then o_zla_tox = 1;

o_zdv_adh_hi = 0; if o_zdv = 1 and adh&j >= 0.8 then o_zdv_adh_hi = 1;
o_3tc_adh_hi = 0; if o_3tc = 1 and adh&j >= 0.8 then o_3tc_adh_hi = 1;
o_ten_adh_hi = 0; if o_ten = 1 and adh&j >= 0.8 then o_ten_adh_hi = 1;
o_taz_adh_hi = 0; if o_taz = 1 and adh&j >= 0.8 then o_taz_adh_hi = 1;
o_lpr_adh_hi = 0; if o_lpr = 1 and adh&j >= 0.8 then o_lpr_adh_hi = 1;
o_efa_adh_hi = 0; if o_efa = 1 and adh&j >= 0.8 then o_efa_adh_hi = 1;
o_nev_adh_hi = 0; if o_nev = 1 and adh&j >= 0.8 then o_nev_adh_hi = 1;
o_dol_adh_hi = 0; if o_dol = 1 and adh&j >= 0.8 then o_dol_adh_hi = 1;
o_tle_adh_hi = 0; if tle = 1 and adh&j >= 0.8 then o_tle_adh_hi = 1;
o_tld_adh_hi = 0; if tld = 1 and adh&j >= 0.8 then o_tld_adh_hi = 1;
o_zld_adh_hi = 0; if zld = 1 and adh&j >= 0.8 then o_zld_adh_hi = 1;
o_zla_adh_hi = 0; if zla = 1 and adh&j >= 0.8 then o_zla_adh_hi = 1;


if caldate&j = date_start_zld_if_reg_op_116 then do;
start_zld_if_reg_op_116=1;
onart_start_zld_if_reg_op_116 = 0; if onart&j = 1 then onart_start_zld_if_reg_op_116 = 1;
...
if caldate&j >= date_start_zld_if_reg_op_116 > . and adh&j > . then a_zld_if_reg_op_116 = 1;
if caldate&j >= date_start_zld_if_reg_op_116 > . and onart_start_zld_if_reg_op_116 = 1 then n_zld_if_reg_op_116 = 1;

if a_zld_if_reg_op_116 = 1 and adh&j > 0.8 then adh_hi_a_zld_if_reg_op_116 = 1; 
if a_zld_if_reg_op_116 = 1 and nactive&j >= 2.75 then nac_ge2p75_a_zld_if_reg_op_116 = 1; 
if a_zld_if_reg_op_116 = 1 and nactive&j >= 2.00 then nac_ge2p00_a_zld_if_reg_op_116 = 1; 
if a_zld_if_reg_op_116 = 1 and nactive&j >= 1.50 then nac_ge1p50_a_zld_if_reg_op_116 = 1; 


d=&j;
	discount = (0.9974649513861632)**(d-(125*3));
...
newp_this_per=0; if newp&j ge 1 then newp_this_per=1;
if newp_this_per=1 then do;
if onart&j=1 then newp_this_per_art=1;
if prep=1 then newp_this_per_prep=1;
if prep=1 or onart&j=1 then newp_this_per_art_or_prep=1;
end;
...
visit_prep_no=0; if visit_prep=0 then visit_prep_no=1; 
visit_prep_d=0; if visit_prep=1 then visit_prep_d=1;	 
visit_prep_dt=0; if visit_prep=2 then visit_prep_dt=1; 	
visit_prep_dtc=0; if visit_prep=3 then visit_prep_dtc=1;	

vlg1000_onart=0; vlg1000_184m=0; vlg1000_65m=0; vlg1000_onart_184m=0; vlg1000_onart_65m=0; 
if v&j >= log10(1000) and ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) then vlg1000_onart=1;
if v&j >= log10(1000) and c_rt184m=1 then vlg1000_184m=1;
if v&j >= log10(1000) and c_rt65m=1 then vlg1000_65m=1;
if v&j >= log10(1000) and ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and c_rt184m=1 then vlg1000_onart_184m=1;
if v&j >= log10(1000) and ((onart&j=1 and tcur&j ge 0.5) or int_clinic_not_aw=1) and c_rt65m=1 then vlg1000_onart_65m=1;
...
if hiv&j ne 1 then do;
	if gender=1 and 15 <= age&j < 50 and (prep ne 1 or adh&j < 0.8) then do;  susc_np_1549_m = newp&j + ep&j;   end;
	if gender=1 and 15 <= age&j < 50 and (prep ne 1 or adh&j < 0.8) and mcirc   ne 1 then do;  susc_np_inc_circ_1549_m = newp&j + ep&j;   end;
	if gender=2 and 15 <= age&j < 50 and (prep ne 1 or adh&j < 0.8) then do;  susc_np_1549_w = newp&j + ep&j;   end;
end;
...
if yrart=caldate&j > .  and ever_nvp_pmtct ne 1 then do;
    ...
    if inprim_&x=1 or insm_&j=1 then _ai_naive_no_pmtct_c_inm_=1;
...
if (return_&j=1 and restart&j=1) or yrart=caldate&j > . then do;
    ...
    if inprim_&x=1 or insm_&j=1 then _all_ai_c_inm_=1;
...
v_alert_past_yr_rm_c=0; if nnm_&j=1 then v_alert_past_yr_rm_c=1; 
...
if (onart&j=1 or int_clinic_not_aw=1) and vg1000=1 and rm_&j = 1 and r_dol   le 0 then outc_ten3tc_r_f_1 = 3;
if (onart&j=1 or int_clinic_not_aw=1) and vg1000=1 and rm_&j = 1 and r_dol   gt 0 then outc_ten3tc_r_f_1 = 4;
...
if naive&j = 0 then do;

	cur_ge_2_active_arv_adh = 0;
	if nactive&j ge 2 and current_adh_dl > 0.8 then cur_ge_2_active_arv_adh = 1;
end;

if sw&j =1 then do;
	sw_o_cla = 0; if o_cla=1 then sw_o_cla = 1;
	sw_p_cla = 0; if p_cla=1 then sw_p_cla = 1;
	sw_f_cla = 0; if f_cla=1 then sw_f_cla = 1;
end;

if naive&j ne 1 and . < adhav < 0.8 then artexp_adhav_l = 1;
if artexp_adhav_l = 1 then do;
	artexp_adhav_l_o_cla = 0; if o_cla = 1 then artexp_adhav_l_o_cla=1;
	artexp_adhav_l_p_cla = 0; if p_cla = 1 then artexp_adhav_l_p_cla=1;
	artexp_adhav_l_f_cla = 0; if f_cla = 1 then artexp_adhav_l_f_cla=1;
end;


if p_cla = 1 and p_cla_tm1 = 0 then do ;
cla_rla_start=1;
r_cla_at_cla_rla_start=0;  if r_cla > 0 then r_cla_at_cla_rla_start=1;
r_rla_at_cla_rla_start=0;  if r_rla > 0 then r_rla_at_cla_rla_start=1;
end;
...
nip_w=.; if gender=2 then nip_w = nip&j ;
nip_m=.; if gender=1 then nip_m = nip&j ;
...
epi_w=0; if gender=2 then epi_w = epi&j;
epi_m=0; if gender=1 then epi_m = epi&j;

newp_ge1_w=0; if gender=2 then newp_ge1_w = newp_ge1;
newp_ge1_m=0; if gender=1 then newp_ge1_m = newp_ge1;

if gender=2 and 15 <= age&j < 50 then do;
sw1549=0; if sw&j = 1 then sw1549=1; 
end;
...
newp_sw = 0;  if sw&j = 1 then newp_sw = newp&j; 


start_clarla_this_period = .; start_clarla_vlg1000 = .; start_clarla_vlg10000 = .; start_clarla_rt103m = .; start_clarla_rt101m = .; start_clarla_rt138m = .;  
start_clarla_rt188m = .;  start_clarla_rt190m = .;  start_clarla_rt181m = .; start_clarla_rt65m = .; start_clarla_rt184m = .; start_clarla_pim = .; 
start_clarla_rtnnm = .;  start_clarla_rtnnm_o103 = .;  start_clarla_iipm = .; start_clarla_iim = .; start_clarla_agelt25 = .; start_clarla_m = .; 
start_clarla_w = .; start_clarla_linefail1 = .; start_clarla_onart = .; start_clarla_adhlt80 = .; start_clarla_p_taz_line2 = .; 

if t ge 2 and p_cla_tm1 ne 1 and p_cla = 1 then do;
start_clarla_this_period=1;
start_clarla_vlg1000 = 0 ; if v&x > 3 then start_clarla_vlg1000 = 1;
start_clarla_vlg10000 = 0; if v&x > 4 then start_clarla_vlg10000 = 1;
start_clarla_rt103m = 0; if e_rt103m=1 then start_clarla_rt103m = 1;
start_clarla_rt101m = 0;  if e_rt101m=1 then start_clarla_rt101m = 1;
start_clarla_rt138m = 0;  if e_rt138m=1 then start_clarla_rt138m = 1;
start_clarla_rt188m = 0;  if e_rt188m=1 then start_clarla_rt188m = 1;
start_clarla_rt190m = 0;  if e_rt190m=1 then start_clarla_rt190m = 1;
start_clarla_rt181m = 0; if e_rt181m=1 then start_clarla_rt181m = 1;
start_clarla_rt65m = 0; if e_rt65m=1 then start_clarla_rt65m  = 1;
start_clarla_rt184m = 0; if e_rt184m=1 then start_clarla_rt184m = 1;
start_clarla_pim = 0; if e_pimut=1 then start_clarla_pim = 1;
start_clarla_rtnnm = 0;  if e_nnmut ge 1 then start_clarla_rtnnm = 1;
start_clarla_rtnnm_o103 = 0;  if (e_rt101m=1 or e_rt138m=1 or e_rt181m=1 or e_rt190m=1 or e_rt188m=1) then start_clarla_rtnnm_o103 = 1;
start_clarla_iipm = 0; if e_inprim=1 then start_clarla_iipm = 1;
start_clarla_iim = 0; if e_inmut=1 then start_clarla_iim = 1;
start_clarla_agelt25 = 0; if 15 <= age&j < 25 then start_clarla_agelt25 = 1; 
start_clarla_m = 0; if gender=1 then start_clarla_m = 1;
start_clarla_w = 0; if gender=2 then start_clarla_w = 1;
start_clarla_linefail1 = 0; if linefail&x = 1 then start_clarla_linefail1 = 1;
start_clarla_onart = 0;  if onart&x = 1 then start_clarla_onart = 1;
start_clarla_adhlt80 = 0; if adh&x < 0.8 then start_clarla_adhlt80 = 1; 
start_clarla_p_taz_line2 = 0; if p_taz=1 then start_clarla_p_taz_line2 = 1;
end;

onart_iicu_vlg1000 = .; onart_iicu_vlg10000 = .; onart_iicu_rt103m = .; onart_iicu_rt101m = .; onart_iicu_rt138m = .;  
onart_iicu_rt188m = .;  onart_iicu_rt190m = .;  onart_iicu_rt181m = .; onart_iicu_rt65m = .; onart_iicu_rt184m = .; onart_iicu_pim = .; 
onart_iicu_rtnnm = .;  onart_iicu_rtnnm_o103 = .;  onart_iicu_iipm = .; onart_iicu_iim = .; onart_iicu_agelt25 = .; onart_iicu_m = .; 
onart_iicu_w = .; onart_iicu_linefail1 = .; onart_iicu_onart = .; onart_iicu_adhlt80 = .; onart_iicu_p_taz_line2 = .; 

if t ge 2 and onart_iicu = 1 then do;
onart_iicu_vlg1000 = 0 ; if v&x > 3 then onart_iicu_vlg1000 = 1;
onart_iicu_vlg10000 = 0; if v&x > 4 then onart_iicu_vlg10000 = 1;
onart_iicu_rt103m = 0; if e_rt103m=1 then onart_iicu_rt103m = 1;
onart_iicu_rt101m = 0;  if e_rt101m=1 then onart_iicu_rt101m = 1;
onart_iicu_rt138m = 0;  if e_rt138m=1 then onart_iicu_rt138m = 1;
onart_iicu_rt188m = 0;  if e_rt188m=1 then onart_iicu_rt188m = 1;
onart_iicu_rt190m = 0;  if e_rt190m=1 then onart_iicu_rt190m = 1;
onart_iicu_rt181m = 0; if e_rt181m=1 then onart_iicu_rt181m = 1;
onart_iicu_rt65m = 0; if e_rt65m=1 then onart_iicu_rt65m  = 1;
onart_iicu_rt184m = 0; if e_rt184m=1 then onart_iicu_rt184m = 1;
onart_iicu_pim = 0; if e_pimut ge 1 then onart_iicu_pim = 1;
onart_iicu_rtnnm = 0;  if e_nnmut=1 then onart_iicu_nnm = 1;
onart_iicu_rtnnm_o103 = 0;  if (e_rt101m=1 or e_rt138m=1 or e_rt181m=1 or e_rt190m=1 or e_rt188m=1) then onart_iicu_rtnnm_o103 = 1;
onart_iicu_iipm = 0; if e_inprim=1 then onart_iicu_iipm = 1;
onart_iicu_iim = 0; if e_inmut=1 then onart_iicu_iim = 1;
onart_iicu_agelt25 = 0; if 15 <= age&j < 25 then onart_iicu_agelt25 = 1; 
onart_iicu_m = 0; if gender=1 then onart_iicu_m = 1;
onart_iicu_w = 0; if gender=2 then onart_iicu_w = 1;
onart_iicu_linefail1 = 0; if linefail&x = 1 then onart_iicu_linefail1 = 1;
onart_iicu_onart = 0;  if onart&x = 1 then onart_iicu_onart = 1;
onart_iicu_adhlt80 = 0; if adh&x < 0.8 then onart_iicu_adhlt80 = 1; 
onart_iicu_p_taz_line2 = 0; if p_taz=1 then onart_iicu_p_taz_line2 = 1;
end;


artexp_clarla_elig_20 = .; artexp_clarla_elig_20_onart = .; artexp_clarla_e_20_adh_dl_ge80 = .;
artexp_clarla_elig_22 = .; artexp_clarla_elig_22_onart = .; artexp_clarla_e_22_adh_dl_ge80 = .;
artexp_clarla_elig_24 = .; artexp_clarla_elig_24_onart = .; artexp_clarla_e_24_adh_dl_ge80 = .;

if caldate&j ge date_clarla_eligible_20 > . then do;	
	if naive&j = 0 then artexp_clarla_elig_20 = 1; 
	if artexp_clarla_elig_20 = 1 then do;
		artexp_clarla_elig_20_onart = 0; if onart&j = 1 then artexp_clarla_elig_20_onart = 1;
		artexp_clarla_e_20_adh_dl_ge80 = 0; if current_adh_dl ge 0.8 then artexp_clarla_e_20_adh_dl_ge80 = 1; 
	end;
end;

if caldate&j ge date_clarla_eligible_22 > . then do;	
	if naive&j = 0 then artexp_clarla_elig_22 = 1; 
	if artexp_clarla_elig_22 = 1 then do;
		artexp_clarla_elig_22_onart = 0; if onart&j = 1 then artexp_clarla_elig_22_onart = 1;
		artexp_clarla_e_22_adh_dl_ge80 = 0; if current_adh_dl ge 0.8 then artexp_clarla_e_22_adh_dl_ge80 = 1; 
	end;
end;

if caldate&j ge date_clarla_eligible_24 > . then do;	
	if naive&j = 0 then artexp_clarla_elig_24 = 1; 
	if artexp_clarla_elig_24 = 1 then do;
		artexp_clarla_elig_24_onart = 0; if onart&j = 1 then artexp_clarla_elig_24_onart = 1;
		artexp_clarla_e_24_adh_dl_ge80 = 0; if current_adh_dl ge 0.8 then artexp_clarla_e_24_adh_dl_ge80 = 1; 
	end;
end;
...
years_since_start_prep n_test_prev_4p_onprep
age_deb_sw act_years_sw  tot_dur_sw
...
rbm  np&j  newp&j  newp_ge1  newp_ge5  newp_ge10  newp_ge50  ep&j   ep_m&j  ep_w&j  npge10  npge2  npge2_l4p_1549m  npge2_l4p_1549w   
...
m5564_ep1524  m5564_ep2534  m5564_ep3544  m5564_ep4554  m5564_ep5564  
...
w5564_ep1524  w5564_ep2534  w5564_ep3544  w5564_ep4554  w5564_ep5564
...
newp_this_per_art_or_prep   newp_this_per_art   newp_this_per_prep  newp_this_per  newp_sw
...
tam1_&j  tam2_&j  tam3_&j  rt184m_&j  rt103m_&j  rt181m_&j  rt190m_&j rt101m_&j rt138m_&j rt188m_&j  nnm_&j  rt151m_&j  rt65m_&j  
pr32m_&j  pr33m_&j  pr46m_&j  pr47m_&j   pr50vm_&j  pr50lm_&j  pr54m_&j   pr76m_&j pr82m_&j   pr84m_&j  pr88m_&j  pr90m_&j  pim_&j 
inprim_&j  insm_&j  rm_&j    i_nnm 	 i_rm&j    i_pim  	 i_tam 	   i_im	   inm_&j    i_184m	  im_art   pim_art  tam_art  m184_art
r_&j	 r_3tc  r_nev  r_lpr   r_taz   r_efa   r_ten   r_zdv r_dol r_rla r_cla
rme_&j   iime_&j  nnme_&j  pime_&j   nrtime_&j 
res_1stline_startline2  nnm_art  nnm_art_m  nnm_art_w  r_art  acq_rt65m  acq_rt184m  acq_mut  onart_iicu_res
...
o_dol_2nd_vlg1000 o_dol_2nd_vlg1000_dolr1_adh0  o_dol_2nd_vlg1000_dolr1_adh1  o_dol_2nd_vlg1000_dolr0_adh0 o_dol_2nd_vlg1000_dolr0_adh1 

zero_3tc_activity_m184  zero_tdf_activity_k65r   r_cla_at_cla_rla_start r_rla_at_cla_rla_start  cla_rla_start 

prep prep_sw prep_w_1524 elig_prep_epdiag  infected_prep  prep_ever  primary_prep  hiv1_prep  i_r_prep  primary_r_prep  ever_i_nor_prep  
...
acq_rt65m_3_prep  acq_rt184m_3_prep   acq_mut_3_prep     acq_rt65m_6_prep   acq_rt184m_6_prep   acq_mut_6_prep 
acq_rt65m_9_prep  acq_rt184m_9_prep   acq_mut_9_prep     acq_rt65m_12_prep  acq_rt184m_12_prep  acq_mut_12_prep  
acq_rt65m_18_prep acq_rt184m_18_prep  acq_mut_18_prep
...
onprep_12_i_prep_no_r 		 onprep_18_i_prep_no_r prepinfect_rm_p   	 prepinfect_rt184m_p    prepinfect_rt65m_p 
prepinfect_tam_p 			 prepinfect_rtm  	   prepinfect_rt65m		 prepinfect_rt184m  	   prepinfect_tam  
...
test_gt_period1_on_prep  test_gt_period1_on_prep_pos  test_period1_on_prep  test_period1_on_prep_pos  
...
pop_wide_tld_prep   prep_strategy 
...
tested_4p_m1549_  tested_4p_m1519_  tested_4p_m2024_  tested_4p_m2529_  tested_4p_m3039_  tested_4p_m4049_  tested_4p_m5064_
tested_4p_w1549_  tested_4p_w1519_ 	tested_4p_w2024_  tested_4p_w2529_	tested_4p_w3039_  tested_4p_w4049_ 	tested_4p_w5064_ 
tested_4p_sw
...
com_test  tested_anc_prevdiag  tested_anc 
...
vl1000	  vl1000_art	 onart_iicu    vl1000_art_iicu    onart_gt6m    vl1000_art_gt6m    onart_gt6m_iicu    vl1000_art_gt6m_iicu
vl1000_m  vl1000_art_m   onart_iicu_m  vl1000_art_iicu_m  onart_gt6m_m  vl1000_art_gt6m_m  onart_gt6m_iicu_m  vl1000_art_gt6m_iicu_m  
vl1000_w  vl1000_art_w   onart_iicu_w  vl1000_art_iicu_w  onart_gt6m_w  vl1000_art_gt6m_w  onart_gt6m_iicu_w  vl1000_art_gt6m_iicu_w  
vl1000_art_1524_  onart_iicu_1524_  vl1000_art_iicu_1524_  onart_gt6m_1524_  vl1000_art_gt6m_1524_  onart_gt6m_iicu_1524_  vl1000_art_gt6m_iicu_1524_

vl1000_art_gt6m_iicu_m_1519_  onart_gt6m_iicu_m_1519_  vl1000_art_gt6m_iicu_w_1519_  onart_gt6m_iicu_w_1519_ 
vl1000_art_gt6m_iicu_m_1524_   onart_gt6m_iicu_m_1524_   vl1000_art_gt6m_iicu_w_1524_   onart_gt6m_iicu_w_1524_

vl1000_art_2549_  onart_iicu_2549_  vl1000_art_iicu_2549_  onart_gt6m_2549_  vl1000_art_gt6m_2549_  onart_gt6m_iicu_2549_  vl1000_art_gt6m_iicu_2549_
vl1000_art_50pl_  onart_iicu_50pl_  vl1000_art_iicu_50pl_  onart_gt6m_50pl_  vl1000_art_gt6m_50pl_  onart_gt6m_iicu_50pl_  vl1000_art_gt6m_iicu_50pl_
...
o_lpr  o_taz  o_3tc  o_nev  o_efa  o_ten  o_zdv  o_dol o_cla o_rla
p_lpr  p_taz  p_3tc  p_nev  p_efa  p_ten  p_zdv  p_dol p_cla p_rla
f_lpr  f_taz  f_3tc  f_nev  f_efa  f_ten  f_zdv  f_dol f_cla f_rla
...
c_tox&j  cur_dol_cns_tox  cur_efa_cns_tox  cla_time_to_lower_threshold_g  dol_efa_cla_rla_potency 
...
o_zdv_tox o_3tc_tox o_ten_tox o_taz_tox o_lpr_tox o_efa_tox o_nev_tox o_dol_tox o_cla_tox o_rla_tox
o_zdv_adh_hi o_3tc_adh_hi o_ten_adh_hi o_taz_adh_hi o_lpr_adh_hi o_efa_adh_hi o_nev_adh_hi o_dol_adh_hi 

o_tle_tox o_tld_tox o_zld_tox o_zla_tox o_tle_adh_hi  o_tld_adh_hi  o_zld_adh_hi  o_zla_adh_hi 

c_nau  c_lip  c_pen  c_ras  c_cns c_lac c_ane c_hep  c_dia  c_otx  c_neph  c_weightg

a_zld_if_reg_op_116  adh_hi_a_zld_if_reg_op_116   nac_ge2p75_a_zld_if_reg_op_116 nac_ge2p00_a_zld_if_reg_op_116  nac_ge1p50_a_zld_if_reg_op_116

start_zld_if_reg_op_116   onart_start_zld_if_reg_op_116   e_rt65m_st_zld_if_reg_op_116  n_zld_if_reg_op_116 

cost     art_cost    adc_cost   cd4_cost    vl_cost    vis_cost    full_vis_cost    who3_cost   cot_cost
tb_cost    cost_test   res_cost   cost_circ    t_adh_int_cost     cost_test_m    cost_test_f   
...
cost_test_f_non_anc  	   pi_cost  	 cost_switch_line  			cost_child_hiv  cost_child_hiv_mo_art  		   cost_art_init
  art_1_cost   art_2_cost  	art_3_cost  	cost_vl_not_done 
cost_zdv  	 cost_ten 	   cost_3tc 	 cost_nev  	   cost_lpr  	cost_dar 	 	cost_taz  	  	cost_efa  	   cost_dol   cost_cla cost_rla
...
_dtb_cost   _dtest_cost   _dres_cost     _dcost_circ   _d_t_adh_int_cost  _dtest_cost_m  _dtest_cost_f 
...
_dcost_test_f_non_anc 	  _dpi_cost  	 _dcost_switch_line  		_dcost_child_hiv _dcost_child_hiv_mo_art  		_dcost_art_init
	_dart_1_cost _dart_2_cost    _dart_3_cost		_dcost_vl_not_done
...
dead_artexp  dead_artexpoff  dead_nn  dead_pir  dead_adc  dead_line1  dead_line2  dead_art_1p
...
sw_newp   sw1524_newp sw_newp_cat1 sw_newp_cat2 sw_newp_cat3 sw_newp_cat4 sw_newp_cat5  
...
mcirc  mcirc_1519m  mcirc_2024m	 mcirc_2529m  mcirc_3034m  mcirc_3539m  mcirc_4044m  mcirc_4549m  mcirc_50plm
vmmc vmmc1519m  vmmc2024m  vmmc2529m  vmmc3034m  vmmc3539m  vmmc4044m  vmmc4549m  vmmc50plm
new_mcirc  new_mcirc_1519m  new_mcirc_2024m  new_mcirc_2529m  new_mcirc_3034m  new_mcirc_3539m  new_mcirc_4044m
new_mcirc_4549m  new_mcirc_50plm
...
newpge1_l4p_1529m	newpge1_l4p_1529w
...
npge1_l4p_1564m  npge1_l4p_1524m  npge1_l4p_2534m  npge1_l4p_3544m  npge1_l4p_4554m  npge1_l4p_5564m  npge1_l4p_1564w  npge1_l4p_1524w  npge1_l4p_2534w  npge1_l4p_3544w  npge1_l4p_4554w  npge1_l4p_5564w
npge2_l4p_1564m  npge2_l4p_1524m  npge2_l4p_2534m  npge2_l4p_3544m  npge2_l4p_4554m  npge2_l4p_5564m  npge2_l4p_1564w  npge2_l4p_1524w  npge2_l4p_2534w  npge2_l4p_3544w  npge2_l4p_4554w  npge2_l4p_5564w
npge10_l4p_1564m  npge10_l4p_1524m  npge10_l4p_2534m  npge10_l4p_3544m  npge10_l4p_4554m  npge10_l4p_5564m  npge10_l4p_1564w  npge10_l4p_1524w  npge10_l4p_2534w  npge10_l4p_3544w  npge10_l4p_4554w  npge10_l4p_5564w
npge50_l4p_1564m  npge50_l4p_1524m  npge50_l4p_2534m  npge50_l4p_3544m  npge50_l4p_4554m  npge50_l4p_5564m  npge50_l4p_1564w  npge50_l4p_1524w  npge50_l4p_2534w  npge50_l4p_3544w  npge50_l4p_4554w  npge50_l4p_5564w
npge1_l4p_1564_hivpos  npge2_l4p_1564_hivpos  npge1_l4p_1564_hivdiag  npge2_l4p_1564_hivdiag  npge1_l4p_1564_hivneg  npge2_l4p_1564_hivneg
...
an_lin_incr_test  date_test_rate_plateau  rate_testanc_inc  incr_test_rate_sympt  max_freq_testing  test_targeting  fxx  gxx
...
greater_disability_tox   greater_tox_zdv   rel_rate_res_cla_dol   dol_efa_cla_rla_potency   cla_time_to_lower_threshold_g
rel_onart_la_drugs  higher_newp_with_lower_adhav  sw_lower_art_adh


onart_gt6m_iicu_1522_	vl1000_art_gt6m_iicu_1522_  sw_o_cla  cur_ge_2_active_arv_adh  vl1000_art_gt6m_iicu_adhav_l_ onart_gt6m_iicu_adhav_l_
artexp_adhav_l  artexp_adhav_l_o_cla  artexp_adhav_l_p_cla  artexp_adhav_l_f_cla  sw_p_cla  sw_f_cla  vl1000_art_gt6m_sw onart_gt6m_sw
...
median=p50_years_since_start_prep sum=s_years_since_start_prep
median=p50_n_test_prev_4p_onprep sum=s_n_test_prev_4p_onprep
median=p50_age_deb_sw sum=s_age_deb 
median=p50_act_years_sw sum=s_act_years_sw 
median=p50_tot_dur_sw sum=s_tot_dur_sw
...
s_rbm  s_np  s_newp  s_newp_ge1  s_newp_ge5  s_newp_ge10  s_newp_ge50  s_ep  s_ep_m  s_ep_w  s_npge10  s_npge2  s_npge2_l4p_1549m  s_npge2_l4p_1549w
...
s_tam1_  s_tam2_  s_tam3_  s_rt184m_  s_rt103m_  s_rt181m_  s_rt190m_  s_rt101m_  s_rt138m_  s_rt188m_  s_nnm_  s_rt151m_  s_rt65m_  
...
s_pop_wide_tld_prep   s_prep_strategy
...
s_c_tox  s_cur_dol_cns_tox  s_cur_efa_cns_tox  s_cla_time_to_lower_threshold_g  s_dol_efa_cla_rla_potency
...
s_start_zld_if_reg_op_116   s_onart_start_zld_if_reg_op_116   s_e_rt65m_st_zld_if_reg_op_116  s_n_zld_if_reg_op_116 
...
s_an_lin_incr_test  s_date_test_rate_plateau  s_rate_testanc_inc  s_incr_test_rate_sympt  s_max_freq_testing  s_test_targeting  s_fxx  s_gxx
...
s_greater_disability_tox   s_greater_tox_zdv     s_rel_rate_res_cla_dol    s_dol_efa_cla_rla_potency    s_cla_time_to_lower_threshold_g
s_rel_onart_la_drugs s_higher_newp_with_lower_adhav  s_sw_lower_art_adh
...
s_incidence1549m
s_r_incidence_1549
s_ratio_prev_age2529w_overall
s_mtct_prop
s_p_onart_vl1000
s_p_vg1000
s_p_ai_no_arv_c_nnm_ 
s_prop_w_giving_birth_this_per
s_prop_w_1549_sw
s_cum_ratio_newp_mw
...
alive_w   alive_m    n_zld_if_reg_op_116 
;
...
s_alive_w s_alive_m	   s_x_n_zld_if_reg_op_116 
;  
run;
...
if s_n gt 0 then do;
	...
	red_adh_multi_pill_pop_			= s_red_adh_multi_pill_pop / s_n;
	...
	greater_disability_tox_			= s_greater_disability_tox / s_n;
	greater_tox_zdv_				= s_greater_tox_zdv / s_n;
	...
	prep_strategy_					= s_prep_strategy / s_n ;

  	rel_rate_res_cla_dol_    		= s_rel_rate_res_cla_dol / s_n ;    	
	dol_efa_cla_rla_potency_    	= s_dol_efa_cla_rla_potency / s_n ;     
	cla_time_to_lower_threshold_g_	= s_cla_time_to_lower_threshold_g / s_n ;
	rel_onart_la_drugs_				= s_rel_onart_la_drugs / s_n ;
	higher_newp_with_lower_adhav_	= s_higher_newp_with_lower_adhav / s_n ;
	sw_lower_art_adh_				= s_sw_lower_art_adh / s_n ;

	prevalence2024w_ 				= s_prevalence2024w / s_n ;
	prevalence2024m_ 				= s_prevalence2024m / s_n ;
	prevalence2529w_ 				= s_prevalence2529w / s_n ;
	incidence1549_ 					= s_incidence1549 / s_n ;
	incidence1549w_ 				= s_incidence1549w / s_n ;
	incidence1549m_ 				= s_incidence1549m / s_n ;
	r_incidence_1549_ 				= s_r_incidence_1549 / s_n ;
	ratio_prev_age2529w_overall_ 	= s_ratio_prev_age2529w_overall / s_n ;
	mtct_prop_ 						= s_mtct_prop / s_n ;
	p_onart_vl1000_ 				= s_p_onart_vl1000 / s_n ;
	p_vg1000_ 						= s_p_vg1000 / s_n ;
	p_ai_no_arv_c_nnm__ 			= s_p_ai_no_arv_c_nnm_  / s_n ;
	prop_w_giving_birth_this_per_ 	= s_prop_w_giving_birth_this_per / s_n ;
	prop_w_1549_sw_ 				= s_prop_w_1549_sw / s_n ;

	cum_ratio_newp_mw_ 				= s_cum_ratio_newp_mw / s_n ;

	keep_going_						= s_keep_going / s_n;			
...
s_prop_tam1 = .;s_prop_tam2 = .;s_prop_tam3 = .;s_prop_rt103m =.;s_prop_rt181m =.;s_prop_rt190m =.;
 s_prop_rt101m=.;  s_prop_rt138m=.;  s_prop_rt188m=.;  
...
s_prop_rt103m 		 = max(0,s_rt103m_  / s_rm_);
s_prop_rt181m		 = max(0,s_rt181m_  / s_rm_);
s_prop_rt190m 		 = max(0,s_rt190m_  / s_rm_);
s_prop_rt101m 		 = max(0,s_rt101m_  / s_rm_);
s_prop_rt138m 		 = max(0,s_rt138m_  / s_rm_);
s_prop_rt188m 		 = max(0,s_rt188m_  / s_rm_);
s_prop_rt184m 		 = max(0,s_rt184m_  / s_rm_);
s_prop_rt151m 		 = max(0,s_rt151m_  / s_rm_);
s_prop_rt65m       	 = max(0,s_rt65m_   / s_rm_);
s_prop_pr32m 		 = max(0,s_pr32m_   / s_rm_);
s_prop_pr33m			 = max(0,s_pr33m_   / s_rm_);
s_prop_pr46m 		 = max(0,s_pr46m_   / s_rm_);
s_prop_pr47m			 = max(0,s_pr47m_   / s_rm_);
s_prop_pr50vm 		 = max(0,s_pr50vm_  / s_rm_);
s_prop_pr50lm 		 = max(0,s_pr50lm_  / s_rm_);
s_prop_pr54m			 = max(0,s_pr54m_   / s_rm_);
s_prop_pr76m 		 = max(0,s_pr76m_   / s_rm_);
s_prop_pr82m 		 = max(0,s_pr82m_   / s_rm_);
s_prop_pr84m 		 = max(0,s_pr84m_   / s_rm_);
s_prop_pr88m 		 = max(0,s_pr88m_   / s_rm_);
s_prop_pr90m 		 = max(0,s_pr90m_   / s_rm_);
s_prop_pim 			 = max(0,s_pim_    / s_rm_);
s_prop_inprim 		 = max(0,s_inprim_   / s_rm_);
...
if s_w5564_ep4554_ gt 0 then r_s_ep_m45w55 = s_m4554_ep5564_ / s_w5564_ep4554_;
...
if s_w5564_ep5564_ gt 0 then r_s_ep_m55w55 = s_m5564_ep5564_ / s_w5564_ep5564_;
...
s_prop_tam1   s_prop_tam2   s_prop_tam3  s_prop_rt103m  s_prop_rt181m  s_prop_rt190m    s_prop_rt101m  s_prop_rt138m  s_prop_rt188m 
s_prop_rt184m  s_prop_rt151m  s_prop_rt65m   
s_prop_pr32m   s_prop_pr33m   s_prop_pr46m  s_prop_pr47m  s_prop_pr50vm   
s_prop_pr50lm  s_prop_pr54m   s_prop_pr76m  s_prop_pr82m  s_prop_pr84m  s_prop_pr88m  s_prop_pr90m  s_prop_pim  s_prop_inprim  s_prop_insm   
...
incidence1549 = (12 * 100 * s_primary1549) / (s_alive1549 - s_hiv1549 + s_primary1549);
incidence1549w = (12 * 100 * s_primary1549w) / (s_alive1549_w - s_hiv1549w + s_primary1549w);
incidence1549m = (12 * 100 * s_primary1549m) / (s_alive1549_m - s_hiv1549m + s_primary1549m);
r_incidence_1549 = incidence1549w / incidence1549m ;
...
ratio_prev_age2529w_overall_yn = 0; if ratio_prev_age2529w_overall_ > 0.5 then ratio_prev_age2529w_overall_yn = 1;
prev_ratio_1524_yn = 0;   if prev_ratio_1524 > 1.25 then prev_ratio_1524_yn = 1;
prevalence1549_yn = 0; if 0.01 	<=	prevalence1549 < 0.35 then prevalence1549_yn = 1;
mtct_prop_yn=0; if 0.02  <= mtct_prop_ < 0.25 then mtct_prop_yn=1;
p_diag_yn = 0; if 0.25  <= p_diag then p_diag_yn = 1;
p_diag_onart_yn = 0; if 0.68  <= p_diag_onart then p_diag_onart_yn=1;
p_onart_vl1000_yn = 0 ; if 0.65 <= p_onart_vl1000_ then p_onart_vl1000_yn = 1;
prop_w_giving_birth_this_per_yn = 0; if 0.012/3 <= prop_w_giving_birth_this_per_ < 0.055/3 then prop_w_giving_birth_this_per_yn = 1; 
prop_w_1549_sw_yn = 0; if 0.002 <=  prop_w_1549_sw_ < 0.04 then prop_w_1549_sw_yn = 1; 
p_ai_no_arv_c_nnm_yn = 0; if 0 < p_ai_no_arv_c_nnm__ then p_ai_no_arv_c_nnm_yn = 1;
cum_ratio_newp_mw_yn=0; if 1/1.15 <= cum_ratio_newp_mw_ < 1.15 then cum_ratio_newp_mw_yn=1;

keep_going=0;  if ratio_prev_age2529w_overall_yn = 1 and prev_ratio_1524_yn  = 1 and prevalence1549_yn  = 1 and p_diag_yn  = 1 and p_diag_onart_yn  = 1 and 
p_onart_vl1000_yn  = 1 and prop_w_giving_birth_this_per_yn  = 1 and prop_w_1549_sw_yn = 1 then keep_going=1;

if keep_going = 0 then do;    abort abend; end;  ;
...
epvls&i epi&i epart&i ep&i dead1564_&i dead&i ageg&i c_rttams&i c_inprim&i c_insm&i c_rt184m&i c_rt65m&i c_rt151m&i   c_rt103m&i c_rt181m&i c_rt190m&i 
c_pr33m&i c_pr32m&i c_pr47m&i  c_pr46m&i c_pr54m&i c_pr76m&i c_pr50vm&i c_pr50lm&i c_pr82m&i c_pr84m&i c_pr88m&i c_pr90m&i c_totmut&i  e_rttams&i e_inprim&i e_insm&i e_rt184m&i e_rt65m&i 
e_rt151m&i e_rtnucxm&i e_rt103m&i e_rt181m&i e_rt190m&i 
e_rt101m&i e_rt138m&i e_rt188m&i c_rt101m&i c_rt138m&i c_rt188m&i 
e_pr33m&i e_pr32m&i e_pr47m&i e_pr46m&i e_pr54m&i e_pr76m&i e_pr50vm&i e_pr50lm&i e_pr82m&i e_pr84m&i e_pr88m&i e_pr90m&i 
...
vlg1&i    vlg2&i    vlg3&i    vlg4&i    vlg5&i     vlg6&i   tam0_&i tam1_&i tam2_&i tam3_&i rt184m_&i 
rt103m_&i rt181m_&i rt190m_&i nnm_&i rt151m_&i rt65m_&i  pr32m_&i pr33m_&i pr46m_&i pr47m_&i 
pr50vm_&i pr50lm_&i pr54m_&i pr76m_&i pr82m_&i pr84m_&i pr88m_&i  pr90m_&i pim_&i
...
epvls&k epdiag&k epi&k epart&k ep&k dead1564_&k dead&k ageg&k  c_rttams&k c_inprim&k c_insm&k c_rt184m&k  c_rt65m&k c_rt151m&k c_rt103m&k c_rt181m&k c_rt190m&k 
c_pr33m&k c_pr32m&k c_pr47m&k  c_pr46m&k c_pr50vm&k c_pr50lm&k c_pr82m&k
c_pr84m&k c_pr88m&k c_pr90m&k c_totmut&k   e_rttams&k e_inprim&k e_insm&k e_rt184m&k  e_rt65m&k e_rt151m&k 
...
vlg1&k   vlg2&k   vlg3&k   vlg4&k   vlg5&k   vlg6&k  tam0_&k tam1_&k tam2_&k tam3_&k rt184m_&k rt103m_&k rt181m_&k rt190m_&k rt151m_&k rt65m_&k  pr32m_&k 
pr33m_&k pr46m_&k pr47m_&k pr50vm_&k pr50lm_&k pr54m_&k pr76m_&k pr82m_&k pr84m_&k pr88m_&k pr90m_&k pim_&k
...
s_vlg1&k s_vlg2&k s_vlg3&k s_vlg4&k s_vlg5&k s_vlg6&k  s_tam0&k s_tam1&k s_tam2&k s_tam3&k s_rt184m_&k  s_l151m_&k  s_l65m_&k  s_pim_&k  sti&k 
...
alive1549_w&k  adhm&k  dead5564_all_w&k dead5564_all_m&k dead4554_all_w&k dead4554_all_m&k 
 rme_&k  rt188m_&k  rt101m_&k rt138m_&k 
...
epvls&l epdiag&l epi&l epart&l ep&l dead1564_&l dead&l  ageg&l  c_rttams&l c_inprim&l c_insm&l c_rt184m&l  
...
e_rttams&l e_inprim&l e_insm&l e_rt184m&l e_rt65m&l e_rt151m&l e_rtnucxm&l e_rt103m&l e_rt181m&l e_rt190m&l e_pr33m&l e_pr32m&l 
...
vlg1&l   vlg2&l   vlg3&l   vlg4&l   vlg5&l   vlg6&l   tam0_&l tam1_&l tam2_&l tam3_&l rt184m_&l rt103m_&l rt181m_&l rt190m_&l nnm_&l rt151m_&l rt65m_&l   pr32m_&l pr33m_&l pr46m_&l 
pr47m_&l pr50vm_&l pr50lm_&l pr54m_&l pr76m_&l pr82m_&l pr84m_&l pr88m_&l pr90m_&l pim_&l  s_alive1564&l 
...
s_vlg1&l s_vlg2&l s_vlg3&l s_vlg4&l s_vlg5&l s_vlg6&l  s_tam0&l s_tam1&l s_tam2&l s_tam3&l s_rt184m_&l   s_l65m_&l s_l151m_&l s_pim_&l   sti&l 
...
i_ep&l diag_ep&l newp_ge1_hiv&l prep&l hiv1564m_&l  hiv1564w_&l      
 elig_treat200&l   elig_treat350&l hiv1549_&l    newp_ge10_&l  newp_ge50_&l  inf_vlsupp&l  inf_newp&l inf_ep&l inf_diag&l inf_naive&l  alive1549&l c_pr50lm&l c_pr76m&l inprim_&l insm_&l e_pr76m&l
...
epvls&b epi&b epart&b dead1564_&b dead&b  ageg&b  c_rttams&b c_inprim&b c_insm&b c_rt184m&b  c_rt65m&b c_rt151m&b  c_rt103m&b c_rt181m&b c_rt190m&b 
c_pr33m&b c_pr32m&b c_pr47m&b  c_pr46m&b c_pr50vm&b c_pr50lm&b c_pr82m&b c_pr84m&b c_pr88m&b c_pr90m&b c_totmut&b  
e_rttams&b e_inprim&b e_insm&b e_rt184m&b e_rt65m&b e_rt151m&b e_rtnucxm&b e_rt103m&b e_rt181m&b e_rt190m&b e_pr33m&b e_pr32m&b 
...
vlg1&b vlg2&b vlg3&b vlg4&b vlg5&b vlg6&b tam0_&b tam1_&b tam2_&b tam3_&b rt184m_&b rt103m_&b rt181m_&b rt190m_&b nnm_&b rt151m_&b rt65m_&b  
 pr32m_&b pr33m_&b pr46m_&b pr47m_&b  pr50vm_&b pr50lm_&b pr54m_&b pr76m_&b pr82m_&b pr84m_&b pr88m_&b pr90m_&b pim_&b
...
s_vlg1&b  s_vlg2&b  s_vlg3&b  s_vlg4&b  s_vlg5&b s_vlg6&b s_tam0&b  s_tam1&b  s_tam2&b s_tam3&b s_rt184m_&b s_l65m_&b s_l151m_&b  s_pim_&b   sti&b 
...
epvls&a epi&a epart&a dead1564_&a dead&a  ageg&a c_rttams&a c_inprim&a c_insm&a c_rt184m&a  c_rt65m&a c_rt151m&a  c_rt103m&a c_rt181m&a c_rt190m&a 
...
e_inprim&a e_insm&a e_rt184m&a  e_rt65m&a e_rt151m&a e_rtnucxm&a e_rt103m&a e_rt181m&a e_rt190m&a
...
vlg1&a vlg2&a vlg3&a vlg4&a vlg5&a vlg6&a tam0_&a tam1_&a tam2_&a tam3_&a rt184m_&a 
rt103m_&a rt181m_&a rt190m_&a nnm_&a rt151m_&a rt65m_&a   pr32m_&a pr33m_&a pr46m_&a pr47m_&a 
 pr50vm_&a pr50lm_&a pr54m_&a pr76m_&a pr82m_&a pr84m_&a pr88m_&a pr90m_&a pim_&a
...
s_vlg1&a  s_vlg2&a  s_vlg3&a  s_vlg4&a  s_vlg5&a s_vlg6&a s_tam0&a  s_tam1&a  s_tam2&a s_tam3&a s_rt184m_&a rt103m_&a rt181m_&a rt190m_&a  s_l65m_&a s_l151m_&a  s_pim_&a   sti&a 
...
adc1  adc&a  adh1 adh2 adh&a adhm1 adhm2 adhm&a   adhmin1 adhmin2 adhmin&a    
 alive1549&x alive1549_m&x alive1549_w&x  alive1549_m&a alive1549_w&a art_cost1  artline1 artline&a  c_ane1 c_ane2 c_ane&a c_cns1 c_cns2 c_cns&a c_dia1 c_dia2 c_dia&a c_head1 c_head2 c_head&a 
	c_hep1 c_hep2 c_hep&a c_inprim1 c_inprim2 c_inprim&a c_insm1 c_insm2 c_insm&a c_lac1 c_lac2 c_lac&a c_lip1 c_lip2 c_lip&a   c_nau1 c_nau2 c_nau&a                            
...
dead_m1  dead_m2 dead_m3 dead_m&a diag_ep1 diag_ep&a e_adh1 e_adh2 e_adh&a e_inprim1 e_inprim2 e_inprim&a e_insm1 e_insm2  e_insm&a  e_pr30m1 e_pr30m2                            
...
f_nev1  f_nev&a f_taz1  f_taz&a f_ten1  f_ten&a f_zdv1  f_zdv&a rt190m_1 rt190m_&a                                 
...
inf_vlsupp&a  inprim_1    inprim_&a    insm_1   insm_&a   interrupt1  interrupt2 interrupt&a    interrupt_choice1  interrupt_choice2   interrupt_choice&a                  
interrupt_supply1  interrupt_supply2    interrupt_supply&a   rt103m_1    rt103m_&a   rt65m_1   rt65m_&a       linefail1                               
linefail&a    lost1    lost&a   rt184m_1   rt184m_&a   m2534_newp_ge1_1                    
 ...
 m4554_newp_ge1_&a   m4554_newp_ge5_1  m4554_newp_ge5_&a  m5564_newp_ge1_1  m5564_newp_ge1_&a   m5564_newp_ge5_1   m5564_newp_ge5_&a                     
  mcirc&a    mr_3tc1  mr_3tc2    mr_3tc&a     mr_dar1   mr_dar2   mr_dar&a                              
...
o_zdv&a onart1    onart&a  p30m_1 p30m_&a    pr32m_1    pr32m_&a   pr33m_1  pr33m_&a  pr46m_1  pr46m_&a  pr47m_1  pr47m_&a    p48m_1    p48m_&a                             
 pr50lm_1  pr50lm_&a   pr50vm_1 pr50vm_&a  pr54m_1 pr54m_&a   pr76m_1 pr76m_&a   pr82m_1  pr82m_&a  pr84m_1  pr84m_&a  pr88m_1   pr88m_&a  pr90m_1  pr90m_&a p_3tc1                              
...
primary_ep_w&a  rt151m_1  rt151m_&a r_3tc1    r_3tc&a   r_dar1    r_dar&a    r_dol1                              
...
who4_1   who4_&a   x4v1   x4v2  x4v&a   rt181m_1   rt181m_&a  i_age1_m_newp&a i_age1_w_newp&a i_age2_m_newp&a i_age2_w_newp&a
...
%update_r1(da1=1,da2=2,e=5,f=6,g=301,h=308,a=303,b=302,i=301,k=300,l=299,x=304,j=305,s=0);
...
%update_r1(da1=1,da2=2,e=5,f=6,g=361,h=368,a=363,b=362,i=361,k=360,l=359,x=364,j=365,s=0);
...
%update_r1(da1=2,da2=1,e=8,f=9,g=373,h=380,a=378,b=377,i=376,k=375,l=374,x=379,j=380,s=0);
%update_r1(da1=1,da2=2,e=5,f=6,g=377,h=384,a=379,b=378,i=377,k=376,l=375,x=380,j=381,s=0);
%update_r1(da1=2,da2=1,e=6,f=7,g=377,h=384,a=380,b=379,i=378,k=377,l=376,x=381,j=382,s=0);
%update_r1(da1=1,da2=2,e=7,f=8,g=377,h=384,a=381,b=380,i=379,k=378,l=377,x=382,j=383,s=0);
%update_r1(da1=2,da2=1,e=8,f=9,g=377,h=384,a=382,b=381,i=380,k=379,l=378,x=383,j=384,s=0);
...
%update_r1(da1=1,da2=2,e=5,f=6,g=401,h=408,a=403,b=402,i=401,k=400,l=399,x=404,j=405,s=1);
...
%update_r1(da1=1,da2=2,e=5,f=6,g=461,h=468,a=463,b=462,i=461,k=460,l=459,x=464,j=465,s=1);
...
%update_r1(da1=1,da2=2,e=5,f=6,g=401,h=408,a=403,b=402,i=401,k=400,l=399,x=404,j=405,s=2);
...
%update_r1(da1=1,da2=2,e=5,f=6,g=461,h=468,a=463,b=462,i=461,k=460,l=459,x=464,j=465,s=2);
...
data x; set cum_l1;
  file "/home/rmjlaph/Scratch/_output_lai_6_6_20_6pm_&dataset_id";  
put   
