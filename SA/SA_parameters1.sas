...
* fold_decr_hivdeath;		  fold_decr_hivdeath = 0.15 ; ***Changed from 0.15 (and then from 0.07) to get closer to Thembisa; 	
...
* art_intro_date;			art_intro_date = 2008; *changed from 2005;
