...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 25000000 by 1000000) valueattrs=(size=10);
...
series  x=cald y=n_onart_obs_sa/lineattrs = (color=red thickness = 2);;
run;quit;
...
series  x=cald y=n_death_2059_w_obs_sa/lineattrs = (color=red thickness = 2);;
run;quit;
...
series  x=cald y=n_death_2059_m_obs_sa /lineattrs = (color=red thickness = 2);;
run;quit;
...
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_ever";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
