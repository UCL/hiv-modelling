...
dead_int_Alt6_rescd4lt200_m=0;dead_int_Alt6_rescd4lt200_w=0;
dead_int_Alt6_rescd4lt2001519m=0;dead_int_Alt6_rescd4lt2002024m=0;dead_int_Alt6_rescd4lt2002529m=0;dead_int_Alt6_rescd4lt2003034m=0;dead_int_Alt6_rescd4lt2003539m=0;
dead_int_Alt6_rescd4lt2004044m=0;dead_int_Alt6_rescd4lt2004549m=0;dead_int_Alt6_rescd4lt2005054m=0;dead_int_Alt6_rescd4lt2005559m=0; dead_int_Alt6_rescd4lt2006064m=0;
dead_int_Alt6_rescd4lt2006569m=0;dead_int_Alt6_rescd4lt2007074m=0;dead_int_Alt6_rescd4lt2007579m=0; dead_int_Alt6_rescd4lt2008084m=0;
dead_int_Alt6_rescd4lt2001519w=0;dead_int_Alt6_rescd4lt2002024w=0;dead_int_Alt6_rescd4lt2002529w=0;dead_int_Alt6_rescd4lt2003034w=0;dead_int_Alt6_rescd4lt2003539w=0;
dead_int_Alt6_rescd4lt2004044w=0;dead_int_Alt6_rescd4lt2004549w=0;dead_int_Alt6_rescd4lt2005054w=0;dead_int_Alt6_rescd4lt2005559w=0; dead_int_Alt6_rescd4lt2006064w=0;
dead_int_Alt6_rescd4lt2006569w=0;dead_int_Alt6_rescd4lt2007074w=0;dead_int_Alt6_rescd4lt2007579w=0; dead_int_Alt6_rescd4lt2008084w=0;

dead_int_Alt6_rescd4gt200_m=0;dead_int_Alt6_rescd4gt200_w=0;
dead_int_Alt6_rescd4gt2001519m=0;dead_int_Alt6_rescd4gt2002024m=0;dead_int_Alt6_rescd4gt2002529m=0;dead_int_Alt6_rescd4gt2003034m=0;dead_int_Alt6_rescd4gt2003539m=0;
dead_int_Alt6_rescd4gt2004044m=0;dead_int_Alt6_rescd4gt2004549m=0;dead_int_Alt6_rescd4gt2005054m=0;dead_int_Alt6_rescd4gt2005559m=0; dead_int_Alt6_rescd4gt2006064m=0;
dead_int_Alt6_rescd4gt2006569m=0;dead_int_Alt6_rescd4gt2007074m=0;dead_int_Alt6_rescd4gt2007579m=0; dead_int_Alt6_rescd4gt2008084m=0;
dead_int_Alt6_rescd4gt2001519w=0;dead_int_Alt6_rescd4gt2002024w=0;dead_int_Alt6_rescd4gt2002529w=0;dead_int_Alt6_rescd4gt2003034w=0;dead_int_Alt6_rescd4gt2003539w=0;
dead_int_Alt6_rescd4gt2004044w=0;dead_int_Alt6_rescd4gt2004549w=0;dead_int_Alt6_rescd4gt2005054w=0;dead_int_Alt6_rescd4gt2005559w=0; dead_int_Alt6_rescd4gt2006064w=0;
dead_int_Alt6_rescd4gt2006569w=0;dead_int_Alt6_rescd4gt2007074w=0;dead_int_Alt6_rescd4gt2007579w=0; dead_int_Alt6_rescd4gt2008084w=0;
...
***By gender and age;
	...
	if dead_int_Alt6_rescd4lt200=1 then do;
		if gender=1 then do;
			dead_int_Alt6_rescd4lt200_m=1;	
			if 15 <= age < 20 then dead_int_Alt6_rescd4lt2001519m=1;
			if 20 <= age < 25 then dead_int_Alt6_rescd4lt2002024m=1;
			if 25 <= age < 30 then dead_int_Alt6_rescd4lt2002529m=1;
			if 30 <= age < 35 then dead_int_Alt6_rescd4lt2003034m=1;
			if 35 <= age < 40 then dead_int_Alt6_rescd4lt2003539m=1;
			if 40 <= age < 45 then dead_int_Alt6_rescd4lt2004044m=1;
			if 45 <= age < 50 then dead_int_Alt6_rescd4lt2004549m=1;
			if 50 <= age < 55 then dead_int_Alt6_rescd4lt2005054m=1;
			if 55 <= age < 60 then dead_int_Alt6_rescd4lt2005559m=1;
			if 60 <= age < 65 then dead_int_Alt6_rescd4lt2006064m=1;
			if 65 <= age < 70 then dead_int_Alt6_rescd4lt2006569m=1;
			if 70 <= age < 75 then dead_int_Alt6_rescd4lt2007074m=1;
			if 75 <= age < 80 then dead_int_Alt6_rescd4lt2007579m=1;
			if 80 <= age < 85 then dead_int_Alt6_rescd4lt2008084m=1;
		end;
		if gender=2 then do;
			dead_int_Alt6_rescd4lt200_w=1;	
			if 15 <= age < 20 then dead_int_Alt6_rescd4lt2001519w=1;
			if 20 <= age < 25 then dead_int_Alt6_rescd4lt2002024w=1;
			if 25 <= age < 30 then dead_int_Alt6_rescd4lt2002529w=1;
			if 30 <= age < 35 then dead_int_Alt6_rescd4lt2003034w=1;
			if 35 <= age < 40 then dead_int_Alt6_rescd4lt2003539w=1;
			if 40 <= age < 45 then dead_int_Alt6_rescd4lt2004044w=1;
			if 45 <= age < 50 then dead_int_Alt6_rescd4lt2004549w=1;
			if 50 <= age < 55 then dead_int_Alt6_rescd4lt2005054w=1;
			if 55 <= age < 60 then dead_int_Alt6_rescd4lt2005559w=1;
			if 60 <= age < 65 then dead_int_Alt6_rescd4lt2006064w=1;
			if 65 <= age < 70 then dead_int_Alt6_rescd4lt2006569w=1;
			if 70 <= age < 75 then dead_int_Alt6_rescd4lt2007074w=1;
			if 75 <= age < 80 then dead_int_Alt6_rescd4lt2007579w=1;
			if 80 <= age < 85 then dead_int_Alt6_rescd4lt2008084w=1;
		end;
	end;

	if dead_int_Alt6_rescd4gt200=1 then do;
		if gender=1 then do;
			dead_int_Alt6_rescd4gt200_m=1;	
			if 15 <= age < 20 then dead_int_Alt6_rescd4gt2001519m=1;
			if 20 <= age < 25 then dead_int_Alt6_rescd4gt2002024m=1;
			if 25 <= age < 30 then dead_int_Alt6_rescd4gt2002529m=1;
			if 30 <= age < 35 then dead_int_Alt6_rescd4gt2003034m=1;
			if 35 <= age < 40 then dead_int_Alt6_rescd4gt2003539m=1;
			if 40 <= age < 45 then dead_int_Alt6_rescd4gt2004044m=1;
			if 45 <= age < 50 then dead_int_Alt6_rescd4gt2004549m=1;
			if 50 <= age < 55 then dead_int_Alt6_rescd4gt2005054m=1;
			if 55 <= age < 60 then dead_int_Alt6_rescd4gt2005559m=1;
			if 60 <= age < 65 then dead_int_Alt6_rescd4gt2006064m=1;
			if 65 <= age < 70 then dead_int_Alt6_rescd4gt2006569m=1;
			if 70 <= age < 75 then dead_int_Alt6_rescd4gt2007074m=1;
			if 75 <= age < 80 then dead_int_Alt6_rescd4gt2007579m=1;
			if 80 <= age < 85 then dead_int_Alt6_rescd4gt2008084m=1;
		end;
		if gender=2 then do;
			dead_int_Alt6_rescd4gt200_w=1;	
			if 15 <= age < 20 then dead_int_Alt6_rescd4gt2001519w=1;
			if 20 <= age < 25 then dead_int_Alt6_rescd4gt2002024w=1;
			if 25 <= age < 30 then dead_int_Alt6_rescd4gt2002529w=1;
			if 30 <= age < 35 then dead_int_Alt6_rescd4gt2003034w=1;
			if 35 <= age < 40 then dead_int_Alt6_rescd4gt2003539w=1;
			if 40 <= age < 45 then dead_int_Alt6_rescd4gt2004044w=1;
			if 45 <= age < 50 then dead_int_Alt6_rescd4gt2004549w=1;
			if 50 <= age < 55 then dead_int_Alt6_rescd4gt2005054w=1;
			if 55 <= age < 60 then dead_int_Alt6_rescd4gt2005559w=1;
			if 60 <= age < 65 then dead_int_Alt6_rescd4gt2006064w=1;
			if 65 <= age < 70 then dead_int_Alt6_rescd4gt2006569w=1;
			if 70 <= age < 75 then dead_int_Alt6_rescd4gt2007074w=1;
			if 75 <= age < 80 then dead_int_Alt6_rescd4gt2007579w=1;
			if 80 <= age < 85 then dead_int_Alt6_rescd4gt2008084w=1;
		end;
	end;
