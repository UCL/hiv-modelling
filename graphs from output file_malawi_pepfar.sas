...
proc transpose data=option_&s out=i&s._&count prefix=&varb;var &varb; by cald; id count_csim;run;
*In order to easily join with from 2012 av_&varb.1,etc...;
data i&s._&count;set i&s._&count;***creates one dataset per variable;
p25_&varb._&s  = PCTL(25,of &varb.1-&varb.&nfit);
p75_&varb._&s = PCTL(75,of &varb.1-&varb.&nfit);
p5_&varb._&s  = PCTL(5,of &varb.1-&varb.&nfit);
p95_&varb._&s = PCTL(95,of &varb.1-&varb.&nfit);
...
label mean_n_death_hiv_2 = "Option 2  (mean) ";
...
series  x=cald y=mean_n_death_hiv_2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_n_death_hiv_2 	upper=p95_n_death_hiv_2  / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
label mean_incidence1549__0 = "Option 0 (mean) ";
label mean_incidence1549__1 = "Option 1  (mean) ";
label mean_incidence1549__2 = "Option 2  (mean) ";
...
series  x=cald y=mean_incidence1549__2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_incidence1549__2 	upper=p95_incidence1549__2  / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
label mean_p_mcirc_1549m_0 = "Option 0 (mean) ";
label mean_p_mcirc_1549m_1 = "Option 1  (mean) ";
label mean_p_mcirc_1549m_2 = "Option 2  (mean) ";
...
series  x=cald y=mean_p_mcirc_1549m_2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_p_mcirc_1549m_2 	upper=p95_p_mcirc_1549m_2  / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
label mean_p_newp_ge2__2 = "Option 2 ";
...
series  x=cald y=mean_p_newp_ge1__2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_p_newp_ge1__2 upper=p95_p_newp_ge1__2 / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 200000 by 50000) valueattrs=(size=10);

label mean_n_prep_0 = "Option 0 (mean) ";
label mean_n_prep_1 = "Option 1  (mean) ";
label mean_n_prep_2 = "Option 2  (mean) ";
...
series  x=cald y=mean_n_prep_2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_n_prep_2 	upper=p95_n_prep_2  / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n onart";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 3000000 by 250000) valueattrs=(size=10);

label mean_n_onart_0 = "Option 0 (mean) ";
label mean_n_onart_1 = "Option 1  (mean) ";
label mean_n_onart_2 = "Option 2  (mean) ";
...
series  x=cald y=mean_n_onart_2/	lineattrs = (color=blue thickness = 2);
band    x=cald lower=p5_n_onart_2 	upper=p95_n_onart_2  / transparency=0.9 fillattrs = (color=blue) legendlabel= "Model 90% range";
...
label mean_n_sw_program_visit_0 = "Option 0 (mean) ";
label mean_n_sw_program_visit_1 = "Option 1 (mean) ";
...
label mean_prop_sw_onprep_0 = "Option 0 (mean) ";
label mean_prop_sw_onprep_1 = "Option 1  (mean) ";
...
series  x=cald y=mean_prop_sw_onprep_1/	lineattrs = (color=red thickness = 2);
...
label mean_p_diag_0 = "Option 0 (mean) ";
label mean_p_diag_1 = "Option 1  (mean) ";
...
label mean_incidence_sw_0 = "Option 0 (mean) ";
label mean_incidence_sw_1 = "Option 1  (mean) ";
...
label mean_n_new_inf1549__0 = "Option 0 (mean) ";
label mean_n_new_inf1549__1 = "Option 1  (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 1000000  by 100000 ) valueattrs=(size=10);
label mean_n_vm_this_per_0 = "Option 0 (mean) ";
label mean_n_vm_this_per_1 = "Option 1 (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 1000000  by 100000 ) valueattrs=(size=10);
label mean_n_self_tested_0 = "Option 0 (mean) ";
label mean_n_self_tested_1 = "Option 1 (mean) ";
...
label mean_n_vm_0 = "Option 0 (mean) ";
label mean_n_vm_1 = "Option 1  (mean) ";
...
label mean_n_new_vmmc_0 = "Option 0 (mean) ";
label mean_n_new_vmmc_1 = "Option 1  (mean) ";
...
label mean_prevalence1549__0 = "All Option 0 (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.2 by 0.05) valueattrs=(size=10);
label mean_p_w_giv_birth_this_per_0 = "Option 0 (mean) ";
label mean_p_w_giv_birth_this_per_1 = "Option 1 (mean) ";
...
label mean_p_ep_0 = "Option 0 (mean) ";
label mean_p_ep_1 = "Option 1 (mean) ";
...
label mean_log_gender_r_newp_0 = "Option 0 (mean) ";
label mean_log_gender_r_newp_1 = "Option 1 (mean) ";
...
label mean_overall_test_yield_0 = "Option 0 (mean) ";
label mean_overall_test_yield_1 = "Option 1 (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.2) valueattrs=(size=10);
label mean_p_tested_past_year_1549w_0 = "Option 0 (mean) ";
label mean_p_tested_past_year_1549w_1 = "Option 1 (mean) ";
...
label mean_prop_w_1549_sw_0 = "Current FSW 15-49 op 0 (mean) ";
label mean_prop_w_1549_sw_1 = "Current FSW 15-49 op 1 (mean) ";

label mean_prop_w_ever_sw_0 = "Ever FSW 15-64 op 0 (mean) ";
label mean_prop_w_ever_sw_1 = "Ever FSW 15-64 op 0 (mean) ";
...
label mean_n_init_prep_oral_1524w_0 = "Option 0 (mean) ";
label mean_n_init_prep_oral_1524w_1 = "Option 1  (mean) ";
...
label mean_n_init_prep_oral_sw_0 = "Option 0 (mean) ";
label mean_n_init_prep_oral_sw_1 = "Option 1  (mean) ";
...
label mean_prop_w_1524_onprep_0 = "Option 0 (mean) ";
label mean_prop_w_1524_onprep_1 = "Option 1  (mean) ";
...
label mean_prevalence1549__0 = "All Option 0 (mean) ";
label mean_prevalence1549__1 = "All Option 1  (mean) ";
label mean_prevalence1549m_0 = "Men Option 0 (mean) ";
label mean_prevalence1549m_1 = "Men Option 1 (mean) ";
label mean_prevalence1549w_0 = "Women Option 0 (mean) ";
label mean_prevalence1549w_1 = "Women Option 1 (mean) ";
...
label mean_incidence1564__0 = "Option 0 (mean) ";
label mean_incidence1564__1 = "Option 1  (mean) ";
...
label mean_incidence1524__0 = "Option 0 (mean) ";
label mean_incidence1524__1 = "Option 1  (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 4 by 0.5) valueattrs=(size=10);
label mean_incidence2534__0 = "Option 0 (mean) ";
label mean_incidence2534__1 = "Option 1  (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 4 by 0.5) valueattrs=(size=10);
label mean_incidence3544__0 = "Option 0 (mean) ";
label mean_incidence3544__1 = "Option 1  (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 4 by 0.5) valueattrs=(size=10);
label mean_incidence4554__0 = "Option 0 (mean) ";
label mean_incidence4554__1 = "Option 1  (mean) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 4 by 0.5) valueattrs=(size=10);
label mean_incidence5564__0 = "Option 0 (mean) ";
label mean_incidence5564__1 = "Option 1  (mean) ";
...
label mean_p_inf_vlsupp_0 = "Option 0 (mean) ";
label mean_p_inf_vlsupp_1 = "Option 1  (mean) ";
...
label mean_p_inf_ep_0 = "Option 0 (mean) ";
label mean_p_inf_ep_1 = "Option 1  (mean) ";
...
label mean_p_inf_newp_0 = "Option 0 (mean) ";
label mean_p_inf_newp_1 = "Option 1  (mean) ";
...
label mean_p_inf_primary_0 = "Option 0 (mean) ";
label mean_p_inf_primary_1 = "Option 1  (mean) ";
...
label mean_p_inf_naive_0 = "Option 0 (mean) ";
label mean_p_inf_naive_1 = "Option 1  (mean) ";
...
label mean_p_inf_diag_0 = "Option 0 (mean) ";
label mean_p_inf_diag_1 = "Option 1  (mean) ";
...
label mean_p_diag_m_0 = "Option 0 (mean) ";
label mean_p_diag_m_1 = "Option 1  (mean) ";
...
label mean_p_diag_w_0 = "Option 0 (mean) ";
label mean_p_diag_w_1 = "Option 1  (mean) ";
...
label mean_p_ai_no_arv_c_nnm_0 = "Option 0 (mean) ";
label mean_p_ai_no_arv_c_nnm_1 = "Option 1  (mean) ";
...
label mean_p_artexp_diag_0 = "Option 0 (mean) ";
label mean_p_artexp_diag_1 = "Option 1  (mean) ";
...
label mean_p_onart_diag_m_0 = "Option 0 (mean) ";
label mean_p_onart_diag_m_1 = "Option 1  (mean) ";
...
label mean_p_onart_diag_w_0 = "Option 0 (mean) ";
label mean_p_onart_diag_w_1 = "Option 1  (mean) ";
...
label mean_n_diagnosed_0 = "Option 0 (mean) ";
label mean_n_diagnosed_1 = "Option 1  (mean) ";
...
label mean_p_efa_0 = "Option 0 (mean) ";
label mean_p_efa_1 = "Option 1  (mean) ";
...
label mean_p_taz_0 = "Option 0 (mean) ";
label mean_p_taz_1 = "Option 1  (mean) ";
...
label mean_p_ten_0 = "Option 0 (mean) ";
label mean_p_ten_1 = "Option 1  (mean) ";
...
label mean_p_zdv_0 = "Option 0 (mean) ";
label mean_p_zdv_1 = "Option 1  (mean) ";
...
label mean_p_3TC_0 = "Option 0 (mean) ";
label mean_p_3TC_1 = "Option 1  (mean) ";
...
label mean_p_lpr_0 = "Option 0 (mean) ";
label mean_p_lpr_1 = "Option 1  (mean) ";
...
label mean_p_nev_0 = "Option 0 (mean) ";
label mean_p_nev_1 = "Option 1  (mean) ";
...
label mean_p_onart_vl1000__0 = "Option 0 (mean) ";
label mean_p_onart_vl1000__1 = "Option 1  (mean) ";
...
label mean_p_onart_m_0 = "Option 0 (mean) ";
label mean_p_onart_m_1 = "Option 1  (mean) ";
...
label mean_p_onart_w_0 = "Option 0 (mean) ";
label mean_p_onart_w_1 = "Option 1  (mean) ";
...
label mean_p_onart_vl1000_m_0 = "Option 0 (mean) ";
label mean_p_onart_vl1000_m_1 = "Option 1  (mean) ";
...
label mean_p_onart_vl1000_w_0 = "Option 0 (mean) ";
label mean_p_onart_vl1000_w_1 = "Option 1  (mean) ";
...
label mean_prevalence_vg1000__0 = "Option 0 (mean) ";
label mean_prevalence_vg1000__1 = "Option 1  (mean) ";
...
label mean_n_death_2059_w_0 = "Option 0 (mean) ";
label mean_n_death_2059_w_1 = "Option 1  (mean) ";
...
label mean_n_death_2059_m_0 = "Option 0 (mean) ";
label mean_n_death_2059_m_1 = "Option 1  (mean) ";
...
label mean_n_death_hiv_m_0 = "Option 0 (mean) ";
...
label mean_n_death_hiv_w_0 = "Option 0 (mean) ";
...
label mean_n_cd4_lt200__0 = "Option 0 (mean) ";
...
label mean_n_alive_0 = "Option 0 (mean) ";
...
label mean_n_hiv_0 = "Option 0 (mean) ";
