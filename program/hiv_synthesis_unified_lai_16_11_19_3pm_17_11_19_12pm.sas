...
if t ge 2 then do;
s=uniform(0);  rate_non_hiv_symptoms=0.005; * dependent_on_time_step_length ;
...
if gender=2 and t ge 4 and ((caldate{t}-dt_lastbirth gt 1.25) or dt_lastbirth=.) then do;
	...
	* consider if pregnant will be 1 only for 1 period ;
	...
	if pregnant=1 and o_dol_tm3 =1 then do; u = uniform(0); if u < ntd_risk_dol then do;  * dependent_on_time_step_length ;
