...
pi_art_adj=0; * dependent_on_time_step_length ;
if (o_lpr=1 or o_dar=1 or o_taz=1) then pi_art_adj=3;

* GREATER CD4 RISE IN WOMEN;
gender_art_adj=0; * dependent_on_time_step_length ;
...
* much of below * dependent_on_time_step_length - need a block of code per 1/12 year rather than every 0.25 yrs - tcur code needs to be updated;
...
* below all * dependent_on_time_step_length ;
...
* below is * dependent_on_time_step_length ;
