...
q=uniform(0);
if art_initiation_strategy=4 and 2011.5 <= caldate{t} and q < 0.4 then art_initiation_strategy=9;  * dependent_on_time_step_length ;
...
u=uniform(0); if u < 0.005 then want_no_more_children = 1; * dependent_on_time_step_length ;
end;
