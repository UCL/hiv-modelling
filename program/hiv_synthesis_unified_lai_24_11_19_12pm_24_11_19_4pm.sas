...
* ts1m: replace line above with : ;
/*
nnewp_ly = newp_tm12 + newp_tm11 + newp_tm10 + newp_tm9  + newp_tm8  + newp_tm7  + newp_tm6  + newp_tm5  + newp_tm4  + newp_tm3  + newp_tm2 + 
newp_tm1  + newp&j ;
*/
...
* here and below * dependent_on_time_step_length ;
