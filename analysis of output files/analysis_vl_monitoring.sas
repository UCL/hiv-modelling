...
libname a "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring";


data d1;  

  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tle_time_repeat_vl_2_7_20_6pm_x";
...
data d2;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tld_time_repeat_vl_2_7_20_6pm";
...
data d3;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tle_time_1st_vl_2_7_20_6pm_x";
...
data d4;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tld_time_1st_vl_2_7_20_6pm";
...
data d6;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tle_single_vl_switch_ahd_2_7_20_6pm";
...
data d7;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\vl_monitoring\c_output_tle_single_vl_switch_23_9_20_10am";
...
data a; set d1 d2 d3 d4 d5 d6 d7;
...
data a.vl_monitoring_6_datasets; set y;

/*
proc means data=y; var p_ai_no_arv_c_nnm ; where 2020 <= cald < 2020.5 ; run;
proc glm data=y; model p_ai_no_arv_c_nnm   =  rate_res_ten res_trans_factor_nn
fold_change_mut_risk adh_effect_of_meas_alert pr_switch_line prob_vl_meas_done
; where 2020 <= cald < 2020.5 and dataset ne 2; run;
*/


data y; set a.vl_monitoring_6_datasets; run;
...
proc means  data=y; var s_alive; output out=y_20 mean= s_alive_20; by run ; where cald = 2020;  run;
...
* To get one row per run;
  ...
  data a.wide_vl_monitoring_2_7_20_6pm_3; 


* merge   wide_outputs  wide_par wide_par_after_int_option0  wide_par_after_int_option1  ; * this for prep and covid_hiv ;
  merge   wide_outputs  wide_par ;  * this for tld_prep and dolswitch ;
  by run;run;
...
libname a "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\";
   ...
   data wide;    
   set a.wide_vl_monitoring_2_7_20_6pm_3; 
...
proc means data=wide; var  p_efa_20  p_efa_20_40_1  p_efa_20_40_2 p_dol_20  p_dol_20_40_1  p_dol_20_40_2 
 p_taz_20  p_taz_20_40_1  p_taz_20_40_2   p_lpr_20  p_lpr_20_40_1  p_lpr_20_40_2   p_nev_20  p_nev_20_40_1  p_nev_20_40_2 ; 
where dataset=6; run; 
ods html close;

ods html;
proc means data=wide; var   p_onart_vl1000_20_40_2  p_onart_vl1000_20_40_1  p_artexp_vl1000_20_40_1 p_artexp_vl1000_20_40_2; 
where dataset=6; run; 
run; 
ods html close;
...
ods html;
proc means data=wide; var   p_vl1000_art_12m_onart_20_40_2  p_vl1000_art_12m_onart_20_40_1  ; where dataset=4; 
run; 
ods html close;

ods html;
proc means data=wide; var   p_vl1000_art_12m_20_40_2  p_vl1000_art_12m_20_40_1  ; where dataset=4; run; 
run; 
ods html close;

ods html;
proc means data=wide; var   p_linefail_ge1_20_40_2  p_linefail_ge1_20_40_1  ; where dataset=6; run; 
run; 
ods html close;
...
proc means data=wide; var   death_rate_onart_20_40_1  death_rate_onart_20_40_2 ; where dataset=6; run; 

proc univariate data=wide; var   d_death_rate_onart_20_40_2  ;  run;


ods html;
proc means data=wide; var death_rate_hiv_20_40_1 death_rate_hiv_20_40_2  ;  where dataset=6; run; 
run; 
ods html close;
...
ods html;
proc means data=wide; var  dcost_20_40_1  dcost_20_40_2   ;  where dataset=6; run; 
run; 
ods html close;
...
proc means data=wide; var  d_dcost_20_40_2  ;  where dataset=6; run;  
...
ods html;
proc means data=wide; var  ddaly_all_20_40_1 ddaly_all_20_40_2  ; where dataset=6; run;   
ods html close;
