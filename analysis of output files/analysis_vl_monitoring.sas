...
data a.vl_monitoring_4_datasets; set y;
...
data y; set a.vl_monitoring_4_datasets; run;
...
* To get one row per run;
  ...
  data a.wide_vl_monitoring_2_7_20_6pm_2; 
...
libname a "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\";
   ...
   data wide;    
   set a.wide_vl_monitoring_2_7_20_6pm_2; 
