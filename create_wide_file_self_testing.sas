...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\self_testing\self_testing_d_out";
...
data b.l_self_testing_d; set y;  

data y; set b.l_self_testing_d; 
