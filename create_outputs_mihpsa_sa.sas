...
proc transpose data=t_9091 out = r_9091; data e9091; set r_9091; y9091 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9192 out = r_9192; data e9192; set r_9192; y9192 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9293 out = r_9293; data e9293; set r_9293; y9293 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9394 out = r_9394; data e9394; set r_9394; y9394 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9495 out = r_9495; data e9495; set r_9495; y9495 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9596 out = r_9596; data e9596; set r_9596; y9596 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9697 out = r_9697; data e9697; set r_9697; y9697 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9798 out = r_9798; data e9798; set r_9798; y9798 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9899 out = r_9899; data e9899; set r_9899; y9899 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9900 out = r_9900; data e9900; set r_9900; y9900 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0001 out = r_0001; data e0001; set r_0001; y0001 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0102 out = r_0102; data e0102; set r_0102; y0102 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0203 out = r_0203; data e0203; set r_0203; y0203 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0304 out = r_0304; data e0304; set r_0304; y0304 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0405 out = r_0405; data e0405; set r_0405; y0405 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0506 out = r_0506; data e0506; set r_0506; y0506 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0607 out = r_0607; data e0607; set r_0607; y0607 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0708 out = r_0708; data e0708; set r_0708; y0708 = COL1; drop _label_ _name_ COL1 ;
proc univariate noprint data=y; var &v; output out=y_0809 mean= &v._0809 ; by run ; where 2008.5 <= cald < 2009.5; 
proc univariate noprint data=y_0809; var &v._0809; output out=t_0800 median= &v._0809_med pctlpts=2.5 97.5 pctlpre= &v._0809_; 
proc transpose data=t_0809 out = r_0809; data e0809; set r_0809; y0809 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_0910 out = r_0910; data e0910; set r_0910; y0910 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1011 out = r_1011; data e1011; set r_1011; y1011 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1112 out = r_1112; data e1112; set r_1112; y1112 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1213 out = r_1213; data e1213; set r_1213; y1213 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1314 out = r_1314; data e1314; set r_1314; y1314 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1415 out = r_1415; data e1415; set r_1415; y1415 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1516 out = r_1516; data e1516; set r_1516; y1516 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_1617 out = r_1617; data e1617; set r_1617; y1617 = COL1; drop _label_ _name_ COL1 ;
...
proc transpose data=t_9091 out = r_9091; data e9091; set r_9091; y9091 = COL1; drop _label_ _name_ COL1 ;
proc univariate noprint data=y; var &v; output out=y_3133 mean= &v._3133 ; by run ; where 2031.5 <= cald < 2033.5; 
proc univariate noprint data=y_3133; var &v._3133; output out=t_3133 median= &v._3133_med pctlpts=2.5 97.5 pctlpre= &v._3133_; 
proc transpose data=t_9091 out = r_9091; data e9091; set r_9091; y9091 = COL1; drop _label_ _name_ COL1 ;
proc univariate noprint data=y; var &v; output out=y_3333 mean= &v._3333 ; by run ; where 2033.5 <= cald < 2033.5; 
proc univariate noprint data=y_3333; var &v._3333; output out=t_3333 median= &v._3333_med pctlpts=2.5 97.5 pctlpre= &v._3333_; 
proc transpose data=t_9091 out = r_9091; data e9091; set r_9091; y9091 = COL1; drop _label_ _name_ COL1 ;
