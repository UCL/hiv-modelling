...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\laa\laa_j_out\";
...
data b.k_laa_j;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
data    b.l_laa_j_y; set y;  

data y ; set b.l_laa_j_y; 
