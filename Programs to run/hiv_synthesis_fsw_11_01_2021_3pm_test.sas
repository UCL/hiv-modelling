...
if caldate_never_dot ge 2014.5 then do; ***this is earlier than when a program comes into place because the sw code in the core program was being read before the options came into play; 
...
proc print;var cald sw age sw_program eff_sw_program sw_program_visit s_sw_program_visit date_1st_sw_prog_vis option j;where gender=2 and age gt 15;run;
/*
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjllob/Scratch/_output_fsw_11_01_21_3pm_&dataset_id";  
