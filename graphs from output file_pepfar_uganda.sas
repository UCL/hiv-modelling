...
libname a "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\pepfar_uganda\pepfar_uganda_out\";
...
ods html;
proc sgplot data=d nolegend; 
* Title '';  * Title    height=1.5 justify=center "p_vl1000";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to &year_end by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0.8  to  1       by 0.05  ) valueattrs=(size=10);
...
series  x=cald y=p50_n_cur_res_dol_0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_n_cur_res_dol_0 upper=p95_n_cur_res_dol_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

series  x=cald y=p50_n_cur_res_dol_1 / lineattrs = (color=darkblue    thickness = 4);
band    x=cald lower=p5_n_cur_res_dol_1 upper=p95_n_cur_res_dol_1 / transparency=0.9 fillattrs = (color=darkblue   ) legendlabel= "90% range";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2030 by 5)	 	 valueattrs=(size=10); 
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2030 by 0.25  )	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1          by 0.1     ) valueattrs=(size=10);
