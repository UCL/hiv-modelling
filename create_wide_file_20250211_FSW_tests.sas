...
libname b "C:\Users\rmjlja9\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_FSW_tests_20250211_out";		* all options in one output;
...
data a.base_11_02_2025_FSW_tests; set b.out: ;
...
/*ods listing;*/
/**/
/*proc contents data=a.base_11_02_2025_FSW_tests;run;							/* show the contents of the input SAS file */*/
...
/*data a.base_11_02_2025_FSW_tests;set a.base_11_02_2025_FSW_tests;*/
...
proc contents data=a.base_11_02_2025_FSW_tests;run;							/* show the contents of the input SAS file */
proc freq data=a.base_11_02_2025_FSW_tests; table run cald option;run;


/*proc freq data=a.base_11_02_2025_FSW_tests; table run option;where cald=2023.75;run;*/
/*proc freq data=a.base_11_02_2025_FSW_tests; table run*option/norow nocol nopercent; where cald=2023.75;run;*/
/*proc freq data=a.base_11_02_2025_FSW_tests; table run cald option;run;*/
/*proc freq data=a.base_11_02_2025_FSW_tests; table option*cald/norow nocol nopercent;run;*/
...
proc sort data=a.base_11_02_2025_FSW_tests; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_11_02_2025_FSW_tests ;
*Zimbabwe;
...
proc sort data=a.base_11_02_2025_FSW_tests; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_11_02_2025_FSW_tests sf;
by run ; run;
...
* n_sw_program_visit;			n_sw_program_visit = s_sw_program_visit * sf * 4;	* x4? JASFeb2025;
...
data a.l_base_11_02_2025_FSW_tests; set y;
if cald=. then delete;run;
proc freq data=a.l_base_11_02_2025_FSW_tests; table option;run;
/*proc contents data=a.l_base_11_02_2025_FSW_tests; run;*/



/*proc freq data=a.l_base_11_02_2025_FSW_tests; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;*/
...
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table incidence1549; where option=1;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_diag_progsw; where option=0;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_inprog_ly; where option=0;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_inprog_ly; where option=1;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_inprog_ly; where option=8;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_program_visit; where option=0;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_program_visit; where option=1;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_sw_program_visit; where option=8;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_attend_mens_clinic; where option=0;run;*/
/*proc freq data=a.l_base_11_02_2025_FSW_tests; table n_access_adult_ret_supp; where option=30;run;*/
