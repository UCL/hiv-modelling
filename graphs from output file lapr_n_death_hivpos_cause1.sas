...
label p50_n_dead_hivpos_cause1_0 = "no cab-la introduction (median) ";
label p50_n_dead_hivpos_cause1_1 = "cab-la introduction (median) ";

series  x=cald y=p50_n_dead_hivpos_cause1_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_dead_hivpos_cause1_0 	upper=p95_n_dead_hivpos_cause1_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "90% range";

series  x=cald y=p50_n_dead_hivpos_cause1_1/	lineattrs = (color=str thickness = 2);
band    x=cald lower=p5_n_dead_hivpos_cause1_1 	upper=p95_n_dead_hivpos_cause1_1  / transparency=0.9 fillattrs = (color=str) legendlabel= "90% range";
