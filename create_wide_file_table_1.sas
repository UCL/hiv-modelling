...
libname a "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\table_1\";
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\table_1\table1_10jul22b_out\";

data i1; set b.out1:; data i2; set b.out2:; data i3; set b.out3:; data i4; set b.out4:; data i5; set b.out5:; 
data i6; set b.out6:; data i7; set b.out7:; data i8; set b.out8:; data i9; set b.out9:;  


%let laprv =  table_1_10jul22b  ;

data a.k_table_1_10jul22b;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;

proc sort data=a.k_table_1_10jul22b; 
by run cald option;
run;
...
data    a.l_table_1_10jul22b; set y;  
...
* To get one row per run;
  ...
  data  a.w_table_1_10jul22b     ; 
  merge a.wide_outputs         a.wide_par     ;
  by run;



  data w_table_1_10jul22b ;
  set a.w_table_1_10jul22b ;


if prevalence1549_22 < 0.35  and incidence1549_22 > 0.05;


* table 1;

ods html;
proc means data=   w_table_1_10jul22b n mean p50 p5 p95 min max;  *  w_pop_wide_tld ;
...
prop_w_1549_sw_22  prop_sw_newp0_22  prop_sw_program_visit_22  incidence_sw_22 ;
* where sw_trans_matrix = 8; 
run;
ods html close;

proc glm; class sw_trans_matrix; model prop_sw_newp0_22 = sw_trans_matrix p_vl1000_22 sw_init_newp / solution; run;  
