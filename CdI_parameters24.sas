...
***Remove PrEP and reduce testing in SW programs (this will be increased in options);
* effect_sw_prog_6mtest;    effect_sw_prog_6mtest=0.25;
...
* rr_testing_female;		rr_testing_female=0.6;
