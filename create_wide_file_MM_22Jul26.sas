...
label median_p_elig_on_prep_oral_mm_2 = "Oral PrEP when only oral PrEP scaled up (Op 2)"; 
...
series  x=cald y=median_p_elig_on_prep_oral_mm_2/	lineattrs = (color=green thickness = 2);
