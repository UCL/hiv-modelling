...
prop_elig_on_prep_w	 prop_elig_on_prep
...
band    x=cald lower=p5_prop_1564w_onprep_0 	upper=p95_prop_1564w_onprep_0  / transparency=0.9 fillattrs = (color=red) legendlabel= "wodel 90% range";
...
band    x=cald lower=p5_prop_elig_on_prep_0 	upper=p95_prop_elig_on_prep_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "wodel 90% range";
