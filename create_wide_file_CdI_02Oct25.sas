...
libname a "C:\Users\lovel\UCL Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\CdI";
...
proc means mean;var s_rate_1sttest;where option=0;run;

proc means mean;var s_rate_1sttest;where option=513;run;
