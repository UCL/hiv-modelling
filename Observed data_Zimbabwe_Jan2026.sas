...
*Source: Zimphia summary sheets;
if cald=2015.75 then o_livingHIV_1564_PHIA = 1200000;
if cald=2020.00 then o_livingHIV_1564_PHIA = 1225000;
...
if cald=2022.5 then o_n_hivst_primd =319396;*VCMar2023;
*Self-test kits distributed (Secondary distribution, excluding for partners) [S2] ;
if cald=2022.5 then o_n_hivst_secd_nopartners =23506;*VCMar2023;
*Self-test kits distributed (Secondary distribution for partners) [S3] ;
if cald=2022.5 then o_n_hivst_secd_partners =31538;*VCMar2023;
