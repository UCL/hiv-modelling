...
data b;
   set a.l_pwt_rev_x    ;
 * set a.l_pwt_rev    ;
 * set a.l_pwt_x10a_jan23 a.l_pwt_x10b_jan23 l_pwt_x10c_jan23;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2000 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number' 	labelattrs=(size=12)  values = ( 0 to 25000    by  5000  ) valueattrs=(size=10);

  label p50_n_death_hiv_0 = "No community TLD/PEP (median)";
  label p50_n_death_hiv_1 = "Community TLD/PEP (median)";

  series  x=cald y=p50_n_death_hiv_0/	lineattrs = (color=red   thickness = 3);
