...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\pop_wide_tld\pop_wide_tld_x10c_out\";
...
proc print data=i1b; var s_prep_any  s_prep_any_elig  s_prep_elig_hivneg_onprep  s_prep_elig_hivneg s_pop_wide_tld_as_art
...
data    a.l_pwt_x10c_jan23 ; set k_pwt_x10c_c;  
...
* &p ;
proc means noprint data=f; var &p ; output out=y_ mean= &p; by run ; where cald = 2022.5 and option=1; run;
...
r_prevalence1549_42_2_1 = prevalence1549_42_2 / prevalence1549_42_1 ;
...
d_p_taz_42_2_1 = p_taz_42_2 - p_taz_42_1 ; 
...
ods html;
proc means data=   w_pwt_x10 n p50 p5 p95 min max;  *  w_pwt_x10 ;
...
proc means data=  w_pwt_x10 n mean p5 p95;
var 
...
p_ai_no_arv_e_inm_42_1 p_ai_no_arv_e_inm_42_2   d_p_ai_no_arv_e_inm_42_2_1
p_iime_42_1 p_iime_42_2  d_p_iime_42_2_1
n_infected_inm_42_1  n_infected_inm_42_2   d_n_infected_inm_42_2_1  
p_vl1000_art_12m_onart_42_1 p_vl1000_art_12m_onart_42_2   d_p_vl1000_art_12m_onart_42_2_1 
p_onart_vl1000_42_1  p_onart_vl1000_42_2   d_p_onart_vl1000_42_2_1 
prevalence_vg1000_42_1 prevalence_vg1000_42_2   d_prevalence_vg1000_42_2_1
...
proc univariate data=  w_pwt_x10; var d_n_death_hiv_50y_2_1 ; where artvis0_lower_adh = 0; run;
proc freq; tables d_n_death_hiv_50y_2_1 d_n_cd4_lt200_50y_2_1 ;  where artvis0_lower_adh = 0; run;

proc freq data=  w_pwt_x10; tables pop_wide_tld_ce  ; where incidence1549_22 >= 0.5; run;
...
proc univariate  data=  w_pwt_x10; var d_p_vl1000_3y_2_1 d_n_death_hiv_50y_2_1; 
where artvis0_lower_adh=0;
run;
