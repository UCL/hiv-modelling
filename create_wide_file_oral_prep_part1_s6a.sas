...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\oral_prep\oral_prep_13_s6a_out";
...
data a.oral_prep_13_s6a      ;
set y;


proc contents data=a.oral_prep_13_s6a  ; 
proc freq data=a.oral_prep_13_s6a ; tables run; where cald = 2020;
run;
