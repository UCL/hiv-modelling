...
* p_ae_clarla_e20_hi_adhdl;	
			if s_artexp_clarla_elig_20 > 0 then p_ae_clarla_e20_hi_adhdl = s_artexp_clarla_e_20_adh_dl_ge80 / s_artexp_clarla_elig_20 ;
* p_ae_clarla_e20_hi_adhdl;	
			if s_artexp_clarla_elig_22 > 0 then p_ae_clarla_e22_hi_adhdl = s_artexp_clarla_e_22_adh_dl_ge80 / s_artexp_clarla_elig_22 ;
* p_ae_clarla_e20_hi_adhdl;	
			if s_artexp_clarla_elig_24 > 0 then p_ae_clarla_e24_hi_adhdl = s_artexp_clarla_e_24_adh_dl_ge80 / s_artexp_clarla_elig_24 ;
...
s_st_clarla_vlg1000    s_st_clarla_rtnnm  s_st_clarla_rt181m  s_st_clarla_rtnnm_o103 
s_st_clarla_iim  s_st_clarla_iipm  s_st_clarla_linefail1  s_st_clarla_agelt25  s_st_clarla_m  s_st_clarla_w 
s_st_clarla_adhlt80  s_st_clarla_this_period p_artexp_adhl50
;
...
d_p_ae_clarla_e20_hi_adhdl = p_ae_clarla_e20_hi_adhdl_2 - p_ae_clarla_e20_hi_adhdl_1;
d_p_ae_clarla_e22_hi_adhdl = p_ae_clarla_e22_hi_adhdl_2 - p_ae_clarla_e22_hi_adhdl_1;
d_p_ae_clarla_e24_hi_adhdl = p_ae_clarla_e24_hi_adhdl_2 - p_ae_clarla_e24_hi_adhdl_1;
...
ods html;
proc means n mean lclm uclm p5 p95 data=wide;  var d_p_ae_clarla_e20_hi_adhdl   p_ae_clarla_e20_hi_adhdl_2   p_ae_clarla_e20_hi_adhdl_1; 
where lai_option=20 ;  run; 
ods html close;
...
* p_onart_iicu_vlg1000;			if s_onart_iicu_this_period > 0 then p_onart_iicu_vlg1000 = s_onart_iicu_vlg1000 / s_onart_iicu_this_period ;
* p_onart_iicu_rtnnm;			if s_onart_iicu_this_period > 0 then p_onart_iicu_rtnnm = s_onart_iicu_rtnnm / s_onart_iicu_this_period ;
* p_onart_iicu_rtnnm_o103;		if s_onart_iicu_this_period > 0 then p_onart_iicu_rtnnm_o103 = s_onart_iicu_rtnnm_o103 / s_onart_iicu_this_period ;
* p_onart_iicu_iim;				if s_onart_iicu_this_period > 0 then p_onart_iicu_iim = s_onart_iicu_iim / s_onart_iicu_this_period ;
* p_onart_iicu_iipm;			if s_onart_iicu_this_period > 0 then p_onart_iicu_iim = s_onart_iicu_iipm / s_onart_iicu_this_period ;
* p_onart_iicu_linefail1;		if s_onart_iicu_this_period > 0 then p_onart_iicu_linefail1 = s_onart_iicu_linefail1 / s_onart_iicu_this_period ;
* p_onart_iicu_agelt25;			if s_onart_iicu_this_period > 0 then p_onart_iicu_agelt25 = s_onart_iicu_agelt25 / s_onart_iicu_this_period ;
* p_onart_iicu_m;				if s_onart_iicu_this_period > 0 then p_onart_iicu_m = s_onart_iicu_m / s_onart_iicu_this_period ;
* p_onart_iicu_w;				if s_onart_iicu_this_period > 0 then p_onart_iicu_w = s_onart_iicu_w / s_onart_iicu_this_period ;
