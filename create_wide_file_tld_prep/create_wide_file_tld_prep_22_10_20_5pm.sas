...
* note this file tld_prep is used for prep also - we just delete the tld_prep option;
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\tld_prep\c_output_tld_prep_22_10_20_5pm_3";
...
keep run option cald dataset cost  prop_elig_on_prep  p_onart_diag  p_onart_as_tld_prep
...
proc sort data=y;by run option;run;
  ...
  data a.tld_prep_22_10_20_5pm_123;
* data a.tld_prep_22_10_20_5pm_123_dis7p; 

set y;

data y; 

  set a.tld_prep_22_10_20_5pm_123; 
* set a.tld_prep_22_10_20_5pm_123_dis7p;
run;
...
data &v ; merge y_17 y_20 t_20_25 t_20_70 ;  
/* data &v ; merge    y_19 y_20 t_20b t_21 t_20_21  t_20_25  t_20_70 ; */ 
drop _NAME_ _TYPE_ _FREQ_;

%mend var;

%var(v=s_alive); %var(v=prop_elig_on_prep);  %var(v=p_onart_diag);  %var(v=p_onart_as_tld_prep);
...
s_alive p_w_giv_birth_this_per p_newp_ge1 p_1524_newp_ge1 p_newp_ge5 p_newp_ge1_age1549 gender_r_newp  av_newp_ge1  av_newp_ge1_non_sw
p_newp_sw  n_tested_m   p_tested_past_year_1549m  p_tested_past_year_1549w  
p_diag_m1524 p_diag_w1524 p_diag_sw  p_onart_cd4_l200  p_newp_prep prop_elig_on_prep  p_onart_diag  p_onart_as_tld_prep
p_mcirc p_mcirc_1519m p_mcirc_2024m p_mcirc_2529m p_mcirc_3039m p_mcirc_4049m p_mcirc_50plm p_mcirc_1549m
...
* To get one row per run;
  ...
  data a.wide_tld_prep_22_10_20_5pm_123; 
* data a.wide_tld_prep_22_10_20_5pm_123_dis7p; 
