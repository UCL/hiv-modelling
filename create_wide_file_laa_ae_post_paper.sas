  ...
  libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\laa\laa_ae_post_paper_out\";
...
data b.k_laa_ae_pp;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
ddaly_yll_mtct = s_mtct * sf * 4 * 5   * discount ; 

ddaly_mtct = ddaly_yll_mtct + (s_ddaly_mtct * sf * 4); 
...
dcost_condom_dn = s_dcost_condom_dn * sf * 4 * 0.25 / 1000; 
dswitchline_cost = s_dcost_switch_line * sf * 4 / 1000;
if dswitchline_cost=. then dswitchline_cost=0;
if s_dcost_drug_level_test=. then s_dcost_drug_level_test=0;
dcost_drug_level_test = s_dcost_drug_level_test * sf * 4 / 1000;

dcost_child_hiv = (s_birth_with_inf_child + s_child_infected_breastfeeding) * 1 * discount * sf * 4 / 1000; 
...
ddaly ddaly_ad_mtct p_emerge_inm_res_cab  p_emerge_inm_res_cab_tail of_all_o_cab_prop_dur_9m of_all_o_cab_prop_dur_ge12m
...
data    b.l_laa_ae_revision_pp; set y;  

data y ; set b.l_laa_ae_revision_pp; 
...
proc means noprint data=e; var &v; output out=y_5y mean= &v._5y; by run option ; where 2027.0 <= cald < 2032.00;   
...
data &v ; merge y_24 y_22_24 t_3y t_5y t_10y t_50y ; 
...
%var(v=ddaly); %var(v=p_emerge_inm_res_cab);  %var(v=p_emerge_inm_res_cab_tail); %var(v=ddaly_ad_ntd_mtct);  %var(v=ddaly_ad_mtct); %var(v=ddaly_mtct);
...
data   b.wide_outputs_revision_pp; merge 
...
ddaly ddaly_gbd  p_emerge_inm_res_cab  p_emerge_inm_res_cab_tail of_all_o_cab_prop_dur_9m of_all_o_cab_prop_dur_ge12m  ddaly_ad_mtct
s_em_inm_res_o_cab_off_3m  s_o_cab_or_o_cab_tm1_no_r   s_emerge_inm_res_cab_tail   s_cur_in_prep_cab_tail_no_r  s_cur_in_prep_len_tail_no_r  p_emerge_inm_res_cab 
...
data b.wide_par2_revision_pp; merge 
...
proc sort; by run;run;
  ...
  data  b.w_laa_ae_revision_pp     ; 
  merge b.wide_outputs_revision_pp   b.wide_par2_revision_pp    ;
  by run;
...
data f; set b.w_laa_ae_revision_pp;
...
d_n_death_hiv_age_1524_5y_2_1 = n_death_hiv_age_1524_5y_2 - n_death_hiv_age_1524_5y_1 ; 
...
d_mtct_prop_5y_2_1 = mtct_prop_5y_2 - mtct_prop_5y_1 ;

r_n_mtct_5y_2_1 = n_mtct_5y_2 / n_mtct_5y_1; 

p_started_lencab_vmgt1000_5y_2 = n_started_lencab_vmgt1000_5y_2 / n_started_lencab_5y_2; 

d_n_death_hiv_5y_2_1 = n_death_hiv_5y_2 - n_death_hiv_5y_1;
r_n_death_hiv_5y_2_1 = n_death_hiv_5y_2 / n_death_hiv_5y_1;
d_p_onart_vl1000_5y_2_1 = p_onart_vl1000_5y_2 - p_onart_vl1000_5y_1;
d_p_vl1000_5y_2_1 = p_vl1000_5y_2 - p_vl1000_5y_1;
r_incidence1549_5y_2_1 = incidence1549_5y_2 / incidence1549_5y_1;
r_incidence1549w_5y_2_1 = incidence1549w_5y_2 / incidence1549w_5y_1;
r_incidence1549m_5y_2_1 = incidence1549m_5y_2 / incidence1549m_5y_1;
d_prevalence1549_5y_2_1 = prevalence1549_5y_2 - prevalence1549_5y_1;
d_p_r_len_1524_5y_2_1 = p_r_len_1524_5y_2 - p_r_len_1524_5y_1 ;
d_p_r_cab_1524_5y_2_1 = p_r_cab_1524_5y_2 - p_r_cab_1524_5y_1 ;
d_mtct_prop_5y_2_1 =  mtct_prop_5y_2 - mtct_prop_5y_1; 
...
p_started_unsupp_5y_2 = p_started_lencab_vmgt1000_5y_2 + p_started_lencab_offart_5y_2;
...
d_p_diag_vl1000_5y_2_1 = p_diag_vl1000_5y_2 - p_diag_vl1000_5y_1; 
...
if p_started_lencab_offart_5y_2 < 0.3 then p_started_lencab_offart_5y_g = 1;
if 0.3 <= p_started_lencab_offart_5y_2 < 0.45 then p_started_lencab_offart_5y_g = 2;
if 0.45 <= p_started_lencab_offart_5y_2 < 0.60 then p_started_lencab_offart_5y_g = 3;
if 0.60 <= p_started_lencab_offart_5y_2 then p_started_lencab_offart_5y_g = 4;

if p_len_5y_2 < 0.1 then p_len_5y_g = 1;
if 0.1 <= p_len_5y_2 < 0.15 then p_len_5y_g = 2;
if 0.15 <= p_len_5y_2 < 0.2 then p_len_5y_g = 3;
if 0.2 <= p_len_5y_2 < 0.25 then p_len_5y_g = 4;
if 0.25 <= p_len_5y_2 then p_len_5y_g = 5;

if p_started_lencab_vls_5y_2 < 0.2 then p_started_lencab_vls_5y_2_g=1;
if 0.2 <= p_started_lencab_vls_5y_2 < 0.4 then p_started_lencab_vls_5y_2_g=2;
if 0.4 <= p_started_lencab_vls_5y_2 < 0.6 then p_started_lencab_vls_5y_2_g=3;
if 0.6 <= p_started_lencab_vls_5y_2       then p_started_lencab_vls_5y_2_g=4;

relative_mtct_prop_5y = mtct_prop_5y_2 / mtct_prop_5y_1 ;

p_diag_vlg1000_5y_1 = 1 - p_diag_vl1000_5y_1;
p_diag_vlg1000_5y_2 = 1 - p_diag_vl1000_5y_2;

relative_prev_diag_vl1000_2_1 = p_diag_vl1000_5y_2 / p_diag_vl1000_5y_1;
relative_prev_diag_vlg1000_2_1 = p_diag_vlg1000_5y_2 / p_diag_vlg1000_5y_1;

r_prevalence_vg1000_5y_2_1 = prevalence_vg1000_5y_2 / prevalence_vg1000_5y_1 ;

r_prev_vg1000_1549_5y_2_1 = prevalence_vg1000_1549_5y_2 / prevalence_vg1000_1549_5y_1 ;
...
rel_death_reduction_ge15 = 0; if r_n_death_hiv_10y_2_1 <= 0.85 then rel_death_reduction_ge15 = 1;



d_dcost_10y_2_1 = dcost_10y_2 - dcost_10y_1;

d_ddaly_10y_2_1 = ddaly_10y_1 - ddaly_10y_2; 

d_ddaly_gbd_10y_2_1 = ddaly_gbd_10y_1 - ddaly_gbd_10y_2;                    

netdaly500_10y_1 = ddaly_10y_1 + (dcost_10y_1 / 0.0005);
netdaly500_10y_2 = ddaly_10y_2 + (dcost_10y_2 / 0.0005);

d_netdaly500_10y_2_1 = netdaly500_10y_1 - netdaly500_10y_2; 



d_dcost_5y_2_1 = dcost_5y_2 - dcost_5y_1;

d_ddaly_5y_2_1 = ddaly_5y_1 - ddaly_5y_2; 

d_ddaly_gbd_5y_2_1 = ddaly_gbd_5y_1 - ddaly_gbd_5y_2;                    

netdaly500_5y_1 = ddaly_5y_1 + (dcost_5y_1 / 0.0005);
netdaly500_5y_2 = ddaly_5y_2 + (dcost_5y_2 / 0.0005);

d_netdaly500_5y_2_1 = netdaly500_5y_1 - netdaly500_5y_2; 
...
proc means data=f  n p50  p5  p95 mean lclm uclm;  
var 
p_len_5y_1 p_len_5y_2 
p_cab_5y_1 p_cab_5y_2 
p_len_w_5y_1 p_len_w_5y_2
p_len_m_5y_1 p_len_m_5y_2
p_len_plw_5y_1 p_len_plw_5y_2
p_ever_len_o_len_5y_1  p_ever_len_o_len_5y_2
p_ever_len_v_failed_5y_1 p_ever_len_v_failed_5y_2
n_offered_return_lencab_5y_1 n_offered_return_lencab_5y_2
n_started_lencab_vmgt1000_5y_1 n_started_lencab_vmgt1000_5y_2   
n_started_lencab_5y_1  n_started_lencab_5y_2
n_started_lencab_offart_5y_1  n_started_lencab_offart_5y_2
p_started_lencab_vmgt1000_5y_1 p_started_lencab_vmgt1000_5y_2 
p_started_lencab_offart_5y_1 p_started_lencab_offart_5y_2 
p_started_lencab_vls_5y_1	p_started_lencab_vls_5y_2
p_onart_diag_5y_1 p_onart_diag_5y_2
relative_prev_diag_vlg1000_2_1
p_vl1000_5y_1 p_vl1000_5y_2 
p_len_1524_5y_1 p_len_1524_5y_2
p_cab_1524_5y_1 p_cab_1524_5y_2
p_len_vl1000_5y_1 p_len_vl1000_5y_2 
p_cab_vl1000_5y_1 p_cab_vl1000_5y_2 
p_onart_1524_5y_1 p_onart_1524_5y_2 
p_onart_vl1000_5y_1 p_onart_vl1000_5y_2 
p_vl1000_m_1524_5y_1 p_vl1000_m_1524_5y_2 
p_vl1000_w_1524_5y_1  p_vl1000_w_1524_5y_2  
p_onart_vl1000_w_1524_5y_1 p_onart_vl1000_w_1524_5y_2 
p_onart_vl1000_m_1524_5y_1 p_onart_vl1000_m_1524_5y_2
d_p_diag_vl1000_5y_2_1 p_diag_vlg1000_5y_1 p_diag_vlg1000_5y_2 
incidence1549_5y_1 incidence1549_5y_2 
incidence1549w_5y_1 incidence1549w_5y_2 
incidence1549m_5y_1 incidence1549m_5y_2 
incidence1524_5y_1 incidence1524_5y_2
n_death_hiv_5y_1 n_death_hiv_5y_2  
n_death_hiv_age_1524_5y_1 n_death_hiv_age_1524_5y_2
p_r_len_5y_1 p_r_len_5y_2
p_r_cab_5y_1 p_r_cab_5y_2
relative_prev_diag_vl1000_2_1
mtct_prop_5y_1 mtct_prop_5y_2 
relative_mtct_prop_5y
mtct_birth_prop_5y_1 mtct_birth_prop_5y_2 
prevalence_vg1000_5y_1 prevalence_vg1000_5y_2
prevalence_vg1000_1549_5y_1 prevalence_vg1000_1549_5y_2
r_n_mtct_5y_2_1 n_mtct_5y_1 n_mtct_5y_2 
r_prevalence_vg1000_5y_2_1 
r_prev_vg1000_1549_5y_2_1
d_n_death_hiv_5y_2_1 
r_n_death_hiv_5y_2_1 
d_p_onart_vl1000_5y_2_1 
d_p_vl1000_5y_2_1 
r_incidence1549_5y_2_1 r_incidence1549w_5y_2_1 r_incidence1549m_5y_2_1  
d_prevalence1549_5y_2_1 
d_p_r_len_1524_5y_2_1 
d_p_r_cab_1524_5y_2_1
d_mtct_prop_5y_2_1 
;
* where p_diag_vl1000_24 < 0.9;
run;
...
* where p_diag_vl1000_24_g = 1;
* where p_diag_24_g = 1;
* where p_onart_vl1000_24_g = 1; 
* where p_onart_diag_24_g = 1;
* where incidence1549_24_g = 6;
...
proc means data=f mean  ;
var 
ddaly_10y_1 ddaly_10y_2
d_ddaly_10y_2_1  
d_ddaly_gbd_10y_2_1  
d_dcost_10y_2_1
d_netdaly500_10y_2_1 
;
run;
...
_rel_death_reduction_ge15 = 1 - rel_death_reduction_ge15;
...
proc logistic;
model _rel_death_reduction_ge15 = incidence1549_24 p_diag_24 p_onart_diag_24  p_onart_vl1000_24;
run;


proc logistic;
model _rel_death_reduction_ge15 = prevalence1549_24 p_diag_24 p_onart_diag_24  p_onart_vl1000_24;
run;

proc logistic;
model _rel_death_reduction_ge15 =  p_onart_diag_24  p_onart_vl1000_24;
run;

proc logistic;
model _rel_death_reduction_ge15 =  p_diag_vl1000_24;
run;
