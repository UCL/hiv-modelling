...
inputdir="${HOME}"
tmpfiles="out_"
combinedsas="pace_27Jul26"
runs="500"
jobname="hivmodel_pace_gold"
model="hiv_synthesis_pace_27Jul26.sas"
clock="h_rt=36:00:00"
account="HIVSynthMod"
...
qsub -N $jobname -t 1-$runs -tc 10 -wd $finaloutdir -P Gold -A $account -l $clock -v SASINPUT=$inputdir,SASOUTPUTDIR=$finaloutdir,SASMODEL=$model,SASTMPFILES=$tmpfiles $inputdir/testmodel.sh
