...
prevalence_vg1000_   incidence1564_   n_tested n_tested_m  n_self_tested 
...
n_vm_per_year    n_self_tested_m    n_self_tested_w    n_tested_due_to_self_t  n_diagnosed_self_test  p_newp_ge1_agyw
p_births_hiv_vlg1000_  p_diag_w1524_  p_diag_m1524_  

p_newp_ge5_  n_prep_inj n_prep_vr
...
p_tested_this_period_msm p_msm_infected_from_msm   n_alive1564_msm   prevalence_pwid  n_pwid  p_onprep_pwid  p_onart_pwid  
...
incidence1564m incidence1564w incidence1549m incidence1549w
logm15r logm25r logm35r logm45r logm55r logw15r logw25r logw35r logw45r logw55r 
...
label p50_n_prep_inj_0 = "status quo";
label p50_n_prep_inj_1 = "option 1";


series  x=cald y=p50_n_prep_inj_0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_n_prep_inj_0 upper=p95_n_prep_inj_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

series  x=cald y=p50_n_prep_inj_1 / lineattrs = (color=lightblue thickness = 4);
band    x=cald lower=p5_n_prep_inj_1 upper=p95_n_prep_inj_1 / transparency=0.9 fillattrs = (color=lightblue) legendlabel= "90% range";
...
* label p50_n_death_hiv_1 = "option 1";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2020 to 2040 by 5)	 	 valueattrs=(size=10); 
...
label p50_p_onart_diag_1 = "option 1";
