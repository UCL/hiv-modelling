...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_b_out\";
...
data b.k_cioa_b;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
data    b.l_cioa_b; set y;  

data y ; set b.l_cioa_b; 
