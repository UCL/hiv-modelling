...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\lapr\future_incidence_out\";

data i1; set b.out1:; data i2; set b.out2:; data i3; set b.out3:; data i4; set b.out4:; data i5; set b.out5:; 
data i6; set b.out6:; data i7; set b.out7:; data i8; set b.out8:; data i9; set b.out9:;  


data a.k_future_inc;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;

proc sort data=a.k_future_inc; 
by run cald option;
run;
...
prev_vg1000_newp_m  prev_vg1000_newp_w
...
dcost_prep_visit dres_cost     dtest_cost    d_t_adh_int_cost    dswitchline_cost   dtaz_cost   dclin_cost  dcost_circ dcost_condom_dn 
dcost_prep_visit_oral dcost_prep_visit_inj   dcost_prep  dcost_clin_care  dcost_non_aids_pre_death  dcost_child_hiv  dnon_tb_who3_cost
dadc_cost       dcd4_cost       dvl_cost       dvis_cost        dcot_cost       dtb_cost    n_hiv  p_mcirc_1549m
n_tested_m p_tested_past_year_1549m   p_tested_past_year_1549w  p_mcirc  prop_w_1549_sw prop_w_1564_sw prop_w_ever_sw prop_sw_hiv 
prop_sw_program_visit prop_w_1524_onprep prop_1564_onprep prop_sw_onprep prevalence1549m prevalence1549w prevalence1549 
prevalence_vg1000 incidence1549  incidence1564  prevalence1524w prevalence_sw incidence1549w  incidence1549m  incidence_sw incidence_onprep
p_inf_vlsupp  p_inf_newp  p_inf_ep  p_inf_diag  p_inf_naive   p_inf_primary mtct_prop p_diag p_diag_m p_diag_w p_diag_sw
...
proc means data=  a.w_future_inc   n p50 p5 p95 min max;  
...
data x; set a.l_future_inc;

if cald ge 2022;

if prevalence_vg1000 < 0.005 then prevalence_vg1000_g=1;
if 0.005 < prevalence_vg1000 < 0.01  then prevalence_vg1000_g=2;
if 0.01  < prevalence_vg1000 < 0.015 then prevalence_vg1000_g=3;
if 0.015 < prevalence_vg1000 < 0.02  then prevalence_vg1000_g=4;
if 0.02  < prevalence_vg1000 < 0.025 then prevalence_vg1000_g=5;
if 0.025 < prevalence_vg1000 < 0.03  then prevalence_vg1000_g=6;
if 0.03  < prevalence_vg1000         then prevalence_vg1000_g=7;

if 0 <= prop_elig_on_prep < 0.2 then prop_elig_on_prep_g=1;
if 0.2 <= prop_elig_on_prep < 0.4 then prop_elig_on_prep_g=2;
if 0.4 <= prop_elig_on_prep < 0.6 then prop_elig_on_prep_g=3;
if 0.6 <= prop_elig_on_prep < 0.8 then prop_elig_on_prep_g=4;
if 0.8 <= prop_elig_on_prep       then prop_elig_on_prep_g=5;

if p_mcirc < 0.33 then p_mcirc_g=1;
if 0.33 <= p_mcirc < 0.67 then p_mcirc_g=2;
if 0.67 <= p_mcirc then p_mcirc_g=3;

incidence_lt_1p1000=0; if incidence1549 < 0.1 then incidence_lt_1p1000=1;
...
proc univariate; var p_prep_adhg80; run;
...
proc freq; 
tables 
prevalence_vg1000_g * incidence_lt_1p1000 / nopercent nocol;
where 2022.75 <= cald < 2030;
proc freq; 
tables 
p_mcirc_g * prevalence_vg1000_g * prop_elig_on_prep_g * incidence_lt_1p1000 / nopercent nocol;
where 2022.75 <= cald < 2030;
run;
proc freq; 
tables 
prevalence_vg1000_g * p_mcirc_g * incidence_lt_1p1000 / nopercent nocol;
where 2022.75 <= cald < 2030;
run;
ods html close;
