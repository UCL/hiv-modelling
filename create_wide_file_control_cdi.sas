...
data a.long_cdi_control_18Dec25; set y;
...
data y; set a.long_cdi_control_18Dec25; 
...
proc export data=a.outputs_&op_num
	...
	outfile= "C:\Users\Lovel\UCL Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\hiv_control_cdi\cdi_18Dec25_excel_&op_num..csv" 
	dbms=csv replace; 
	putnames=no;
run;
