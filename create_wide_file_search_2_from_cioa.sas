...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_lgh_rev_out\";
libname c "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_lgh_rev_d_vlm_out\";
...
data b.cioa_lgh_rev_vlm_d;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;

run;

*/

data b.k_cioa_lgh_rev_vlm; set b.cioa_lgh_rev_vlm_d ;
...
proc sort data=b.k_cioa_lgh_rev_vlm; 
by run cald option;
run;
...
data    b.l_cioa_lgh_rev_vlm; set y;  
...
data y ; set b.l_cioa_lgh_rev_vlm; 
...
proc means noprint data=e; var &v; output out=y_20y mean= &v._20y; by run option ; where 2026.0 <= cald < 2046.00;   
...
data &v ; merge y_19 y_24 t_3y t_10y t_20y  t_50y ; 
...
* libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_lgh_rev_vlm_out\";

data f; set b.w_cioa_lgh_rev_vlm;
