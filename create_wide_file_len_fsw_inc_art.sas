...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\len_fsw_inc_art_out\";
...
data b.k_len_fsw_inc_art;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_len_fsw_inc_art; 
by run cald option;
run;
...
data    b.l_len_fsw_inc_art; set y;  
...
data y ; set b.l_len_fsw_inc_art; 
...
data f; set b.w_len_fsw_inc_art;
