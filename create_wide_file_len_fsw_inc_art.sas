...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\len_fsw_inc_art_a_out\";
...
data b.k_len_fsw_inc_art_a;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_len_fsw_inc_art_a; 
by run cald option;
run;
...
merge b.k_len_fsw_inc_art_a sf;
by run ;
...
data    b.l_len_fsw_inc_art_a; set y;  
...
data y ; set b.l_len_fsw_inc_art_a; 
...
data f; set b.w_len_fsw_inc_art_a;
