...
proc means noprint data=y; var &v; output out=z_51  mean= &v   ; where 2050.5 < cald <= 2051.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_52  mean= &v   ; where 2051.5 < cald <= 2052.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_53  mean= &v   ; where 2052.5 < cald <= 2053.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_54  mean= &v   ; where 2053.5 < cald <= 2054.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_55  mean= &v   ; where 2054.5 < cald <= 2055.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_56  mean= &v   ; where 2055.5 < cald <= 2056.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_57  mean= &v   ; where 2056.5 < cald <= 2057.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_58  mean= &v   ; where 2057.5 < cald <= 2058.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_59  mean= &v   ; where 2058.5 < cald <= 2059.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_60  mean= &v   ; where 2059.5 < cald <= 2060.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_61  mean= &v   ; where 2060.5 < cald <= 2061.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_62  mean= &v   ; where 2061.5 < cald <= 2062.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_63  mean= &v   ; where 2062.5 < cald <= 2063.5 and option=11 ;
proc means noprint data=y; var &v; output out=z_64  mean= &v   ; where 2063.5 < cald <= 2064.5 and option=11 ;
...
z_51 z_52 z_53 z_54 z_55 z_56 z_57 z_58 z_59 z_60 z_61 z_62 z_63 z_64
;  
...
%var_flow(v=	n_new_inf1564m);						
%var_flow(v=	n_new_inf1564w);									
%var_flow(v=	n_death_hivrel_m);
%var_flow(v=	n_death_hivrel_w);			
%var_flow(v=	n_death_m);
%var_flow(v=	n_death_w		);				
%var_flow(v=	n_dyllag_hiv_m);
%var_flow(v=	n_dyllag_hiv_w	);						
%var_flow(v=	n_give_birth_w_hiv);
%var_flow(v=	n_give_birth_on_art);
%var_flow(v=	n_init_prep_oral_curr_m);
%var_flow(v=	n_init_prep_oral_curr_w);
%var_flow(v=	n_hivpos_tests			);			
%var_flow(v=	n_hivneg_tests			);			
%var_flow(v=	n_diag_anc);
%var_flow(v=	n_hivneg_tests_anc);
%var_flow(v=	n_hivpos_tests_sympt);				
%var_flow(v=	n_hivneg_tests_sympt);								
%var_flow(v=	n_new_vmmc1549m);
%var_flow(v=	n_new_vmmc1014m		);			
%var_flow(v=	n_vm_w);
%var_flow(v=	n_vm_m				);				
%var_flow(v=	n_init_prep_vr_1524w);
%var_flow(v=	n_init_prep_oral_plw);
%var_flow(v=	n_init_prep_inj_1524w);
%var_flow(v=	n_init_prep_inj_curr_m);
%var_flow(v=	n_init_prep_inj_curr_w);
%var_flow(v=	n_art_mens_clinic);
%var_flow(v=	n_receive_u_u);
...
%var_flow(v=	n_init_prep_oral_first_w);			
%var_flow(v=	n_init_prep_inj_first_w	);			
%var_flow(v=	n_init_prep_inj_first_m	);			
%var_flow(v=	n_prep_oral_w			);			
%var_flow(v=	n_prep_oral_m			);			
%var_flow(v=	n_prep_inj_w			);			
%var_flow(v=	n_prep_inj_m	);
...
dummy40=.;dummy41=.;dummy42=.;dummy43=.;dummy44=.;dummy45=.;dummy46=.;dummy47=.;dummy48=.;dummy49=.;dummy50=.;
