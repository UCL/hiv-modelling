...
* HIV testing;
* Per person tested;
%let cost_per_facility_test=13.03;
%let cost_per_contact_tracing=27.52;
%let cost_per_self_test=12.75;

* ART;
%let cost_art_pppy=100.10;			* Ingredients-based, pppy;
%let cost_pmtct_per_test=13.03;		* Per woman tested at ANC;
...
%let cost_prep_oral_pppy=76.15;
%let cost_prep_cab_pppy=88.36;	
%let cost_prep_len_pppy=72.59;	

* VMMC;
%let cost_VMMC_per_procedure=32.08;

* Key pop programs;
* Per person reached;
%let cost_FSW_services_pppy=279;
%let cost_MSM_services_pppy=61.44;
