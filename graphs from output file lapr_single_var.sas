...
label mean_p_ai_no_arv_e_inm_0 = "no cab-la introduction (median) ";
label mean_p_ai_no_arv_e_inm_1 = "cab-la introduction (median) ";

series  x=cald y=mean_p_ai_no_arv_e_inm_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_p_ai_no_arv_e_inm_1/	lineattrs = (color=str thickness = 2);
