...
a_r_incidence1549_6570_2_1 = 1 - r_incidence1549_6570_2_1;
...
ods html;
proc glm data = r   PLOTS = CONTOURFIT(obs=NONE); 
model a_r_incidence1549_6570_2_1 = vaccine_efficacy  vaccine_duration_effect  vaccine_efficacy*vaccine_duration_effect  / solution;
title 'Contour Plot of relative effect of vaccine in 2065-2070';
run;
ods html close;
