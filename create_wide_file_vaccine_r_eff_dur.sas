...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\vaccine\vaccine_n_d_r_eff_dur_out\";
...
data b.k_vaccine_n_d_r_eff_dur;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_vaccine_n_d_r_eff_dur; 
by run cald option;
run;
...
merge b.k_vaccine_n_d_r_eff_dur sf;
by run ;
...
data    b.l_vaccine_n_d_r_eff_dur_y; set y;  

data y ; set b.l_vaccine_n_d_r_eff_dur_y; 
...
proc freq data=b.wide_par2; tables future_prep_condom ; run;  
  ...
  data  b.w_vaccine_n_d_r_eff_dur     ; 
...
proc freq; tables r_incidence1549_6570_2_1 run future_prep_condom; run;  
