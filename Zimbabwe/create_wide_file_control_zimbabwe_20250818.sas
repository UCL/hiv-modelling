...
* prep_agyw_pg;					* need to add new code in 15/09 version; * Person years of PrEP distributed to sexually active AGYW and pregnant women;
* total_agyw_pg;				* need to add new code in 15/09 version; * Number of people in the total population, sexually active AGYW and pregnant women;
...
* n_init_prep_cab_1524w; 		n_init_prep_cab_1524w  = s_init_prep_cab_1524w * 4 * sf;  
* n_init_prep_cab_sw; 			n_init_prep_cab_sw     = s_init_prep_cab_sw * 4 * sf; 
* n_init_prep_cab_sdc; 			n_init_prep_cab_sdc    = s_init_prep_cab_sdc * 4 * sf; 
* n_init_prep_cab_plw; 			n_init_prep_cab_plw     = s_init_prep_cab_plw * 4 * sf; *Feb2024;
* n_init_prep_len_1524w; 		n_init_prep_len_1524w  = s_init_prep_len_1524w * 4 * sf;  
* n_init_prep_len_sw; 			n_init_prep_len_sw     = s_init_prep_len_sw * 4 * sf; 
* n_init_prep_len_sdc; 			n_init_prep_len_sdc    = s_init_prep_len_sdc * 4 * sf; 
* n_init_prep_len_plw; 			n_init_prep_len_plw     = s_init_prep_len_plw * 4 * sf; *Feb2024;
...
* n_prep_cab_ly_1524w; 			n_prep_cab_ly_1524w    = s_prep_cab_ly_1524w * sf;      
* n_prep_cab_ly_sw;  			n_prep_cab_ly_sw  	   = s_prep_cab_ly_sw * sf;      
* n_prep_cab_ly_sdc;  			n_prep_cab_ly_sdc      = s_prep_cab_ly_sdc * sf;    
* n_prep_cab_ly_plw; 			n_prep_cab_ly_plw 	   = s_prep_cab_ly_plw * sf;   *Feb2024;     
* n_prep_len_ly_1524w; 			n_prep_len_ly_1524w    = s_prep_len_ly_1524w * sf;      
* n_prep_len_ly_sw;  			n_prep_len_ly_sw  	   = s_prep_len_ly_sw * sf;      
* n_prep_len_ly_sdc;  			n_prep_len_ly_sdc      = s_prep_len_ly_sdc * sf;    
* n_prep_len_ly_plw; 			n_prep_len_ly_plw 	   = s_prep_len_ly_plw * sf;   *Feb2024;     
...
* n_prep_cab_1524w; 		n_prep_cab_1524w  = s_prep_cab_w_1524 * sf; 
* n_prep_cab_sw; 			n_prep_cab_sw     = s_prep_cab_sw * sf; 
* n_prep_cab_sdc; 			n_prep_cab_sdc    = s_prep_cab_sdc * sf; 
* n_prep_cab_plw; 			n_prep_cab_plw    = s_prep_cab_plw * sf; *Feb2024;
* n_prep_len_1524w; 		n_prep_len_1524w  = s_prep_len_w_1524 * sf; 
* n_prep_len_sw; 			n_prep_len_sw     = s_prep_len_sw * sf; 
* n_prep_len_sdc; 			n_prep_len_sdc    = s_prep_len_sdc * sf; 
...
* n_contprep_cab_1524w; 		n_contprep_cab_1524w  = (s_prep_cab_w_1524 - s_init_prep_cab_1524w) * sf;   
* n_contprep_cab_sw; 			n_contprep_cab_sw     = (s_prep_cab_sw - s_init_prep_cab_sw) * sf; 
* n_contprep_cab_sdc; 			n_contprep_cab_sdc    = (s_prep_cab_sdc - s_init_prep_cab_sdc) * sf; 
* n_contprep_cab_plw; 			n_contprep_cab_plw    = (s_prep_cab_plw - s_init_prep_cab_plw) * sf; *Feb2024;
* n_contprep_len_1524w; 		n_contprep_len_1524w  = (s_prep_len_w_1524 - s_init_prep_len_1524w) * sf;   
* n_contprep_len_sw; 			n_contprep_len_sw     = (s_prep_len_sw - s_init_prep_len_sw) * sf; 
* n_contprep_len_sdc; 			n_contprep_len_sdc    = (s_prep_len_sdc - s_init_prep_len_sdc) * sf; 
* n_contprep_len_plw; 			n_contprep_len_plw    = (s_prep_len_plw - s_init_prep_len_plw) * sf; *Feb2024;
...
* n_prep_cab_ever_1524w; 		n_prep_cab_ever_1524w  = s_prep_cab_ever_1524w * sf;    
* n_prep_cab_ever_sw;  			n_prep_cab_ever_sw     = s_prep_cab_ever_sw * sf;  
* n_prep_cab_ever_sdc;  		n_prep_cab_ever_sdc    = s_prep_cab_ever_sdc * sf;  
* n_prep_cab_ever_plw;  		n_prep_cab_ever_plw    = s_prep_cab_ever_plw * sf;    *Feb2024;
* n_prep_len_ever_1524w; 		n_prep_len_ever_1524w  = s_prep_len_ever_1524w * sf;    
* n_prep_len_ever_sw;  			n_prep_len_ever_sw     = s_prep_len_ever_sw * sf;  
* n_prep_len_ever_sdc;  		n_prep_len_ever_sdc    = s_prep_len_ever_sdc * sf;  
* n_prep_len_ever_plw;  		n_prep_len_ever_plw    = s_prep_len_ever_plw * sf;    *Feb2024;
...
* py_prep_cab_1524w;			py_prep_cab_1524w =		0.25 * n_prep_cab_1524w;
* py_prep_cab_sw;				py_prep_cab_sw = 		0.25 * n_prep_cab_sw;
* py_prep_len_1524w;			py_prep_len_1524w =		0.25 * n_prep_len_1524w;
* py_prep_len_sw;				py_prep_len_sw = 		0.25 * n_prep_len_sw;
...
n_circumcised_15_24_m			prep_agyw_pg	total_agyw_pg	/* added Sept 2025 */
...
n_init_prep_cab_1524w   n_init_prep_cab_sw   n_init_prep_cab_sdc  	n_init_prep_cab_plw   
...
n_prep_cab_ly_1524w		n_prep_cab_ly_sw	 n_prep_cab_ly_sdc		n_prep_cab_ly_plw
n_prep_len_ly_1524w		n_prep_len_ly_sw	 n_prep_len_ly_sdc		n_prep_len_ly_plw
...
n_prep_cab_1524w		n_prep_cab_sw		 n_prep_cab_sdc			n_prep_cab_plw
...
n_contprep_cab_1524w	n_contprep_cab_sw	 n_contprep_cab_sdc		n_contprep_cab_plw
...
n_prep_cab_ever_1524w	n_prep_cab_ever_sw	 n_prep_cab_ever_sdc	n_prep_cab_ever_plw  
n_prep_len_ever_1524w	n_prep_len_ever_sw	 n_prep_len_ever_sdc	n_prep_len_ever_plw  
...
py_prep_cab_1524w		py_prep_cab_sw
...
proc means noprint data=y; var &v; output out=y_1985 mean= &v;  where cald = 1985.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1986 mean= &v;  where cald = 1986.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1987 mean= &v;  where cald = 1987.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1988 mean= &v;  where cald = 1988.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1989 mean= &v;  where cald = 1989.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1990 mean= &v;  where cald = 1990.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1991 mean= &v;  where cald = 1991.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1992 mean= &v;  where cald = 1992.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1993 mean= &v;  where cald = 1993.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1994 mean= &v;  where cald = 1994.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1995 mean= &v;  where cald = 1995.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1996 mean= &v;  where cald = 1996.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1997 mean= &v;  where cald = 1997.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1998 mean= &v;  where cald = 1998.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_1999 mean= &v;  where cald = 1999.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2000 mean= &v;  where cald = 2000.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2001 mean= &v;  where cald = 2001.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2002 mean= &v;  where cald = 2002.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2003 mean= &v;  where cald = 2003.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2004 mean= &v;  where cald = 2004.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2005 mean= &v;  where cald = 2005.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2006 mean= &v;  where cald = 2006.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2007 mean= &v;  where cald = 2007.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2008 mean= &v;  where cald = 2008.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2009 mean= &v;  where cald = 2009.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2010 mean= &v;  where cald = 2010.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2011 mean= &v;  where cald = 2011.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2012 mean= &v;  where cald = 2012.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2013 mean= &v;  where cald = 2013.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2014 mean= &v;  where cald = 2014.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2015 mean= &v;  where cald = 2015.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2016 mean= &v;  where cald = 2016.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2017 mean= &v;  where cald = 2017.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2018 mean= &v;  where cald = 2018.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2019 mean= &v;  where cald = 2019.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2020 mean= &v;  where cald = 2020.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2021 mean= &v;  where cald = 2021.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2022 mean= &v;  where cald = 2022.5 and option = &op_num;
proc means noprint data=y; var &v; output out=y_2023 mean= &v;  where cald = 2023.5 and option = &op_num;
...
proc means noprint data=y; var &v; output out=z_1985 mean= &v; where 1984.5 < cald <= 1985.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1986 mean= &v; where 1985.5 < cald <= 1986.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1987 mean= &v; where 1986.5 < cald <= 1987.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1988 mean= &v; where 1987.5 < cald <= 1988.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1989 mean= &v; where 1988.5 < cald <= 1989.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1990 mean= &v; where 1989.5 < cald <= 1990.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1991 mean= &v; where 1990.5 < cald <= 1991.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1992 mean= &v; where 1991.5 < cald <= 1992.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1993 mean= &v; where 1992.5 < cald <= 1993.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1994 mean= &v; where 1993.5 < cald <= 1994.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1995 mean= &v; where 1994.5 < cald <= 1995.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1996 mean= &v; where 1995.5 < cald <= 1996.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1997 mean= &v; where 1996.5 < cald <= 1997.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1998 mean= &v; where 1997.5 < cald <= 1998.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_1999 mean= &v; where 1998.5 < cald <= 1999.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2000 mean= &v; where 1999.5 < cald <= 2000.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2001 mean= &v; where 2000.5 < cald <= 2001.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2002 mean= &v; where 2001.5 < cald <= 2002.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2003 mean= &v; where 2002.5 < cald <= 2003.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2004 mean= &v; where 2003.5 < cald <= 2004.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2005 mean= &v; where 2004.5 < cald <= 2005.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2006 mean= &v; where 2005.5 < cald <= 2006.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2007 mean= &v; where 2006.5 < cald <= 2007.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2008 mean= &v; where 2007.5 < cald <= 2008.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2009 mean= &v; where 2008.5 < cald <= 2009.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2010 mean= &v; where 2009.5 < cald <= 2010.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2011 mean= &v; where 2010.5 < cald <= 2011.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2012 mean= &v; where 2011.5 < cald <= 2012.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2013 mean= &v; where 2012.5 < cald <= 2013.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2014 mean= &v; where 2013.5 < cald <= 2014.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2015 mean= &v; where 2014.5 < cald <= 2015.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2016 mean= &v; where 2015.5 < cald <= 2016.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2017 mean= &v; where 2016.5 < cald <= 2017.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2018 mean= &v; where 2017.5 < cald <= 2018.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2019 mean= &v; where 2018.5 < cald <= 2019.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2020 mean= &v; where 2019.5 < cald <= 2020.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2021 mean= &v; where 2020.5 < cald <= 2021.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2022 mean= &v; where 2021.5 < cald <= 2022.5 and option = &op_num;
proc means noprint data=y; var &v; output out=z_2023 mean= &v; where 2022.5 < cald <= 2023.5 and option = &op_num;
