...
ods rtf file = 'C:\Users\rmjlja9\Documents\GitHub\hiv-modelling\Malawi\graphs_20260112.doc' startpage=never;
...
proc export data=icer_sums
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260112_out\icer_sums.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
