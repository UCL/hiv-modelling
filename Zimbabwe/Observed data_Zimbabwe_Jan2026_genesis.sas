...
* Source:https://www.unicef.org/zimbabwe/media/8636/file/Ending%20HIV%20AIDS%20with%20Children,%20Adolescents%20and%20Young%20Women.pdf;
if cald=2022 then o_n_preg_hiv_unicef=53000;
...
if cald=2015 then 	e_hiv_15plus_nac=1449842;*summed above three;
...
if cald=2016 then e_livingHIV_1549=1413000;*It is not clear whether 2015 or 2016;
...
*Source: "GLOBAL AIDS RESPONSE PROGRESS REPORT 2020"
https://www.unaids.org/sites/default/files/country/documents/ZWE_2020_countryreport.pdf (accessed 05/03/2021); 
if cald=2019 then o_livingHIV_all_GARPR=1400000;
...
if cald=2009.5 then o_p_evertested_1549w_mim=0.449;
...
***LBM Update Sep 2016;
*Source: Population-Level Impact of Zimbabweís National Behavioural Change Programme, Buzdugan, Benedikt et al;
...
if cald=2010 then o_s_tested_1549_py_garcpr =1653603;
if cald=2011 then o_s_tested_1549_py_garcpr =1943694;
if cald=2016 then m_s_tested_1549_py_garcpr =2777000; *target;

***LBM Update Sep 2016 
*Source: Global AIDS response country  progress report Zimbabwe 2016;
if cald=2007 then o_s_tested_1549_py_garcpr = 579767;
if cald=2009 then o_s_tested_1549_py_garcpr =1108264;
if cald=2012 then o_s_tested_1549_py_garcpr =2240344;
*Source: "GLOBAL AIDS RESPONSE PROGRESS REPORT 2020"
https://www.unaids.org/sites/default/files/country/documents/ZWE_2020_countryreport.pdf (accessed 05/03/2021)
15-49 are from page
...
if cald=2013 then o_s_tested_1549_py_garcpr =2274328;
if cald=2014 then do; o_s_tested_1549_py_garcpr =1755179;o_s_tested_py_garcpr =1795179;end;
if cald=2015 then do; o_s_tested_1549_py_garcpr =2201246;o_s_tested_py_garcpr =1952278;end;*how can alla ges be higher than 15-49?;
if cald=2016 then do; o_s_tested_1549_py_garcpr =2664844;o_s_tested_py_garcpr =2580766;end;
if cald=2017 then o_s_tested_1549_py_garcpr =2851049;
if cald=2018 then do;o_s_tested_1549_py_garcpr =3011027;
					   o_s_tested_1549w_py_garcpr =1959193;
					   o_s_tested_1549m_py_garcpr =1051834;end;
if cald=2019 then o_s_tested_1549_py_garcpr =2382768;
...
*Source: HIVcalibrationData_Zimbabwe.xls sent by Isaac Taramusi in Sept 2021;
if cald=2011 then do;o_s_test_15ov_py_z=1656719; o_pos_rate_15ov_z=0.2; end;
if cald=2012 then do;o_s_test_15ov_py_z=1868842; o_pos_rate_15ov_z=0.16; end;
if cald=2013 then do;o_s_test_15ov_py_z=1430246; o_pos_rate_15ov_z=0.13; end;
if cald=2014 then do;o_s_test_15ov_py_z=1756524; o_pos_rate_15ov_z=0.11; end;
if cald=2015 then do;o_s_test_15ov_py_z=2201250; o_pos_rate_15ov_z=0.09; end;
if cald=2016 then do;o_s_test_15ov_py_z=2664844; o_pos_rate_15ov_z=0.07; end;
if cald=2017 then do;o_s_test_15ov_py_z=3174630; o_pos_rate_15ov_z=0.06; end;
if cald=2018 then do;o_s_test_15ov_py_z=3011027; o_pos_rate_15ov_z=0.06; end;
if cald=2019 then do;o_s_test_15ov_py_z=2382768; o_pos_rate_15ov_z=0.05; end;
if cald=2020 then do;o_s_test_15ov_py_z=1521942; o_pos_rate_15ov_z=0.06; end;
...
if cald=2022 then o_n_hivst_primd =319396;*VCMar2023;
*Self-test kits distributed (Secondary distribution, excluding for partners) [S2] ;
if cald=2022 then o_n_hivst_secd_nopartners =23506;*VCMar2023;
*Self-test kits distributed (Secondary distribution for partners) [S3] ;
if cald=2022 then o_n_hivst_secd_partners =31538;*VCMar2023;
*Contacts tested for HIV at the facility [B11];
if cald=2022 then o_n_contactsested_fac =62526;*VCMar2023;


*Source: Draft 2023 HIV Prevention Targets Handbook 20022023 (1).docs sent by Ngwarai on 28/6/2023;
if cald=2023 then target_n_hcwtest=1793079;*Conventional tests;
if cald=2023 then target_n_hivst=769860;
...
*Source: Interventions for consideration_MIHPSA_Zimbabwe_v8_20230214.xls;
if cald=2021.5 then o_nfsw_sistclin =27006;*VCMar2023;

*Number of FSW tested in the Sisters with a Voice clinic;
*Source: Interventions for consideration_MIHPSA_Zimbabwe_v8_20230214.xls;
if cald=2021.5 then o_nfswtested_sistclin=26845;
...
if cald=2009.5 then o_p_testedanc_1549_mim = 0.581;
*Source: Multiple Indicator Monitoring (MIM) survey 2014, Page 259 and 263
***LBM Update Sep 2016;
if cald=2014.5 then o_p_testedanc_1549_mim = 0.902;
...
*# HIV + in Labour and Delivery ;
if cald=2022.5 then o_n_hiv_labdel =510;*VCMar2023;
*# HIV +  for the first time during Post delivery (I assumed it was a typo in excel spreadsheet); 
if cald=2022.5 then o_n_newdiag_postdel =368;*VCMar2023;
...
****CAREFUL: "This presentation is based on data extracted from 77 ePMS sites across the countryís 10 provinces in March 2015. 
...
*Source: Interventions for consideration_MIHPSA_Zimbabwe_v8_20230214.xls;
if cald=2021.75 then o_p_onart_1549_diag_Spectrum=0.89;*VCMar2023;
...
*Source: Renaud-ThÈry F, Duncombe C, Kerr S, Thierry S, Perriens J. Adult antiretroviral therapy in resource limited settings: a systematic review of first-line failure and attrition rates. WHO 2013 [cited 2014 Mar 26], 
...
if cald = 2008 then o_s_new_vmmc=0;
if cald = 2009 then o_s_new_vmmc=2801;
if cald = 2010 then o_s_new_vmmc=11176;
if cald = 2011 then o_s_new_vmmc=36603;
...
if cald = 2009  then o_s_new_vmmc_1049m=2784 ;
if cald = 2010  then o_s_new_vmmc_1049m=9381;*9384;  *slightly updated based on Isaac;
if cald = 2011  then o_s_new_vmmc_1049m=27973;*27971;*slightly updated based on Isaac;
if cald = 2012  then o_s_new_vmmc_1049m=29321;*29625;*slightly updated based on Isaac;
if cald = 2013  then o_s_new_vmmc_1049m=65679;*65613;*slightly updated based on Isaac;

*Source: HIVcalibrationData_Zimbabwe.xls sent by Isaac Taramusi in Sept 2021,;
if cald = 2014  then o_s_new_vmmc_1049m=110163;
if cald = 2015  then o_s_new_vmmc_1049m=133012;
if cald = 2016  then o_s_new_vmmc_1049m=136986;
if cald = 2017  then o_s_new_vmmc_1049m=159476;
if cald = 2018  then o_s_new_vmmc_1049m=197705;
if cald = 2019  then o_s_new_vmmc_1049m=207375;
if cald = 2020  then o_s_new_vmmc_1049m=53743;

*Source: "GLOBAL AIDS RESPONSE PROGRESS REPORT 2020"
https://www.unaids.org/sites/default/files/country/documents/ZWE_2020_countryreport.pdf (accessed 05/03/2021); 
*page 22;
*Note: the age range is not indicated so probably all ages;
if cald = 2013  then o_s_new_vmmc_all=112084;
if cald = 2014  then o_s_new_vmmc_all=209125;
if cald = 2015  then o_s_new_vmmc_all=188732;
if cald = 2016  then o_s_new_vmmc_all=205784;
if cald = 2017  then o_s_new_vmmc_all=301366;
if cald = 2018  then o_s_new_vmmc_all=326012;
if cald = 2019  then o_s_new_vmmc_all=354819;
