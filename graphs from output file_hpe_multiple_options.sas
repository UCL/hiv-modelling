...
series  x=cald y=p50_p_vl1000__1 / lineattrs = (color=pink thickness = 4);
band    x=cald lower=p5_p_vl1000__1 upper=p95_p_vl1000__1 / transparency=0.9 fillattrs = (color=pink) legendlabel= "90% range";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2000 to 2070 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0   to  0.1   by 0.005    ) valueattrs=(size=10);

series  x=cald y=p50_p_newp_ge1_age1549__0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_p_newp_ge1_age1549__0 upper=p95_p_newp_ge1_age1549__0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";
...
label p50_n_tested_0 = "continuation of current programs";
...
label p50_n_alive_0 = "continuation of current programs";
...
ods html;
proc sgplot data=d ; 
Title    height=1.5 justify=center "prevalence1549";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2000 to 2070 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0   to  0.4   by 0.05     ) valueattrs=(size=10);

label p50_prevalence1549__0 = "continuation of current programs";
...
label p50_prop_elig_on_prep_0 = "continuation of current programs";
...
series  x=cald y=p50_p_len_3 / lineattrs = (color=navy thickness = 4);
band    x=cald lower=p5_p_len_3 upper=p95_p_len_3 / transparency=0.9 fillattrs = (color=navy) legendlabel= "90% range";
...
series  x=cald y=p50_p_onart_3 / lineattrs = (color=navy thickness = 4);
band    x=cald lower=p5_p_onart_3 upper=p95_p_onart_3 / transparency=0.9 fillattrs = (color=navy) legendlabel= "90% range";
...
label p50_p_vl1000__3 = "len/cab";

series  x=cald y=p50_p_vl1000__0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_p_vl1000__0 upper=p95_p_vl1000__0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

series  x=cald y=p50_p_vl1000__3 / lineattrs = (color=navy thickness = 4);
band    x=cald lower=p5_p_vl1000__3 upper=p95_p_vl1000__3 / transparency=0.9 fillattrs = (color=navy) legendlabel= "90% range";
