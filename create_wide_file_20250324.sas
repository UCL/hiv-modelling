...
data a.base_24_03_2025; set b.out: ;
...
/*proc contents data=a.base_24_03_2025;run;							/* show the contents of the input SAS file */*/
proc freq data=a.base_24_03_2025; table run cald option; where cald=2030; run;
* 13 runs;
* Extra test options are 32 (mens clinics), 33 (FSW prog), 38-40 (ART support);


proc sort data=a.base_24_03_2025; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_24_03_2025 ;
*Zimbabwe;
...
proc sort data=a.base_24_03_2025; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_24_03_2025 sf;
by run ; run;
...
data a.l_base_24_03_2025; set y;
if cald=. then delete;run;
proc freq data=a.l_base_24_03_2025; table option; where cald=2030;run;
/*proc contents data=a.l_base_24_03_2025; run;*/



/*proc freq data=a.l_base_24_03_2025; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;*/
/*proc freq data=a.l_base_24_03_2025;*/
...
/*proc freq data=a.l_base_24_03_2025; table incidence1549; where option=1;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_diag_progsw; where option=0;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_inprog_ly; where option=0;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_inprog_ly; where option=1;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_inprog_ly; where option=8;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_inprog_ly; where option=33;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_program_visit; where option=0;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_program_visit; where option=1;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_sw_program_visit; where option=8;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_attend_mens_clinic; where option=0;run;*/
/*proc freq data=a.l_base_24_03_2025; table n_access_adult_ret_supp; where option=30;run;*/
