...
* THis is program used for final results;
...
data a.pwt_rev_y1r_b; 
merge pwt_rev_y1r_a   sf;
by run ;
...
proc sort data= a.pwt_rev_y1r_b out= a.pwt_rev_y1r_c ; by run option; run;

proc freq data=a.pwt_rev_y1r_c ; tables run; where cald = 2022; run;
...
data    a.l_pwt_rev_y1r     ; set a.pwt_rev_y1r_c;  
...
incidence1549m_22  incidence1549w_22
p_diag_m_22   p_diag_w_22
p_onart_diag_w_22 	p_onart_diag_m_22
p_onart_vl1000_w_22	p_onart_vl1000_m_22
