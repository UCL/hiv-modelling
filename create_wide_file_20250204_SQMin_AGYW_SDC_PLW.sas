...
libname a "C:\Users\rmjlja9\OneDrive - University College London\MIHPSA Zimbabwe\Phase 2\2025FEB04_SQMin_AGYW_SDC_PLW";								* dont save on Dropbox;
	*This is using last full run, there is also a Min-SQ run set available from Nov 28th;
libname b "C:\Users\rmjlja9\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_SQMin_AGYW_SDC_PLW_20250204_out";		* all options in one output;
...
data a.base_04_02_2025_SQMin_PrEP; set b.out: ;
...
proc contents data=a.base_04_02_2025_SQMin_PrEP;run;							/* show the contents of the input SAS file */
proc freq data=a.base_04_02_2025_SQMin_PrEP; table run cald option;run;
...
data a.base_04_02_2025_SQMin_PrEP;set a.base_04_02_2025_SQMin_PrEP;
...
proc freq data=a.base_04_02_2025_SQMin_PrEP; table run option;where cald=2023.75;run;
proc freq data=a.base_04_02_2025_SQMin_PrEP; table run*option/norow nocol nopercent; where cald=2023.75;run;
proc freq data=a.base_04_02_2025_SQMin_PrEP; table run cald option;run;
proc freq data=a.base_04_02_2025_SQMin_PrEP; table option*cald/norow nocol nopercent;run;
...
proc sort data=a.base_04_02_2025_SQMin_PrEP; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_04_02_2025_SQMin_PrEP ;
*Zimbabwe;
...
proc sort data=a.base_04_02_2025_SQMin_PrEP; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_04_02_2025_SQMin_PrEP sf;
by run ; run;
...
n_sw_1564 n_sw_1549 prev_sti_sw n_sw_inprog_ly  /*n_sw_inprog_ever*/ n_diag_sw_inprog
...
data a.l_base_04_02_2025_SQMin_PrEP; set y;
if cald=. then delete;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table option;run;
...
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP;
...
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table incidence1549; where option=1;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table n_diag_progsw; where option=0;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table n_sw_inprog_ly; where option=0;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table n_attend_mens_clinic; where option=0;run;
proc freq data=a.l_base_04_02_2025_SQMin_PrEP; table n_access_adult_ret_supp; where option=30;run;
