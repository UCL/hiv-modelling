...
keep run sf      incidence1549_2024 prevalence1549_2024;
...
* p_vlg1000_onart_allhiv;		p_vlg1000_onart_allhiv = s_onart_gt6m_vlg1000 /  (s_hivge15m + s_hivge15w) ;
...
* note o_dol_2nd_vlg1000 is if have 2nd vlg1000 in this period;
...
* 
s_uvl2_now_tld_only  s_uvl2_now_no_prev_vfail 

s_uvl2_now_prev_vfail 

s_uvl2_now_tld_only_dol_r  s_uvl2_now_no_prev_vfail_dol_r s_uvl2_now_prev_vfail_dol_r 
;
...
* n_onart_uvl2; 				n_onart_uvl2=  s_onart_uvl2 * sf    ;
...
* p_dol_start_nactive_p5_r;		p_dol_start_nactive_p5_r = s_o_dol_start_nactive_p5_r / s_o_dol_start_nactive_p5;
* p_dol_start_nactive_1p5_r;	p_dol_start_nactive_1p5_r = s_o_dol_start_nactive_1p5_r / s_o_dol_start_nactive_1p5;
* p_dol_start_nactive_2_r;		p_dol_start_nactive_2_r = s_o_dol_start_nactive_2_r / s_o_dol_start_nactive_2;
...
n_ontld  n_o_dol_r  n_onart_iicu_uvl2 n_onart_iicu_uvl21  n_onart_iicu_uvl22  n_onart_iicu_uvl23  n_onart_uvl2
...
n_started_prep_cab_hiv  n_started_prep_len_hiv n_started_prep_any_hiv   prop_prep_tot5yrs n_start_rest_prep_cab_hiv n_start_rest_prep_len_hiv 
n_prep_cab 
...
n_onart_iicu_uvl2           n_onart_iicu_uvl21           n_onart_iicu_uvl22            n_onart_iicu_uvl23   n_onart_uvl2
...
dcost_treatment_hiv_dis_50y_1 = dadc_cost_50y_1 + dnon_tb_who3_cost_50y_1 + dtb_cost_50y_1 + dcost_non_aids_pre_death_50y_1;
dcost_visplus_50y_1 = dvis_cost_50y_1 + d_t_adh_int_cost_50y_1 + dswitchline_cost_50y_1 ;
dcost_primary_prev_50y_1 = dcost_circ_50y_1 + dcost_condom_dn_50y_1 + dcost_prep_visit_50y_1 + dcost_prep_50y_1;

dcost_treatment_hiv_dis_50y_2 = dadc_cost_50y_2 + dnon_tb_who3_cost_50y_2 + dtb_cost_50y_2 + dcost_non_aids_pre_death_50y_2;
dcost_visplus_50y_2 = dvis_cost_50y_2 + d_t_adh_int_cost_50y_2 + dswitchline_cost_50y_2 ;
dcost_primary_prev_50y_2 = dcost_circ_50y_2 + dcost_condom_dn_50y_2 + dcost_prep_visit_50y_2 + dcost_prep_50y_2;

dcost_treatment_hiv_dis_50y_3 = dadc_cost_50y_3 + dnon_tb_who3_cost_50y_3 + dtb_cost_50y_3 + dcost_non_aids_pre_death_50y_3;
dcost_visplus_50y_3 = dvis_cost_50y_3 + d_t_adh_int_cost_50y_3 + dswitchline_cost_50y_3 ;
dcost_primary_prev_50y_3 = dcost_circ_50y_3 + dcost_condom_dn_50y_3 + dcost_prep_visit_50y_3 + dcost_prep_50y_3;
...
d_netdaly500_2_3 = netdaly500_2 - netdaly500_3;
...
n_res_test_dol_py_10y_2 n_res_test_p100k_dol_py_10y_2
...
prevalence1549_24_g3 = 0; if 10  <= prevalence1549_24 < 15 then prevalence1549_24_g3 = 1;
prevalence1549_24_g4 = 0; if 15  <= prevalence1549_24      then prevalence1549_24_g4 = 1;

incidence1549_24_g1 = 0; if 0 <= incidence1549_24 < 2  then incidence1549_24_g1 = 1;
incidence1549_24_g2 = 0; if 2 <= incidence1549_24 < 6  then incidence1549_24_g2 = 1;
incidence1549_24_g3 = 0; if 6   <= incidence1549_24      then incidence1549_24_g3 = 1;

p_diag_24_g1 = 0; if 0  <= p_diag_24 < 89  then p_diag_24_g1 = 1;
p_diag_24_g2 = 0; if 89 <= p_diag_24 < 93  then p_diag_24_g2 = 1;
p_diag_24_g3 = 0; if 93   <= p_diag_24      then p_diag_24_g3 = 1;

p_onart_diag_24_g1 = 0; if 0  <= p_onart_diag_24 < 92  then p_onart_diag_24_g1 = 1;
p_onart_diag_24_g2 = 0; if 92 <= p_onart_diag_24 < 96  then p_onart_diag_24_g2 = 1;
p_onart_diag_24_g3 = 0; if 96   <= p_onart_diag_24      then p_onart_diag_24_g3 = 1;

p_onart_vl1000_24_g1 = 0; if 0  <= p_onart_vl1000_24 < 92  then p_onart_vl1000_24_g1 = 1;
p_onart_vl1000_24_g2 = 0; if 92 <= p_onart_vl1000_24 < 96  then p_onart_vl1000_24_g2 = 1;
p_onart_vl1000_24_g3 = 0; if 96   <= p_onart_vl1000_24      then p_onart_vl1000_24_g3 = 1;

p_vl1000_24_g1 = 0; if 0  <= p_vl1000_24 < 74  then p_vl1000_24_g1 = 1;
p_vl1000_24_g2 = 0; if 74 <= p_vl1000_24 < 83  then p_vl1000_24_g2 = 1;
p_vl1000_24_g3 = 0; if 83   <= p_vl1000_24      then p_vl1000_24_g3 = 1;

prevalence_vg1000_24_g1 = 0; if 0  <= prevalence_vg1000_24 < 17  then prevalence_vg1000_24_g1 = 1;
prevalence_vg1000_24_g2 = 0; if 17 <= prevalence_vg1000_24 < 42  then prevalence_vg1000_24_g2 = 1;
prevalence_vg1000_24_g3 = 0; if 42   <= prevalence_vg1000_24      then prevalence_vg1000_24_g3 = 1;

prop_r_dol_ge_p5_uvl2_24_g1 = 0; if 0  <= prop_r_dol_ge_p5_uvl2_24 < 4  then prop_r_dol_ge_p5_uvl2_24_g1 = 1;
prop_r_dol_ge_p5_uvl2_24_g2 = 0; if 4 <= prop_r_dol_ge_p5_uvl2_24 < 13  then prop_r_dol_ge_p5_uvl2_24_g2 = 1;
prop_r_dol_ge_p5_uvl2_24_g3 = 0; if 13   <= prop_r_dol_ge_p5_uvl2_24      then prop_r_dol_ge_p5_uvl2_24_g3 = 1;

prop_tldsw_uvl2_24_g1 = 0; if 0  <= prop_tldsw_uvl2_24 < 1   then prop_tldsw_uvl2_24_g1 = 1;
...
proc logistic data=c; model x = prevalence1549_24 incidence1549_24 p_diag_24 p_onart_diag_24  p_onart_vl1000_24  p_vl1000_24  prevalence_vg1000_24 
prop_r_dol_ge_p5_uvl2_24  prop_tldsw_uvl2_24 ; 
run; 

proc logistic data=c; model x = prevalence1549_24  p_diag_24 p_onart_diag_24  p_onart_vl1000_24  p_vl1000_24  prevalence_vg1000_24 
prop_r_dol_ge_p5_uvl2_24  prop_tldsw_uvl2_24 ; 
run; 

proc logistic data=c; model x = incidence1549_24 p_diag_24 p_onart_diag_24  p_onart_vl1000_24  p_vl1000_24  prevalence_vg1000_24 
prop_r_dol_ge_p5_uvl2_24  prop_tldsw_uvl2_24 ; 
run; 
...
prevalence_vg1000_24_g2 
prevalence_vg1000_24_g3 
