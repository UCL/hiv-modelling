...
data d2;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\c_output_prep_2_7_20_6pm";
...
* data g.wide_vmmc_2_7_20_10am; 
  data f.wide_prep_2_7_20_6pm_copy;
...
*  set f.wide_core_18_6_20_6pm ;
   set f.wide_prep_2_7_20_6pm_copy; 
