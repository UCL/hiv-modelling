...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\dcp_cab\dcp_cab_a_out\";
...
proc means   data = a.w_dcp_cab  n p50 p5 p95 min max;  
