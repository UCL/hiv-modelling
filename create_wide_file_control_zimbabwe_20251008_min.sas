...
proc export data=a.outputs_&op_num
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_zimbabwe\hiv_control_zim_20251008_min_out\outputs_&op_num..csv" 
	dbms=csv replace; 
	putnames=no;
run;
