...
proc freq data=wide; tables icer_2_20yr   ; 
run;
...
p_mcirc_1549m_21 av_newp_ge1_non_sw_21 incidence1549_21 / stepwise
; 
run;
...
p_mcirc_1549m_21 av_newp_ge1_non_sw_21 prevalence_vg1000_21 / solution
; 
run;
...
proc glm; model d_ddaly_all_21_71_2 = p_mcirc_1549m_21  av_newp_ge1_non_sw_21 prevalence_vg1000_21   ; 
run;



proc glm; model d_dcost_21_71_2 = p_mcirc_1549m_21  av_newp_ge1_non_sw_21 prevalence_vg1000_21  ;
run;
...
proc means n mean median uclm lclm p5 p95 data=wide; var cost_per_infection_averted_21_26  ; 
run;
...
* where 0.02 <= prevalence_vg1000_21 < 1.05 ; 
