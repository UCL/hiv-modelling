...
if new_option=514 then option=1;
...
%let var = 
p_w_giv_birth_this_per mtct_prop			prevalence_hiv_preg			p_anc		p_pmtct		p_tested_anc
p_newp_ge1_		p_newp_ge5_
p_newp_ge1m_				p_newp_ge1w_		n_tested					test_prop_positive	av_newp_ge1_non_sw		
n_self_tested				n_tested_anc		p_tested_past_year_ov25m 	p_tested_past_year_ov25w	p_tested_agywfsw
p_tested_py_agyw
...
p_onprep_msm	p_elig_prep_any_msm_1564_				p_onart_msm			prevalence_vg1000_msm	p_tested_py_msm
p_diag_msm		p_onart_diag_msm	p_vl1000_art_gt6m_msm 					p_ever_tested_msm	p_tested_this_period_msm
p_msm_infected_from_msm				prop_m_msm			p_ep_msm			p_msm_ge1newp		p_tested_msm
p_m_ge1newp		n_pwid				p_av_newp_msm		p_msm_newp0_		p_onprep_pwid		p_onart_pwid		p_diag_pwid			prevalence_pwid
n_tested_msm	n_tested_pwid		p_tested_py_pwid	n_vm_per_year		/*p_tb*/
p_tested_past_year_1549m
;
...
p_diag_msm		p_onart_diag_msm	p_vl1000_art_gt6m_msm 					p_ever_tested_msm	p_tested_this_period_msm
p_msm_infected_from_msm				prop_m_msm			p_ep_msm			p_msm_ge1newp		p_tested_msm
p_m_ge1newp		p_av_newp_msm		p_msm_newp0_		n_pwid				p_onprep_pwid		p_onart_pwid		p_diag_pwid			prevalence_pwid
n_tested_msm	n_tested_pwid		p_tested_py_pwid	n_vm_per_year		/*p_tb*/
p_tested_past_year_1549m
;
...
g101  g102 g103 g104 g105 g106 g107 g108 g109 g110 g111 g112 g113 g114 g115 g116 g117 g118 g119 g120 g121 g122 g123 g124 
...
h101 h102 h103 h104 h105 h106 h107 h108 h109 h110 h111 h112 h113 h114 h115 h116 h117 h118 h119 h120 h121 h122 h123 h124 
h125 h126 h127 h128 h129/* h130
...
label mean_n_hiv_0 = "Model 0";
label mean_n_hiv_1 = "Model 1";
...
series  x=cald y=mean_n_hiv_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_pregnant_0 = "Model 0";
label mean_n_pregnant_1 = "Model 1";
...
series  x=cald y=mean_n_pregnant_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_tested_anc_0 = "Model 0";
label mean_n_tested_anc_1 = "Model 1";

label o_preg_UNAIDS = "UNAIDS";

series  x=cald y=mean_n_tested_anc_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_n_tested_anc_1/	lineattrs = (color=green thickness = 2);
...
proc sgplot data=d; 
Title    height=1.5 justify=center "p_tested_anc";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)   valueattrs=(size=10);

label mean_p_tested_anc_0 = "Model 0";
label mean_p_tested_anc_1 = "Model 1";

series  x=cald y=mean_p_tested_anc_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_anc_0 	upper=p95_p_tested_anc_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Option 0 90% range";

series  x=cald y=mean_p_tested_anc_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_anc_1 	upper=p95_p_tested_anc_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Option 0 90% range";
...
label mean_prevalence_hiv_preg_0 = "Option 0 (mean) ";
label mean_prevalence_hiv_preg_1= "Option 1 (mean) ";
...
series  x=cald y=mean_prevalence_hiv_preg_1/	lineattrs = (color=green thickness = 2);
...
label mean_mtct_prop_0 = "Option 0 (mean) ";
label mean_mtct_prop_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_mtct_prop_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_anc_0 = "Option 0 (mean) ";
label mean_p_anc_0 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_anc_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_newp_ge1__0 = "Option 0 (mean) ";
label mean_p_newp_ge1__0 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_newp_ge1__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_newp_ge1m__0 = "Option 0 newp >=1 amongst men";
label mean_p_newp_ge1m__1 = "Option 1 newp >=1 amongst men";
...
series  x=cald y=mean_p_newp_ge1m__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_newp_ge1m__0 = "Option 0 newp >=1 amongst women";
label mean_p_newp_ge1m__1 = "Option 1 newp >=1 amongst women";
...
series  x=cald y=mean_p_newp_ge1w__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_newp_ge5__0 = "Option 0 (mean) ";
label mean_p_newp_ge5__1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_newp_ge5__1/	lineattrs = (color=green thickness = 2);
...
label mean_av_newp_ge1_non_sw_0 = "Option 0 (mean) ";
label mean_av_newp_ge1_non_sw_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_av_newp_ge1_non_sw_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_tested_0 = "Option 0 (mean) ";
label mean_n_tested_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_tested_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_tested_past_year_1549m_0 = "Option 0 (mean) ";
label mean_p_tested_past_year_1549m_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_tested_past_year_1549m_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_past_year_1549m_1 	upper=p95_p_tested_past_year_1549m_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";

run;quit;


proc sgplot data=d; 
Title    height=1.5 justify=center "p_tested_past_year_ov25m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)   valueattrs=(size=10);

label mean_p_tested_past_year_ov25m_0 = "Option 0 (mean) ";
label mean_p_tested_past_year_ov25m_1 = "Option 1 (mean) ";

series  x=cald y=mean_p_tested_past_year_ov25m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_past_year_ov25m_0 	upper=p95_p_tested_past_year_ov25m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_p_tested_past_year_ov25m_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_past_year_ov25m_1 	upper=p95_p_tested_past_year_ov25m_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";

run;quit;

proc sgplot data=d; 
Title    height=1.5 justify=center "p_tested_past_year_ov25w";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  valueattrs=(size=10);

label mean_p_tested_past_year_ov25w_0 = "Option 0 (mean) ";
label mean_p_tested_past_year_ov25w_1 = "Option 1 (mean) ";

series  x=cald y=mean_p_tested_past_year_ov25w_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_past_year_ov25w_0 	upper=p95_p_tested_past_year_ov25w_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_p_tested_past_year_ov25w_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_past_year_ov25w_1 	upper=p95_p_tested_past_year_ov25w_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to  500000) valueattrs=(size=10);

label mean_self_tested_0 = "Option 0 (mean) ";
label mean_self_tested_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_self_tested_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_trad_circ_0 = "Option 0 Traditional";
label mean_p_trad_circ_1 = "Option 1 Traditional";
...
series  x=cald y=mean_p_trad_circ_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_p_trad_circ_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_sw_1549__0 = "Option 0 Current FSW 15-49";
label mean_n_sw_1549__1 = "Option 1 Current FSW 15-49";
label o_pop_fsw_UNAIDS= "Number of FSW 15-49 (UNAIDS)";

series  x=cald y=mean_n_sw_1549__0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_n_sw_1549__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_tested_sw_0 = "FSW tested Op 0 (mean) ";
label mean_p_tested_sw_1 = "FSW tested Op 1 (mean) ";

series  x=cald y=mean_p_tested_sw_0/	lineattrs = (color=black thickness = 2);
...
proc sgplot data=d; 
Title    height=1.5 justify=center "Of AGYW, proportion tested";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.2) valueattrs=(size=10);

label mean_p_tested_agywfsw_0 = "AGYW tested Op 0 (mean) ";
label mean_p_tested_agywfsw_1 = "AGYW tested Op 1 (mean) ";

series  x=cald y=mean_p_tested_agywfsw_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_agywfsw_0 	upper=p95_p_tested_agywfsw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_p_tested_agywfsw_1	/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_agywfsw_1 	upper=p95_p_tested_agywfsw_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
run;quit;

proc sgplot data=d; 
Title    height=1.5 justify=center "Of AGYW, proportion tested_py";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.2) valueattrs=(size=10);

label mean_p_tested_py_agyw_0 = "AGYW tested_py Op 0 (mean) ";
label mean_p_tested_py_agyw_1 = "AGYW tested_py Op 1 (mean) ";

series  x=cald y=mean_p_tested_py_agyw_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_py_agyw_0 	upper=p95_p_tested_py_agyw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_p_tested_py_agyw_1	/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_py_agyw_1 	upper=p95_p_tested_py_agyw_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
run;quit;
...
label mean_p_diag_sw_0 = "FSW diagnosed Op 0 (mean) ";
label mean_p_diag_sw_1 = "FSW diagnosed Op 1 (mean) ";

series  x=cald y=mean_p_diag_sw_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_diag_sw_0 	upper=p95_p_diag_sw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_p_diag_sw_1	/	lineattrs = (color=green thickness = 2);
...
label mean_prop_sw_hiv_0 = "FSW with HIV 15-64 Op 0 (mean) ";
label mean_prop_sw_hiv_1 = "FSW with HIV 15-64 Op 1 (mean) ";
...
series  x=cald y=mean_prop_sw_hiv_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_fsw_newp0__0 = "Option 0";
label mean_p_fsw_newp0__1 = "Option 1";
...
series  x=cald y=mean_p_fsw_newp0__1  / 	 lineattrs = (color=green thickness = 2);
...
label mean_p_sw_prog_vis_0 = "Option 0";
label mean_p_sw_prog_vis_1 = "Option 1";
...
series  x=cald y=mean_p_sw_prog_vis_1  / 	 lineattrs = (color=green thickness = 2);
...
series  x=cald y=mean_n_prep_oral_ever_sw_1/	lineattrs = (color=green thickness = 2);
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Percentage'	labelattrs=(size=12)  values = (0 to 2 by 0.2);
...
label mean_prop_w_1524_onprep_0 = "Model 0";
label mean_prop_w_1524_onprep_1 = "Model 1";
...
series  x=cald y=mean_prop_w_1524_onprep_1/	lineattrs = (color=green thickness = 2);
...
label mean_prop_1564_onprep_0 = "Option 0 (mean) ";
label mean_prop_1564_onprep_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_prop_1564_onprep_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_prep_ever_0 = "Option 0 (mean) ";
label mean_n_prep_ever_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_prep_ever_1/	lineattrs = (color=green thickness = 2);
...
label mean_prevalence1549m_0 = "Option 0";
label mean_prevalence1549m_1 = "Option 1";
...
series  x=cald y=mean_prevalence1549m_1/	lineattrs = (color=green thickness = 2);
...
label mean_prevalence1549w_0 = "Option 0";
label mean_prevalence1549w_1 = "Option 0";
...
series  x=cald y=mean_prevalence1549w_1/	lineattrs = (color=green thickness = 2);
...
label mean_incidence1549m_0 = "Option 0";
label mean_incidence1549m_1 = "Option 1";
...
series  x=cald y=mean_incidence1549m_1/	lineattrs = (color=green thickness = 2);
...
label mean_incidence1549w_0 = "Option 0 (mean) ";
label mean_incidence1549w_1 = "Option 1 (mean) ";
label o_Incid1549m_phia = "PHIA";
...
series  x=cald y=mean_incidence1549w_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_inf_vlsupp_0 = "Option 0";
label mean_p_inf_vlsupp_1 = "Option 1 ";
...
series  x=cald y=mean_p_inf_vlsupp_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_diag_m_0 = "Option 0";
label mean_p_diag_m_1 = "Option 1";
...
series  x=cald y=mean_p_diag_m_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_diag_w_0 = "Option 0";
label mean_p_diag_w_1 = "Option 1";
...
series  x=cald y=mean_p_diag_w_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_diag_m_0 = "Option 0";
label mean_p_onart_diag_m_1 = "Option 1";
...
series  x=cald y=mean_p_onart_diag_m_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_diag_w_0 = "Option 0";
label mean_p_onart_diag_w_1 = "Option 1";
...
series  x=cald y=mean_p_onart_diag_w_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_vl1000_m_0 = "Option 0";
label mean_p_onart_vl1000_m_1 = "Option 1";
...
series  x=cald y=mean_p_onart_vl1000_m_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_vl1000_w_0 = "Option 0";
label mean_p_onart_vl1000_w_1 = "Option 1";
...
series  x=cald y=mean_p_onart_vl1000_w_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_vl1000__0 = "Option 0 (mean) ";
label mean_p_vl1000__1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_vl1000__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_vg1000__0 = "Option 0 (mean) ";
label mean_p_vg1000__1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_vg1000__1/	lineattrs = (color=green thickness = 2);
...
label mean_n_vm_per_year_0 = "Option 0 (mean) ";
label mean_n_vm_per_year_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_vm_per_year_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_artexp_diag_0 = "Option 0";
label mean_p_artexp_diag_1 = "Option 1";
...
series  x=cald y=mean_p_artexp_diag_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_onart_0 = "Option 0";
label mean_n_onart_1 = "Option 1";
...
series  x=cald y=mean_n_onart_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_onart_m_0 = "Option 0";
label mean_n_onart_m_1 = "Option 1";
...
series  x=cald y=mean_n_onart_m_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_onart_w_0 = "Option 0 (mean) ";
label mean_n_onart_w_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_onart_w_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_dol_0 = "Option 0 (mean) ";
label mean_p_dol_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_dol_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_0 = "Option 0";
label mean_p_onart_1 = "Option 1";
...
series  x=cald y=mean_p_onart_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_m_0 = "Option 0";
label mean_p_onart_m_1 = "Option 1";
...
series  x=cald y=mean_p_onart_m_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_w_0 = "Option 0";
label mean_p_onart_w_1 = "Option 1";
...
series  x=cald y=mean_p_onart_w_1/	lineattrs = (color=green thickness = 2);
...
series  x=cald y=mean_n_death_hiv_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_alive1564_msm_0 = "Option 0 (mean) ";
label mean_n_alive1564_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_alive1564_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_prop_m_msm_0 = "Option 0 (mean) ";
label mean_prop_m_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_prop_m_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_incidence1564msm_0 = "Option 0";
label mean_incidence1564msm_1 = "Option 1";
...
series  x=cald y=mean_incidence1564msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_prevalence1549_msm_0 = "Option 0 (mean) ";
label mean_prevalence1549_msm_1= "Option 1 (mean) ";
...
series  x=cald y=mean_prevalence1549_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_msm_infected_from_msm_0 = "Option 0 (mean) ";
label mean_p_msm_infected_from_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_msm_infected_from_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onprep_msm_0 = "Option 0 (mean) ";
label mean_p_onprep_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onprep_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_elig_prep_any_msm_1564__0 = "Option 0 (mean) ";
label mean_p_elig_prep_any_msm_1564__1 = "Option 1 (mean) ";

series  x=cald y=mean_p_elig_prep_any_msm_1564__0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_p_elig_prep_any_msm_1564__1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_msm_0 = "Option 0 (mean) ";
label mean_p_onart_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onart_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_prevalence_vg1000_msm_0 = "Option 0 (mean) ";
label mean_prevalence_vg1000_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_prevalence_vg1000_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_tested_msm_0 = "Option 0 (mean) ";
label mean_n_tested_msm_1 = "Option 1 (mean) ";

series  x=cald y=mean_n_tested_msm_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_n_tested_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_ever_tested_msm_0 = "Option 0 (mean) ";
label mean_p_ever_tested_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_ever_tested_msm_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_ever_tested_msm_1 	upper=p95_p_ever_tested_msm_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
series  x=cald y=mean_p_tested_msm_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_msm_0 	upper=p95_p_tested_msm_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_tested_msm_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_msm_1 	upper=p95_p_tested_msm_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";

run;quit;

proc sgplot data=d; 
Title    height=1.5 justify=center "p_tested_py_msm";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  valueattrs=(size=10);

label mean_p_tested_py_msm_0 = "Option 0 (mean) ";
label mean_p_tested_py_msm_1 = "Option 1 (mean) ";

series  x=cald y=mean_p_tested_py_msm_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_py_msm_0 	upper=p95_p_tested_py_msm_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_tested_py_msm_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_py_msm_1 	upper=p95_p_tested_py_msm_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
label mean_p_tested_this_period_msm_0 = "Option 0 (mean) ";
label mean_p_tested_this_period_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_tested_this_period_msm_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_this_period_msm_1 	upper=p95_p_tested_this_period_msm_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
label mean_p_diag_msm_0 = "Option 0 (mean) ";
label mean_p_diag_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_diag_msm_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_diag_msm_0 = "Option 0 (mean) ";
label mean_p_onart_diag_msm_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onart_diag_msm_1/	lineattrs = (color=green thickness = 2);
...
proc sgplot data=d; 
Title    height=1.5 justify=center "p_msm_newp0_";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  valueattrs=(size=10);

label mean_p_msm_newp0__0 = "Option 0 (mean) ";
label mean_p_msm_newp0__1 = "Option 1 (mean) ";

series  x=cald y=mean_p_msm_newp0__0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_msm_newp0__0 	upper=p95_p_msm_newp0__0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_msm_newp0__1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_msm_newp0__1 	upper=p95_p_msm_newp0__1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";

run;quit;

proc sgplot data=d; 
Title    height=1.5 justify=center "p_av_newp_msm";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  valueattrs=(size=10);

label mean_p_av_newp_msm_0 = "Option 0 (mean) ";
label mean_p_av_newp_msm_1 = "Option 1 (mean) ";

series  x=cald y=mean_p_av_newp_msm_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_av_newp_msm_0 	upper=p95_p_av_newp_msm_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_av_newp_msm_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_av_newp_msm_1 	upper=p95_p_av_newp_msm_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
label mean_p_onart_sw_0 = "Option 0 (mean) ";
label mean_p_onart_sw_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onart_sw_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_pwid_0 = "Option 0 (mean) ";
label mean_n_pwid_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_n_pwid_1/	lineattrs = (color=green thickness = 2);
...
label mean_prevalence_pwid_0 = "Option 0 (mean) ";
label mean_prevalence_pwid_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_prevalence_pwid_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onart_pwid_0 = "Option 0 (mean) ";
label mean_p_onart_pwid_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onart_pwid_1/	lineattrs = (color=green thickness = 2);
...
label mean_p_onprep_pwid_0 = "Option 0 (mean) ";
label mean_p_onprep_pwid_1 = "Option 1 (mean) ";
...
series  x=cald y=mean_p_onprep_pwid_1/	lineattrs = (color=green thickness = 2);
...
label mean_n_tested_pwid_0 = "Option 0 (mean) ";
label mean_n_tested_pwid_1 = "Option 1 (mean) ";

series  x=cald y=mean_n_tested_pwid_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_tested_pwid_0 	upper=p95_n_tested_pwid_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_tested_pwid_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_n_tested_pwid_1 	upper=p95_n_tested_pwid_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";

run;quit;

proc sgplot data=d; 
Title    height=1.5 justify=center "p_tested_py_pwid";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1980 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 10000) valueattrs=(size=10);

label mean_p_tested_py_pwid_0 = "Option 0 (mean) ";
label mean_p_tested_py_pwid_1 = "Option 1 (mean) ";

series  x=cald y=mean_p_tested_py_pwid_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tested_py_pwid_0 	upper=p95_p_tested_py_pwid_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_tested_py_pwid_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_p_tested_py_pwid_1 	upper=p95_p_tested_py_pwid_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
series  x=cald y=mean_p_diag_pwid_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_p_diag_pwid_1/	lineattrs = (color=green thickness = 2);
...
series  x=cald y=mean_p_tb_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_tb_0 	upper=p95_p_tb_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_tb_1/	lineattrs = (color=green thickness = 2);
