...
who may be dead and hence have caldate{t} missing;
	...
	if option = 1 then do;
		...
		decr_r_choose_stop_prep_2020 = 1; eff_rate_choose_stop_prep = 0.03 ; 
		inc_p_prep_restart_choi_2020 = 1; eff_prob_prep_restart_choice = 0.8 ;
		incr_adh_pattern_prep_2020 = 1; adhav_pr = adhav*1.00;
		incr_prepuptake_pop_2020 = 1; if _u37 < 0.95 and prep_willing_pop = 0 then prep_willing_pop = 1;
