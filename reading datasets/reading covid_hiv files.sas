...
* 
3mths:  c_output_covid_hiv_16_4_20_11am  contains results for 3 month disruptions
6mths_a: c_output_covid_hiv_6m_22_4_20_8am  contains results for 6 month disruptions, except art interruption is 3 months
6mths_b: c_output_covid_hiv_6m_24_4_20_5pm  contains results for 6 month disruptions
6mths_c:  c_output_covid_hiv_6m_5_5_20_2pm  c_output_covid_hiv_6m_8_5_20_5pm  c_output_covid_hiv_6m_10_5_20_1pm  contains results for 6 month disruptions
...
* data a.covid_hiv_3mths; 
* data a.covid_hiv_6mths_a;
* data a.covid_hiv_6mths_b;
* data a.covid_hiv_6mths_c;
...
proc print; var run cald option  s_onart s_primary ; where cald ge 2020.25; where no_art_disrup_covid = 1; run;

proc means; var  p_vl1000 s_primary  ; where 2020.25 <= cald < 2021.25 and no_art_disrup_covid = 0 ; run;
proc means; var  p_vl1000 s_primary  ; where 2020.25 <= cald < 2021.25 and no_art_disrup_covid = 1 ; run;

proc print; var run cald option no_art_disrup_covid ; where cald ge 2020; run;

percent_death_per1_art_int = s_dead_per1_art_int / s_per1_art_int ;
percent_death_per2_art_int = s_dead_per2_art_int / s_per2_art_int ;

proc print; var cald option no_art_disrup_covid p_vl1000
s_per1_art_int s_per2_art_int	s_dead_per1_art_int	percent_death_per1_art_int s_dead_per2_art_int  s_cd4_before_int	s_cd4_before_int_lt100   	s_cd4_before_int_100200 
s_cd4_per1_art_int 	s_cd4_per1_art_int_lt100	s_cd4_per1_art_int_100200 s_cd4_per2_art_int 	s_cd4_per2_art_int_lt100	s_cd4_per2_art_int_100200
; 
where 2020 <= cald < 2021.5;
run;

proc means; var cald option percent_death_per1_art_int; where option = 1 and no_art_disrup_covid = 1 and cald=2020.25; run;
proc means; var cald option percent_death_per2_art_int; where option = 1 and no_art_disrup_covid = 1 and cald=2020.50; run;
