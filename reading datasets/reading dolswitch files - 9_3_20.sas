...
data d1;  
  ...
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\c_output_dolswitch_27_2_20_7am_temp";
...
data a.dolswitch; set d1 ;


proc print; var run cald reg_option; run;
