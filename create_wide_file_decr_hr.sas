...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\decr_hr\decr_hr_out\";
...
data k_decr_hr; set a.k_decr_hr;

proc sort data=k_decr_hr; 
by run cald option;
run;
