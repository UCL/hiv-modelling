...
* proc contents data=a.hiv_synthesis_base_old;
*	title "Compressed SAS Input Data"
* run;

proc contents data=a.hiv_synthesis_base; run;

proc freq data=a.hiv_synthesis_base; tables run; run;
...
* incidence_sw;   				if (s_sw_1564  - s_hiv_sw  + s_primary_sw) gt 0 then 
								incidence_sw=(s_primary_sw * 4 * 100) / (s_sw_1564  - s_hiv_sw  + s_primary_sw);

* av_newp_sw;					if s_sw_1564 > 0 then av_newp_sw = s_newp_sw / s_sw_1564;
...
art_mon_drug_levels_2020       ten_is_taf_2020    lower_future_art_cov  eff_adh_prep  sens_vct_test_type_3  
...
%var(v=s_sw_newp);  %var(v=incidence_sw); %var(v=av_newp_sw);
...
n_mcirc1549_  n_mcirc1549_3m  n_vmmc1549_  n_vmmc1549_3m  n_new_inf1549m  n_new_inf1549
s_sw_newp incidence_sw av_newp_sw
;
...
%par_ai1(p=prob_return_adc );  %par_ai1(p=prob_lossdiag_adctb );  %par_ai1(p=higher_newp_less_engagement ); 
...
prob_return_adc_ai1 prob_lossdiag_adctb_ai1  higher_newp_less_engagement_ai1 
...
incidence1549w_21  incidence1549m_21  incidence_sw_21 av_newp_sw_21  prop_sw_newp0_21
p_diag_21 	p_diag_m_21   p_diag_w_21	p_ai_no_arv_c_nnm_21   
prop_w_1549_sw_21  mtct_prop_21  prop_1564_onprep_21  p_inf_newp_21
...
m15r_21 m25r_21 m35r_21 m45r_21 m55r_21 w15r_21 w25r_21 w35r_21 w45r_21 w55r_21 prevalence_vg1000_21 ;
*  where prevalence_vg1000_21 < 0.04;
*  where  sw_trans_matrix in ( 4 5 );
run;
ods html close;

proc glm; 
class  sex_beh_trans_matrix_m sex_beh_trans_matrix_w sex_age_mixing_matrix_m sex_age_mixing_matrix_w p_rred_p
p_hsb_p sw_trans_matrix ;
model incidence_sw_21 = 
 sw_trans_matrix / solution ;
* where  sw_trans_matrix in (1 2 4 5 ) ;
run;


proc sort; by sw_trans_matrix;
proc means ; var incidence_sw_21 av_newp_sw_21  prop_sw_hiv_21 p_newp_sw_21 prop_sw_newp0_21; by sw_trans_matrix;
run;
