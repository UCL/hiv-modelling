...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\south_africa\sa6_out\";


  data a.sa6;    set b.out: ;
...
proc freq  data = a.w_base_sa6 ; tables run; run; 

data e; set a.w_base_sa6; 
...
proc means data=a.w_base_sa6 n p50 p5 p95 mean;
var 
...
data a.l_base_keep_sa6; merge a.l_base_sa6 q1 ; by run;

if run_keep ne .;

ods html;
proc print noobs data = a.l_base_keep_sa6; var run;
where cald = 2021;
run;
ods html close;
...
proc glm data=a.l_base_sa6; model n_death_2059_m = gx fx  ; run;   


proc freq data=a.l_base_sa6; tables run; where cald = 2021; run;
...
proc glm data=a.w_base_sa6; class gx fx ;
