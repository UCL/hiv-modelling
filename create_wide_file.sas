...
%var(v=n_death_hivpos_anycause); %var(v=p_age1549_hivneg );  %var(v=p_age1549_hiv ); %var(v=p_onart_m_age50pl ); %var(v=p_onart_w_age50pl ); 
%var(v=n_onart);
