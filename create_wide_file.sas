...
* This is a template to use to build a "create_wide_file" program for your project that reads in the data set created in "create_derived_variables"
* unlike "create_derived)vvariables", we will leave this program as it is and not try to make it a common program that is consistent for all projects
