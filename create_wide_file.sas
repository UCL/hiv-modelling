...
dcost = dart_cost_y + dadc_cost + dcd4_cost + dvl_cost + dvis_cost + dnon_tb_who3_cost + dcot_cost + dtb_cost + dres_cost +
		...
		dcost_prep + dcost_prep_visit + dcost_prep_ac_adh +
		dcost_sw_program +
		dhtn_cost_total;
...
s_hiv_ge18m = s_hiv1819m + s_hiv2024m + s_hiv2529m + s_hiv3034m + s_hiv3539m + s_hiv4044m + s_hiv4549m + s_hiv5054m + s_hiv5559m + s_hiv6064m + s_hiv65plm ;
s_hiv_ge18w = s_hiv1819w + s_hiv2024w + s_hiv2529w + s_hiv3034w + s_hiv3539w + s_hiv4044w + s_hiv4549w + s_hiv5054w + s_hiv5559w + s_hiv6064w + s_hiv65plw ;
s_hiv_ge18 = s_hiv_ge18m + s_hiv_ge18w ;
...
* p_vg1000, p_vl1000;			if s_hiv1549  > 0 then p_vg1000 = s_vg1000_1549 / s_hiv1549 ;  p_vl1000 = 1- p_vg1000 ;
* prevalence_vg1000;			if (s_alive1549_w + s_alive1549_m) > 0 then prevalence_vg1000 = s_vg1000_1549 / (s_alive1549_w + s_alive1549_m);
...
popge40 = s_ageg4044m + s_ageg4044w + pop4554 + pop5564 + pop6574 + pop7584 + popge85 ;
...
* p_on_tx_htn_ge18 ;		p_on_tx_htn_ge18 = s_on_tx_htn_ge18 / s_htn_true_ge18 ;
* p_on_tx_htn_2534 ;		p_on_tx_htn_2534 = s_on_tx_htn_2534 / s_htn_true_2534 ;
* p_on_tx_htn_3544 ;		p_on_tx_htn_3544 = s_on_tx_htn_3544 / s_htn_true_3544 ;
* p_on_tx_htn_4554 ;		p_on_tx_htn_4554 = s_on_tx_htn_4554 / s_htn_true_4554 ;
* p_on_tx_htn_5564 ;		p_on_tx_htn_5564 = s_on_tx_htn_5564 / s_htn_true_5564 ;
* p_on_tx_htn_2544 ;		p_on_tx_htn_2544 = (s_on_tx_htn_2534 + s_on_tx_htn_3544) / (s_htn_true_2534 + s_htn_true_3544) ;
* p_on_tx_htn_4564 ;		p_on_tx_htn_4564 = (s_on_tx_htn_4554 + s_on_tx_htn_5564) / (s_htn_true_4554 + s_htn_true_5564) ;
* p_on_tx_htn_ge65 ;		p_on_tx_htn_ge65 = s_on_tx_htn_ge65 / s_htn_true_ge65 ;

* p_ever_tx_htn_ge18 ;		p_ever_tx_htn_ge18 = s_ever_tx_htn_ge18 / s_htn_true_ge18 ;
* p_ever_tx_htn_2544 ;		p_ever_tx_htn_2544 = (s_ever_tx_htn_2534 + s_ever_tx_htn_3544) / (s_htn_true_2534 + s_htn_true_3544) ;
* p_ever_tx_htn_4564 ;		p_ever_tx_htn_4564 = (s_ever_tx_htn_4554 + s_ever_tx_htn_5564) / (s_htn_true_4554 + s_htn_true_5564) ;
* p_ever_tx_htn_ge65 ;		p_ever_tx_htn_ge65 = s_ever_tx_htn_ge65 / s_htn_true_ge65 ;
...
* p_on_tx_htn_over_ge18 ;		p_on_tx_htn_over_ge18 = s_on_tx_htn_over_ge18 / s_normotensive_ge18 ;
* p_on_tx_htn_over_2544 ;		p_on_tx_htn_over_2544 = (s_on_tx_htn_over_2534 + s_on_tx_htn_over_3544) / (s_normotensive_2534 + s_normotensive_3544) ;
* p_on_tx_htn_over_4564 ;		p_on_tx_htn_over_4564 = (s_on_tx_htn_over_4554 + s_on_tx_htn_over_5564) / (s_normotensive_4554 + s_normotensive_5564) ;
* p_on_tx_htn_over_ge65 ;		p_on_tx_htn_over_ge65 = s_on_tx_htn_over_ge65 / s_normotensive_ge65 ;

* p_ever_tx_htn_over_ge18 ;		p_ever_tx_htn_over_ge18 = s_ever_tx_htn_over_ge18 / s_normotensive_ge18 ;
* p_ever_tx_htn_over_2544 ;		p_ever_tx_htn_over_2544 = (s_ever_tx_htn_over_2534 + s_ever_tx_htn_over_3544) / (s_normotensive_2534 + s_normotensive_3544) ;
* p_ever_tx_htn_over_4564 ;		p_ever_tx_htn_over_4564 = (s_ever_tx_htn_over_4554 + s_ever_tx_htn_over_5564) / (s_normotensive_4554 + s_normotensive_5564) ;
* p_ever_tx_htn_over_ge65 ;		p_ever_tx_htn_over_ge65 = s_ever_tx_htn_over_ge65 / s_normotensive_ge65 ;
...
* p_on_tx_htn160_ge18 ;	p_on_tx_htn160_ge18 = s_on_tx_htn160_ge18 / s_htn_true160_ge18 ;
* p_on_tx_htn160_2544 ;	p_on_tx_htn160_2544 = (s_on_tx_htn160_2534 + s_on_tx_htn160_3544) / (s_htn_true160_2534 + s_htn_true160_3544) ;
* p_on_tx_htn160_4564 ;	p_on_tx_htn160_4564 = (s_on_tx_htn160_4554 + s_on_tx_htn160_5564) / (s_htn_true160_4554 + s_htn_true160_5564) ;
* p_on_tx_htn160_ge65 ;	p_on_tx_htn160_ge65 = s_on_tx_htn160_ge65 / s_htn_true160_ge65 ;
...
rate_ihd_modsev_2544 =  (s_ihd_inc_all_modsev_2544 * 4 * 100) / (s_ageg2529w + s_ageg2529m + s_ageg3034w + s_ageg3034m + s_ageg3539w + s_ageg3539m + s_ageg4044w + s_ageg4044m) ;
rate_ihd_modsev_4564 =  (s_ihd_inc_all_modsev_4564 * 4 * 100) / (s_ageg4549m + s_ageg5054m + s_ageg5559m + s_ageg6064m + s_ageg4549w + s_ageg5054w + s_ageg5559w + s_ageg6064w) ;
rate_ihd_modsev_ge65 =  (s_ihd_inc_all_modsev_ge65 * 4 * 100) / (s_ageg6569m + s_ageg7074m + s_ageg7579m + s_ageg8084m + s_ageg85plm + s_ageg6569w + s_ageg7074w + s_ageg7579w + s_ageg8084w + s_ageg85plw) ;
...
rate_cva_modsev_2544 =  (s_cva_inc_all_modsev_2544 * 4 * 100) / (s_ageg2529w + s_ageg2529m + s_ageg3034w + s_ageg3034m + s_ageg3539w + s_ageg3539m + s_ageg4044w + s_ageg4044m) ;
rate_cva_modsev_4564 =  (s_cva_inc_all_modsev_4564 * 4 * 100) / (s_ageg4549m + s_ageg5054m + s_ageg5559m + s_ageg6064m + s_ageg4549w + s_ageg5054w + s_ageg5559w + s_ageg6064w) ;
rate_cva_modsev_ge65 =  (s_cva_inc_all_modsev_ge65 * 4 * 100) / (s_ageg6569m + s_ageg7074m + s_ageg7579m + s_ageg8084m + s_ageg85plm + s_ageg6569w + s_ageg7074w + s_ageg7579w + s_ageg8084w + s_ageg85plw) ;
...
* CVD and all cause deaths (n and rate) ;
			...
			* HIV positive;
			...
			rate_dead_hivpos_ac = (s_dead_hivpos_anycause * 4 * 100) / s_hivge15 ; */
			rate_dead_hivpos_cvd_ge18 = (s_dead_hivpos_cvd_ge18 * 4 * 100) / s_hiv_ge18 ;
			rate_dead_hivpos_ac_ge18 = (s_dead_hivpos_anycause_ge18 * 4 * 100) / s_hiv_ge18 ;
			
			* HIV negative;
			/*rate_dead_hivneg_cvd = (s_dead_hivneg_cvd * 4 * 100) / (s_alive - s_hivge15) ;
			rate_dead_hivneg_ac = (s_dead_hivneg_anycause * 4 * 100) / (s_alive - s_hivge15) ;*/
			rate_dead_hivneg_cvd_ge18 = (s_dead_hivneg_cvd_ge18 * 4 * 100) / (popge18 - s_hiv_ge18) ;
			rate_dead_hivneg_ac_ge18 = (s_dead_hivneg_anycause_ge18 * 4 * 100) / (popge18 - s_hiv_ge18) ;
			...
			* All (HIV+ and HIV-);
			...
			rate_dead_all_anycause = ((s_dead_hivneg_anycause + s_dead_hivpos_anycause) * 4 * 100) / (s_alive) ;
				...
				* age-specific;
				...
				rate_dead_cvd_2544 =  (s_dead_cvd_2544 * 4 * 100) / (s_ageg2529w + s_ageg2529m + s_ageg3034w + s_ageg3034m + s_ageg3539w + s_ageg3539m + s_ageg4044w + s_ageg4044m) ;
				rate_dead_cvd_4564 =  (s_dead_cvd_4564 * 4 * 100) / (s_ageg4549m + s_ageg5054m + s_ageg5559m + s_ageg6064m + s_ageg4549w + s_ageg5054w + s_ageg5559w + s_ageg6064w) ;
				rate_dead_cvd_ge65 =  (s_dead_cvd_ge65 * 4 * 100) / (s_ageg6569m + s_ageg7074m + s_ageg7579m + s_ageg8084m + s_ageg85plm + s_ageg6569w + s_ageg7074w + s_ageg7579w + s_ageg8084w + s_ageg85plw) ;
...
p_on_tx_htn_ge18 p_on_tx_htn_2534 p_on_tx_htn_3544 p_on_tx_htn_4554 p_on_tx_htn_5564 p_on_tx_htn_ge65
...
p_on_tx_htn_2544 p_on_tx_htn_4564 
p_ever_tx_htn_ge18 p_ever_tx_htn_2544 p_ever_tx_htn_4564 p_ever_tx_htn_ge65 
p_hypert_control_2544 p_hypert_control_4564

p_on_tx_htn_over_ge18 p_on_tx_htn_over_2544 p_on_tx_htn_over_4564 p_on_tx_htn_over_ge65
p_ever_tx_htn_over_ge18 p_ever_tx_htn_over_2544 p_ever_tx_htn_over_4564 p_ever_tx_htn_over_ge65
...
rate_ihd_modsev_2544 
rate_ihd_modsev_4564 
rate_ihd_modsev_ge65
...
rate_cva_modsev_2544 
rate_cva_modsev_4564 
rate_cva_modsev_ge65 
...
rate_dead_hivpos_cvd_ge18 rate_dead_hivpos_ac_ge18
rate_dead_hivneg_cvd_ge18 rate_dead_hivneg_ac_ge18 
n_dead_cvd rate_dead_cvd
n_dead_all_anycause rate_dead_all_anycause 
n_dead_ac_ge18 rate_dead_ac_ge18
...
%var(v=p_on_tx_htn_ge18); %var(v=p_on_tx_htn_2534); %var(v=p_on_tx_htn_3544); %var(v=p_on_tx_htn_4554); %var(v=p_on_tx_htn_5564); %var(v=p_on_tx_htn_ge65); 
...
%var(v=p_on_tx_htn_2544); %var(v=p_on_tx_htn_4564); 
%var(v=p_ever_tx_htn_ge18); %var(v=p_ever_tx_htn_2544); %var(v=p_ever_tx_htn_4564); %var(v=p_ever_tx_htn_ge65);
...
%var(v=p_on_tx_htn_over_ge18); %var(v=p_on_tx_htn_over_2544); %var(v=p_on_tx_htn_over_4564); %var(v=p_on_tx_htn_over_ge65);
%var(v=p_ever_tx_htn_over_ge18); %var(v=p_ever_tx_htn_over_2544); %var(v=p_ever_tx_htn_over_4564); %var(v=p_ever_tx_htn_over_ge65);	
...
%var(v=rate_ihd_modsev_ge18);  %var(v=rate_ihd_modsev_2544); %var(v=rate_ihd_modsev_4564); %var(v=rate_ihd_modsev_ge65); 
...
%var(v=rate_cva_modsev_ge18); %var(v=rate_cva_modsev_2544); %var(v=rate_cva_modsev_4564); %var(v=rate_cva_modsev_ge65); 
...
%var(v=rate_dead_hivneg_cvd_ge18); %var(v=rate_dead_hivneg_ac_ge18);
%var(v=n_dead_cvd); %var(v=rate_dead_cvd); %var(v=n_dead_all_anycause); %var(v=rate_dead_all_anycause);
%var(v=n_dead_cvd_ge18); %var(v=n_dead_ac_ge18); %var(v=rate_dead_ac_ge18);
