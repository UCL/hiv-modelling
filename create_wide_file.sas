...
* n_tested1st_anc;				*n_tested1st_anc = s_tested1st_anc * &sf * 4;
* n_tested1st_labdel;			*n_tested1st_labdel = s_tested1st_labdel * &sf * 4;
* n_tested1st_pd;				*n_tested1st_pd = s_tested1st_pd * &sf * 4;
...
* n_pcp_p_80;					n_pcp_p_80_ = s_pcp_p_80 *&sf;
...
s_alive n_birth n_give_birth_w_hiv p_w_giv_birth_this_per p_newp_ge1 p_1524_newp_ge1 p_newp_ge5 p_newp_ge1_age1549 gender_r_newp  av_newp_ge1  av_newp_ge1_non_sw
p_newp_sw  n_tested_m  n_tested_w p_tested_past_year_1549m  p_tested_past_year_1549w n_pmtct
p_diag_m1524 p_diag_w1524 p_diag_sw n_cm n_vm /*p_vm_ly_onart*/ n_pcp_p_80_ p_onart_cd4_l200
...
%var(v=n_birth); %var(v=n_give_birth_w_hiv); %var(v=p_w_giv_birth_this_per); %var(v=p_newp_ge1); %var(v=p_newp_ge5);   %var(v=gender_r_newp); 
...
%var(v=mtct_prop); %var(v=p_diag); %var(v=p_diag_m); %var(v=p_diag_w); %var(v=p_diag_sw);%var(v=n_cm);%var(v=n_vm);/*%var(v=p_vm_ly_onart);*/%var(v=n_pcp_p_80_);
...
n_not_on_art_cd4050 n_not_on_art_cd450200 n_not_on_art_cd4200350 n_not_on_art_cd4350500 n_not_on_art_cd4ge500
n_asympt_Undiag n_asympt_diagoffart n_asympt_diagonart n_sympt_notaids n_sympt_aids
n_birth n_give_birth_w_hiv p_w_giv_birth_this_per  p_newp_ge1 p_newp_ge5  gender_r_newp
...
mtct_prop  p_diag  p_diag_m  p_diag_w  p_diag_sw p_diag_m1524  p_diag_w1524 n_cm n_vm /*p_vm_ly_onart*/ n_pcp_p_80_
...
p_onart_m_age50pl p_onart_w_age50pl  n_onart
prevalence_hiv_preg prevalence1549preg prevalence1524preg n_onart_w n_onart_m n_onart_1524_ n_art_start_y p_diag_w p_diag_m p_onart_vl1000 n_new_inf1549m n_new_inf1549w /*n_death_hiv_m 
