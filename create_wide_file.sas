...
libname b "C:\Users\Valentina\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_v15_uptoend2042_2023Aug09_out";

data a.base_09_08_2023;   set b.out:;
...
proc freq data=a.base_09_08_2023; table run;run;
proc freq data=a.base_09_08_2023; table cald;run;*116 simulations;
ods html close;
ods listing;
/*
...
data a.l_base_09_08_2023; set y;  run;
