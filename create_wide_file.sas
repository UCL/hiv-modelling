...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\south_africa\sa3_out\";


  data a.sa3;    set b.out: ;
...
proc means data=a.w_base_sa3 n p50 p5 p95 mean;
var 
...
data a.l_base_keep_sa3; merge a.l_base_sa3 q1 ; by run;
...
proc glm data=a.l_base_sa3; model n_death_2059_m = gx fx  ; run;   


proc freq data=a.l_base_sa3; tables run; where cald = 2021; run;
...
proc glm data=a.w_base_sa3; class gx fx ;
