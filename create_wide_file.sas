...
* libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\south_africa\";


  data a.sa_prep40_aug24;    set a.out: ;


data g; set  a.sa_prep40_aug24 ;
...
sf_2021 = (58500000 * 0.706) / s_alive;  * statistica 70.6% of sa population in 2019 >= age 15 (https://www.statista.com/statistics/1116077/total-population-of-south-africa-by-age-group/);
keep run sf_2021;
proc sort; by run;
...
* n_prep_w ;					n_prep_w = s_onprep_w * &sf;
...
prop_sw_hiv prop_w_1524_onprep prop_1564_hivneg_onprep prop_sw_onprep p_prep_adhg80  n_prep_w
...
data a.l_base_sa_prep40_aug24; set y;  
...
data y; set a.l_base_sa_prep40_aug24; 
...
proc means  noprint data=y; var &v; output out=y_89 mean= &v._89; by run ; where 1989.0 <= cald < 1989.5; 
...
data &v ; merge y_89 y_90 y_95 y_00 y_05 y_10 y_15 y_17 y_20 y_21 y_40 y_70 t_21_26 t_21_22 t_21_71 ;  
...
%par(p= incr_mort_risk_dol_weightg ); %par(p=prep_strategy ); %par(p=rred_initial);
...
* To get one row per run;
  ...
  data a.w_base_sa_prep40_aug24; 
* merge   wide_outputs  wide_par wide_par_after_int_option0  wide_par_after_int_option1  ; * this if you have parameter values changing after
  baseline that you need to track the values of;
  merge   wide_outputs  wide_par ;  
  by run;

proc freq  data = a.w_base_sa_prep40_aug24 ; tables run; run; 

data e; set a.w_base_sa_prep40_aug24; 
...
proc means data=a.w_base_sa_prep40_aug24 n p50 p5 p95 mean;
var 
...
proc freq data=a.w_base_sa_prep40_aug24;
tables run; 
run;
...
n_death_2059_w_05 n_death_hivrel_05 n_hiv_05
;
run;
...
n_onart_21 n_death_hivpos_anycause_21  n_death_2059_m_21 n_death_2059_w_21 n_hiv_21 p_ep_21
;
run;
...
r_prev_6064m_4549w_40 r_prev_65plm_4549w_40 p_age1549_hivneg_40 p_age1549_hiv_40  n_hiv_40
;
run;
...
data q1; set a.w_base_sa_prep40_aug24;
...
data a.l_base_keep_sa_prep40_aug24; merge a.l_base_sa_prep40_aug24 q1 ; by run;

if run_keep ne .;

ods html;
proc print noobs data = a.l_base_keep_sa_prep40_aug24; var run;
where cald = 2021;
run;
ods html close;
...
data s; set a.w_base_sa_prep40_aug24;
...
proc glm data=a.l_base_sa_prep40_aug24; model n_death_2059_m = gx fx  ; run;   


proc freq data=a.l_base_sa_prep40_aug24; tables run; where cald = 2021; run;
...
proc glm data = a.w_base_sa_prep40_aug24; 
...
proc sort data = e; by rred_initial;
proc means data = e; var p_newp_ge1_89 ratio_p_newp_ge1_9000; 
by rred_initial  ; 
run;

proc sort data = e; by newp_factor;
proc means data = e; var p_newp_ge1_89 ratio_p_newp_ge1_9000; 
by newp_factor ; 
run;
...
proc glm data=a.w_base_sa_prep40_aug24; class gx fx ;
