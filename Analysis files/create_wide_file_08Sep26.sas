...
n_tested_as_sw		 n_tested_sw_sympt	  n_tested_sw_anc		p_tested_sw_sympt	 p_tested_sw_anc	p_tested_sw_anclabpd
...
n_tested_as_esw		 n_tested_esw_sympt	   n_tested_esw_anc			p_tested_esw_sympt	 p_tested_esw_anc	p_tested_esw_anclabpd
...
data a.pace_08_09_26_short; set y;run;

data y; set a.pace_08_09_26_short;run;
...
%var(v=n_tested_as_sw);	%var(v=n_tested_sw_sympt);	%var(v=n_tested_sw_anc);	%var(v=p_tested_sw_sympt);	
%var(v=p_tested_sw_anc);%var(v=p_tested_sw_anclabpd);
...
%var(v=n_tested_as_esw);%var(v=n_tested_esw_sympt);	%var(v=n_tested_esw_anc);		%var(v=p_tested_esw_sympt);
%var(v=p_tested_esw_anc);%var(v=p_tested_esw_anclabpd);
