...
*** 20260205 version has options 0-9 and 99, using weaker condom change intervention parameters and removing self-testing in the minimal (option 0);
* Building up package of interventions in order of decreasing cost-effectivesness (based on ICER);

libname a "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260205_out\";
...
ods rtf file = 'C:\Users\rmjlja9\Documents\GitHub\hiv-modelling\Malawi\graphs_20260205.doc' startpage=never;
...
label mean_incidence1549__5 = " + msm-program";
label mean_incidence1549__6 = " + fsw-program";
...
proc export data=icer_sums
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260205_out\icer_sums.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
...
proc export data=icer_sums_2049
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260205_out\icer_sums_2049.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
