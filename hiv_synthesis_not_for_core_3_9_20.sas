...
* adh_pattern; r=uniform(0);  
				if 0.00 <= r < 0.03 then adh_pattern=100 ; if 0.03 <= r < 0.60 then adh_pattern=1;   if 0.60 <= r < 0.70 then adh_pattern=2;   
...
* AP 19-7-19 ;
* rate_return;  r=uniform(0); if  r < 0.25 then rate_return = 0.02; 
