...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\lapr\lapr20_out\";
...
* p_prep_init_primary_res;		p_prep_init_primary_res = prep_init_primary_res / prep_init_primary;
