...
ods rtf file = 'C:\Users\rmjlja9\OneDrive - University College London\MIHPSA Zimbabwe\Phase 2\2025FEB05\graphs_20250205.doc' startpage=never;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&year_start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  /*values = (0 to 2e5 by 2e4)*/ valueattrs=(size=10);
label p50_n_sw_inprog_ly_0  = "Number of FSW tested in SW program in past year op 0 (median) ";
label p50_n_sw_inprog_ly_1  = "Number of FSW tested in SW program in past year op 1 (median) ";
label p50_n_sw_inprog_ly_8  = "Number of FSW tested in SW program in past year op 8 (median) ";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&year_start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  /*values = (0 to 2e5 by 2e4)*/ valueattrs=(size=10);
label p50_n_sw_program_visit_0  = "Number of FSW tested in SW program in past year op 0 (median) ";
label p50_n_sw_program_visit_1  = "Number of FSW tested in SW program in past year op 1 (median) ";
label p50_n_sw_program_visit_8  = "Number of FSW tested in SW program in past year op 8 (median) ";
