...
p_ev_prepi_res_cab_hiv = prop_ever_prep_inj_res_cab_hiv ;
...
prop_elig_on_prep   p_elig_prep   p_hiv1_prep   prop_onprep_newpge1_   p_prep_elig_past_year   p_prep_newp   prop_sw_onprep

prop_prep_inj    ratio_inj_prep_on_tail          prop_ever_prep_inj_res_cab       p_ev_prepi_res_cab_hiv
...
h51  h52 h53   h54  h55  h56  h57  h58  h59  h60  h61  h62  h63  h64  h65  h66  h67  h68  h69  h70  h71  h72 h73
 h74 h75  h76  h77  h78 h79  h80  h81  h82  h83  h84  h85  h86 h87 h88  h89  h90  h91  h92 h93  h94  h95  h96  h97  h98  h99  h100
...
label p50_prop_elig_on_prep_1 = "Option 1  (median) ";
...
series  x=cald y=p50_prop_elig_on_prep_1/	lineattrs = (color=red thickness = 2);
...
label p50_p_elig_prep_0 = "Option 0 (median) ";
label p50_p_elig_prep_1 = "Option 1  (median) ";
...
series  x=cald y=p50_p_elig_prep_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_elig_prep_1 	upper=p95_p_elig_prep_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_hiv1_prep";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.6 by 0.1) valueattrs=(size=10);

label p50_p_hiv1_prep_0 = "Option 0 (median) ";
label p50_p_hiv1_prep_1 = "Option 1  (median) ";

series  x=cald y=p50_p_hiv1_prep_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_hiv1_prep_0 	upper=p95_p_hiv1_prep_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_p_hiv1_prep_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_hiv1_prep_1 	upper=p95_p_hiv1_prep_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_onprep_newpge1_";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.6 by 0.1) valueattrs=(size=10);

label p50_prop_onprep_newpge1__0 = "Option 0 (median) ";
label p50_prop_onprep_newpge1__1 = "Option 1  (median) ";

series  x=cald y=p50_prop_onprep_newpge1__0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_onprep_newpge1__0 	upper=p95_prop_onprep_newpge1__0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_onprep_newpge1__1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_onprep_newpge1__1 	upper=p95_prop_onprep_newpge1__1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_prep_elig_past_year";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.6 by 0.1) valueattrs=(size=10);

label p50_p_prep_elig_past_year_0 = "Option 0 (median) ";
label p50_p_prep_elig_past_year_1 = "Option 1  (median) ";

series  x=cald y=p50_p_prep_elig_past_year_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_prep_elig_past_year_0 	upper=p95_p_prep_elig_past_year_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_p_prep_elig_past_year_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_prep_elig_past_year_1 	upper=p95_p_prep_elig_past_year_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_prep_newp";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.6 by 0.1) valueattrs=(size=10);

label p50_p_prep_newp_0 = "Option 0 (median) ";
label p50_p_prep_newp_1 = "Option 1  (median) ";

series  x=cald y=p50_p_prep_newp_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_prep_newp_0 	upper=p95_p_prep_newp_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_p_prep_newp_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_prep_newp_1 	upper=p95_p_prep_newp_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_sw_onprep";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.6 by 0.1) valueattrs=(size=10);
...
series  x=cald y=p50_prop_sw_onprep_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_sw_onprep_1 	upper=p95_prop_sw_onprep_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_all_start";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 100000  by 1000 ) valueattrs=(size=10);

label p50_n_prep_all_start_0 = "Option 0 (median) ";
label p50_n_prep_all_start_1 = "Option 1  (median) ";

series  x=cald y=p50_n_prep_all_start_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_all_start_0 	upper=p95_n_prep_all_start_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_prep_all_start_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_all_start_1 	upper=p95_n_prep_all_start_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_oral_start";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 100000  by 1000 ) valueattrs=(size=10);

label p50_n_prep_oral_start_0 = "Option 0 (median) ";
label p50_n_prep_oral_start_1 = "Option 1  (median) ";

series  x=cald y=p50_n_prep_oral_start_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_oral_start_0 	upper=p95_n_prep_oral_start_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_prep_oral_start_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_oral_start_1 	upper=p95_n_prep_all_start_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_inj_start";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 100000  by 1000 ) valueattrs=(size=10);

label p50_n_prep_inj_start_0 = "Option 0 (median) ";
label p50_n_prep_inj_start_1 = "Option 1  (median) ";

series  x=cald y=p50_n_prep_inj_start_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_inj_start_0 	upper=p95_n_prep_inj_start_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_prep_inj_start_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_inj_start_1 	upper=p95_n_prep_inj_start_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_switch_prep_to_inj";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 10000  by 100 ) valueattrs=(size=10);

label p50_n_switch_prep_to_inj_0 = "Option 0 (median) ";
label p50_n_switch_prep_to_inj_1 = "Option 1  (median) ";

series  x=cald y=p50_n_switch_prep_to_inj_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_switch_prep_to_inj_0 	upper=p95_n_switch_prep_to_inj_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_switch_prep_to_inj_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_switch_prep_to_inj_1 	upper=p95_n_switch_prep_to_inj_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_switch_prep_to_oral";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1000   by 100 ) valueattrs=(size=10);

label p50_n_switch_prep_to_oral_0 = "Option 0 (median) ";
label p50_n_switch_prep_to_oral_1 = "Option 1  (median) ";

series  x=cald y=p50_n_switch_prep_to_oral_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_switch_prep_to_oral_0 	upper=p95_n_switch_prep_to_oral_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_switch_prep_to_oral_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_switch_prep_to_oral_1 	upper=p95_n_switch_prep_to_oral_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_switch_prep_from_inj";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1000   by 100 ) valueattrs=(size=10);

label p50_n_switch_prep_from_inj_0 = "Option 0 (median) ";
label p50_n_switch_prep_from_inj_1 = "Option 1  (median) ";

series  x=cald y=p50_n_switch_prep_from_inj_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_switch_prep_from_inj_0 	upper=p95_n_switch_prep_from_inj_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_switch_prep_from_inj_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_switch_prep_from_inj_1 	upper=p95_n_switch_prep_from_inj_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_switch_prep_from_oral";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 10000   by 100 ) valueattrs=(size=10);

label p50_n_switch_prep_from_oral_0 = "Option 0 (median) ";
label p50_n_switch_prep_from_oral_1 = "Option 1  (median) ";

series  x=cald y=p50_n_switch_prep_from_oral_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_switch_prep_from_oral_0 	upper=p95_n_switch_prep_from_oral_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_switch_prep_from_oral_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_switch_prep_from_oral_1 	upper=p95_n_switch_prep_from_oral_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_emerge_inm_res_cab";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1000   by 100 ) valueattrs=(size=10);

label p50_n_emerge_inm_res_cab_0 = "Option 0 (median) ";
label p50_n_emerge_inm_res_cab_1 = "Option 1  (median) ";

series  x=cald y=p50_n_emerge_inm_res_cab_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_emerge_inm_res_cab_0 	upper=p95_n_emerge_inm_res_cab_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_n_emerge_inm_res_cab_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_emerge_inm_res_cab_1 	upper=p95_n_emerge_inm_res_cab_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_prep_inj";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_prep_inj_0 = "Option 0 (median) ";
label p50_prop_prep_inj_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_prep_inj_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_prep_inj_0 	upper=p95_prop_prep_inj_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_prep_inj_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_prep_inj_1 	upper=p95_prop_prep_inj_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "ratio_inj_prep_on_tail";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 5     by 1    ) valueattrs=(size=10);

label p50_ratio_inj_prep_on_tail_0 = "Option 0 (median) ";
label p50_ratio_inj_prep_on_tail_1 = "Option 1  (median) ";

series  x=cald y=p50_ratio_inj_prep_on_tail_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_ratio_inj_prep_on_tail_0 	upper=p95_ratio_inj_prep_on_tail_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_ratio_inj_prep_on_tail_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_ratio_inj_prep_on_tail_1 	upper=p95_ratio_inj_prep_on_tail_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_ever_prep_inj_res_cab";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_ever_prep_inj_res_cab_0 = "Option 0 (median) ";
label p50_prop_ever_prep_inj_res_cab_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_ever_prep_inj_res_cab_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_ever_prep_inj_res_cab_0 	upper=p95_prop_ever_prep_inj_res_cab_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_ever_prep_inj_res_cab_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_ever_prep_inj_res_cab_1 	upper=p95_prop_ever_prep_inj_res_cab_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_ev_prepi_res_cab_hiv";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_p_ev_prepi_res_cab_hiv_0 = "Option 0 (median) ";
label p50_p_ev_prepi_res_cab_hiv_1 = "Option 1  (median) ";

series  x=cald y=p50_p_ev_prepi_res_cab_hiv_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_ev_prepi_res_cab_hiv_0 	upper=p95_p_ev_prepi_res_cab_hiv_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_p_ev_prepi_res_cab_hiv_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_ev_prepi_res_cab_hiv_1 	upper=p95_p_ev_prepi_res_cab_hiv_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_cab_res_o_cab";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_cab_res_o_cab_0 = "Option 0 (median) ";
label p50_prop_cab_res_o_cab_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_cab_res_o_cab_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_cab_res_o_cab_0 	upper=p95_prop_cab_res_o_cab_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_cab_res_o_cab_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_cab_res_o_cab_1 	upper=p95_prop_cab_res_o_cab_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_cab_res_tail ";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_cab_res_tail_0 = "Option 0 (median) ";
label p50_prop_cab_res_tail_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_cab_res_tail_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_cab_res_tail_0 	upper=p95_prop_cab_res_tail_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_cab_res_tail_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_cab_res_tail_1 	upper=p95_prop_cab_res_tail_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_cab_res_1st_per";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_cab_res_1st_per_0 = "Option 0 (median) ";
label p50_prop_cab_res_1st_per_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_cab_res_1st_per_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_cab_res_1st_per_0 	upper=p95_prop_cab_res_1st_per_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_cab_res_1st_per_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_cab_res_1st_per_1 	upper=p95_prop_cab_res_1st_per_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_prep_inj_at_inf_diag";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_prep_inj_at_inf_diag_0 = "Option 0 (median) ";
label p50_prop_prep_inj_at_inf_diag_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_prep_inj_at_inf_diag_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_prep_inj_at_inf_diag_0 	upper=p95_prop_prep_inj_at_inf_diag_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_prep_inj_at_inf_diag_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_prep_inj_at_inf_diag_1 	upper=p95_prop_prep_inj_at_inf_diag_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_o_cab_diag_at_3m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_o_cab_diag_at_3m_0 = "Option 0 (median) ";
label p50_prop_o_cab_diag_at_3m_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_o_cab_diag_at_3m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_3m_0 	upper=p95_prop_o_cab_diag_at_3m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_o_cab_diag_at_3m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_3m_1 	upper=p95_prop_o_cab_diag_at_3m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_o_cab_diag_at_6m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_o_cab_diag_at_6m_0 = "Option 0 (median) ";
label p50_prop_o_cab_diag_at_6m_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_o_cab_diag_at_6m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_6m_0 	upper=p95_prop_o_cab_diag_at_6m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_o_cab_diag_at_6m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_6m_1 	upper=p95_prop_o_cab_diag_at_6m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "prop_o_cab_diag_at_9m ";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_prop_o_cab_diag_at_9m_0 = "Option 0 (median) ";
label p50_prop_o_cab_diag_at_9m_1 = "Option 1  (median) ";

series  x=cald y=p50_prop_o_cab_diag_at_9m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_9m_0 	upper=p95_prop_o_cab_diag_at_9m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prop_o_cab_diag_at_9m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prop_o_cab_diag_at_9m_1 	upper=p95_prop_o_cab_diag_at_9m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "of_all_o_cab_prop_dur_3m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1   by 0.1 ) valueattrs=(size=10);

label p50_of_all_o_cab_prop_dur_3m_0 = "Option 0 (median) ";
label p50_of_all_o_cab_prop_dur_3m_1 = "Option 1  (median) ";

series  x=cald y=p50_of_all_o_cab_prop_dur_3m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_of_all_o_cab_prop_dur_3m_0 	upper=p95_of_all_o_cab_prop_dur_3m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_of_all_o_cab_prop_dur_3m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_of_all_o_cab_prop_dur_3m_1 	upper=p95_of_all_o_cab_prop_dur_3m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "of_all_o_cab_prop_dur_6m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1     by 0.1 ) valueattrs=(size=10);

label p50_of_all_o_cab_prop_dur_6m_0 = "Option 0 (median) ";
label p50_of_all_o_cab_prop_dur_6m_1 = "Option 1  (median) ";

series  x=cald y=p50_of_all_o_cab_prop_dur_6m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_of_all_o_cab_prop_dur_6m_0 	upper=p95_of_all_o_cab_prop_dur_6m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_of_all_o_cab_prop_dur_6m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_of_all_o_cab_prop_dur_6m_1 	upper=p95_of_all_o_cab_prop_dur_6m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_prep_inj_hiv";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1     by 0.1  ) valueattrs=(size=10);

label p50_p_prep_inj_hiv_0 = "Option 0 (median) ";
label p50_p_prep_inj_hiv_1 = "Option 1  (median) ";

series  x=cald y=p50_p_prep_inj_hiv_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_prep_inj_hiv_0 	upper=p95_p_prep_inj_hiv_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_p_prep_inj_hiv_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_prep_inj_hiv_1 	upper=p95_p_prep_inj_hiv_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
