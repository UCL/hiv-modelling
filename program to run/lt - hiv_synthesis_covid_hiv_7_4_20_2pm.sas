...
proc print; var s_covid; where serial_no = 10000; run;

proc print; var serial_no cald caldate&j hiv covid death dead dcause; where covid=1;
...
proc means; var s_covid; run;
proc freq; tables s_covid keep_going_2020 ; run;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_7_4_20_2pm_&dataset_id";  
put   
