...
* ts1m:  ac_deathrix = 1 - exp(-(1/12)*ac_death_rate); 
	...
	covid = 0; a = uniform(0);
	if age ge 15 and caldate{t} >= 2020.5 and covid ne 1 and a < 0.5 then covid = 1;
	...
	xcovid = uniform(0);
	if xcovid le cov_deathrix then do;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_3_4_20_11am_&dataset_id";  
put   
