...
;
		vmmc_disrup_covid = 0 ; if _u43 < 0.2 then vmmc_disrup_covid = 1 ;
		condom_disrup_covid = 0; if _u44 < 0.2 then condom_disrup_covid = 1 ;
/*		prep_disrup_covid = 0; if _u45 < 0.2 then prep_disrup_covid = 1 ;
		swprog_disrup_covid = 0; if _u46 < 0.2 then swprog_disrup_covid = 1 ; */
		testing_disrup_covid = 0; if _u47 < 0.2 then testing_disrup_covid = 1 ;
		art_tld_disrup_covid = 0; if _u48 < 0.2 then art_tld_disrup_covid = 1 ;
		art_tld_eod_disrup_covid = 0; if _u49 < 0.2 then art_tld_eod_disrup_covid = 1 ;
		art_init_disrup_covid = 0; if _u50 < 0.2 then art_init_disrup_covid = 1 ;
		vl_adh_switch_disrup_covid = 0; if _u51 < 0.2 then vl_adh_switch_disrup_covid = 1 ;
		cotrim_disrup_covid = 0; if _u52 < 0.2 then cotrim_disrup_covid = 1 ;
		inc_death_rate_aids_disrup_covid = 0; if _u53 < 0.2 then inc_death_rate_aids_disrup_covid = 1 ;
		no_art_disrup_covid = 0; if _u54 < 0.2 then no_art_disrup_covid = 1 ;
...
* INTERRUPTION OF ART  (AND LOSS TO FOLLOW-UP);
	...
	if no_art_disrup_covid = 1 then do; 
		if 2020.5 <= caldate{t} < 2021 and onart=1 then do;
			onart=0; visit=0; was_on_art_covid_disrup=1;
		end;
		if caldate{t} = 2021 and was_on_art_covid_disrup=1 then do;
			onart=1; visit=1;
		end;
	end;
...
if vm ne . then do; latest_vm = vm; date_latest_vm=caldate{t}; end;
	...
	* DEATH - causes:  who4=1 / non-HIV =2 ;
	...
	dead_6m_onart=.;dead_12m_onart=.;dead_24m_onart=.;dead_36m_onart=.;
		...
		if 2020.5 <= caldate{t} < 2021 and inc_death_rate_aids_disrup_covid = 1 and (adc=1 or (0 <= (caldate{t} - date_most_recent_tb) <= 0.5)) then do;  
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_covid_hiv_9_4_20_5pm_&dataset_id";  
put   
