...
if 15 <= age or death ne . then do;
	...
	s_dead_daly + dead_daly ; s_dead_ddaly + dead_ddaly ; s_dead_allage + dead; s_death_hiv_allage + death_hiv  ; 
...
s_ev_onart_gt6m_vlg1000_adead  s_ev_onart_gt6m_vl_m_g1000_dead  s_ev_onart_gt6m_vl_m_g1000_adead
 s_ev_art_g1k_not2l_adead  s_dead_allage   s_death_hiv_allage  s_death_dcause3_allage s_death_hivrel_allage
