...
* decline in sexual behaviour during any disruption;
if 2020.25 <= caldate{t} < 2020.75 
and vmmc_disrup_covid = 1 or   condom_disrup_covid = 1 or   prep_disrup_covid = 1 or  swprog_disrup_covid = 1 or   testing_disrup_covid  =1
or art_tld_disrup_covid = 1 or art_tld_eod_disrup_covid =1 or art_init_disrup_covid=1 or  vl_adh_switch_disrup_covid =1 or cotrim_disrup_covid =1 or
inc_death_rate_aids_disrup_covid =1 or no_art_disrup_covid =1 or  art_low_adh_disrup_covid = 1 then rred_rc = rred_rc * 0.5;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_covid_hiv_main_30r_dsb_&dataset_id";  
put   
