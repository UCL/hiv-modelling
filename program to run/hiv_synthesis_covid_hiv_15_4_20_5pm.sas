...
* Returning to clinic after loss to follow-up ;
	...
	if caldate{t} = 2020.5 and no_art_disrup_covid=1 and was_on_art_covid_disrup=1 and lost_tm1 =1 then do;
...
if 2020.25 <= caldate{t} < 2020.5 and no_art_disrup_covid=1 and was_on_art_covid_disrup=1 then do;return=0;lost=1;visit=0; end;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_covid_hiv_15_4_20_5pm_&dataset_id";  
put   
