...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\kenya\kenya_al_options_r_out\";



data   kenya_al_options_r ; set b.out: ;


proc sort data=  kenya_al_options_r; 
...
if cald >= 2024 then daly_gbd = ddaly_gbd / &discount ; 
...
data a.l_base_kenya_al_options_r; set y;  




data y; set a.l_base_kenya_al_options_r; 
...
proc means noprint data=y; var &v; output out=y_41  mean= &v   ;         ; where 2041.0 <= cald < 2042.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_42  mean= &v   ;         ; where 2042.0 <= cald < 2043.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_43  mean= &v   ;         ; where 2043.0 <= cald < 2044.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_44  mean= &v   ;         ; where 2044.0 <= cald < 2045.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_45  mean= &v   ;         ; where 2045.0 <= cald < 2046.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_46  mean= &v   ;         ; where 2046.0 <= cald < 2047.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_47  mean= &v   ;         ; where 2047.0 <= cald < 2048.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_48  mean= &v   ;         ; where 2048.0 <= cald < 2049.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_49  mean= &v   ;         ; where 2049.0 <= cald < 2050.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_50  mean= &v   ;         ; where 2050.0 <= cald < 2051.0 and option=115 ;

proc means noprint data=y; var &v; output out=y_51  mean= &v   ;         ; where 2051.0 <= cald < 2052.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_52  mean= &v   ;         ; where 2052.0 <= cald < 2053.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_53  mean= &v   ;         ; where 2053.0 <= cald < 2054.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_54  mean= &v   ;         ; where 2054.0 <= cald < 2055.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_55  mean= &v   ;         ; where 2055.0 <= cald < 2056.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_56  mean= &v   ;         ; where 2056.0 <= cald < 2057.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_57  mean= &v   ;         ; where 2057.0 <= cald < 2058.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_58  mean= &v   ;         ; where 2058.0 <= cald < 2059.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_59  mean= &v   ;         ; where 2059.0 <= cald < 2060.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_60  mean= &v   ;         ; where 2060.0 <= cald < 2061.0 and option=115 ;

proc means noprint data=y; var &v; output out=y_61  mean= &v   ;         ; where 2061.0 <= cald < 2062.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_62  mean= &v   ;         ; where 2062.0 <= cald < 2063.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_63  mean= &v   ;         ; where 2063.0 <= cald < 2064.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_64  mean= &v   ;         ; where 2064.0 <= cald < 2065.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_65  mean= &v   ;         ; where 2065.0 <= cald < 2066.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_66  mean= &v   ;         ; where 2066.0 <= cald < 2067.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_67  mean= &v   ;         ; where 2067.0 <= cald < 2068.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_68  mean= &v   ;         ; where 2068.0 <= cald < 2069.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_69  mean= &v   ;         ; where 2069.0 <= cald < 2070.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_70  mean= &v   ;         ; where 2070.0 <= cald < 2071.0 and option=115 ;

proc means noprint data=y; var &v; output out=y_71  mean= &v   ;         ; where 2071.0 <= cald < 2072.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_72  mean= &v   ;         ; where 2072.0 <= cald < 2073.0 and option=115 ;
proc means noprint data=y; var &v; output out=y_73  mean= &v   ;         ; where 2073.0 <= cald < 2074.0 and option=115 ;
...
y_41 y_42 y_43 y_44 y_45 y_46 y_47 y_48 y_49 y_50 y_51 y_52 y_53 y_54 y_55 y_56 y_57 y_58 y_59 y_60
y_61 y_62 y_63 y_64 y_65 y_66 y_67 y_68 y_69 y_70 y_71 y_72 y_73 
;  
