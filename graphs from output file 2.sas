...
p_w_giv_birth_this_per	p_newp_ge1_ p_newp_ge5_  log_gender_r_newp  p_tested_past_year_1549m p_tested_past_year_1549w   n_tested_m
p_mcirc_1549m	 		
prop_w_1549_sw	prop_w_ever_sw 	prop_sw_hiv 	prop_w_1524_onprep  prop_1564_onprep 	prevalence1549m prevalence1549w
prevalence1549_  prevalence_vg1000_  incidence1549_ incidence1564_  p_inf_vlsupp  p_inf_newp  p_inf_ep  p_inf_diag  p_inf_naive  p_inf_primary
...
p_onart_vl1000_w				p_onart_vl1000_m  logm15r logm25r logm35r logm45r logm55r logw15r logw25r logw35r logw45r logw55r 
 p_mcirc_1519m p_mcirc_2024m p_mcirc_2529m p_mcirc_3034m p_mcirc_3539m p_mcirc_4044m p_mcirc_4549m p_mcirc_50plm p_mcirc_1549m p_vmmc
 p_vmmc_1519m  p_vmmc_2024m p_vmmc_2529m p_vmmc_3039m p_vmmc_4049m p_vmmc_50plm p_vmmc_1549m
;
...
h51  h52 h53   h54  h55  h56  h57  h58  h59  h60 h61  h62  h63  h64  h65  h66  h67  h68  h69  h70  h71  h72  h73  h74  h75  h76  h77
...
proc sgplot data=d; 
Title    height=1.5 justify=center "p_mcirc_1519m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.2) valueattrs=(size=10);
label p50_p_mcirc_1519m_0 = "Option 0 (median) ";
label p50_p_mcirc_1519m_1 = "Option 1 (median) ";
...
series  x=cald y=p50_p_mcirc_1519m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_mcirc_1519m_1 	upper=p95_p_mcirc_1519m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";

run;quit;


proc sgplot data=d; 
Title    height=1.5 justify=center "p_mcirc_4549m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.2) valueattrs=(size=10);
label p50_p_mcirc_4549m_0 = "Option 0 (median) ";
label p50_p_mcirc_4549m_1 = "Option 1 (median) ";

series  x=cald y=p50_p_mcirc_4549m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_mcirc_4549m_0 	upper=p95_p_mcirc_4549m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=p50_p_mcirc_4549m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_mcirc_4549m_1 	upper=p95_p_mcirc_4549m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
