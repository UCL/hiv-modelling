...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\kenya\kenya_af_options_out\";

data a.kenya_af_options ; set b.out: ;


proc sort data=a.kenya_af_options; 
...
data a.l_base_kenya_af_options; set y;  
...
data y; set a.l_base_kenya_af_options; 
...
proc print data = a.w_base_kenya_af_options noobs; var run ; where prevalence1549_msm_17 < 0.4  and incidence1564_20 < 0.20; run;
...
proc means data=a.w_base_kenya_af_options n p50 p5 p95 mean;
...
data q1; set a.w_base_kenya_af_options;
...
data a.l_base_keep_kenya_af_options; merge a.l_base_kenya_af_options q1 ; by run;
...
proc freq data = a.l_base_keep_kenya_af_options; tables
sf_2022 dataset sex_beh_trans_matrix_m sex_beh_trans_matrix_w sex_age_mixing_matrix_m sex_age_mixing_matrix_w p_rred_p
p_hsb_p newp_factor eprate conc_ep ch_risk_diag ch_risk_diag_newp
ych_risk_beh_newp ych2_risk_beh_newp ych_risk_beh_ep exp_setting_lower_p_vl1000
external_exp_factor rate_exp_set_lower_p_vl1000 prob_pregnancy_base fold_change_w
