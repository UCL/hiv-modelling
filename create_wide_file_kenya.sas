...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\uganda\uganda_out\";
...
sf_2021 = (46000000 * 0.54) / s_alive;  * 54% of uganda population in 2019 >= age 15 ;
keep run sf_2021;
proc sort; by run;
...
data a.l_base_uganda; set y;  




data y; set a.l_base_uganda; 
...
proc means data=a.w_base_uganda n p50 p5 p95 mean;
...
data a.l_base_keep_uganda; merge a.l_base_uganda q1 ; by run;
...
proc freq data = a.l_base_keep_uganda; tables
sf_2021 /*dataset*/ sex_beh_trans_matrix_m sex_beh_trans_matrix_w sex_age_mixing_matrix_m sex_age_mixing_matrix_w p_rred_p
p_hsb_p newp_factor eprate conc_ep ch_risk_diag ch_risk_diag_newp
ych_risk_beh_newp ych2_risk_beh_newp ych_risk_beh_ep exp_setting_lower_p_vl1000
external_exp_factor rate_exp_set_lower_p_vl1000 prob_pregnancy_base fold_change_w
