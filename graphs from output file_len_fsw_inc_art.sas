...
ods html;
proc sgplot data=d nolegend; 
  Title '';    Title    height=1.5 justify=center "prop_prep_len";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to  0.5     by 0.05  ) valueattrs=(size=10);

series  x=cald y=p50_prop_prep_len_0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_prop_prep_len_0 upper=p95_prop_prep_len_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

series  x=cald y=p50_prop_prep_len_1 / lineattrs = (color=darkblue    thickness = 4);
band    x=cald lower=p5_prop_prep_len_1 upper=p95_prop_prep_len_1 / transparency=0.9 fillattrs = (color=darkblue   ) legendlabel= "90% range";
...
ods html;
proc sgplot data=d nolegend; 
  Title '';    Title    height=1.5 justify=center "prop_sw_onprep";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to  0.5     by 0.05  ) valueattrs=(size=10);

series  x=cald y=p50_prop_sw_onprep_0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_prop_sw_onprep_0 upper=p95_prop_sw_onprep_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";
