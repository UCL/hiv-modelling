...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_t_out\";
...
data b.k_cioa_t;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
* dcost_self_test_50y_4 = dcost_self_test_50y_4 * 1.5 / 2;
* dcost_self_test_50y_5 = dcost_self_test_50y_5 * 1.5 / 2;
