...
data d1;  
  ...
  infile "/home/rmjlaph/c_output_tld_prep_22_10_20_5pm_prep5yr";
...
* data a.prep_22_10_20_5pm_29_jan_21_ps12_1 ;
  data a.prep_22_10_20_5pm_prep5yr;
...
* set a.prep_29_jan_21_prep_eff_0;
  set a.prep_22_10_20_5pm_prep5yr;
...
proc means  noprint data=y; var &v; output out=y_40 mean= &v._40; by run ; where 2039.5 <= cald < 2040.5 and option=0; 
proc means  noprint data=y; var &v; output out=y_70 mean= &v._70; by run ; where 2069.5 <= cald < 2070.5 and option=0;; 
...
* data a.wide_prep_29_jan_21_prep_eff_0;
  data a.wide_prep_22_10_20_5pm_prep5yr;
