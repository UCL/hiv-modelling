...
keep cald	run
n_alive			n_alive_m			n_alive_w			prevalence1564_		prevalence1564m		prevalence1564w	
...
%var_d(n_alive);	   %var_d(n_alive_m);		%var_d(n_alive_w);		 %var_d(prevalence1564_); %var_d(prevalence1564m); %var_d(prevalence1564w);	
...
%var(v=s_I_undiag1519w); 		%var(v=s_I_diag_naive1519w);	 %var(v=s_I_diag_startart1519w); 	%var(v=s_I_onart1519w);	   		%var(v=s_I_offart1519w); 	
%var(v=s_I_onart_lt6m1519w);    %var(v=s_I_onart_lt6m_nvs1519w); %var(v=s_I_onart_gt6m_nvs1519w);	%var(v=s_I_onart_gt6m_vs1519w); %var(v=s_I_offart_1stI1519w);
%var(v=s_I_offart_SI1519w); 	%var(v=s_I_offart_SIlt6m1519w);  %var(v=s_I_offart_SIgt6m1519w); 

%var(v=s_I_undiag2024w); 		%var(v=s_I_diag_naive2024w);	 %var(v=s_I_diag_startart2024w);	%var(v=s_I_onart2024w); 		%var(v=s_I_offart2024w);
%var(v=s_I_onart_lt6m2024w); 	%var(v=s_I_onart_lt6m_nvs2024w); %var(v=s_I_onart_gt6m_nvs2024w);	%var(v=s_I_onart_gt6m_vs2024w); %var(v=s_I_offart_1stI2024w); 
%var(v=s_I_offart_SI2024w); 	%var(v=s_I_offart_SIlt6m2024w);  %var(v=s_I_offart_SIgt6m2024w); 

%var(v=s_I_undiag2529w);		%var(v=s_I_diag_naive2529w); 	 %var(v=s_I_diag_startart2529w); 	%var(v=s_I_onart2529w);			%var(v=s_I_offart2529w);
%var(v=s_I_onart_lt6m2529w); 	%var(v=s_I_onart_lt6m_nvs2529w); %var(v=s_I_onart_gt6m_nvs2529w);   %var(v=s_I_onart_gt6m_vs2529w); %var(v=s_I_offart_1stI2529w); 
%var(v=s_I_offart_SI2529w); 	%var(v=s_I_offart_SIlt6m2529w);  %var(v=s_I_offart_SIgt6m2529w); 

%var(v=s_I_undiag3034w); 		%var(v=s_I_diag_naive3034w); 	 %var(v=s_I_diag_startart3034w); 	%var(v=s_I_onart3034w);			 %var(v=s_I_offart3034w); 
%var(v=s_I_onart_lt6m3034w); 	%var(v=s_I_onart_lt6m_nvs3034w); %var(v=s_I_onart_gt6m_nvs3034w);   %var(v=s_I_onart_gt6m_vs3034w);  %var(v=s_I_offart_1stI3034w); 
%var(v=s_I_offart_SI3034w); 	%var(v=s_I_offart_SIlt6m3034w);  %var(v=s_I_offart_SIgt6m3034w); 

%var(v=s_I_undiag3539w); 		%var(v=s_I_diag_naive3539w);	 %var(v=s_I_diag_startart3539w); 	%var(v=s_I_onart3539w); 		 %var(v=s_I_offart3539w);
%var(v=s_I_onart_lt6m3539w); 	%var(v=s_I_onart_lt6m_nvs3539w); %var(v=s_I_onart_gt6m_nvs3539w);   %var(v=s_I_onart_gt6m_vs3539w);  %var(v=s_I_offart_1stI3539w);
%var(v=s_I_offart_SI3539w); 	%var(v=s_I_offart_SIlt6m3539w);  %var(v=s_I_offart_SIgt6m3539w); 

%var(v=s_I_undiag4044w); 		%var(v=s_I_diag_naive4044w);	 %var(v=s_I_diag_startart4044w); 	%var(v=s_I_onart4044w); 		 %var(v=s_I_offart4044w);
%var(v=s_I_onart_lt6m4044w); 	%var(v=s_I_onart_lt6m_nvs4044w); %var(v=s_I_onart_gt6m_nvs4044w);   %var(v=s_I_onart_gt6m_vs4044w);  %var(v=s_I_offart_1stI4044w);
%var(v=s_I_offart_SI4044w); 	%var(v=s_I_offart_SIlt6m4044w);  %var(v=s_I_offart_SIgt6m4044w); 

%var(v=s_I_undiag4549w); 		%var(v=s_I_diag_naive4549w);	 %var(v=s_I_diag_startart4549w); 	%var(v=s_I_onart4549w); 		 %var(v=s_I_offart4549w);
%var(v=s_I_onart_lt6m4549w); 	%var(v=s_I_onart_lt6m_nvs4549w); %var(v=s_I_onart_gt6m_nvs4549w);   %var(v=s_I_onart_gt6m_vs4549w);  %var(v=s_I_offart_1stI4549w);
%var(v=s_I_offart_SI4549w); 	%var(v=s_I_offart_SIlt6m4549w);  %var(v=s_I_offart_SIgt6m4549w); 

%var(v=s_I_undiag5054w); 		%var(v=s_I_diag_naive5054w);	 %var(v=s_I_diag_startart5054w); 	%var(v=s_I_onart5054w); 		 %var(v=s_I_offart5054w);
%var(v=s_I_onart_lt6m5054w); 	%var(v=s_I_onart_lt6m_nvs5054w); %var(v=s_I_onart_gt6m_nvs5054w);   %var(v=s_I_onart_gt6m_vs5054w);  %var(v=s_I_offart_1stI5054w);
%var(v=s_I_offart_SI5054w); 	%var(v=s_I_offart_SIlt6m5054w);  %var(v=s_I_offart_SIgt6m5054w); 

%var(v=s_I_undiag5559w); 		%var(v=s_I_diag_naive5559w);	 %var(v=s_I_diag_startart5559w); 	%var(v=s_I_onart5559w); 		 %var(v=s_I_offart5559w);
%var(v=s_I_onart_lt6m5559w); 	%var(v=s_I_onart_lt6m_nvs5559w); %var(v=s_I_onart_gt6m_nvs5559w);   %var(v=s_I_onart_gt6m_vs5559w);  %var(v=s_I_offart_1stI5559w);
%var(v=s_I_offart_SI5559w); 	%var(v=s_I_offart_SIlt6m5559w);  %var(v=s_I_offart_SIgt6m5559w); 

%var(v=s_I_undiag6064w); 		%var(v=s_I_diag_naive6064w);	 %var(v=s_I_diag_startart6064w); 	%var(v=s_I_onart6064w); 		 %var(v=s_I_offart6064w);
%var(v=s_I_onart_lt6m6064w); 	%var(v=s_I_onart_lt6m_nvs6064w); %var(v=s_I_onart_gt6m_nvs6064w);   %var(v=s_I_onart_gt6m_vs6064w);  %var(v=s_I_offart_1stI6064w);
%var(v=s_I_offart_SI6064w); 	%var(v=s_I_offart_SIlt6m6064w);  %var(v=s_I_offart_SIgt6m6064w); 

%var(v=s_I_undiag6569w); 		%var(v=s_I_diag_naive6569w);	 %var(v=s_I_diag_startart6569w); 	%var(v=s_I_onart6569w); 		 %var(v=s_I_offart6569w);
%var(v=s_I_onart_lt6m6569w); 	%var(v=s_I_onart_lt6m_nvs6569w); %var(v=s_I_onart_gt6m_nvs6569w);   %var(v=s_I_onart_gt6m_vs6569w);  %var(v=s_I_offart_1stI6569w);
%var(v=s_I_offart_SI6569w); 	%var(v=s_I_offart_SIlt6m6569w);  %var(v=s_I_offart_SIgt6m6569w); 

%var(v=s_I_undiag7074w); 		%var(v=s_I_diag_naive7074w);	 %var(v=s_I_diag_startart7074w); 	%var(v=s_I_onart7074w); 		 %var(v=s_I_offart7074w);
%var(v=s_I_onart_lt6m7074w); 	%var(v=s_I_onart_lt6m_nvs7074w); %var(v=s_I_onart_gt6m_nvs7074w);   %var(v=s_I_onart_gt6m_vs7074w);  %var(v=s_I_offart_1stI7074w);
%var(v=s_I_offart_SI7074w); 	%var(v=s_I_offart_SIlt6m7074w);  %var(v=s_I_offart_SIgt6m7074w); 

%var(v=s_I_undiag7579w); 		%var(v=s_I_diag_naive7579w);	 %var(v=s_I_diag_startart7579w); 	%var(v=s_I_onart7579w); 		 %var(v=s_I_offart7579w);
%var(v=s_I_onart_lt6m7579w); 	%var(v=s_I_onart_lt6m_nvs7579w); %var(v=s_I_onart_gt6m_nvs7579w);   %var(v=s_I_onart_gt6m_vs7579w);  %var(v=s_I_offart_1stI7579w);
%var(v=s_I_offart_SI7579w); 	%var(v=s_I_offart_SIlt6m7579w);  %var(v=s_I_offart_SIgt6m7579w); 

%var(v=s_I_undiag8084w); 		%var(v=s_I_diag_naive8084w);	 %var(v=s_I_diag_startart8084w); 	%var(v=s_I_onart8084w); 		 %var(v=s_I_offart8084w);
%var(v=s_I_onart_lt6m8084w); 	%var(v=s_I_onart_lt6m_nvs8084w); %var(v=s_I_onart_gt6m_nvs8084w);   %var(v=s_I_onart_gt6m_vs8084w);  %var(v=s_I_offart_1stI8084w);
%var(v=s_I_offart_SI8084w); 	%var(v=s_I_offart_SIlt6m8084w);  %var(v=s_I_offart_SIgt6m8084w); 
