...
* n_inf1519_;					n_inf1519_ = s_primary1519_ * &sf;
* n_inf2024_;					n_inf2024_ = s_primary2024_ * &sf;
* n_inf2529_;					n_inf2529_ = s_primary2529_ * &sf;
* n_inf3034_;					n_inf3034_ = s_primary3034_ * &sf;
* n_inf3539_;					n_inf3539_ = s_primary3539_ * &sf;
* n_inf4044_;					n_inf4044_ = s_primary4044_ * &sf;
* n_inf4549_;					n_inf4549_ = s_primary4549_ * &sf;
* n_inf5054_;					n_inf5054_ = s_primary5054_ * &sf;
* n_inf5559_;					n_inf5559_ = s_primary5559_ * &sf;
* n_inf6064_;					n_inf6064_ = s_primary6064_ * &sf;
* n_inf6569_;					n_inf6569_ = s_primary6569_ * &sf;
* n_inf7074_;					n_inf7074_ = s_primary7074_ * &sf;
* n_inf7579_;					n_inf7579_ = s_primary7579_ * &sf;
* n_inf8084_;					n_inf8084_ = s_primary8084_ * &sf;

* n_inf1519m;					n_inf1519m = s_primary1519m * &sf;
* n_inf2024m;					n_inf2024m = s_primary2024m * &sf;
* n_inf2529m;					n_inf2529m = s_primary2529m * &sf;
* n_inf3034m;					n_inf3034m = s_primary3034m * &sf;
* n_inf3539m;					n_inf3539m = s_primary3539m * &sf;
* n_inf4044m;					n_inf4044m = s_primary4044m * &sf;
* n_inf4549m;					n_inf4549m = s_primary4549m * &sf;
* n_inf5054m;					n_inf5054m = s_primary5054m * &sf;
* n_inf5559m;					n_inf5559m = s_primary5559m * &sf;
* n_inf6064m;					n_inf6064m = s_primary6064m * &sf;
* n_inf6569m;					n_inf6569m = s_primary6569m * &sf;
* n_inf7074m;					n_inf7074m = s_primary7074m * &sf;
* n_inf7579m;					n_inf7579m = s_primary7579m * &sf;
* n_inf8084m;					n_inf8084m = s_primary8084m * &sf;

* n_inf1519w;					n_inf1519w = s_primary1519w * &sf;
* n_inf2024w;					n_inf2024w = s_primary2024w * &sf;
* n_inf2529w;					n_inf2529w = s_primary2529w * &sf;
* n_inf3034w;					n_inf3034w = s_primary3034w * &sf;
* n_inf3539w;					n_inf3539w = s_primary3539w * &sf;
* n_inf4044w;					n_inf4044w = s_primary4044w * &sf;
* n_inf4549w;					n_inf4549w = s_primary4549w * &sf;
* n_inf5054w;					n_inf5054w = s_primary5054w * &sf;
* n_inf5559w;					n_inf5559w = s_primary5559w * &sf;
* n_inf6064w;					n_inf6064w = s_primary6064w * &sf;
* n_inf6569w;					n_inf6569w = s_primary6569w * &sf;
* n_inf7074w;					n_inf7074w = s_primary7074w * &sf;
* n_inf7579w;					n_inf7579w = s_primary7579w * &sf;
* n_inf8084w;					n_inf8084w = s_primary8084w * &sf;


*/


***Rename so variables do not end in a number and are less than <32 char as this breaks the macro;
...
n_dead_diag_not_linked 		= s_dead_diag_not_linked * sf_2022;
n_dead_Alt6_Acd4lt200 		= s_dead_Alt6_artcd4lt200 * sf_2022;
n_dead_Alt6_Acd4gt200 		= s_dead_Alt6_artcd4gt200 * sf_2022;
n_d_I_Alt6_Rcd4lt200 		= s_dead_I_Alt6_Rcd4lt200 * sf_2022;
n_d_I_Alt6_Rcd4gt200 		= s_dead_I_Alt6_Rcd4gt200 * sf_2022;
n_dead_A_vl1000 			= s_dead_A_vl1000 * sf_2022;
n_dead_A_vg1000 			= s_dead_A_vg1000 * sf_2022;
n_dead_Alt6_vl1000 			= s_dead_Alt6_vl1000 * sf_2022;
n_dead_Alt6_vg1000 			= s_dead_Alt6_vg1000 * sf_2022;
n_dead_Agt6_vl1000 			= s_dead_Agt6_vl1000 * sf_2022;
n_dead_Agt6_vg1000 			= s_dead_Agt6_vg1000 * sf_2022;
n_dead_int_lost 			= s_dead_int_lost * sf_2022;
n_dead_1stint_lost 			= s_dead_1stint_lost * sf_2022;
n_dead_subintlt6_lost 		= s_dead_subintlt6_lost * sf_2022;
n_dead_subintgt6_lost 		= s_dead_subintgt6_lost * sf_2022;
n_dead_A_cd4lt200 			= s_dead_A_cd4lt200 * sf_2022;
n_dead_A_cd4gt200 			= s_dead_A_cd4gt200 * sf_2022;
n_dead_Alt6_cd4lt200 		= s_dead_Alt6_cd4lt200 * sf_2022;
n_dead_Alt6_cd4gt200 		= s_dead_Alt6_cd4gt200 * sf_2022;
n_dead_Agt6_cd4lt200 		= s_dead_Agt6_cd4lt200 * sf_2022;
n_dead_Agt6_cd4gt200 		= s_dead_Agt6_cd4gt200 * sf_2022;

n_dead_undiag_m				= s_dead_undiag_m * sf_2022;
n_dead_diag_not_linked_m 	= s_dead_diag_not_linked_m * sf_2022;
n_dead_Alt6_Acd4lt200_m 	= s_dead_Alt6_artcd4lt200_m * sf_2022;
n_dead_Alt6_Acd4gt200_m 	= s_dead_Alt6_artcd4gt200_m * sf_2022;
n_d_I_Alt6_Rcd4lt200_m 		= s_dead_I_Alt6_Rcd4lt200_m * sf_2022;
n_d_I_Alt6_Rcd4gt200_m 		= s_dead_I_Alt6_Rcd4gt200_m * sf_2022;
n_dead_A_vl1000_m 			= s_dead_A_vl1000_m * sf_2022;
n_dead_A_vg1000_m 			= s_dead_A_vg1000_m * sf_2022;
n_dead_Alt6_vl1000_m 		= s_dead_Alt6_vl1000_m * sf_2022;
n_dead_Alt6_vg1000_m 		= s_dead_Alt6_vg1000_m * sf_2022;
n_dead_Agt6_vl1000_m 		= s_dead_Agt6_vl1000_m * sf_2022;
n_dead_Agt6_vg1000_m 		= s_dead_Agt6_vg1000_m * sf_2022;
n_dead_int_lost_m 			= s_dead_int_lost_m * sf_2022;
n_dead_1stint_lost_m 		= s_dead_1stint_lost_m * sf_2022;
n_dead_subintlt6_lost_m 	= s_dead_subintlt6_lost_m * sf_2022;
n_dead_subintgt6_lost_m 	= s_dead_subintgt6_lost_m * sf_2022;
n_dead_A_cd4lt200_m 		= s_dead_A_cd4lt200_m * sf_2022;
n_dead_A_cd4gt200_m 		= s_dead_A_cd4gt200_m * sf_2022;
n_dead_Alt6_cd4lt200_m 		= s_dead_Alt6_cd4lt200_m * sf_2022;
n_dead_Alt6_cd4gt200_m 		= s_dead_Alt6_cd4gt200_m * sf_2022;
n_dead_Agt6_cd4lt200_m 		= s_dead_Agt6_cd4lt200_m * sf_2022;
n_dead_Agt6_cd4gt200_m 		= s_dead_Agt6_cd4gt200_m * sf_2022;

n_dead_undiag_w				= s_dead_undiag_w * sf_2022;
n_dead_diag_not_linked_w 	= s_dead_diag_not_linked_w * sf_2022;
n_dead_Alt6_Acd4lt200_w 	= s_dead_Alt6_artcd4lt200_w * sf_2022;
n_dead_Alt6_Acd4gt200_w		= s_dead_Alt6_artcd4gt200_w * sf_2022;
n_d_I_Alt6_Rcd4lt200_w 		= s_dead_I_Alt6_Rcd4lt200_w * sf_2022;
n_d_I_Alt6_Rcd4gt200_w 		= s_dead_I_Alt6_Rcd4gt200_w * sf_2022;
n_dead_A_vl1000_w 			= s_dead_A_vl1000_w * sf_2022;
n_dead_A_vg1000_w 			= s_dead_A_vg1000_w * sf_2022;
n_dead_Alt6_vl1000_w 		= s_dead_Alt6_vl1000_w * sf_2022;
n_dead_Alt6_vg1000_w 		= s_dead_Alt6_vg1000_w * sf_2022;
n_dead_Agt6_vl1000_w 		= s_dead_Agt6_vl1000_w * sf_2022;
n_dead_Agt6_vg1000_w 		= s_dead_Agt6_vg1000_w * sf_2022;
n_dead_int_lost_w 			= s_dead_int_lost_w * sf_2022;
n_dead_1stint_lost_w 		= s_dead_1stint_lost_w * sf_2022;
n_dead_subintlt6_lost_w 	= s_dead_subintlt6_lost_w * sf_2022;
n_dead_subintgt6_lost_w 	= s_dead_subintgt6_lost_w * sf_2022;
n_dead_A_cd4lt200_w 		= s_dead_A_cd4lt200_w * sf_2022;
n_dead_A_cd4gt200_w 		= s_dead_A_cd4gt200_w * sf_2022;
n_dead_Alt6_cd4lt200_w 		= s_dead_Alt6_cd4lt200_w * sf_2022;
n_dead_Alt6_cd4gt200_w 		= s_dead_Alt6_cd4gt200_w * sf_2022;
n_dead_Agt6_cd4lt200_w 		= s_dead_Agt6_cd4lt200_w * sf_2022;
n_dead_Agt6_cd4gt200_w 		= s_dead_Agt6_cd4gt200_w * sf_2022;

n_I_undiag 			= s_I_undiag * sf_2022;
n_I_diag_naive 		= s_I_diag_naive  * sf_2022;
n_I_diag_startart 	= s_I_diag_startart * sf_2022;
n_I_onart 			= s_I_onart * sf_2022;
n_I_offart			= s_I_offart * sf_2022;
n_I_onart_lt6m		= s_I_onart_lt6m * sf_2022;
n_I_onart_lt6m_nvs	= s_I_onart_lt6m_nvs * sf_2022;
n_I_onart_gt6m_nvs	= s_I_onart_gt6m_nvs * sf_2022;
n_I_onart_gt6m_vs	= s_I_onart_gt6m_vs * sf_2022;
n_I_offart_1stI		= s_I_offart_1stI * sf_2022;
n_I_offart_SI		= s_I_offart_SI * sf_2022;     
n_I_offart_SIlt6m	= s_I_offart_SIlt6m * sf_2022;
n_I_offart_SIgt6m	= s_I_offart_SIgt6m * sf_2022;

n_I_undiag_m 			= s_I_undiag_m * sf_2022;
n_I_diag_naive_m 		= s_I_diag_naive_m  * sf_2022;
n_I_diag_startart_m 	= s_I_diag_startart_m * sf_2022;
n_I_onart_m 			= s_I_onart_m * sf_2022;
n_I_offart_m			= s_I_offart_m * sf_2022;
n_I_onart_lt6m_m		= s_I_onart_lt6m_m * sf_2022;
n_I_onart_lt6m_nvs_m	= s_I_onart_lt6m_nvs_m * sf_2022;
n_I_onart_gt6m_nvs_m	= s_I_onart_gt6m_nvs_m * sf_2022;
n_I_onart_gt6m_vs_m		= s_I_onart_gt6m_vs_m * sf_2022;
n_I_offart_1stI_m		= s_I_offart_1stI_m * sf_2022;
n_I_offart_SI_m			= s_I_offart_SI_m * sf_2022;     
n_I_offart_SIlt6m_m		= s_I_offart_SIlt6m_m * sf_2022;
n_I_offart_SIgt6m_m		= s_I_offart_SIgt6m_m * sf_2022;

n_I_undiag_w 			= s_I_undiag_w * sf_2022;
n_I_diag_naive_w 		= s_I_diag_naive_w  * sf_2022;
n_I_diag_startart_w 	= s_I_diag_startart_w * sf_2022;
n_I_onart_w 			= s_I_onart_w * sf_2022;
n_I_offart_w			= s_I_offart_w * sf_2022;
n_I_onart_lt6m_w		= s_I_onart_lt6m_w * sf_2022;
n_I_onart_lt6m_nvs_w	= s_I_onart_lt6m_nvs_w * sf_2022;
n_I_onart_gt6m_nvs_w	= s_I_onart_gt6m_nvs_w * sf_2022;
n_I_onart_gt6m_vs_w		= s_I_onart_gt6m_vs_w * sf_2022;
n_I_offart_1stI_w		= s_I_offart_1stI_w * sf_2022;
n_I_offart_SI_w			= s_I_offart_SI_w * sf_2022;     
n_I_offart_SIlt6m_w		= s_I_offart_SIlt6m_w * sf_2022;
n_I_offart_SIgt6m_w		= s_I_offart_SIgt6m_w * sf_2022;

%macro scaleup (age, mage, wage);

n_I_undiag&age 			= s_I_undiag&age * sf_2022;
n_I_diag_naive&age 		= s_I_diag_naive&age  * sf_2022;
n_I_diag_startart&age 	= s_I_diag_startart&age * sf_2022;
n_I_onart&age 			= s_I_onart&age * sf_2022;
n_I_offart&age			= s_I_offart&age * sf_2022;
n_I_onart_lt6m&age		= s_I_onart_lt6m&age * sf_2022;
n_I_onart_lt6m_nvs&age	= s_I_onart_lt6m_nvs&age * sf_2022;
n_I_onart_gt6m_nvs&age	= s_I_onart_gt6m_nvs&age * sf_2022;
n_I_onart_gt6m_vs&age	= s_I_onart_gt6m_vs&age * sf_2022;
n_I_offart_1stI&age		= s_I_offart_1stI&age * sf_2022;
n_I_offart_SI&age		= s_I_offart_SI&age * sf_2022;     
n_I_offart_SIlt6m&age	= s_I_offart_SIlt6m&age * sf_2022;
n_I_offart_SIgt6m&age	= s_I_offart_SIgt6m&age * sf_2022;

n_I_undiag&mage 			= s_I_undiag&mage * sf_2022;
n_I_diag_naive&mage 		= s_I_diag_naive&mage  * sf_2022;
n_I_diag_startart&mage 	= s_I_diag_startart&mage * sf_2022;
n_I_onart&mage 			= s_I_onart&mage * sf_2022;
n_I_offart&mage			= s_I_offart&mage * sf_2022;
n_I_onart_lt6m&mage		= s_I_onart_lt6m&mage * sf_2022;
n_I_onart_lt6m_nvs&mage	= s_I_onart_lt6m_nvs&mage * sf_2022;
n_I_onart_gt6m_nvs&mage	= s_I_onart_gt6m_nvs&mage * sf_2022;
n_I_onart_gt6m_vs&mage	= s_I_onart_gt6m_vs&mage * sf_2022;
n_I_offart_1stI&mage		= s_I_offart_1stI&mage * sf_2022;
n_I_offart_SI&mage		= s_I_offart_SI&mage * sf_2022;     
n_I_offart_SIlt6m&mage	= s_I_offart_SIlt6m&mage * sf_2022;
n_I_offart_SIgt6m&mage	= s_I_offart_SIgt6m&mage * sf_2022;

n_I_undiag&wage 			= s_I_undiag&wage * sf_2022;
n_I_diag_naive&wage 		= s_I_diag_naive&wage  * sf_2022;
n_I_diag_startart&wage 	= s_I_diag_startart&wage * sf_2022;
n_I_onart&wage 			= s_I_onart&wage * sf_2022;
n_I_offart&wage			= s_I_offart&wage * sf_2022;
n_I_onart_lt6m&wage		= s_I_onart_lt6m&wage * sf_2022;
n_I_onart_lt6m_nvs&wage	= s_I_onart_lt6m_nvs&wage * sf_2022;
n_I_onart_gt6m_nvs&wage	= s_I_onart_gt6m_nvs&wage * sf_2022;
n_I_onart_gt6m_vs&wage	= s_I_onart_gt6m_vs&wage * sf_2022;
n_I_offart_1stI&wage		= s_I_offart_1stI&wage * sf_2022;
n_I_offart_SI&wage		= s_I_offart_SI&wage * sf_2022;     
n_I_offart_SIlt6m&wage	= s_I_offart_SIlt6m&wage * sf_2022;
n_I_offart_SIgt6m&wage	= s_I_offart_SIgt6m&wage * sf_2022;


n_dead_undiag&age				= s_dead_undiag&age * sf_2022;
n_dead_diag_not_linked&age 		= s_dead_diag_not_linked&age * sf_2022;
n_dead_Alt6_Acd4lt200&age 		= s_dead_Alt6_Acd4lt200&age * sf_2022;
n_dead_Alt6_Acd4gt200&age 		= s_dead_Alt6_Acd4gt200&age * sf_2022;
n_d_I_Alt6_Rcd4lt200&age 		= s_d_I_Alt6_Rcd4lt200&age * sf_2022;
n_d_I_Alt6_Rcd4gt200&age 		= s_d_I_Alt6_Rcd4gt200&age * sf_2022;
n_dead_A_vl1000&age 			= s_dead_A_vl1000&age * sf_2022;
n_dead_A_vg1000&age 			= s_dead_A_vg1000&age * sf_2022;
n_dead_Alt6_vl1000&age 			= s_dead_Alt6_vl1000&age * sf_2022;
n_dead_Alt6_vg1000&age 			= s_dead_Alt6_vg1000&age * sf_2022;
n_dead_Agt6_vl1000&age 			= s_dead_Agt6_vl1000&age * sf_2022;
n_dead_Agt6_vg1000&age 			= s_dead_Agt6_vg1000&age * sf_2022;
n_dead_int_lost&age 			= s_dead_int_lost&age * sf_2022;
n_dead_1stint_lost&age 			= s_dead_1stint_lost&age * sf_2022;
n_dead_subintlt6_lost&age 		= s_dead_subintlt6_lost&age * sf_2022;
n_dead_subintgt6_lost&age 		= s_dead_subintgt6_lost&age * sf_2022;
n_dead_A_cd4lt200&age 			= s_dead_A_cd4lt200&age * sf_2022;
n_dead_A_cd4gt200&age 			= s_dead_A_cd4gt200&age * sf_2022;
n_dead_Alt6_cd4lt200&age 		= s_dead_Alt6_cd4lt200&age * sf_2022;
n_dead_Alt6_cd4gt200&age 		= s_dead_Alt6_cd4gt200&age * sf_2022;
n_dead_Agt6_cd4lt200&age 		= s_dead_Agt6_cd4lt200&age * sf_2022;
n_dead_Agt6_cd4gt200&age 		= s_dead_Agt6_cd4gt200&age * sf_2022;

n_dead_undiag&mage				= s_dead_undiag&mage * sf_2022;
n_dead_diag_not_linked&mage 	= s_dead_diag_not_linked&mage * sf_2022;
n_dead_Alt6_Acd4lt200&mage 		= s_dead_Alt6_Acd4lt200&mage * sf_2022;
n_dead_Alt6_Acd4gt200&mage 		= s_dead_Alt6_Acd4gt200&mage * sf_2022;
n_d_I_Alt6_Rcd4lt200&mage 		= s_d_I_Alt6_Rcd4lt200&mage * sf_2022;
n_d_I_Alt6_Rcd4gt200&mage 		= s_d_I_Alt6_Rcd4gt200&mage * sf_2022;
n_dead_A_vl1000&mage 			= s_dead_A_vl1000&mage * sf_2022;
n_dead_A_vg1000&mage 			= s_dead_A_vg1000&mage * sf_2022;
n_dead_Alt6_vl1000&mage 		= s_dead_Alt6_vl1000&mage * sf_2022;
n_dead_Alt6_vg1000&mage 		= s_dead_Alt6_vg1000&mage * sf_2022;
n_dead_Agt6_vl1000&mage 		= s_dead_Agt6_vl1000&mage * sf_2022;
n_dead_Agt6_vg1000&mage 		= s_dead_Agt6_vg1000&mage * sf_2022;
n_dead_int_lost&mage 			= s_dead_int_lost&mage * sf_2022;
n_dead_1stint_lost&mage 		= s_dead_1stint_lost&mage * sf_2022;
n_dead_subintlt6_lost&mage 		= s_dead_subintlt6_lost&mage * sf_2022;
n_dead_subintgt6_lost&mage 		= s_dead_subintgt6_lost&mage * sf_2022;
n_dead_A_cd4lt200&mage 			= s_dead_A_cd4lt200&mage * sf_2022;
n_dead_A_cd4gt200&mage 			= s_dead_A_cd4gt200&mage * sf_2022;
n_dead_Alt6_cd4lt200&mage 		= s_dead_Alt6_cd4lt200&mage * sf_2022;
n_dead_Alt6_cd4gt200&mage 		= s_dead_Alt6_cd4gt200&mage * sf_2022;
n_dead_Agt6_cd4lt200&mage 		= s_dead_Agt6_cd4lt200&mage * sf_2022;
n_dead_Agt6_cd4gt200&mage 		= s_dead_Agt6_cd4gt200&mage * sf_2022;

n_dead_undiag&wage				= s_dead_undiag&wage * sf_2022;
n_dead_diag_not_linked&wage 		= s_dead_diag_not_linked&wage * sf_2022;
n_dead_Alt6_Acd4lt200&wage 		= s_dead_Alt6_Acd4lt200&wage * sf_2022;
n_dead_Alt6_Acd4gt200&wage 		= s_dead_Alt6_Acd4gt200&wage * sf_2022;
n_d_I_Alt6_Rcd4lt200&wage 		= s_d_I_Alt6_Rcd4lt200&wage * sf_2022;
n_d_I_Alt6_Rcd4gt200&wage 		= s_d_I_Alt6_Rcd4gt200&wage * sf_2022;
n_dead_A_vl1000&wage 			= s_dead_A_vl1000&wage * sf_2022;
n_dead_A_vg1000&wage 			= s_dead_A_vg1000&wage * sf_2022;
n_dead_Alt6_vl1000&wage 			= s_dead_Alt6_vl1000&wage * sf_2022;
n_dead_Alt6_vg1000&wage 			= s_dead_Alt6_vg1000&wage * sf_2022;
n_dead_Agt6_vl1000&wage 			= s_dead_Agt6_vl1000&wage * sf_2022;
n_dead_Agt6_vg1000&wage 			= s_dead_Agt6_vg1000&wage * sf_2022;
n_dead_int_lost&wage 			= s_dead_int_lost&wage * sf_2022;
n_dead_1stint_lost&wage 			= s_dead_1stint_lost&wage * sf_2022;
n_dead_subintlt6_lost&wage 		= s_dead_subintlt6_lost&wage * sf_2022;
n_dead_subintgt6_lost&wage 		= s_dead_subintgt6_lost&wage * sf_2022;
n_dead_A_cd4lt200&wage 			= s_dead_A_cd4lt200&wage * sf_2022;
n_dead_A_cd4gt200&wage 			= s_dead_A_cd4gt200&wage * sf_2022;
n_dead_Alt6_cd4lt200&wage 		= s_dead_Alt6_cd4lt200&wage * sf_2022;
n_dead_Alt6_cd4gt200&wage 		= s_dead_Alt6_cd4gt200&wage * sf_2022;
n_dead_Agt6_cd4lt200&wage 		= s_dead_Agt6_cd4lt200&wage * sf_2022;
n_dead_Agt6_cd4gt200&wage 		= s_dead_Agt6_cd4gt200&wage * sf_2022;
...
n_dead_Alt6_artcd4lt200_  n_dead_Alt6_artcd4gt200_  
n_dead_I_Alt6_Rcd4lt200_  n_dead_I_Alt6_Rcd4gt200_  
...
n_dead_Alt6_artcd4lt200_m  n_dead_Alt6_artcd4lt200_w  
...
n_dead_Alt6_artcd4gt200_m  n_dead_Alt6_artcd4gt200_w  
...
n_dead_I_Alt6_Rcd4lt200_m  n_dead_I_Alt6_Rcd4lt200_w  
...
n_dead_I_Alt6_Rcd4gt200_m  n_dead_I_Alt6_Rcd4gt200_w  
n_d_I_Alt6_Rcd4lt2001519_  n_d_I_Alt6_Rcd4lt2002024_  n_d_I_Alt6_Rcd4lt2002529_  n_d_I_Alt6_Rcd4lt2003034_  n_d_I_Alt6_Rcd4lt2003539_  
n_d_I_Alt6_Rcd4lt2004044_  n_d_I_Alt6_Rcd4lt2004549_  n_d_I_Alt6_Rcd4lt2005054_  n_d_I_Alt6_Rcd4lt2005559_   n_d_I_Alt6_Rcd4lt2006064_  
n_d_I_Alt6_Rcd4lt2006569_  n_d_I_Alt6_Rcd4lt2007074_  n_d_I_Alt6_Rcd4lt2007579_  n_d_I_Alt6_Rcd4lt2008084_  
...
n_I_undiag_m n_I_diag_naive_m n_I_diag_startart_m n_I_onart_m n_I_offart_m n_I_onart_lt6m_m n_I_onart_lt6m_nvn_m 
n_I_onart_gt6m_nvn_m n_I_onart_gt6m_vn_m n_I_offart_1stI_m n_I_offart_SI_m n_I_offart_SIlt6m_m n_I_offart_SIgt6m_m 
n_I_undiag_w n_I_diag_naive_w n_I_diag_startart_w n_I_onart_w n_I_offart_w n_I_onart_lt6m_w n_I_onart_lt6m_nvn_w 
n_I_onart_gt6m_nvn_w n_I_onart_gt6m_vn_w n_I_offart_1stI_w n_I_offart_SI_w n_I_offart_SIlt6m_w n_I_offart_SIgt6m_w 
...
proc print;var s_I_undiag1519m  ss_I_undiag1519m  sf_2022;where cald=2010;run; 



proc print;var cald s_primary s_inf_ep s_inf_newp;run; 
...
l_s_I_undiag&age			l_s_I_undiag&mage			l_s_I_undiag&wage
l_s_I_diag_naive&age		l_s_I_diag_naive&mage		l_s_I_diag_naive&wage
l_s_I_diag_startart&age		l_s_I_diag_startart&mage	l_s_I_diag_startart&wage
l_s_I_onart&age				l_s_I_onart&mage			l_s_I_onart&wage
l_s_I_onart_lt6m&age		l_s_I_onart_lt6m&mage		l_s_I_onart_lt6m&wage
l_s_I_onart_lt6m_nvs&age	l_s_I_onart_lt6m_nvs&mage	l_s_I_onart_lt6m_nvs&wage
l_s_I_onart_gt6m_nvs&age	l_s_I_onart_gt6m_nvs&mage	l_s_I_onart_gt6m_nvs&wage
l_s_I_onart_gt6m_vs&age		l_s_I_onart_gt6m_vs&mage	l_s_I_onart_gt6m_vs&wage
l_s_I_offart_1stI&age		l_s_I_offart_1stI&mage		l_s_I_offart_1stI&wage
l_s_I_offart_SI&age			l_s_I_offart_SI&mage		l_s_I_offart_SI&wage
l_s_I_offart_SIlt6m&age		l_s_I_offart_SIlt6m&mage	l_s_I_offart_SIlt6m&wage
l_s_I_offart_SIgt6m&age		l_s_I_offart_SIgt6m&mage	l_s_I_offart_SIgt6m&wage
