...
prevalence1549_=(s_hiv1549w  + s_hiv1549m ) / (s_alive1549_w + s_alive1549_m);

proc freq;table prevalence1549_;run;

 if cald = 1998.5 and (prevalence1549 < 0.08  or prevalence1549 > 0.19 ) then remove=run;
 if cald = 1999.5 and (prevalence1549 < 0.08  or prevalence1549 > 0.19 ) then remove=run;
 if cald = 2004.5 and (prevalence1549 < 0.07  or prevalence1549 > 0.20 ) then remove=run;
 if cald = 2016.5 and (prevalence1549 < 0.08  or prevalence1549 > 0.12 ) then remove=run;
 if cald = 2020 and p_vl1000 < 0.75 then remove=run;
...
***Remove runs that don't fit with Malawi;
...
prevalence1549_=(s_hiv1549w  + s_hiv15490m ) / (s_alive1549_w + s_alive1549_m);
