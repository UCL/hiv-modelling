...
***Observed data;
%include "C:\Loveleen\Synthesis model\Zim\Calibration\Observed data_Zimbabwe_LBMMay2017.sas";run;
...
ods rtf file = 'C:\Loveleen\Synthesis model\Zim\Zim_10sep.doc' startpage=never; 
