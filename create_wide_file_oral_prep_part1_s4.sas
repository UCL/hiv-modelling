...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\oral_prep\oral_prep_13_s4_out";
...
data a.oral_prep_13_s4      ;
set y;


proc contents data=a.oral_prep_13_s4  ; 
proc freq data=a.oral_prep_13_s4 ; tables run; where cald = 2020;
run;
