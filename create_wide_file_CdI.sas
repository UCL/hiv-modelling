...
* p_age1549_hiv ; 				if s_hivge15 gt 0 then  p_age1549_hiv = (s_hiv1549m + s_hiv1549w) / s_hivge15 ;
* p_age1549_hivneg ;			if ((s_alive_m + s_alive_w) - s_hivge15) gt 0 then 
								p_age1549_hivneg = ((s_alive1549_w + s_alive1549_m) - (s_hiv1549m + s_hiv1549w)) / ((s_alive_m + s_alive_w) - s_hivge15);
...
* gender_r_newp;				if s_w_newp gt 0 then  gender_r_newp = s_m_newp / s_w_newp;

* p_newp_ge1;					if s_alive1564 gt 0 then p_newp_ge1 = s_newp_ge1 / s_alive1564 ;

* p_newp_ge5;					if s_alive1564 gt 0 then p_newp_ge5 = s_newp_ge5 / s_alive1564 ;

* av_newp_ge1;					if s_newp_ge1 gt 0 then av_newp_ge1 = s_newp / s_newp_ge1 ;
...
* p_newp_ge1_age1549;			if (s_alive1549_w + s_alive1549_m) gt 0 then p_newp_ge1_age1549 = (s_w1549_newp_ge1 + s_m1549_newp_ge1) / (s_alive1549_w + s_alive1549_m) ;
...
* p_npge2_l4p_1549m ;			if s_alive1549_m gt 0 then p_npge2_l4p_1549m = s_npge2_l4p_1549m / s_alive1549_m ;
* p_npge2_l4p_1549w ;			if s_alive1549_w gt 0 then p_npge2_l4p_1549w = s_npge2_l4p_1549w / s_alive1549_w ;
...
* p_mcirc_1549m;				if s_ageg1549m gt 0 then p_mcirc_1549m = s_mcirc_1549m / s_ageg1549m ;

* p_vmmc;						p_vmmc = s_vmmc / s_alive_m ;
* p_vmmc_1519m;					if s_ageg1519m gt 0 then p_vmmc_1519m = s_vmmc1519m / s_ageg1519m ;
* p_vmmc_2024m;					if s_ageg2024m gt 0 then p_vmmc_2024m = s_vmmc2024m / s_ageg2024m ;
* p_vmmc_2529m;					if s_ageg2529m gt 0 then p_vmmc_2529m = s_vmmc2529m / s_ageg2529m ;
* p_vmmc_3039m;					if (s_ageg3034m + s_ageg3539m) gt 0 then p_vmmc_3039m = s_vmmc3039m / (s_ageg3034m + s_ageg3539m) ;
* p_vmmc_4049m;					if (s_ageg4044m + s_ageg4549m) gt 0 then p_vmmc_4049m = s_vmmc4049m / (s_ageg4044m + s_ageg4549m) ;
* p_vmmc_1549m;					if s_ageg1549m gt 0 then p_vmmc_1549m = s_vmmc1549m / s_ageg1549m ;
...
* prevalence5054w;				if s_ageg5054w gt 0 then prevalence5054w = s_hiv5054w  / s_ageg5054w ;
* prevalence5054m;				if s_ageg5054m gt 0 then prevalence5054m = s_hiv5054m  / s_ageg5054m ;
* prevalence5559w;				if s_ageg5559w gt 0 then prevalence5559w = s_hiv5559w  / s_ageg5559w ;
* prevalence5559m;				if s_ageg5559m gt 0 then prevalence5559m = s_hiv5559m  / s_ageg5559m ;
* prevalence6064w;				if s_ageg6064w gt 0 then prevalence6064w = s_hiv6064w  / s_ageg6064w ;
* prevalence6064m;				if s_ageg6064m gt 0 then prevalence6064m = s_hiv6064m  / s_ageg6064m ;
* prevalence65plw;				if s_ageg65plw gt 0 then prevalence65plw = s_hiv65plw  / s_ageg65plw ;
* prevalence65plm;				if s_ageg65plm gt 0 then prevalence65plm = s_hiv65plm  / s_ageg65plm ;
...
* prevalence_sw;				if s_sw_1564 gt 0 then  prevalence_sw = s_hiv_sw / s_sw_1564; 
...
* p_onart_m_age50pl;			if (s_onart_m1549_ + s_onart_m50pl) gt 0 then  p_onart_m_age50pl = s_onart_m50pl / (s_onart_m1549_ + s_onart_m50pl);
* p_onart_w_age50pl;			if (s_onart_w1549_ + s_onart_w50pl) gt 0 then p_onart_w_age50pl = s_onart_w50pl / (s_onart_w1549_ + s_onart_w50pl);

* prevalence_vg1000;			if s_alive gt 0 then if s_alive > 0 then prevalence_vg1000 = s_vg1000 / s_alive;
...
/*
prop_1564_hivneg_onprep prop_sw_onprep death_rate p_elig_prep prop_elig_on_prep  n_hiv1_prep
n_death_covid n_death n_death_hivrel p_death_hivrel_age_le64 p_prep_ever  p_hiv1_prep
av_prep_eff_non_res_v  n_prep_elig_w n_prep_elig_m p_ahd_re_enter_care_100 p_ahd_re_enter_care_200
rate_dead_allage rate_dead_hivneg_anycause rate_dead_hivpos_anycause prep_disrup_covid p_prep_elig_past_year  p_prep_elig_past_5year
...
p_mcirc p_mcirc_1519m p_mcirc_2024m p_mcirc_2529m p_mcirc_3034m p_mcirc_3539m p_mcirc_4044m p_mcirc_4549m p_mcirc_1549m
p_vmmc p_vmmc_1519m p_vmmc_2024m p_vmmc_2529m p_vmmc_3039m p_vmmc_4049m p_vmmc_1549m																								 
prop_w_1549_sw  prop_w_1564_sw	prop_w_ever_sw prop_sw_program_visit
prop_sw_hiv prop_w_1524_onprep   p_prep_adhg80
...
prevalence1524w prevalence1524m  prevalence_sw   prevalence_hiv_preg
...
n_sw_1564 n_sw_1549  p_onart  p_vl1000_art_12m  p_vl1000_art_12m_onart
...
n_birth_with_inf_child  dead_ddaly_ntd   ddaly_mtct   dead_ddaly_odabe n_tested n_tested_sw p_vlg1000_onart_65m  p_vlg1000_onart_184m    n_prep  n_covid  
...
p_newp_this_per_prep  p_newp_prep_hivneg    n_onprep_m  n_onprep_w


  n_infected

 n_death_2059_m n_death_2059_w
n_death_hiv_m n_death_hiv_w n_cd4_lt50 n_cd4_lt200
p_age1549_hivneg p_age1549_hiv
 n_death_hivpos_anycause
sf_2023 sex_beh_trans_matrix_m sex_beh_trans_matrix_w sex_age_mixing_matrix_m sex_age_mixing_matrix_w p_rred_p
...
fold_tr fold_tr_newp  switch_for_tox       base_rate_sw  
...
incr_max_freq_testing_year_i */    initial_pr_switch_line     initial_prob_vl_meas_done  
/*
sw_test_6mthly_year_i  art_mon_drug_levels_year_i       ten_is_taf_year_i    lower_future_art_cov e_decr_hard_reach_year_i 
*/
vmmc_disrup_covid  condom_disrup_covid    swprog_disrup_covid  
...
p_prep_newp  prop_1564m_onprep  prop_1564w_onprep    mean_newp_ppers_prep  prop_onprep_newpge1
prop_onprep_newpge2 prop_onprep_newpge3  prop_1564_onprep   n_newp_ge1_w
