...
libname a "C:\Users\loveleen\UCL Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\Genesis_Zim\znasp_package";
...
data b.GenesisZim_znasp_package;
set b;
run;
