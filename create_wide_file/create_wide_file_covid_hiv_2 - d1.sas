...
proc sort data=d1; by run cald option;run;
...
data a.covid_hiv_2_16_9_20_10am_u; set y;  


data y; set a.covid_hiv_2_16_9_20_10am_u; 
...
* To get one row per run;
  ...
  data a.w_covid_hiv_2_16_9_20_10am_d1; 
