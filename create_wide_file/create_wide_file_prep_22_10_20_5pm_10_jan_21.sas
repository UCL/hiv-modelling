...
* note this file tld_prep is used for prep also - we just delete the tld_prep option;
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\tld_prep\c_output_tld_prep_22_10_20_5pm_10_jan_21_temp";
...
/* proc means noprint data=y; var &v; output out=y_20_40 mean= &v._20_40; by run option ; where 2020.5 <= cald < 2040.50; */
 ...
 proc means noprint data=y; var &v; output out=y_21_71 mean= &v._21_71; by run option ; where 2021.5 <= cald < 2071.50;  
...
data &v ; merge y_17 y_20 y_21 y_40 y_70 t_21_26 t_21_71 ;  
