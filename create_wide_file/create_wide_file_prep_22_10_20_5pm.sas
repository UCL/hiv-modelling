...
data d1;  * this data set of n=250 used for draft ms circulated ;
...
s_alive p_w_giv_birth_this_per p_newp_ge1 p_1524_newp_ge1 p_newp_ge5 p_newp_ge1_age1549 gender_r_newp  av_newp_ge1
...
data a.prep_22_10_20_5pm_1; set y;

data y; set a.prep_22_10_20_5pm_1; run;
...
proc means  noprint data=y; var &v; output out=y_17 mean= &v._17; by run ; where cald = 2017; 
...
%var(v=s_alive); %var(v=p_w_giv_birth_this_per); %var(v=p_newp_ge1); %var(v=p_newp_ge1_age1549); %var(v=av_newp_ge1);
...
* To get one row per run;
  ...
  data a.wide_prep_22_10_20_5pm_1; 
