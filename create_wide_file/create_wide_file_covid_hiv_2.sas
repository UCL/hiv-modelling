...
infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\covid_hiv_2\c_output_covid_hiv_2_22_8_20_3pm_1";  
...
infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\covid_hiv_2\c_output_covid_hiv_2_22_8_20_3pm_2";  
...
proc means data=d2; var s_new_vmmc1519m ; where option=0 and cald=2019 ; run;

proc means data=d2; var s_new_vmmc1519m ; where option=0 and cald=2021 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=1 and cald=2021 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=2 and cald=2021 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=3 and cald=2021 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=4 and cald=2021 ; run;

proc means data=d2; var s_new_vmmc1519m ; where option=0 and cald=2023 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=1 and cald=2023 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=2 and cald=2023 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=3 and cald=2023 ; run;
proc means data=d2; var s_new_vmmc1519m ; where option=4 and cald=2023 ; run;
...
* n_new_mcirc;					n_new_mcirc = s_new_mcirc * sf_2019 * 4;
...
data covid_hiv_2_22_8_20_3pm_1_2; set y;  


data y; set covid_hiv_2_22_8_20_3pm_1_2; 
...
* To get one row per run;
  ...
  data a.w_covid_hiv_2_22_8_20_3pm_1_2; 
