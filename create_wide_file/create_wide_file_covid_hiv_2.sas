...
* note data sets d1 d2 d3 created separately by adapting code below;


proc sort data=d3; by run cald option;run;
...
data a.covid_hiv_2_16_9_20_10am_d3; set y;  


data y; set a.covid_hiv_2_16_9_20_10am_d3; 
