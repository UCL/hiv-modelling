...
* note this file tld_prep is used for prep also - we just delete the tld_prep option;
  infile "C:\Users\Toshiba\Dropbox\hiv synthesis ssa unified program\output files\tld_prep\c_output_tld_prep_22_10_20_5pm_21_jan_21_temp";
...
eff_rate_test_startprep   	eff_rate_test_restartprep   	
eff_rate_choose_stop_prep   		eff_prob_prep_restart_choice   	
p_prep_newp  prop_1564m_onprep  prop_1564w_onprep  p_prep_elig_past_year  p_prep_elig_past_5year  mean_newp_per_person_prep
;
...
proc sort data=y;by run option;run;
  ...
  data a.prep_22_10_20_5pm_21_jan_21_temp;

set y;

data y; 

  set a.prep_22_10_20_5pm_21_jan_21_temp;
