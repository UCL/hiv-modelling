...
libname a "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\art_retention";

libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\art_retention\art_retention__out\";
...
* p_c_tox ; 					p_c_tox = s_c_tox / s_onart;
