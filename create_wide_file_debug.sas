...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\pop_wide_tld\debug\";
...
rate_dead_hivpos_cause1 rate_dead_hivpos_cause2 rate_dead_hivpos_cause3 rate_dead_hivpos_cause4
...
n_cd4_lt200 n_inf_pre_yr_interv  n_inf_post_yr_interv n_death_hiv_inf_pre_yr_interv   n_death_hiv_inf_post_yr_interv rate_dead_hivpos_anycause
rate_dead_hivpos_cause1 rate_dead_hivneg_cause2 rate_dead_hivpos_cause2 rate_dead_hivpos_cause3 rate_dead_hivpos_cause4
;
...
%par(p=rr_non_aids_death_hiv_off_art); %par(p=rr_non_aids_death_hiv_on_art);
...
proc means; var rate_dead_hivpos_anycause_3y_1  
rate_dead_hivpos_cause1_3y_1
rate_dead_hivpos_cause2_3y_1
rate_dead_hivpos_cause3_3y_1
rate_dead_hivpos_cause4_3y_1
death_rate_hiv_3y_1 
rate_dead_hivneg_cause2_3y_1
;
where rr_non_aids_death_hiv_off_art = 1.5 and rr_non_aids_death_hiv_on_art = 1.1  ;
run; 

proc glm; 
class rr_non_aids_death_hiv_off_art rr_non_aids_death_hiv_on_art;
model rate_dead_hivpos_cause2_3y_1 = rr_non_aids_death_hiv_off_art rr_non_aids_death_hiv_on_art / solution;
run;
