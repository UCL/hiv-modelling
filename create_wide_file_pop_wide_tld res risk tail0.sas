...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\lapr\pop_wide_tld11_res_risk_tail0_out\";

data i1; set b.out1:; data i2; set b.out2:; data i3; set b.out3:; data i4; set b.out4:; data i5; set b.out5:; 
data i6; set b.out6:; data i7; set b.out7:; data i8; set b.out8:; data i9; set b.out9:;  


%let laprv =  pop_wide_tld11_res_risk_tail0  ;

data a.k_pop_wide_tld11_res_risk_tail0;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;

proc sort data=a.k_pop_wide_tld11_res_risk_tail0; 
by run cald option;
run;
...
set a.k_pop_wide_tld11_res_risk_tail0 ;
...
data y; 
merge a.k_pop_wide_tld11_res_risk_tail0 sf;
by run ;
...
* for pop_wide_tld11_res_risk_tail0 to get n=1000;
* if run in (
519697 
670623 
1560012 
...
data    a.l_pop_wide_tld11_res_risk_tail0_y; set y;  

proc freq; tables run; where cald = 2020;

run;

data y ; set a.l_pop_wide_tld11_res_risk_tail0_y; 
...
* To get one row per run;
  ...
  data  a.w_pop_wide_tld11_res_risk_tail0     ; 
  merge a.wide_outputs         a.wide_par     ;
  by run;


  data w_pop_wide_tld ;
  set a.w_pop_wide_tld11_res_risk_tail0 ;
...
* if run <=  958425156 ;  * for n=1000 pop_wide_tld11_res_risk_tail0 ;
