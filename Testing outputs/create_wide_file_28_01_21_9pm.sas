...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\FSW\c_output_fsw_28_01_21";
...
data a.fsw_28_01_21_9pm; set y;run;


data y; set a.fsw_28_01_21_9pm; run;
