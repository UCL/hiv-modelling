/* COSTS FOR HIV CONTROL PROJECT - CdI */
...
* HIV testing;
* Per person tested;
%let cost_per_facility_test=22.55;
%let cost_per_contact_tracing=27.52;
%let cost_per_self_test=12.75;

* ART;
%let cost_art_pppy=121.37;			* Ingredients-based, pppy;
%let cost_pmtct_per_test=22.55;		* Per woman tested at ANC;
...
%let cost_prep_oral_pppy=84.36;
%let cost_prep_cab_pppy=93.40;	
%let cost_prep_len_pppy=75.89;	

* VMMC;
%let cost_VMMC_per_procedure=0;

* Key pop programs;
* Per person reached;
%let cost_FSW_services_pppy=33.45; ***hugely different to Zim (234);
%let cost_MSM_services_pppy=37.10;
