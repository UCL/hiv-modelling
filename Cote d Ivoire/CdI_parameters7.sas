...
* prob_loss_at_diag;  		prob_loss_at_diag = 0.05;
...
* prop_v_alert_perm;		prop_v_alert_perm=0.3;  ***Reduce impact of VL alert impacting long term adherence;
* adh_effect_of_meas_alert; adh_effect_of_meas_alert=0.2;
