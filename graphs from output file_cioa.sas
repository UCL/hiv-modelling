...
libname a "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\cioa_s_out\";
...
yaxis grid label	= 'incidence1549_'		labelattrs=(size=12)  values = (0   to  1   by  0.1 )  valueattrs=(size=10);
...
* band    x=cald lower=p5_incidence1549__1 upper=p95_incidence1549__1 / transparency=0.9 fillattrs = (color=lightgrey     ) legendlabel= "90% range";
...
series  x=cald y=p50_incidence1549__4 / lineattrs = (color=darkredred       thickness = 4);
...
series  x=cald y=p50_prevalence1549__4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_prevalence1549__4 upper=p95_prevalence1549__4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=mean_n_hiv_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_hiv_4 upper=p95_n_hiv_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_prevalence_vg1000__4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_prevalence_vg1000__4 upper=p95_prevalence_vg1000__4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=mean_cost_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_cost_4 upper=p95_cost_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_onart_diag_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_onart_diag_4 upper=p95_p_onart_diag_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_tested_past_year_1549w_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_tested_past_year_1549w_4 upper=p95_p_tested_past_year_1549w_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_diag_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_diag_4 upper=p95_p_diag_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_newp_ge1__4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_newp_ge1__4 upper=p95_p_newp_ge1__4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=mean_n_death_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_death_4 upper=p95_n_death_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_n_pcp_p_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_pcp_p_4 upper=p95_n_pcp_p_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_n_tested_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_tested_4 upper=p95_n_tested_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
Title '';  Title    height=1.5 justify=center "p_diag";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'p_diag'		labelattrs=(size=12)  values = (0.5 to  1   by  0.1 )  valueattrs=(size=10);

series  x=cald y=p50_p_diag_0 / lineattrs = (color=grey     thickness = 4);
* band    x=cald lower=p5_p_diag_0 upper=p95_p_diag_0 / transparency=0.9 fillattrs = (color=grey    ) legendlabel= "90% range";

series  x=cald y=p50_p_diag_1 / lineattrs = (color=green          thickness = 4);
* band    x=cald lower=p5_p_diag_1 upper=p95_p_diag_1 / transparency=0.9 fillattrs = (color=lightgrey     ) legendlabel= "90% range";

series  x=cald y=p50_p_diag_2 / lineattrs = (color=lightblue thickness = 4);
* band    x=cald lower=p5_p_diag_2 upper=p95_p_diag_2 / transparency=0.9 fillattrs = (color=lightblue    ) legendlabel= "90% range";
...
series  x=cald y=p50_p_diag_4 / lineattrs = (color=darkredred       thickness = 4);
...
ods html;
proc sgplot data=d nolegend; 
Title '';  Title    height=1.5 justify=center "n tested";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'n_tested'		labelattrs=(size=12)  values = (0 to  2000000     by  500000 )  valueattrs=(size=10);

series  x=cald y=p50_n_tested_0 / lineattrs = (color=grey     thickness = 4);
* band    x=cald lower=p5_n_tested_0 upper=p95_n_tested_0 / transparency=0.9 fillattrs = (color=grey    ) legendlabel= "90% range";

series  x=cald y=p50_n_tested_1 / lineattrs = (color=green          thickness = 4);
* band    x=cald lower=p5_n_tested_1 upper=p95_n_tested_1 / transparency=0.9 fillattrs = (color=lightgrey     ) legendlabel= "90% range";

series  x=cald y=p50_n_tested_2 / lineattrs = (color=lightblue thickness = 4);
* band    x=cald lower=p5_n_tested_2 upper=p95_n_tested_2 / transparency=0.9 fillattrs = (color=lightblue    ) legendlabel= "90% range";
...
series  x=cald y=p50_n_tested_4 / lineattrs = (color=darkredred       thickness = 4);
...
series  x=cald y=p50_n_self_tested_1 / lineattrs = (color=green          thickness = 4);
* band    x=cald lower=p5_n_self_tested_1 upper=p95_n_self_tested_1 / transparency=0.9 fillattrs = (color=lightgrey     ) legendlabel= "90% range";

series  x=cald y=p50_n_self_tested_2 / lineattrs = (color=lightblue thickness = 4);
* band    x=cald lower=p5_n_self_tested_2 upper=p95_n_self_tested_2 / transparency=0.9 fillattrs = (color=lightblue    ) legendlabel= "90% range";
...
series  x=cald y=p50_n_self_tested_4 / lineattrs = (color=darkredred       thickness = 4);
...
series  x=cald y=p50_n_mtct_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_mtct_4 upper=p95_n_mtct_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_dcost_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_dcost_4 upper=p95_dcost_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_cost_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_cost_4 upper=p95_cost_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_cost_per_adult_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_cost_per_adult_4 upper=p95_cost_per_adult_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_n_prep_oral_4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_n_prep_oral_4 upper=p95_n_prep_oral_4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_onartvisit0__4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_onartvisit0__4 upper=p95_p_onartvisit0__4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
...
series  x=cald y=p50_p_onartvisit0_vl1000__4 / lineattrs = (color=red       thickness = 4);
band    x=cald lower=p5_p_onartvisit0_vl1000__4 upper=p95_p_onartvisit0_vl1000__4 / transparency=0.9 fillattrs = (color=red      ) legendlabel= "90% range";
