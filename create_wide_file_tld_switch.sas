...
data b.k_tld_switch_z;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_tld_switch_z; 
by run cald option;
run;
...
data    b.l_tld_switch_z; set y;  

data y ; set b.l_tld_switch_z; 
