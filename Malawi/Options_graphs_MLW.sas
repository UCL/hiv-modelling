...
label mean_p_onart_vl1000__17 = "VL and CD4 testing";
...
series  x=cald y=mean_incidence_1564sw_7/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_1564sw_10/	lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_1564sw_13/	lineattrs = (color=blue thickness = 2 pattern=solid);
run;quit;
...
series  x=cald y=mean_prevalence_agyw_8/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_prevalence_agyw_11/	lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_prevalence_agyw_14/	lineattrs = (color=blue thickness = 2 pattern=solid);
run;quit;
...
series  x=cald y=mean_incidence_agyw_8/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_agyw_11/lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_agyw_14/lineattrs = (color=blue thickness = 2 pattern=solid);
run;quit;
...
series  x=cald y=mean_p_onprep_agyw_8/	lineattrs = (color=purple thickness = 2 pattern=solid);
...
series  x=cald y=mean_prevalence1549_msm_9/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_prevalence1549_msm_12/lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_prevalence1549_msm_15/lineattrs = (color=blue thickness = 2 pattern=solid);
run;quit;
...
series  x=cald y=mean_incidence_msm_9/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_msm_12/	lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_incidence_msm_15/	lineattrs = (color=blue thickness = 2 pattern=solid);
run;quit;
...
series  x=cald y=mean_p_onprep_msm_9/	lineattrs = (color=purple thickness = 2 pattern=solid);
series  x=cald y=mean_p_onprep_msm_12/	lineattrs = (color=lightpurple thickness = 2 pattern=solid);
series  x=cald y=mean_p_onprep_msm_15/	lineattrs = (color=blue thickness = 2 pattern=solid);
