...
libname a "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260116_out\";
...
proc export data=a.outputs_&op_num
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260116_out\outputs_&op_num..csv" 
	dbms=csv replace; 
	putnames=no;
run;
