...
inputdir="${HOME}"
tmpfiles="out_"
combinedsas="Genesis_Zim_06Feb26_package"
runs="1000"
jobname="hivmodel_zimpack"
model="hiv_synthesis_GenesisZim_06Feb26_package.sas"
clock="h_rt=48:00:00"
account="HIVSynthMod"
...
qsub -N $jobname -t 1-$runs -tc 10 -wd $finaloutdir -P AllUsers -l $clock -v SASINPUT=$inputdir,SASOUTPUTDIR=$finaloutdir,SASMODEL=$model,SASTMPFILES=$tmpfiles $inputdir/testmodel.sh
