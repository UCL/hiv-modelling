...
if gender=1 then do;
		 if          d_s_newp >= 10000 then rred_balance = 0.01 ;
	...
	else if .     <= d_s_newp < -10000 then rred_balance =100;
end;
else if gender=2 then do;
	     if          d_s_newp >= 10000 then rred_balance = 100;
	...
	else if .     <= d_s_newp < -10000 then rred_balance = 0.01;
end;
...
sw_1549=0;sw_1849=0;sw_1519=0;sw_2024=0;sw_2529=0;sw_3039=0;sw_ov40=0;sw_newp=0;sw1524_newp=0;
...
keep_going_1999=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549 and 1/2   <= cum_ratio_newp_mw < 2   then keep_going_1999=1;
...
incidence1549 = s_primary1549 / (s_alive1549 - s_hiv1549 + s_primary1549);
keep_going_2004=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549 and prev_ratio_1524 > 1 and 1/1.5 <= cum_ratio_newp_mw < 1.5 then keep_going_2004=1;
...
keep_going_2016=0;
if ratio_prev_age2529w_overall > 0.6 and sex_ratio_prev_age2024 > 1.5 and 1/1.2 <= cum_ratio_newp_mw < 1.2 then keep_going_2016=1;
...
and 1/1.2 <= cum_ratio_newp_mw < 1.2
...
data x; set cum_l1;
   file "/home/rmjlaph/Scratch/_output_18_9_19_prep_8am_&dataset_id";  
*  file "/home/rmjllob/Scratch/_output_17_9_19_prep_5pm_&dataset_id";  
