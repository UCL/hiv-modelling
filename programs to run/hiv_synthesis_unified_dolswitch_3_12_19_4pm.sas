...
- 3_12_19 4pm  - adjust range of fx, dist of gx, add in v{t}=vmax{t-1} after more than 3 months of interruption
...
* gx;		r=uniform(0);  if r < 0.5 then gx = 1.0; if 0.5 <= r  then gx = 2.0;  
...
incidence1549w = s_primary1549w / (s_alive1549_w - s_hiv1549w + s_primary1549w);
incidence1549m = s_primary1549m / (s_alive1549_m - s_hiv1549m + s_primary1549m);
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_dolswitch_3_12_19_4pm_&dataset_id";  
put   
