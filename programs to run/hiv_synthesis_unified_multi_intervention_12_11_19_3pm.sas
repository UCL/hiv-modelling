...
* cascade of care;
		...
		if _u1 < 1.0 then cascade_care_improvements = 1;
		if cascade_care_improvements = 1 then do;
		
* incr_test_2020; 		incr_test_2020 = 0; if _u43 < 0.75 then do;  
...
* incr_test_targeting_2020;	
						incr_test_targeting_2020 = 0; if _u42 < 0.375 then incr_test_targeting_2020=1;
						if 0.375 <= _u42 < 0.75 then incr_test_targeting_2020=2;
...
* incr_max_freq_testing_2020;
						incr_max_freq_testing_2020 = 0; if _u44 < 0.75 then incr_max_freq_testing_2020=1;
...
* sw_test_6mthly_2020; sw_test_6mthly_2020 = 0;
						if _u45 < 0.75 then do; 
							sw_test_6mthly_2020 = 1; sw_test_6mthly =1; 
						end;
						
* incr_adh_2020;  		incr_adh_2020 = 0;  if _u3 < 0.75 then do; 
...
* reg_option_switch_2020;	
						reg_option_switch_2020 = 0;
						if _u49 < 0.33 then do; reg_option = 104; reg_option_switch_2020 = 104; end;
						if 0.33 <= _u49 < 0.67 then do; reg_option = 116; reg_option_switch_2020 = 116; end;
						if 0.67 <= _u49       then do; reg_option = 103; reg_option_switch_2020 = 103; end;

* art_mon_drug_levels_2020;
						art_mon_drug_levels_2020 = 0;
						if _u50 < 0.75 then do;
...
* incr_adh_pattern_prep_2020;
						incr_adh_pattern_prep_2020 = 0;  
						if _u25 < 0.75 then do; 
							incr_adh_pattern_prep_2020 = 1; 
							adhav_pr = adhav*1.00; 
						end;		

* inc_r_test_startprep_2020;
						inc_r_test_startprep_2020 = 0;  if _u26 <= 0.75 then do; 
...
* incr_prepuptake_sw_2020;
						incr_prepuptake_sw_2020 = 0;  
						if _u34 < 0.75 then do; incr_prepuptake_sw_2020 = 1; 
							if _u35 < 0.8 and prep_willing_sw = 0 then prep_willing_sw = 1;
						end;		

* incr_prepuptake_pop_2020;
						incr_prepuptake_pop_2020 = 0;  
						if _u36 < 0.75 then do; 
...
* circumcision;			if _u39 < 0.75 then circ_improvements = 1;
...
* increase condom use - decrease in newp;
						condom_incr_2020 = 0;
						if _u41 < 0.25 then condom_incr_2020 = 1;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_multi_intervention_12_11_19_3pm_&dataset_id";  
put   
