...
if t ge 2 and caldate{t-1} < 2070.0  and death=. then caldate{t}=caldate{t-1}+0.25; * dependent_on_time_step_length ;
* ts1m ; * change this line to: 
if t ge 2 and caldate{t-1} < 2070.0  and dead_tm1 ne 1 and dead_tm1 ne .  then caldate{t}=caldate{t-1} + (1/12);
;
...
if t ge 2 and caldate{t} < 2070.0 and death =.  then do;
...
if epi=1 then do;  * dependent_on_time_step_length ;  
	if epvls=1    then do; risk_eip = max(0,tr_rate_undetec_vl+(0.000025*normal(0)));          vl_source=1;	s_prop_rm=s_prop_vlg1_rm; end;
	if epvls ne 1 then do;
		if epi_tm1 =0 then do; risk_eip = max(0,tr_rate_primary+(0.075*normal(0))); ep_primary=1; vl_source=6;	s_prop_rm=s_prop_vlg6_rm; end;* infection in primary;
		if epi_tm1 =1 then do; risk_eip = max(0,(0.05*fold_tr)+(0.0125*normal(0)));               vl_source=4;	s_prop_rm=s_prop_vlg4_rm; end;
...
d=uniform(0);
if (s_hiv1564  <= 0) and caldate{t}=startyr and newp >= newp_seed and d < 0.8   and infection=.  then do; 
...
if t ge 2 and . < infection < caldate{t} < 2070.0 and dead_tm1 ne 1  then do;
...
data sums; set r&da1; if serial_no =  3000;
keep sum_newp   ;

data r&da1; merge r&da1 sums;

proc print; var run_ cald sum_newp&j s_newp;
...
proc means; var 
rred  newp_factor  rred_a  rred_p  rred_adc  rred_d  rred_rc  rred_balance_m  rred_balance_w ych_risk_beh_newp  rred_ep  
prevalence1549m prevalence1549w age incidence1549w incidence1549m sex_beh_trans_matrix_w  sex_age_mixing_matrix_w sex_beh_trans_matrix_m  
sex_age_mixing_matrix_m  cum_ratio_newp_mw s_m_newp  s_w_newp  s_newp_sw r_s_newp   risk_nippnp_m   risk_nippnp_w  sw1549  
nip_m  nip_w   risk_nip_m  risk_nip_w   epi_m  epi_w s1_m s2_m s3_m s4_m s1_f s2_f caldate&j
newp_f_age1524 newp_f_age2534 newp_f_age3544  newp_m_age1524 newp_m_age2534 newp_m_age3544 ; 
where 14.9 <= age < 65;
run;
...
proc freq; tables newp ; where gender=1 and 15 <= age < 50 ; 
proc freq; tables newp ; where gender=2 and 15 <= age < 50 ; 
proc freq; tables cald s_m_newp s_w_newp sw1 hiv newp_factor ; 
where 15 <= age < 50 ;  
run;
...
proc means; var caldate&j  rred  newp_factor  rred_a  rred_p  rred_adc  rred_d  rred_rc  rred_balance_m
rred_balance_w ych_risk_beh_newp  rred_ep  prevalence1549m
prevalence1549w age incidence1549  sex_beh_trans_matrix_w  sex_age_mixing_matrix_w sex_beh_trans_matrix_m  sex_age_mixing_matrix_m  cum_ratio_newp_mw
s_m_newp  s_w_newp  s_newp_sw 
r_s_newp  newp_ge1_m newp_ge1_w  risk_nippnp_m   risk_nippnp_w  sw1549  nip_m  nip_w   risk_nip_m  risk_nip_w   epi_m  epi_w
 s1_m s2_m s3_m s4_m s1_f s2_f 
; 
where 14.9 <= age < 65;
run;
...
proc freq; tables newp ; 
where gender=1 and 15 <= age < 50 ; 
proc freq; tables cald s_m_newp s_w_newp  sw1 newp ; 
where gender=2 and 15 <= age < 50 ;  
run;

proc print; var caldate&j gender rred   newp_factor  rred_a  rred_p  rred_adc  rred_d  rred_rc  rred_balance  rred_ep  newp 
...
proc print; 
var caldate&j gender age newp sw ep mcirc prob_birth_circ date_mcirc; 
where gender=1 and 10 <= age < 65 ; 
run;



proc freq; tables  mcirc ; where gender=1 and 15 <= age < 20 ; run;
proc freq; tables  mcirc ; where gender=1 and 20 <= age < 25 ; run;
proc freq; tables  mcirc ; where gender=1 and 25 <= age < 30 ; run;
proc freq; tables  mcirc ; where gender=1 and 30 <= age < 35 ; run;
proc freq; tables  mcirc ; where gender=1 and 35 <= age < 40 ; run;
proc freq; tables  mcirc ; where gender=1 and 40 <= age      ; run;


proc freq; tables caldate&j gender newp ep hiv sex_beh_trans_matrix_m sex_age_mixing_matrix rred_balance;  
where gender =1 and 15 <= age < 65; run;
proc freq; tables caldate&j gender newp ep hiv sw base_rate_sw sex_beh_trans_matrix_w sex_age_mixing_matrix rred_balance; 
where gender =2 and 15 <= age < 65; run;
proc freq; tables gender newp age ; 
where gender =2 and 15 <= age < 25; run;
...
proc freq; tables  gender  newp  hiv ep  sw   rred_rc  ych_risk_beh_newp p_rred_p p_hsb_p ; 
where gender=2 and 15 <= age < 65 ;
run;
*/
...
proc print; var caldate&j age newp ep nip mcirc prep hiv tested registd onart vl cd4 prob_vl_meas_done vm vc adc ;
where age ge 15;
run; 
...
/*primary infection*/
primary 		primary1549   primary1549m  primary1549w  infected_primary  inf_primary
...
/*Number ep and newp*/
rbm  np  newp  newp_ge1  newp_ge5  newp_ge10  newp_ge50  ep   ep_m    ep_w    npge10  npge2  npge2_l4p_1549m  npge2_l4p_1549w   
...
/*status of partner*/
eph0_m  	eph0_w    nip  	 epi    
newp_hiv  newp_ge1_hiv_diag   epdiag  diag_epun  epart  epvls
...
/*resistance*/
tam1_  tam2_  tam3_  m184m_  k103m_  y181m_  g190m_  nnm_  q151m_  k65m_  
p32m_  p33m_  p46m_  p47m_   p50vm_  p50lm_  p54m_   p76m_ p82m_   p84m_  p88m_  p90m_  pim_ 
inpm_  insm_  rm_    i_nnm 	 i_rm    i_pim  	 i_tam 	   i_im	   inm_    i_184m	  im_art   pim_art  tam_art  m184_art
r_	 r_3tc  r_nev  r_lpr   r_taz   r_efa   r_ten   r_zdv r_dol
rme_   iime_  nnme_  pime_   nrtime_ 
...
elig_prep_w_1524 elig_prep_w_2534 elig_prep_w_3544    prep_w_2534      prep_w_3544 
...
tested  tested_m  tested_f  tested_f_non_anc  tested_f_anc  ever_tested_m  ever_tested_w  firsttest
...
/*ART*/
art_initiation_strategy  art_monitoring_strategy  naive  onart  int_clinic_not_aw
...
eponart_m  eponart_w  hiv1564_onart  dead1564_onart  who3_art_init  who4_art_init  art_start_pregnant 
...
c_tox  cur_dol_cns_tox  cur_efa_cns_tox  rel_dol_tox  dol_higher_potency  
...
/*visits and linkage*/
visit  lost    linked_to_care  linked_to_care_this_period
pre_art_care      
...
dead1564_  death_hiv  dead_diag  dead_naive  dead_onart  dead_line1_lf0  dead_line1_lf1  dead_line2_lf1  dead_line2_lf2 
...
/*sex workers*/
base_rate_sw  sw	sw_1549   sw_1849  sw_1519  sw_2024  sw_2529  sw_3039  sw_ov40  
...
/*ADC etc*/
adc  who3_event    who4_   tb    adc_diagnosed onart_adc  adc_naive  adc_line1_lf0  adc_line1_lf1  adc_line2_lf1 
...
s_elig_prep_w_1524 s_elig_prep_w_2534 s_elig_prep_w_3544     s_prep_w_2534      s_prep_w_3544 
...
birth_circ  mcirc_1014m  new_mcirc_1014m  vmmc1014m
...
drop i;
data r&da2; merge r&da1 s; if age  >= year_start;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_prep_26_1_20_1pm_&dataset_id";  
put   
