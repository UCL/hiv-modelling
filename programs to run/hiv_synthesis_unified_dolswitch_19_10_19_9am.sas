...
o_zdv_tox = 1; if o_zdv = 1 and c_tox&j = 1 then o_zdv_tox = 1;
o_3tc_tox = 1; if o_3tc = 1 and c_tox&j = 1 then o_3tc_tox = 1;
o_ten_tox = 1; if o_ten = 1 and c_tox&j = 1 then o_ten_tox = 1;
o_taz_tox = 1; if o_taz = 1 and c_tox&j = 1 then o_taz_tox = 1;
o_lpr_tox = 1; if o_lpr = 1 and c_tox&j = 1 then o_lpr_tox = 1;
o_efa_tox = 1; if o_efa = 1 and c_tox&j = 1 then o_efa_tox = 1;
o_nev_tox = 1; if o_nev = 1 and c_tox&j = 1 then o_nev_tox = 1;
o_dol_tox = 1; if o_dol = 1 and c_tox&j = 1 then o_dol_tox = 1;

o_zdv_adh_hi = 1; if o_zdv = 1 and adh&j >= 0.8 then o_zdv_adh_hi = 1;
o_3tc_adh_hi = 1; if o_3tc = 1 and adh&j >= 0.8 then o_3tc_adh_hi = 1;
o_ten_adh_hi = 1; if o_ten = 1 and adh&j >= 0.8 then o_ten_adh_hi = 1;
o_taz_adh_hi = 1; if o_taz = 1 and adh&j >= 0.8 then o_taz_adh_hi = 1;
o_lpr_adh_hi = 1; if o_lpr = 1 and adh&j >= 0.8 then o_lpr_adh_hi = 1;
o_efa_adh_hi = 1; if o_efa = 1 and adh&j >= 0.8 then o_efa_adh_hi = 1;
o_nev_adh_hi = 1; if o_nev = 1 and adh&j >= 0.8 then o_nev_adh_hi = 1;
o_dol_adh_hi = 1; if o_dol = 1 and adh&j >= 0.8 then o_dol_adh_hi = 1;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_dolswitch_19_10_19_9am_&dataset_id";  
put   
