...
* prob_vl_meas_done; r=uniform(0); prob_vl_meas_done=0.85; if 0.25 <= r < 0.50 then prob_vl_meas_done=0.25; if 0.50 <= r < 0.75 then prob_vl_meas_done=1.00; if 0.75 <= r then prob_vl_meas_done=0.00;
...
* pop_wide_tld_2020;	pop_wide_tld_2020 = 0;
						if _u47 < 0.50 then do;  
							pop_wide_tld_2020 = 1; pop_wide_tld = 1; expand_prep_to_all_2020 = 1; prep_strategy = 7;prob_prep_pop_wide_tld = 0.50; 
							decr_rate_choose_stop_prep_2020 = 1; eff_rate_choose_stop_prep = eff_rate_choose_stop_prep = 0.05 ; 
...
* inc_r_test_startprep_2020;
						inc_r_test_startprep_2020 = 0;  if _u26 <= 0.9 then do; 
...
if epi{t}=1 then do;
	...
	if gender=1 and mcirc   =1   then risk_eip = risk_eip* 0.4;  * lower transmission risk in men circumcised;
		...
		if prep   =1 then do; 
			...
			if m184m_p=1 and k65m_p=1 and (inpm_p ne 1 and pop_wide_tld_prep=1)  then risk_eip = risk_eip * (1-(adh{t} * 0.75 * eff_adh_prep));
...
keep_going_1999=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549  then keep_going_1999=1;
...
incidence1549 = s_primary1549 / (s_alive1549 - s_hiv1549 + s_primary1549);
keep_going_2004=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549 and prev_ratio_1524 > 1 then keep_going_2004=1;
...
keep_going_2016=0;
if ratio_prev_age2529w_overall > 0.5 and prev_ratio_1524 > 1.5 then keep_going_2016=1;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_prep_28_9_19_1pm_&dataset_id";  
put   
