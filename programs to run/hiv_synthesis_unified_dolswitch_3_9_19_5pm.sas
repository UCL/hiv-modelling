...
***** Sexual behaviour;
* base_rate_sw; r=uniform(0);  if 0 <= r < 0.33 then base_rate_sw = 0.0005;   if 0.33 <= r < 0.67 then base_rate_sw = 0.0007;   
								 if 0.67 <= r then base_rate_sw = 0.001;   
* base_rate_stop_sexwork;   r=uniform(0); base_rate_stop_sexwork = 0.03; if r < 0.33 then base_rate_stop_sexwork = 0.015;
							 if r > 0.67 then base_rate_stop_sexwork = 0.05;
...
* sex_age_mixing_matrix;e=uniform(0); sex_age_mixing_matrix=4; if e < 0.23 then sex_age_mixing_matrix=1;
			if 0.25 <= e < 0.5 then sex_age_mixing_matrix=2;if 0.5 <= e < 0.75 then sex_age_mixing_matrix=3;
* rred_a_p;	r=uniform(0); if r < 0.33 then rred_a_p=1; if 0.33 <= r < 0.67 then rred_a_p=2;  if r > 0.67 then rred_a_p=3; 
* p_rred_p; r=uniform(0); if r < 0.33 then p_rred_p = 0.1; if 0.33 <= r < 0.67 then p_rred_p = 0.3; 
			if 0.67 <= r  then p_rred_p = 0.5;  	
* p_hsb_p; 	r=uniform(0); if r < 0.33 then p_hsb_p = 0.10; if 0.33 <= r < 0.67 then p_hsb_p = 0.15; if 0.67 <= r then p_hsb_p = 0.2;
* newp_factor; newp_factor = 0.01;
...
* fold_change_w; r=uniform(0); if r < 0.05 then fold_change_w = 1; if 0.05 <= r < 0.10 then fold_change_w = 1.25; if 0.10 <= r then fold_change_w = 1.5; *dec16 changed from ms4d;
...
* adh_pattern; r=uniform(0);  if  r < 0.02 then adh_pattern=98 ;if 0.02 <= r < 0.04 then adh_pattern=105; if 0.04 <= r < 0.15 then adh_pattern=101; 
				if 0.15 <= r < 0.45 then adh_pattern=99; if 0.45 <= r < 0.80 then adh_pattern=1;   if 0.80 <= r < 0.90 then adh_pattern=2;   
				if 0.90 <= r < 0.95 then adh_pattern=3;   if 0.95 <= r < 0.98 then adh_pattern=4; if 0.98 <= r  then adh_pattern=5; * jan18;
...
r=uniform(0);
life_sex_risk=2; rred_p=1;
if r < p_rred_p then do; life_sex_risk = 1;  rred_p=0.001; end;
...
if cu2/cu4 <= a < cu3/cu4 then do; ne=uniform(0); if e < 0.22 then newp1=4; if 0.22 <= e < 0.42 then newp1=5; if 0.42 <= e < 0.60 then newp1=6; 
...
if 15 <= age1 < 18 and life_sex_risk = 2 and e < 0.010 then sw1=1;
if 18 <= age1 < 20 and life_sex_risk = 2 and e < 0.010 then sw1=1;
if 20 <= age1 < 25 and life_sex_risk = 2 and e < 0.010 then sw1=1;
if 25 <= age1 < 40 and life_sex_risk = 2 and e < 0.008 then sw1=1;
if 40 <= age1 < 50 and life_sex_risk = 2 and e < 0.003 then sw1=1;

if 15 <= age1 < 18 and life_sex_risk = 3 and e < 0.30  then sw1=1;
if 18 <= age1 < 20 and life_sex_risk = 3 and e < 0.30  then sw1=1;
if 20 <= age1 < 25 and life_sex_risk = 3 and e < 0.10  then sw1=1;
if 25 <= age1 < 40 and life_sex_risk = 3 and e < 0.03  then sw1=1;
if 40 <= age1 < 50 and life_sex_risk = 3 and e < 0.01  then sw1=1;
...
if sw1 = 1 then do;
e=uniform(0);
if e < 0.2 then newp1=0;
if 0.2 <= e < 0.7 then do; q=uniform(0); 
...
if 0.7 <= e < 0.90 then do; q=uniform(0); 
...
if option = 0 then reg_option = 113;
if option = 1 then reg_option = 115;
if option = 2 then reg_option = 116;
if option = 3 then reg_option = 117;
if option = 4 then reg_option = 104;
if option = 5 then reg_option = 118;

* this below is just so dont need to delete these parameter names below;

condom_incr_2020 = .; 		  cascade_care_improvements = .;    incr_test_2020 = .;             decr_hard_reach_2020 = .;   incr_adh_2020_= .; 
decr_prob_loss_at_diag_2020 = .; 	  decr_rate_lost_2020_= .; 		    decr_rate_lost_art_2020 = .;    incr_rate_return_2020 = .;     
...
circ_improvements = .; 			  circ_inc_rate_2020 = .; 		     incr_test_targeting_2020 = .;   option_0_prep_continue_2020_= .; 
incr_max_freq_testing_2020 = .;      initial_pr_switch_line = .;       initial_prob_vl_meas_done = .;  sw_test_6mthly_2020 = .;  
reg_option_switch_2020_= .; art_mon_drug_levels_2020 = .;  ten_is_taf_2020_= .; 		pop_wide_tld_2020_= .; 
incr_adh_2020= .;  decr_rate_lost_2020= .;  option_0_prep_continue_2020= .;  reg_option_switch_2020= .;  pop_wide_tld_2020= .;  
...
* reg_option_switch_2020;	
						reg_option_switch_2020 = 0;
						if _u49 < 0.45 then do; reg_option = 104; reg_option_switch_2020 = 104; end;
						if 0.45 <= _u49 < 0.9 then do; reg_option = 116; reg_option_switch_2020 = 116; end;
...
* prep;			if _u48 < 0.9 then prep_improvements = 1;
				if prep_improvements = 1 then do;

* incr_adh_pattern_prep_2020;
						incr_adh_pattern_prep_2020 = 0;  
						if _u25 < 0.90 then do; 
							incr_adh_pattern_prep_2020 = 1; 
							adhav_pr = adhav*0.90; 
						end;		

* inc_r_test_startprep_2020;
						inc_r_test_startprep_2020 = 0;  if _u26 < 0.90 then do; 
...
* expand_prep_to_all_2020;
						expand_prep_to_all_2020 = 0;  
						if _u38 < 0.90 then do;
							expand_prep_to_all_2020 = 1; prep_strategy = 7;
						end;
			end;

* circumcision;			if _u39 < 0.90 then circ_improvements = 1;
...
* increase condom use - decrease in newp;
						condom_incr_2020 = 0;
						if _u41 < 0.10 then condom_incr_2020 = 1;

* pop_wide_tld_2020;	pop_wide_tld_2020 = 0;
						if _u47 < 0.90 then do;  * not implemented when assessing prep and improvements in cascade, condom use, circumcision;
...
if reg_option in (102 103 104 105 106 113 115 116 117 118) then flr=2; 
...
if reg_option in (101 102 103 104 105 106 107 109 110 111 112 113 114 115 116 117 118) then do; 
...
if reg_option in (115 117 118) then art_monitoring_strategy=1500;
...
if cu1/cu2 <= a < cu2/cu2  then do; 
	e=uniform(0); if e < 0.70 then newp{t} = 1; if 0.70 <= e < 0.85 then newp{t} = 2; if e ge 0.85 then newp{t} = 3; 
end;
...
if  t ge 2 and  41 <= newp{t-1} <= 130 then do;
	...
	if 0.2 <= e < 0.98 then do; q=uniform(0); 	newp{t} = 41 + (q*89); newp{t} = round(newp{t},1);  end;
	if 0.98 <= e       then do; q=uniform(0); 	newp{t} = 131 + (q*50 ); newp{t} = round(newp{t},1);  end;
end;
...
if sex_age_mixing_matrix=1 then do;
...
else if 0.975<= e < 1.00   then do; risk_nippnp = s_prop_newp_i_w_3544; age_newp=3; end; 
...
else if 0.99 <= e <=1.00 then do; risk_nippnp = s_prop_newp_i_w_5564;   age_newp=5;end; 
end;
...
if sex_age_mixing_matrix=2 then do;
...
else if 0.975<= e < 1.00  /*(then newp age 35-45)*/ then do; risk_nippnp = s_prop_newp_i_w_3544; age_newp=3; end; 
else if 1.00 <= e < 1.00  /*(then newp age 45-55)*/ then do; risk_nippnp = s_prop_newp_i_w_4554; age_newp=4; end; 
else if 1.00 <= e         /*(then newp age 55-65)*/ then do; risk_nippnp = s_prop_newp_i_w_5564; age_newp=5; end; 
end;
else if 25 <= age{t} < 35 then do;e=uniform(0);
if              e < 0.47 then do; risk_nippnp = s_prop_newp_i_w_1524;  age_newp=1; end; 
else if 0.47 <= e < 0.90 then do; risk_nippnp = s_prop_newp_i_w_2534;  age_newp=2; end; 
...
if sex_age_mixing_matrix=3 then do;
...
if sex_age_mixing_matrix=4 then do;
...
* measured viral load;
vm_tm3 = vm_tm2; vm_tm2 = vm_tm1; vm_tm1 = vm;	

* measured cd4 count;
    cm_tm3 = cm_tm2; cm_tm2 = cm_tm1;      cm_tm1 = cm;              
...
if reg_option in (102 103 104 105 106 118) and (ever_dual_nvp =1 or ever_sd_nvp = 1) then flr=2;
...
* WHETHER TO INITIATE 3rd LINE HAART (FOR PEOPLE WHO FAILED second LINE AND STILL ON second LINE);
	...
	* restart_pi_after_dtg_fail   -  may18;
	if reg_option in (103 104 110 111 114 116 117 118) and f_dol=1 and o_dol=1 and o_taz ne 1 and o_lpr ne 1 and (p_taz=1 or p_lpr=1) then do;
...
* s15;	if reg_option in (103 104 110 111 114 116 117 118) and linefail{t-1}=2 and (f_dol=1) then do;  * mar19 - not sure why above need f_3tc and f_ten =1 to
...
if t ge 4 then do;
	* efa;
	...
	if  (interrupt{t}=0 and o_efa_tm1=1 and transition_from_nnrti_done ne 1) and    
		( reg_option in (104 105 118) 
		or (reg_option in (102 103 106) and sv=1) 
		or (reg_option in (116 117) and ( sv=1 or (vm_tm3  < 3 and vm_tm2  < 3 and vm_tm1  < 3 and vm    < 3) )))
	then do;
		tss_efa   =0; o_dol=1;o_efa=0; 
		transition_from_nnrti_done = 1;
	end;
	
	if interrupt{t}=0 and o_efa_tm1=1	and transition_from_nnrti_done ne 1 and reg_option = 106 and sv ne 1 then do;
		tss_efa   =0; o_dol=1;o_efa=0; 	tss_ten   =0; o_ten=0;o_zdv=1; 
		transition_from_nnrti_done = 1;
	end;
	...
	* zdv subsituted by ten after 2010.5;
	if interrupt{t}=0 and o_zdv_tm1=1 and caldate{t} ge 2010.5 and linefail{t-1} = 0 and artline{t}=1 then do;
...
if artline{t}=2 and transition_from_pi_done ne 1 and ( 
reg_option in (104 105 106 111 116 117 118)  or ( reg_option in (103) and sv = 1) 
) then do;
* taz;  
	if t ge 2  and interrupt{t}=0 and f_dol ne 1 and o_taz=1 then do; tss_taz   =0; o_dol=1;o_taz=0; end;
* lpr;
	if t ge 2  and interrupt{t}=0 and f_dol ne 1 and o_lpr=1 then do;	tss_lpr   =0; o_dol=1;o_lpr=0; end;
* ten;
...
* AP 20-7-19;
	...
	* note if returing to former definition of policy 103 then need to add 103 in here;
	...
	if caldate{t} >= 2015 and (f_efa=1 or f_nev=1)  and reg_option in (103 110 111 114 116 117) then do; * aug18;
			o_zdv=0;o_3tc=0;o_ten=0;o_nev=0;o_lpr=0;o_taz=0;o_efa=0;o_dol=0;o_dar=0;
			o_3tc=1;
 	...
 	if caldate{t} >= 2015 and f_dol=1 and reg_option in (102 103 104 113 115 116 117 118) then do;
...
and restart{t} ne 1 and restart{t-1} ne 1 and t ge 2 then do;  
...
and restart{t} ne 1 and restart{t-1} ne 1 and t ge 2 then do;  
	...
	if ((caldate{t}=date_conf_vl_measure_done and vm_format in (3,4) and vm gt log10(vl_threshold)) or
	(caldate{t} - date_conf_vl_measure_done = 0.25 and . < vm_format <= 2 and vm_tm1 gt log10(vl_threshold))) and adh{t} > 0.8
	then do;
			linefail{t}=1;r_fail=c_totmut{t}; cd4_fail1=c{t}; vl_fail1=v{t}; d1stlfail=caldate{t}; 
			if o_zdv=1 then f_zdv=1;
			if o_3tc=1 then f_3tc=1;
...
and restart{t} ne 1 and restart{t-1} ne 1 and linefail{t-1}=0 and t ge 2 then do;  
...
if ((reg_option in (103 116)) or (reg_option = 104 and art_monitoring_strategy ne 1500)) and o_dol=1 and p_taz=1 and f_dol_tm1 ne 1 and restart{t} ne 1 and restart{t-1} ne 1 and t ge 2 then do; 
	if (time_since_last_vm >= 0.75) and (caldate&j - date_conf_vl_measure_done >= 1 or date_conf_vl_measure_done=.) then do; 
		s=uniform(0);  date_last_vm_attempt=caldate&j;	if s < eff_prob_vl_meas_done then do; 
		if vm_format=1 then do; vm = max(0,v{t}+(normal(0)*0.22)); vm_type=1; end;
		if vm_format=2 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=2;  end;
		if vm_format=3 then do; vm = max(0,v{t}+(normal(0)*0.22));  vm_type=3;  end;
...
if (reg_option = 117 or (reg_option = 104 and art_monitoring_strategy = 1500) or reg_option = 118) and o_dol=1 and p_taz=1 and f_dol_tm1 ne 1 and restart{t} ne 1 and restart{t-1} ne 1 and t ge 2 then do; 
	if (time_since_last_vm >= 0.75) and (caldate&j - date_conf_vl_measure_done >= 1 or date_conf_vl_measure_done=.) then do; 
		s=uniform(0);  date_last_vm_attempt=caldate&j;	if s < eff_prob_vl_meas_done then do; 
		if vm_format=1 then do; vm = max(0,v{t}+(normal(0)*0.22)); vm_type=1; end;
		if vm_format=2 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=2;  end;
		if vm_format=3 then do; vm = max(0,v{t}+(normal(0)*0.22));  vm_type=3;  end;
		if vm_format=4 then do; vm_plasma = max(0,v{t}+(normal(0)*0.22)) ; vm = (0.5 * v{t}) + (0.5 * vm_plasma) + vl_whb_offset + (normal(0)*(sd_vl_whb + (decr_sd_vl_whb*(4-v{t}))))  ; vm_type=4;  end;
		if 0.25 <= caldate{t}-date_vl_switch_eval <= 1.0 then do; date_conf_vl_measure_done = caldate&j ;date_drug_level_test = caldate{t};end;
		drug_level_test=1;end;  
		vl_cost_inc = 1;
		if vm gt log10(vl_threshold) then do; hhh=1;
			date_last_vlm_g1000=caldate{t}; if (date_vl_switch_eval=. or time_since_last_vm >= 1) then date_vl_switch_eval=caldate{t}; 
...
if reg_option ne 103 and reg_option ne 104  and reg_option ne 116  and reg_option ne 117  and reg_option ne 118 and f_dol ne 1 then do;   
...
sw_1549=0;sw_newp=0;
if gender=2 and 15 le age&j lt 50 and sw&j=1 then sw_1549=1;
sw_1849=0;
if gender=2 and 18 le age&j lt 50 and sw&j=1 then sw_1849=1;
...
new_1519sw=.;new_2024sw=.;new_2529sw=.;new_ge30sw=.;
if 15 le age&j le 65 then do;
	...
	if t ge 2 and gender=2 and sw&j=1 and sw&x ne 1 then do;
			...
			if       age&j ge 30 then new_ge30sw = 1;
...
***HIV amongst FSW;
hiv_sw=0;     if hiv&j=1 and sw&j=1        				then hiv_sw=1;
hiv_sw1849_=0;   if hiv&j=1 and sw&j=1    and 18 le age&j lt 50 then hiv_sw1849_=1;
...
if death = caldate&j and rdcause=2 then ddaly_non_aids_pre_death = 1 ;
dead_rdcause2=0;
...
/*sex workers*/
base_rate_sw  sw&j	sw_1549   sw_1849  ever_sw  ever_sw1849_ ever_sw_hiv  ever_sw_diag
hiv_sw
...
p_hard_reach_w hard_reach_higher_in_men  p_hard_reach_m  
 inc_cat   sex_age_mixing_matrix   cd4_monitoring   base_rate_stop_sexwork   rred_a_p
;
...
/*sex workers*/
s_base_rate_sw  s_sw_1564	 s_sw_1549   s_sw_1849   s_ever_sw  s_ever_sw1849_  s_ever_sw_hiv  s_ever_sw_diag
s_hiv_sw
...
s_inc_cat   s_sex_age_mixing_matrix    s_cd4_monitoring  s_base_rate_stop_sexwork  s_rred_a_p
...
if s_n gt 0 then do;
	...
	sex_age_mixing_matrix_			= s_sex_age_mixing_matrix / s_n;
...
if sex_age_mixing_matrix_=1 then do;
ptnewp15_m=(0.43*s_w_1524_newp)+(0.09*s_w_2534_newp)+(0.03*s_w_3544_newp)+(0.00*s_w_4554_newp)+(0.00*s_w_5564_newp);
...
if sex_age_mixing_matrix_=2 then do;
ptnewp15_m=(0.43*s_w_1524_newp)+(0.09*s_w_2534_newp)+(0.03*s_w_3544_newp)+(0.00*s_w_4554_newp)+(0.00*s_w_5564_newp);
ptnewp25_m=(0.415*s_w_1524_newp)+(0.50*s_w_2534_newp)+(0.25*s_w_3544_newp)+(0.00*s_w_4554_newp)+(0.00*s_w_5564_newp);
ptnewp35_m=(0.12*s_w_1524_newp)+(0.35*s_w_2534_newp)+(0.34*s_w_3544_newp)+(0.05*s_w_4554_newp)+(0.00*s_w_5564_newp);
ptnewp45_m=(0.03*s_w_1524_newp)+(0.05*s_w_2534_newp)+(0.25*s_w_3544_newp)+(0.70*s_w_4554_newp)+(0.10*s_w_5564_newp);
...
if sex_age_mixing_matrix_=3 then do;
...
/*sex workers*/
s_sw_1564	 s_sw_1549  s_sw_1849  s_ever_sw  s_ever_sw1849_  s_ever_sw_hiv  s_ever_sw_diag
s_hiv_sw
s_i_fsw_v1_np 	s_i_fsw_v2_np   s_i_fsw_v3_np	s_i_fsw_v4_np  	s_i_fsw_v5_np	s_i_fsw_v6_np
s_i_v1_ep 		s_i_v2_ep 		s_i_v3_ep 		s_i_v4_ep 		s_i_v5_ep  		s_i_v6_ep
s_i_v1_newp 	s_i_v2_newp 	s_i_v3_newp 	s_i_v4_newp 	s_i_v5_newp  	s_i_v6_newp
...
/*parameters sampled*/
sex_beh_trans_matrix_m_  sex_beh_trans_matrix_w_  sex_age_mixing_matrix_  p_rred_p_  p_hsb_p_  newp_factor_  
...
data qq; set q;
if s_s_w_newp>0 then cum_ratio_newp_mw = s_s_m_newp / s_s_w_newp;
run;
...
keep_going=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549 and 1/1.2 <= cum_ratio_newp_mw < 1.2 then keep_going=1;
...
incidence1549 = s_primary1549 / (s_alive1549 - s_hiv1549 + s_primary1549);
keep_going=0;
if 0.01 <= prevalence1549 < 0.40 and 0.01 <= incidence1549 and prev_ratio_1524 > 1 and 1/1.2 <= cum_ratio_newp_mw < 1.2 then keep_going=1;
/* if keep_going=0 then do; abort abend; end; */
end;
...
and     0.00  <  p_ai_no_arv_c_nnm_ < 0.3         
...
%update_r1(da1=1,da2=2,e=5,f=6,g=145,h=152,a=147,b=146,i=145,k=144,l=143,x=148,j=149,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=145,h=152,a=148,b=147,i=146,k=145,l=144,x=149,j=150,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=145,h=152,a=149,b=148,i=147,k=146,l=145,x=150,j=151,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=145,h=152,a=150,b=149,i=148,k=147,l=146,x=151,j=152,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=149,h=156,a=151,b=150,i=149,k=148,l=147,x=152,j=153,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=149,h=156,a=152,b=151,i=150,k=149,l=148,x=153,j=154,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=149,h=156,a=153,b=152,i=151,k=150,l=149,x=154,j=155,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=149,h=156,a=154,b=153,i=152,k=151,l=150,x=155,j=156,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=153,h=160,a=155,b=154,i=153,k=152,l=151,x=156,j=157,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=153,h=160,a=156,b=155,i=154,k=153,l=152,x=157,j=158,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=153,h=160,a=157,b=156,i=155,k=154,l=153,x=158,j=159,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=153,h=160,a=158,b=157,i=156,k=155,l=154,x=159,j=160,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=157,h=164,a=159,b=158,i=157,k=156,l=155,x=160,j=161,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=157,h=164,a=160,b=159,i=158,k=157,l=156,x=161,j=162,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=157,h=164,a=161,b=160,i=159,k=158,l=157,x=162,j=163,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=157,h=164,a=162,b=161,i=160,k=159,l=158,x=163,j=164,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=161,h=168,a=163,b=162,i=161,k=160,l=159,x=164,j=165,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=161,h=168,a=164,b=163,i=162,k=161,l=160,x=165,j=166,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=161,h=168,a=165,b=164,i=163,k=162,l=161,x=166,j=167,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=161,h=168,a=166,b=165,i=164,k=163,l=162,x=167,j=168,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=165,h=172,a=167,b=166,i=165,k=164,l=163,x=168,j=169,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=165,h=172,a=168,b=167,i=166,k=165,l=164,x=169,j=170,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=165,h=172,a=169,b=168,i=167,k=166,l=165,x=170,j=171,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=165,h=172,a=170,b=169,i=168,k=167,l=166,x=171,j=172,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=169,h=176,a=171,b=170,i=169,k=168,l=167,x=172,j=173,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=169,h=176,a=172,b=171,i=170,k=169,l=168,x=173,j=174,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=169,h=176,a=173,b=172,i=171,k=170,l=169,x=174,j=175,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=169,h=176,a=174,b=173,i=172,k=171,l=170,x=175,j=176,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=173,h=180,a=175,b=174,i=173,k=172,l=171,x=176,j=177,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=173,h=180,a=176,b=175,i=174,k=173,l=172,x=177,j=178,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=173,h=180,a=177,b=176,i=175,k=174,l=173,x=178,j=179,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=173,h=180,a=178,b=177,i=176,k=175,l=174,x=179,j=180,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=177,h=184,a=179,b=178,i=177,k=176,l=175,x=180,j=181,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=177,h=184,a=180,b=179,i=178,k=177,l=176,x=181,j=182,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=177,h=184,a=181,b=180,i=179,k=178,l=177,x=182,j=183,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=177,h=184,a=182,b=181,i=180,k=179,l=178,x=183,j=184,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=181,h=188,a=183,b=182,i=181,k=180,l=179,x=184,j=185,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=181,h=188,a=184,b=183,i=182,k=181,l=180,x=185,j=186,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=181,h=188,a=185,b=184,i=183,k=182,l=181,x=186,j=187,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=181,h=188,a=186,b=185,i=184,k=183,l=182,x=187,j=188,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=185,h=192,a=187,b=186,i=185,k=184,l=183,x=188,j=189,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=185,h=192,a=188,b=187,i=186,k=185,l=184,x=189,j=190,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=185,h=192,a=189,b=188,i=187,k=186,l=185,x=190,j=191,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=185,h=192,a=190,b=189,i=188,k=187,l=186,x=191,j=192,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=189,h=196,a=191,b=190,i=189,k=188,l=187,x=192,j=193,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=189,h=196,a=192,b=191,i=190,k=189,l=188,x=193,j=194,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=189,h=196,a=193,b=192,i=191,k=190,l=189,x=194,j=195,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=189,h=196,a=194,b=193,i=192,k=191,l=190,x=195,j=196,s=5);
%update_r1(da1=1,da2=2,e=5,f=6,g=193,h=200,a=195,b=194,i=193,k=192,l=191,x=196,j=197,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=193,h=200,a=196,b=195,i=194,k=193,l=192,x=197,j=198,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=193,h=200,a=197,b=196,i=195,k=194,l=193,x=198,j=199,s=5);
%update_r1(da1=2,da2=1,e=8,f=9,g=193,h=200,a=198,b=197,i=196,k=195,l=194,x=199,j=200,s=5);   
%update_r1(da1=1,da2=2,e=5,f=6,g=197,h=204,a=199,b=198,i=197,k=196,l=195,x=200,j=201,s=5);
%update_r1(da1=2,da2=1,e=6,f=7,g=197,h=204,a=200,b=199,i=198,k=197,l=196,x=201,j=202,s=5);
%update_r1(da1=1,da2=2,e=7,f=8,g=197,h=204,a=201,b=200,i=199,k=198,l=197,x=202,j=203,s=5);
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_3_9_19_dolswitch_5pm_&dataset_id";  
put   
