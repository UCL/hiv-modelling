...
if t ge 4 then do;
	...
	* nev;
	...
	reg_option in (116 117) and  (vm_tm1  > 3 or vm > 3) 
	then do;
		tss_nev   =0; o_dol=1;o_nev=0; 	tss_ten   =0; o_ten=0;o_zdv=1;  
		transition_from_nnrti_done = 1;
	end;

	* zdv substituted by ten after 2010.5;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_7_9_19_dolswitch_5pm_&dataset_id";  
put   
