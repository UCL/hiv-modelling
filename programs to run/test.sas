...
if 15 <= age and (death = . or caldate&j = death ) then do;
	...
	s_alive_w + alive_w ; s_alive_m + alive_m ; s_restart + restart ; s_art_initiation + art_initiation;
	s_x_n_zld_if_reg_op_116 + n_zld_if_reg_op_116 ;  s_hivge15 + hiv;  s_primaryge15 + primary;
