...
***** Sexual behaviour;
* base_rate_sw; r=uniform(0);  if 0 <= r < 0.25 then base_rate_sw = 0.0005;   if 0.25 <= r < 0.50 then base_rate_sw = 0.0007;   
...
* sex_age_mixing_matrix_m;e=uniform(0); if e < 1/6  then sex_age_mixing_matrix_m=1; if 1/6  <= e < 2/6 then sex_age_mixing_matrix_m=2;
										...
										if 4/6 <= e < 0.8  then sex_age_mixing_matrix_m=5; if 4/6 <= e < 0.8  then sex_age_mixing_matrix_m=6;
* sex_age_mixing_watrix_w;e=uniform(0); if e < 1/6  then sex_age_mixing_matrix_w=1; if 1/6  <= e < 2/6 then sex_age_mixing_matrix_w=2;
										if 2/6 <= e < 3/6  then sex_age_mixing_matrix_w=3; if 3/6 <= e < 4/6  then sex_age_mixing_matrix_w=4;
										if 4/6 <= e < 0.8  then sex_age_mixing_matrix_w=5; if 4/6 <= e < 0.8  then sex_age_mixing_matrix_w=6;* rred_a_p;	r=uniform(0); if r < 0.25 then rred_a_p=1; if 0.25 <= r < 0.50 then rred_a_p=2;  if 0.50 <= r < 0.75 then rred_a_p=3;  if r >= 0.75 then rred_a_p=4; 
* p_rred_p; r=uniform(0); if r < 0.33 then p_rred_p = 0.1; if 0.33 <= r < 0.67 then p_rred_p = 0.3; 
			if 0.67 <= r  then p_rred_p = 0.5;  	
* p_hsb_p; 	r=uniform(0); if r < 0.33 then p_hsb_p = 0; if 0.33 <= r < 0.67 then p_hsb_p = 0.1; if 0.67 <= r then p_hsb_p = 0.2;
...
if 15 <= age1 < 18 and life_sex_risk = 2 and e < 0.030 then sw1=1;
if 18 <= age1 < 20 and life_sex_risk = 2 and e < 0.100 then sw1=1;
if 20 <= age1 < 25 and life_sex_risk = 2 and e < 0.050 then sw1=1;
if 25 <= age1 < 40 and life_sex_risk = 2 and e < 0.030 then sw1=1;
if 40 <= age1 < 50 and life_sex_risk = 2 and e < 0.002 then sw1=1;
...
if option = 0 and caldate{t} ge 2019.5 then reg_option = 113;
...
if s_n gt 0 then do;
	...
	keep_going_1999_				= s_keep_going_1999 / s/n;			
	keep_going_2004_				= s_keep_going_2004 / s/n;			
	keep_going_2016_				= s_keep_going_2016 / s/n;			
	keep_going_2020_				= s_keep_going_2020 / s/n;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_5_9_19_dolswitch_12pm_&dataset_id";  
put   
