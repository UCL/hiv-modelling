...
* adh_pattern; r=uniform(0);  if  r < 0.02 then adh_pattern=98 ;if 0.02 <= r < 0.04 then adh_pattern=105; if 0.04 <= r < 0.15 then adh_pattern=101; 
				if 0.15 <= r < 0.35 then adh_pattern=99; if 0.35 <= r < 0.55 then adh_pattern=1;   if 0.55 <= r < 0.75 then adh_pattern=2;   
				if 0.75 <= r < 0.85 then adh_pattern=3;   if 0.85 <= r < 0.95 then adh_pattern=4; if 0.95 <= r  then adh_pattern=5; 
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_15_9_19_prep_10am_&dataset_id";  
put   
