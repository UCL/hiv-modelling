...
libname b "C:\Users\rmjlja9\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_SQMin_20250126_out";		* all options in one output;
...
data a.base_26_01_2025_SQMin; set b.out: ;
...
proc contents data=a.base_26_01_2025_SQMin;run;							/* show the contents of the input SAS file */
proc freq data=a.base_26_01_2025_SQMin; table run cald option;run;
...
data a.base_26_01_2025_SQMin;set a.base_26_01_2025_SQMin;
...
proc freq data=a.base_26_01_2025_SQMin; table run option;where cald=2023.75;run;
proc freq data=a.base_26_01_2025_SQMin; table run*option/norow nocol nopercent; where cald=2023.75;run;
proc freq data=a.base_26_01_2025_SQMin; table run cald option;run;
proc freq data=a.base_26_01_2025_SQMin; table option*cald/norow nocol nopercent;run;
...
proc sort data=a.base_26_01_2025_SQMin; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_26_01_2025_SQMin ;
*Zimbabwe;
...
proc sort data=a.base_26_01_2025_SQMin; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_26_01_2025_SQMin sf;
by run ; run;
...
data a.l_base_26_01_2025_SQMin; set y;
...
proc freq data=a.l_base_26_01_2025_SQMin; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;
...
proc freq data=a.l_base_26_01_2025_SQMin; table incidence1549; where option=1;run;
proc freq data=a.l_base_26_01_2025_SQMin; table n_diag_progsw; where option=0;run;
proc freq data=a.l_base_26_01_2025_SQMin; table n_sw_inprog_ly; where option=0;run;
proc freq data=a.l_base_26_01_2025_SQMin; table n_attend_mens_clinic; where option=0;run;
proc freq data=a.l_base_26_01_2025_SQMin; table n_access_adult_ret_supp; where option=30;run;
