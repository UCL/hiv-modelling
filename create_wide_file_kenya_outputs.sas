...
* n_infected_m;					n_infected_n = s_primary_n * 4 * sf;
...
p_onart_diag_m p_onart_diag_w  p_onart_diag_m p_onart_vl1000_m p_onart_vl1000_w p_onart_vl1000  prop_w_1549_sw  prevalence_sw   p_mcirc  
n_death_hivrel n_hiv prop_m_msm  prevalence_msm  incidence1564m incidence1564w  incidence1564  n_onart  n_onprep  yll
...
proc means noprint data=y; var &v; output out=y_24  mean= &v._24   ; by run        ; where 2024.0 <= cald < 2025.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_25  mean= &v._25   ; by run        ; where 2025.0 <= cald < 2026.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_26  mean= &v._26   ; by run        ; where 2026.0 <= cald < 2027.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_27  mean= &v._27   ; by run        ; where 2027.0 <= cald < 2028.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_28  mean= &v._28   ; by run        ; where 2028.0 <= cald < 2029.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_29  mean= &v._29   ; by run        ; where 2029.0 <= cald < 2030.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_30  mean= &v._30   ; by run        ; where 2030.0 <= cald < 2031.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_31  mean= &v._31   ; by run        ; where 2031.0 <= cald < 2032.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_32  mean= &v._32   ; by run        ; where 2032.0 <= cald < 2033.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_33  mean= &v._33   ; by run        ; where 2033.0 <= cald < 2034.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_34  mean= &v._34   ; by run        ; where 2034.0 <= cald < 2035.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_35  mean= &v._35   ; by run        ; where 2035.0 <= cald < 2036.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_36  mean= &v._36   ; by run        ; where 2036.0 <= cald < 2037.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_37  mean= &v._37   ; by run        ; where 2037.0 <= cald < 2038.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_38  mean= &v._38   ; by run        ; where 2038.0 <= cald < 2039.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_39  mean= &v._39   ; by run        ; where 2039.0 <= cald < 2040.0 and option=0 ;
proc means noprint data=y; var &v; output out=y_40  mean= &v._40   ; by run        ; where 2040.0 <= cald < 2041.0 and option=0 ;
 																										   
																										
data &v ; merge y_00  y_24  ;  
...
proc contents data=wide_outputs; run;
