...
alternatives below), alternative monitoring strategies of tld art initiators, tld for all men (except if tested ・ｽve and np=0, start tld if np goes >= 1) 
sample these)
...
cia world factbook 
malawi
Total population (x 1000)	Population aged 0・ｽE4 (%)	Population aged 15・ｽE4 (%)	Population aged 65+ (%)   n population aged 15・ｽE4
...
* pregnancy leads to re-engagement once option b+ implemented; 
	if registd=1 and (pregnant=1 or . < caldate{t} - dt_lastbirth <= 1) and art_initiation_strategy in (3,9,10) and return ne 1 then do;
...
if gender=1 then do;
	...
	if 15 <= age < 40 then ageg1549m=1;else ageg1549m=0;
end;
...
* file "C:\Loveleen\Synthesis model\Multiple enhancements\multiple_enhancements_&dataset_id";  
  file "/home/rmjlaph/Scratch/_output_27_4_20_10pm_&dataset_id";  
put   
