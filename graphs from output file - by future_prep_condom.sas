...
label p50_incidence1549__1 = "A (median)";
label p50_incidence1549__2 = "B (median)";
label p50_incidence1549__3 = "C (median)";
label p50_incidence1549__4 = "D (median)";

 series  x=cald y=p50_incidence1549__1/	lineattrs = (color=black thickness = 4);
  ...
  series  x=cald y=p50_incidence1549__3/	lineattrs = (color=charcoal thickness = 4);
  ...
  series  x=cald y=p50_incidence1549__4/	lineattrs = (color=grey    thickness = 4);
...
label p50_prop_elig_on_prep_1 = "A";
label p50_prop_elig_on_prep_2 = "B";
label p50_prop_elig_on_prep_3 = "C";
label p50_prop_elig_on_prep_4 = "D";

 series  x=cald y=p50_prop_elig_on_prep_1/	lineattrs = (color=black thickness = 4);
  ...
  series  x=cald y=p50_prop_elig_on_prep_3/	lineattrs = (color=charcoal thickness = 4);
  ...
  series  x=cald y=p50_prop_elig_on_prep_4/	lineattrs = (color=grey    thickness = 4);
...
label p50_p_vl1000__1 = "A";
label p50_p_vl1000__2 = "B";
label p50_p_vl1000__3 = "C";
label p50_p_vl1000__4 = "D";

 series  x=cald y=p50_p_vl1000__1/	lineattrs = (color=black thickness = 4);
  ...
  series  x=cald y=p50_p_vl1000__3/	lineattrs = (color=charcoal thickness = 4);
  band    x=cald lower=p5_p_vl1000__3 	upper=p95_p_vl1000__3  / transparency=0.9 fillattrs = (color=charcoal) legendlabel= "90% range";
  series  x=cald y=p50_p_vl1000__4/	lineattrs = (color=grey    thickness = 4);
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2024 to 2039 by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0.8 to  1.0       by 0.05     ) valueattrs=(size=10);

label p50_p_onart_vl1000__1 = "A";
label p50_p_onart_vl1000__2 = "B";
label p50_p_onart_vl1000__3 = "C";
label p50_p_onart_vl1000__4 = "D";

 series  x=cald y=p50_p_onart_vl1000__1/	lineattrs = (color=black thickness = 4);
  ...
  series  x=cald y=p50_p_onart_vl1000__3/	lineattrs = (color=blue thickness = 4);
...
ods html;
proc sgplot data=d ; 
Title    height=1.5 justify=center "Proportion of HIV negative adults age 15-64 taking PrEP";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2024 to 2039 by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0.0 to  0.3       by 0.05     ) valueattrs=(size=10);

label p50_prop_1564_hivneg_onprep_1 = "A";
label p50_prop_1564_hivneg_onprep_2 = "B";
label p50_prop_1564_hivneg_onprep_3 = "C";
label p50_prop_1564_hivneg_onprep_4 = "D";

 series  x=cald y=p50_prop_1564_hivneg_onprep_1/	lineattrs = (color=black thickness = 4);
  ...
  series  x=cald y=p50_prop_1564_hivneg_onprep_2/	lineattrs = (color=green  thickness = 4);
  band    x=cald lower=p5_prop_1564_hivneg_onprep_2 	upper=p95_prop_1564_hivneg_onprep_2  / transparency=0.9 fillattrs = (color=green ) legendlabel= "90% range";
  series  x=cald y=p50_prop_1564_hivneg_onprep_3/	lineattrs = (color=charcoal thickness = 4);
  band    x=cald lower=p5_prop_1564_hivneg_onprep_3 	upper=p95_prop_1564_hivneg_onprep_3  / transparency=0.9 fillattrs = (color=charcoal) legendlabel= "90% range";
  series  x=cald y=p50_prop_1564_hivneg_onprep_4/	lineattrs = (color=grey    thickness = 4);
  band    x=cald lower=p5_prop_1564_hivneg_onprep_4 	upper=p95_prop_1564_hivneg_onprep_4  / transparency=0.9 fillattrs = (color=grey   ) legendlabel= "90% range";
