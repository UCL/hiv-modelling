...
* n_prep_oral;					n_prep_oral = n_prep_oral_w + n_prep_oral_m;
* n_prep_inj;					n_prep_inj = n_prep_inj_w + n_prep_inj_m;
* n_prep_w;						n_prep_w = n_prep_oral_w + n_prep_inj_w + n_prep_vr_w;
...
* incidence_notonprep ;			incidence_notonprep  = (s_primary - s_primary_prep) * 4 * 100 / (s_alive1564 - s_prep_any) ;
...
* p_onart_gt6m_vl1000_w;		if s_onart_gt6m_w   	 > 0 then p_onart_gt6m_vl1000_w = s_vl1000_art_gt6m_w / s_onart_gt6m_w ; 		*JASJul2024;
* p_onart_gt6m_vl1000_m;		if s_onart_gt6m_m   	 > 0 then p_onart_gt6m_vl1000_m = s_vl1000_art_gt6m_m / s_onart_gt6m_m ; 		*JASJul2024;
...
p_diag_m1524 p_diag_w1524 p_diag_sw n_cm n_vm n_vm_w n_vm_m p_vm_ly_onart n_pcp_p p_onart_cd4_l200
p_mcirc p_mcirc_1014m p_mcirc_1519m p_mcirc_2024m p_mcirc_2529m p_mcirc_3034m p_mcirc_3539m p_mcirc_4044m p_mcirc_4549m p_mcirc_5064m p_mcirc_1549m  p_mcirc_1049m 
p_vmmc p_vmmc_1014m p_vmmc_1519m p_vmmc_2024m p_vmmc_2529m p_vmmc_3039m p_vmmc_4049m p_vmmc_5064m p_vmmc_1549m p_vmmc_1049m	
...
p_onart_gt6m_vl1000_w  p_onart_gt6m_vl1000_m
p_onart_vl1000_w p_onart_vl1000_m  n_onart_vl1000_m n_onart_vl1000_w 
p_onart_vl1000_1524	  p_onart_vl1000_sw 	p_onart_vl1000_w1524evpr
...
n_hivpos_tests n_hivneg_tests n_hivpos_tests_sympt n_hivneg_tests_sympt n_hivneg_tests_anc n_hivneg_tests_anclabpd
...
n_prep_vr_w
n_prep_oral				n_prep_inj			n_prep_w				n_prep_m
...
data b.l_base_sa_options_e  ; 
	set y;
	if cald=. then delete;
run;

proc contents data=b.l_base_sa_options_e; run;
