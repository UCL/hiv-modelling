...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\oral_prep\oral_prep_13_s6_bp_out";


data d ; set b._oral_prep: ; 
...
data a.oral_prep_13_s6        ;
set y;


proc contents data=a.oral_prep_13_s6  ; 
proc freq data=a.oral_prep_13_s6   ; tables run; where cald = 2020;
run;
