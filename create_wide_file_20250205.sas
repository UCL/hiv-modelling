...
libname a "C:\Users\rmjlja9\OneDrive - University College London\MIHPSA Zimbabwe\Phase 2\2025FEB05";								* dont save on Dropbox;
	*This is using last full run, there is also a Min-SQ run set available from Nov 28th;
libname b "C:\Users\rmjlja9\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_all_20250205_out";		* all options in one output;
...
data a.base_05_02_2025; set b.out: ;
...
/*ods listing;*/
/**/
/*proc contents data=a.base_05_02_2025;run;							/* show the contents of the input SAS file */*/
...
/*data a.base_05_02_2025;set a.base_05_02_2025;*/
...
proc contents data=a.base_05_02_2025;run;							/* show the contents of the input SAS file */
proc freq data=a.base_05_02_2025; table run cald option;run;


/*proc freq data=a.base_05_02_2025; table run option;where cald=2023.75;run;*/
/*proc freq data=a.base_05_02_2025; table run*option/norow nocol nopercent; where cald=2023.75;run;*/
/*proc freq data=a.base_05_02_2025; table run cald option;run;*/
/*proc freq data=a.base_05_02_2025; table option*cald/norow nocol nopercent;run;*/
...
proc sort data=a.base_05_02_2025; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_05_02_2025 ;
*Zimbabwe;
...
proc sort data=a.base_05_02_2025; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_05_02_2025 sf;
by run ; run;
...
data a.l_base_05_02_2025; set y;
if cald=. then delete;run;
proc freq data=a.l_base_05_02_2025; table option;run;
/*proc contents data=a.l_base_05_02_2025; run;*/



/*proc freq data=a.l_base_05_02_2025; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;*/
/*proc freq data=a.l_base_05_02_2025;*/
...
/*proc freq data=a.l_base_05_02_2025; table incidence1549; where option=1;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_diag_progsw; where option=0;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_inprog_ly; where option=0;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_inprog_ly; where option=1;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_inprog_ly; where option=8;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_program_visit; where option=0;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_program_visit; where option=1;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_sw_program_visit; where option=8;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_attend_mens_clinic; where option=0;run;*/
/*proc freq data=a.l_base_05_02_2025; table n_access_adult_ret_supp; where option=30;run;*/
