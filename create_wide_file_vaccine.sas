...
data b.k_vaccine_n_d_keep_prep;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_vaccine_n_d_keep_prep; 
by run cald option;
run;
...
merge b.k_vaccine_n_d_keep_prep sf;
by run ;
...
data    b.l_vaccine_n_d_keep_prep_y; set y;  
...
* To get one row per run;
  ...
  data  b.w_vaccine_n_d_keep_prep     ; 
...
proc means   data = b.w_vaccine_n_d_keep_prep  n p50 p5 p95 ;  
...
proc means   data = b.w_vaccine_n_d_keep_prep  n mean  p50 p5 p95 ;
...
proc glm  data = b.w_vaccine_n_d_keep_prep ;
...
proc sort data = b.w_vaccine_n_d_keep_prep; by future_prep_condom;
proc means  data = b.w_vaccine_n_d_keep_prep ;
...
proc means   data = b.w_vaccine_n_d_keep_prep  n p50 p5 p95 min max;  
var prevalence1549w_24 prevalence1549m_24 incidence1549_24 p_diag_24 p_onart_diag_24 p_onart_vl1000_24 p_vl1000_24 prevalence_vg1000_24 
...
proc means  data = b.w_vaccine_n_d_keep_prep  n mean p50 p5 p95 clm;  
var
...
ods html;
proc means  data = b.w_vaccine_n_d_keep_prep  n mean clm;  
var
incidence1549_30y_1 incidence1549_30y_2 
r_incidence1549_30y_2_1 
;
