...
p_mcirc_1549m	 		p_mcirc_1519m	p_mcirc_2024m	p_mcirc_2529m		p_mcirc_3039m	p_mcirc_4049m 	p_mcirc_50plm 
prop_w_1549_sw	prop_w_ever_sw 	prop_sw_hiv 	prop_w_1524_onprep  prop_1564_onprep 	prevalence1549m prevalence1549w
prevalence1549_  prevalence_vg1000_  incidence1549_  p_inf_vlsupp  p_inf_newp  p_inf_ep  p_inf_diag  p_inf_naive  p_inf_primary
...
n_death_hivrel prevalence4549m  prevalence4549w  ;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to 2020 by 2)	 	 valueattrs=(size=10); 
...
proc sgplot data=d; 
Title    height=1.5 justify=center "prevalence4549m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to 2020.5 by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'number'		labelattrs=(size=12)  values = (0 to 1 by 0.1) valueattrs=(size=10);

label p50_prevalence4549m_0 = "Option 0 (median) ";
label p50_prevalence4549m_1 = "Option 1  (median) ";
...
series  x=cald y=p50_prevalence4549m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prevalence4549m_1 	upper=p95_prevalence4549m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
proc sgplot data=d; 
Title    height=1.5 justify=center "prevalence4549w";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1993 to 2020.5 by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'number'		labelattrs=(size=12)  values = (0 to 1 by 0.1) valueattrs=(size=10);

label p50_prevalence4549w_0 = "Option 0 (median) ";
label p50_prevalence4549w_1 = "Option 1  (median) ";

series  x=cald y=p50_prevalence4549w_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_prevalence4549w_0 	upper=p95_prevalence4549w_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=p50_prevalence4549w_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_prevalence4549w_1 	upper=p95_prevalence4549w_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
