...
qsub -hold_jid $jobname -N create_wide -v sas_infile=$inputdir/create_wide_myriad.sas,SASOUTPUTDIR=$finaloutdir,SASTMPFILES=$tmpfiles $inputdir/run_create_wide_file.sh
