...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\pop_wide_tld\pop_wide_tld_u_out\";
...
n_pop_tld_neg_prep_inel  prev_vg1000_1549  n_dead_hivpos_cause1
...
low_prep_inj_uptake pop_wide_tld_selective_hiv  death_r_iris_pop_wide_tld
;
...
%par(p=inc_oral_prep_pref_pop_wide_tld);
 ...
 %par(p=low_prep_inj_uptake); %par(p=pop_wide_tld_selective_hiv); %par(p=death_r_iris_pop_wide_tld);
...
class artvis0_lower_adh;
model  pop_wide_tld_ce_x    = d_p_elig_hivneg_onprep_3y_2_1  d_prop_prep_inj_3y_2_1   d_prevalence_vg1000_3y_2_1
p_onartvisit0_3y_2
;
where artvis0_lower_adh = 0;
run;
...
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_1_to_0 prob_onartvis0_1_to_0
prob_prep_pop_wide_tld  inc_oral_prep_pref_pop_wide_tld  prep_dependent_prev_vg1000_g   prop_pep  artvis0_lower_adh  pop_wide_prep_adh_effect 
low_prep_inj_uptake  pop_wide_tld_selective_hiv death_r_iris_pop_wide_tld prep_dependent_prev_vg1000 adh_pattern
/ solution ;
where artvis0_lower_adh=0;
run;
...
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_1_to_0 prob_onartvis0_1_to_0
prob_prep_pop_wide_tld  inc_oral_prep_pref_pop_wide_tld  prep_dependent_prev_vg1000_g   prop_pep  artvis0_lower_adh  pop_wide_prep_adh_effect 
low_prep_inj_uptake  pop_wide_tld_selective_hiv death_r_iris_pop_wide_tld prep_dependent_prev_vg1000 
/ solution ;
run;
