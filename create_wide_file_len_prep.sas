...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\len_prep\len_prep_d_out\";
...
data b.k_len_prep_d;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
data    b.l_len_prep_d; set y;  

data y ; set b.l_len_prep_d; 
...
* To get one row per run;
  ...
  libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\cioa\len_prep_d_out\";

data f; set b.w_len_prep_d;
