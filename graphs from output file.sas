...
n_prep_any_w_1524_ = n_prep_any_w_1524;
...
n_alive n_hiv  p_ep  p_newp_ge1_m   p_newp_ge1_w  prev_vg1000_newp_m  prev_vg1000_newp_w  n_prep_w n_prep_inj n_prep_oral
n_prep_any_w_1524_ incidence1524w_  n_prep_vr_w  n_self_tests prop_elig_on_prep n_prep_any_plw
p_prep_elig   p_prep_plw  n_mcirc_15m
;
...
g105 g106 g107 g108 g109 g110 g111 g112 g113 g114 g115 g116 g117 g118 g119 g120


/*
g112 g113 g114 g115 g116 g117 g118 g119 g120 g121 g122 g123 g124 g125 g126 g127 g128 g129 g130
...
h103 h104 h105 h106 h107 h108 h109 h110  h111 h112 h113  h114 h115 h116 h117 h118 h119 h120
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "av_newp";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 2   by 0.5) valueattrs=(size=10);
label mean_av_newp_0 = "Option 0 (median) ";
label mean_av_newp_1 = "Option 1 (median) ";

series  x=cald y=mean_av_newp_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_av_newp_0 	upper=p95_av_newp_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_av_newp_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_av_newp_1 	upper=p95_av_newp_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_newp_ge1_m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.2 by 0.05) valueattrs=(size=10);
label mean_p_newp_ge1_m_0 = "Option 0 (median) ";
label mean_p_newp_ge1_m_1 = "Option 1 (median) ";

series  x=cald y=mean_p_newp_ge1_m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_newp_ge1_m_0 	upper=p95_p_newp_ge1_m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_newp_ge1_m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_newp_ge1_m_1 	upper=p95_p_newp_ge1_m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";

run;quit;

ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_newp_ge1_w";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 0.2 by 0.05) valueattrs=(size=10);
label mean_p_newp_ge1_w_0 = "Option 0 (median) ";
label mean_p_newp_ge1_w_1 = "Option 1 (median) ";

series  x=cald y=mean_p_newp_ge1_w_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_newp_ge1_w_0 	upper=p95_p_newp_ge1_w_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_newp_ge1_w_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_newp_ge1_w_1 	upper=p95_p_newp_ge1_w_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_prep_elig";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1    by 0.1 ) valueattrs=(size=10);
label mean_p_prep_elig_0 = "Option 0 (median) ";
label mean_p_prep_elig_1 = "Option 1 (median) ";

series  x=cald y=mean_p_prep_elig_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_prep_elig_0 	upper=p95_p_prep_elig_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_prep_elig_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_prep_elig_1 	upper=p95_p_prep_elig_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "p_prep_plw";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1    by 0.1 ) valueattrs=(size=10);
label mean_p_prep_plw_0 = "Option 0 (median) ";
label mean_p_prep_plw_1 = "Option 1 (median) ";

series  x=cald y=mean_p_prep_plw_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_p_prep_plw_0 	upper=p95_p_prep_plw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_p_prep_plw_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_prep_plw_1 	upper=p95_p_prep_plw_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "n_mcirc_15m";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1000000    by 100000 ) valueattrs=(size=10);
label mean_n_mcirc_15m_0 = "Option 0 (median) ";
label mean_n_mcirc_15m_1 = "Option 1 (median) ";

series  x=cald y=mean_n_mcirc_15m_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_mcirc_15m_0 	upper=p95_n_mcirc_15m_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_mcirc_15m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_mcirc_15m_1 	upper=p95_n_mcirc_15m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_w";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 2000000 by 100000) valueattrs=(size=10);
label mean_n_prep_w_0 = "Option 0 (median) ";
label mean_n_prep_w_1 = "Option 1 (median) ";

series  x=cald y=mean_n_prep_w_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_w_0 	upper=p95_n_prep_w_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_prep_w_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_w_1 	upper=p95_n_prep_w_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";

run;quit;


proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_any_w_1524";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 2000000 by 100000) valueattrs=(size=10);
label mean_n_prep_any_w_1524__0 = "Option 0 (median) ";
label mean_n_prep_any_w_1524__1 = "Option 1 (median) ";

series  x=cald y=mean_n_prep_any_w_1524__0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_any_w_1524__0 	upper=p95_n_prep_any_w_1524__0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_prep_any_w_1524__1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_any_w_1524__1 	upper=p95_n_prep_any_w_1524__1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_any_plw";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 2000000 by 100000) valueattrs=(size=10);
label mean_n_prep_any_plw_0 = "Option 0 (median) ";
label mean_n_prep_any_plw_1 = "Option 1 (median) ";

series  x=cald y=mean_n_prep_any_plw_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_any_plw_0 	upper=p95_n_prep_any_plw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_prep_any_plw_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_any_plw_1 	upper=p95_n_prep_any_plw_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_oral";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 2000000 by 100000) valueattrs=(size=10);
label mean_n_prep_oral_0 = "Option 0 (median) ";
label mean_n_prep_oral_1 = "Option 1 (median) ";

series  x=cald y=mean_n_prep_oral_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_oral_0 	upper=p95_n_prep_oral_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_prep_oral_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_oral_1 	upper=p95_n_prep_oral_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
proc sgplot data=d; 
Title    height=1.5 justify=center "n_prep_vr_w";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 2000000 by 100000) valueattrs=(size=10);
label mean_n_prep_vr_w_0 = "Option 0 (median) ";
label mean_n_prep_vr_w_1 = "Option 1 (median) ";

series  x=cald y=mean_n_prep_vr_w_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_prep_vr_w_0 	upper=p95_n_prep_vr_w_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";

series  x=cald y=mean_n_prep_vr_w_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_prep_vr_w_1 	upper=p95_n_prep_vr_w_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "Incidence (age 15-24 women)";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'rate per 100 person years'		labelattrs=(size=12)  values = (0 to 5 by 0.5) valueattrs=(size=10);

label mean_incidence1524___0 = "Option 0 (median) ";
label mean_incidence1524___1 = "Option 1  (median) ";

series  x=cald y=mean_incidence1524___0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_incidence1524___0 	upper=p95_incidence1524___0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
series  x=cald y=mean_incidence1524___1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_incidence1524___1 	upper=p95_incidence1524___1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
run;
quit;
...
label mean_prev_vg1000_newp_0 = "Option 0 (median) ";
label mean_prev_vg1000_newp_1 = "Option 1  (median) ";

series  x=cald y=mean_prev_vg1000_newp_0/	lineattrs = (color=black thickness = 2);
...
series  x=cald y=mean_prev_vg1000_newp_1/	lineattrs = (color=red thickness = 2);
...
mean_prevalence5559w_0 	mean_prevalence5559m_0 
