...
p_mcirc_1549m	p_mcirc_1049m	n_new_vmmc1549m 	n_new_vmmc1049m	n_birth_circ
...
proc sgplot data=d; 
Title    height=1.5 justify=center "Annual # traditional circumcisions at birth";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1990 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to  400000 by 50000) valueattrs=(size=10);
label p50_n_birth_circ_0 = "Option 0 (median) 15-49";
series  x=cald y=p50_n_birth_circ_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_birth_circ_0 	upper=p95_n_birth_circ_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
run;quit;
