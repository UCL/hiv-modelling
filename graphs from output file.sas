...
series  x=cald y=p50_n_cd4_lt200_0/	lineattrs = (color=black thickness = 2);
band    x=cald lower=p5_n_cd4_lt200_0 	upper=p95_n_cd4_lt200_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "Model 90% range";
