...
ods rtf file = 'C:\Users\ValentinaCambiano\Projects\Modelling Consortium\MIHPSA\Zimbabwe\Phase 2 - Synthesis\Findings\V0_20230428.doc' startpage=never; 
...
proc freq data=d;table p50_n_w1524_newp_ge1_0;run;
proc sgplot data=d; 
...
scatter x=cald y=o_n_tests_anc / markerattrs = (symbol=square color=orange size = 10);
run;quit;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1990 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to  30000 by 2500) valueattrs=(size=10);
