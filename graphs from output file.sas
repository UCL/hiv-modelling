...
incidence5564w_ incidence5564m_ n_tested n_tested_m n_diagnosed
test_prop_positive
...
series  x=cald y=p50_n_art_start_y_15/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_n_art_start_y_15 	upper=p95_n_art_start_y_15  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
run;quit;
...
series  x=cald y=p50_n_prep_1/	lineattrs = (color=green thickness = 2);
band    x=cald lower=p5_n_prep_1 	upper=p95_n_prep_1  / transparency=0.9 fillattrs = (color=green) legendlabel= "Model 90% range";
...
label p50_n_prep_ever_15 = "Option 1  (median) ";
...
series  x=cald y=p50_incidence1549__1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_incidence1549__1 	upper=p95_incidence1549__1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
series  x=cald y=p50_incidence1549__15/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_incidence1549__15 	upper=p95_incidence1549__15  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
*****START HERE****;
proc sgplot data=d; 
Title    height=1.5 justify=center "of men with hiv 15+, % diagnosed";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1990 to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Proportion'		labelattrs=(size=12)  values = (0 to 1 by 0.1) valueattrs=(size=10);
label p50_p_diag_m_0 = "Option 0 (median)";
label p50_p_diag_m_1 = "Option 1  (median)";
...
series  x=cald y=p50_p_diag_m_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_diag_m_1 	upper=p95_p_diag_m_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
series  x=cald y=p50_p_diag_m_15/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_diag_m_15 	upper=p95_p_diag_m_15  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
...
series  x=cald y=p50_p_artexp_diag_1/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_artexp_diag_1 	upper=p95_p_artexp_diag_1  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
series  x=cald y=p50_p_artexp_diag_15/	lineattrs = (color=red thickness = 2);
band    x=cald lower=p5_p_artexp_diag_15 	upper=p95_p_artexp_diag_15  / transparency=0.9 fillattrs = (color=red) legendlabel= "Model 90% range";
run;quit;
...
label p50_n_onart_0 = "Option 0  (median)";
label p50_n_onart_1 = "Option 1  (median)";
label p50_n_onart_1 = "Option 15 (median)";
