...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2010 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'prevalence'		labelattrs=(size=12)  values = (0 to  0.15      by 0.01    ) valueattrs=(size=10);
