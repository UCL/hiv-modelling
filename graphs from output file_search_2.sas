...
proc transpose data=option_2 out=f&count prefix=&varb;var &varb; by cald; id count_csim;run;
*In order to easily join with from 2012 av_&varb.1,etc...;
data f&count;set f&count;***creates one dataset per variable;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2085 by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'n_tested'		labelattrs=(size=12)  values = (0 to  2500000     by 500000 )  valueattrs=(size=10);
