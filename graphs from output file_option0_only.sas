...
prop_w_vlg1  prop_w_vlg2  prop_w_vlg3  prop_w_vlg4  prop_w_vlg5 prop_w_vlg6  prop_w_1549_sw  incidence_sw 
;
...
label p50_p_onart_5 = "option_5";
  ...
  series  x=cald y=p50_p_onart_3/	lineattrs = (color=orange thickness = 4);
...
ods html;
proc sgplot data=d; 
Title    height=1.5 justify=center "incidence_sw";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2000 to 2070 by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Rate'		labelattrs=(size=12)  values = (0 to 10.0   by 1.0 ) valueattrs=(size=10);

label mean_incidence_sw_0 = "option 0";

  series  x=cald y=mean_incidence_sw_0/	lineattrs = (color=black thickness = 4);
  band    x=cald lower=p5_incidence_sw_0 	upper=p95_incidence_sw_0  / transparency=0.9 fillattrs = (color=black) legendlabel= "90% range";
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (1995 to 2070 by 1)	 	 valueattrs=(size=10); 
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2010 to 2030 by 1)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0.50 to 1   by 0.05 ) valueattrs=(size=10);
...
label p50_n_hiv_3 = "option_3";
  ...
  series  x=cald y=p50_n_hiv_3/	lineattrs = (color=orange thickness = 4);
...
label p50_n_onart_3 = "option_3";
  ...
  series  x=cald y=p50_n_onart_3/	lineattrs = (color=orange thickness = 4);
