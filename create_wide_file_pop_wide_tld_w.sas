...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\pop_wide_tld\pop_wide_tld_w_out\";
...
proc sort data = a.k_pwt_w_a out=a.k_pwt_w_b ; 
by run cald option;
run;
...
proc sort data=a.k_pwt_w_c out=a.k_pwt_w_c ; by run option; run;
...
data    a.l_pwt_w  ; set a.k_pwt_w_c;  
...
ods html;
proc means data=   w_pwt_w n p50 p5 p95 min max;  *  w_pwt_w ;
...
ods html;
proc means  data=   w_pwt_w n median p5 p95 min max ;
...
proc means data=  w_pwt_w n mean p5 p95;
var 
...
proc univariate data=  w_pwt_w; var d_n_death_hiv_50y_2_1 ; where artvis0_lower_adh = 0; run;
proc freq; tables d_n_death_hiv_50y_2_1 d_n_cd4_lt200_50y_2_1 ;  where artvis0_lower_adh = 0; run;

proc freq data=  w_pwt_w; tables pop_wide_tld_ce  ; where incidence1549_22 >= 0.5; run;
...
proc univariate  data=  w_pwt_w; var d_p_vl1000_3y_2_1 d_n_death_hiv_50y_2_1; 
where artvis0_lower_adh=0;
run;
