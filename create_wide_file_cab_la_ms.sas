...
if option=3 then do; 
	...
	dcost_prep_oral = dcost_prep_oral * ( 85 / 60 ) ; 
	...
	dvis_cost = dvis_cost - (discount * (s_onartvisit0 * 0.010)) ;
...
data &v ; merge y_22 t_20y t_42 t_50y ;  
...
proc means data=   w_pop_wide_tld n p50 p5 p95 min max;  
