...
data    b.l_laa_ac_r_01; set y;  

data y ; set b.l_laa_ac_r_01; 
...
if 0.025 <= prevalence_vg1000_24 < 0.030 then prevalence_vg1000_24_g=5;
if 0.030 <= prevalence_vg1000_24 < 0.035 then prevalence_vg1000_24_g=5;
if 0.035 <= prevalence_vg1000_24 < 0.040 then prevalence_vg1000_24_g=5;
if 0.040 <= prevalence_vg1000_24        then prevalence_vg1000_24_g=6;

if p_diag_vlg1000_24 < 0.005 then p_diag_vlg1000_24_g=1;
if 0.005 <= p_diag_vlg1000_24 < 0.010 then p_diag_vlg1000_24_g=2;
if 0.010 <= p_diag_vlg1000_24 < 0.015 then p_diag_vlg1000_24_g=3;
if 0.015 <= p_diag_vlg1000_24 < 0.020 then p_diag_vlg1000_24_g=4;
if 0.020 <= p_diag_vlg1000_24 < 0.025 then p_diag_vlg1000_24_g=5;
if 0.025 <= p_diag_vlg1000_24 < 0.030 then p_diag_vlg1000_24_g=5;
if 0.030 <= p_diag_vlg1000_24 < 0.035 then p_diag_vlg1000_24_g=5;
if 0.035 <= p_diag_vlg1000_24 < 0.040 then p_diag_vlg1000_24_g=5;
if 0.040 <= p_diag_vlg1000_24        then p_diag_vlg1000_24_g=6;
...
* prevalence1549_24 incidence1549_24 p_diag_24  p_onart_diag_24  p_onart_vl1000_24;

proc freq; tables prevalence_vg1000_24_g * lowest_netdaly ; 
run;

proc freq; tables p_diag_vlg1000_24_g * lowest_netdaly ; 
run;
