...
libname a "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\laa\laa_ac_out\";
...
series  x=cald y=p50_p_len_1 / lineattrs = (color=stlg thickness = 4);
band    x=cald lower=p5_p_len_1 upper=p95_p_len_1 / transparency=0.9 fillattrs = (color=stlg) legendlabel= "90% range";
...
series  x=cald y=p50_n_mtct_1 / lineattrs = (color=stlg thickness = 4);
band    x=cald lower=p5_n_mtct_1 upper=p95_n_mtct_1 / transparency=0.9 fillattrs = (color=stlg) legendlabel= "90% range";
