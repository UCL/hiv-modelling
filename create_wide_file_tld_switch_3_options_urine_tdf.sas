...
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\tld_switch\tld_switch_an_utdf_out\";


/*

libname c "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\tld_switch\tld_switch_an_out\";
libname b "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\tld_switch\tld_switch_an_utdf_out\";
...
data b.k_tld_switch_an_utdf;  set i1 i2 i3 i4 i5 i6 i7 i8 i9 ;
...
proc sort data=b.k_tld_switch_an_utdf; 
by run cald option;
run;
...
merge b.k_tld_switch_an_utdf sf;
by run ;
...
dten_cost d3tc_cost ddar_cost ddol_cost  p_r_dol   sens_res_test  date_prep_cab_intro  p_vlg1000_onart_allhiv
;
...
data    b.l_tld_switch_an_utdf; set y;  

data y ; set b.l_tld_switch_an_utdf; 
...
* To get one row per run;
  ...
  data  b.w_tld_switch_an_utdf_024    ; 
...
data b;
set b.w_tld_switch_an_utdf_024   ;
...
proc means data = b  n mean lclm uclm p50 p5 p95;
  var       
r_incidence1549_50y_3_1 r_incidence1549_50y_2_1
n_death_hiv_50y_1 n_death_hiv_50y_2 n_death_hiv_50y_3 
d_n_death_hiv_50y_2_1 d_n_death_hiv_50y_3_1 
