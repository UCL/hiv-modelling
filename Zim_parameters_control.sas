...
* rate_non_hiv_symptoms;	rate_non_hiv_symptoms=0.004;	* rate of development of non-hiv symptoms, regardless of hiv status;
* Jun2024: rate_non_hiv_symptoms added in Zim_parameters  to align with # of tests in symptomatic based on PEPFAR data. In core it is 0.01;
...
* SEX WORKERS;	
* SW parameters updated to LBMs latest version (25/6/24) on 23/1/25;
...
* rr_sw_age_1519;			rr_sw_age_1519 = 0.60;	*NEW PARAM;
...
* effect_sw_prog_newp;		*PARAM REMOVED;
* effect_sw_prog_6mtest;    %sample_uniform(effect_sw_prog_6mtest, 0.05 0.10);*consider changing in core as this is now lower than core and Zim should have one of the better programs;
* effect_sw_prog_int;		*PARAM REMOVED;
* effect_sw_prog_lossdiag;	*PARAM REMOVED;
...
* effect_sw_prog_pers_sti;	*PARAM REMOVED;
