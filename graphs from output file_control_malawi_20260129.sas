...
*** 20260129 version has options 0-9 and 99, using weaker condom change intervention parameters and removing self-testing in the minimal (option 0);
...
ods rtf file = 'C:\Users\rmjlja9\Documents\GitHub\hiv-modelling\Malawi\graphs_20260129.doc' startpage=never;
...
label mean_incidence1549__4 = " + adh-supp";
label mean_incidence1549__5 = " + fsw-program";
label mean_incidence1549__6 = " + msm-program";
label mean_incidence1549__7 = " + agyw-prep-mix";
label mean_incidence1549__8 = " + msm-prep-mix";
...
run;
* inc = 0.24204 in 2023 (51 runs). 10% less = 0.21784;
...
run;
* option 6 brings incidence below the threshold (51 runs) - condoms, vmmc, fsw-prep-mix, adh-supp, fsw-program, msm-program;
...
label mean_incidence1564__4 = " + adh-supp";
label mean_incidence1564__5 = " + fsw-program";
label mean_incidence1564__6 = " + msm-program";
label mean_incidence1564__7 = " + agyw-prep-mix";
label mean_incidence1564__8 = " + msm-prep-mix";
...
label mean_n_new_inf1549__4 = " + adh-supp";
label mean_n_new_inf1549__5 = " + fsw-program";
label mean_n_new_inf1549__6 = " + msm-program";
label mean_n_new_inf1549__7 = " + agyw-prep-mix";
label mean_n_new_inf1549__8 = " + msm-prep-mix";
...
label mean_p_newp_ge1__4 = " + adh-supp";
label mean_p_newp_ge1__5 = " + fsw-program";
label mean_p_newp_ge1__6 = " + msm-program";
label mean_p_newp_ge1__7 = " + agyw-prep-mix";
label mean_p_newp_ge1__8 = " + msm-prep-mix";
...
label mean_p_ep_4 = " + adh-supp";
label mean_p_ep_5 = " + fsw-program";
label mean_p_ep_6 = " + msm-program";
label mean_p_ep_7 = " + agyw-prep-mix";
label mean_p_ep_8 = " + msm-prep-mix";
...
label mean_p_diag_m_4 = " + adh-supp";
label mean_p_diag_m_5 = " + fsw-program";
label mean_p_diag_m_6 = " + msm-program";
label mean_p_diag_m_7 = " + agyw-prep-mix";
label mean_p_diag_m_8 = " + msm-prep-mix";
...
label mean_p_diag_w_4 = " + adh-supp";
label mean_p_diag_w_5 = " + fsw-program";
label mean_p_diag_w_6 = " + msm-program";
label mean_p_diag_w_7 = " + agyw-prep-mix";
label mean_p_diag_w_8 = " + msm-prep-mix";
...
label mean_p_art_m_4 = " + adh-supp";
label mean_p_art_m_5 = " + fsw-program";
label mean_p_art_m_6 = " + msm-program";
label mean_p_art_m_7 = " + agyw-prep-mix";
label mean_p_art_m_8 = " + msm-prep-mix";
...
label mean_p_art_w_4 = " + adh-supp";
label mean_p_art_w_5 = " + fsw-program";
label mean_p_art_w_6 = " + msm-program";
label mean_p_art_w_7 = " + agyw-prep-mix";
label mean_p_art_w_8 = " + msm-prep-mix";
...
label mean_p_diag_art_m_4 = " + adh-supp";
label mean_p_diag_art_m_5 = " + fsw-program";
label mean_p_diag_art_m_6 = " + msm-program";
label mean_p_diag_art_m_7 = " + agyw-prep-mix";
label mean_p_diag_art_m_8 = " + msm-prep-mix";
...
label mean_p_diag_art_w_4 = " + adh-supp";
label mean_p_diag_art_w_5 = " + fsw-program";
label mean_p_diag_art_w_6 = " + msm-program";
label mean_p_diag_art_w_7 = " + agyw-prep-mix";
label mean_p_diag_art_w_8 = " + msm-prep-mix";
...
label mean_p_art_vls_m_4 = " + adh-supp";
label mean_p_art_vls_m_5 = " + fsw-program";
label mean_p_art_vls_m_6 = " + msm-program";
label mean_p_art_vls_m_7 = " + agyw-prep-mix";
label mean_p_art_vls_m_8 = " + msm-prep-mix";
...
label mean_p_art_vls_w_4 = " + adh-supp";
label mean_p_art_vls_w_5 = " + fsw-program";
label mean_p_art_vls_w_6 = " + msm-program";
label mean_p_art_vls_w_7 = " + agyw-prep-mix";
label mean_p_art_vls_w_8 = " + msm-prep-mix";
...
label mean_p_mcirc_1549m_4 = " + adh-supp";
label mean_p_mcirc_1549m_5 = " + fsw-program";
label mean_p_mcirc_1549m_6 = " + msm-program";
label mean_p_mcirc_1549m_7 = " + agyw-prep-mix";
label mean_p_mcirc_1549m_8 = " + msm-prep-mix";
...
label mean_p_mcirc_1524m_4 = " + adh-supp";
label mean_p_mcirc_1524m_5 = " + fsw-program";
label mean_p_mcirc_1524m_6 = " + msm-program";
label mean_p_mcirc_1524m_7 = " + agyw-prep-mix";
label mean_p_mcirc_1524m_8 = " + msm-prep-mix";
...
label mean_n_onprep_4 = " + adh-supp";
label mean_n_onprep_5 = " + fsw-program";
label mean_n_onprep_6 = " + msm-program";
label mean_n_onprep_7 = " + agyw-prep-mix";
label mean_n_onprep_8 = " + msm-prep-mix";
...
label mean_n_sw_program_visit_4 = " + adh-supp";
label mean_n_sw_program_visit_5 = " + fsw-program";
label mean_n_sw_program_visit_6 = " + msm-program";
label mean_n_sw_program_visit_7 = " + agyw-prep-mix";
label mean_n_sw_program_visit_8 = " + msm-prep-mix";
...
label mean_n_self_tested_4 = " + adh-supp";
label mean_n_self_tested_5 = " + fsw-program";
label mean_n_self_tested_6 = " + msm-program";
label mean_n_self_tested_7 = " + agyw-prep-mix";
label mean_n_self_tested_8 = " + msm-prep-mix";
...
label mean_n_tested_m_4 = " + adh-supp";
label mean_n_tested_m_5 = " + fsw-program";
label mean_n_tested_m_6 = " + msm-program";
label mean_n_tested_m_7 = " + agyw-prep-mix";
label mean_n_tested_m_8 = " + msm-prep-mix";
...
label mean_n_tested_w_4 = " + adh-supp";
label mean_n_tested_w_5 = " + fsw-program";
label mean_n_tested_w_6 = " + msm-program";
label mean_n_tested_w_7 = " + agyw-prep-mix";
label mean_n_tested_w_8 = " + msm-prep-mix";
...
label mean_total_cost_hiv_control_4 = " + adh-supp";
label mean_total_cost_hiv_control_5 = " + fsw-program";
label mean_total_cost_hiv_control_6 = " + msm-program";
label mean_total_cost_hiv_control_7 = " + agyw-prep-mix";
label mean_total_cost_hiv_control_8 = " + msm-prep-mix";
...
proc export data=icer_sums
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260129_out\icer_sums.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
...
proc export data=icer_sums_2049
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_malawi\mlw_control_20260129_out\icer_sums_2049.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
