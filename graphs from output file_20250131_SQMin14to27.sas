...
data b;
set a.l_base_31_01_2025_SQMin14to27;
...
ods rtf file = 'C:\Users\rmjlja9\OneDrive - University College London\MIHPSA Zimbabwe\Phase 2\2025JAN31\SQMin14to27_graphs_20250131.doc' startpage=never;
...
xaxis label			= 'Year'		labelattrs=(size=12)  values = (&year_start to &year_end by 2)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 5e5   by 1e5 ) valueattrs=(size=10);
label p50_n_contprep_oral_1524w_0 = 	"Status quo (median) ";
label p50_n_contprep_oral_1524w_1 = 	"Minimal  (median) ";
...
scatter x=cald y=target_prep_1524w_lq  / markerattrs = (color=orange);
run;quit;
