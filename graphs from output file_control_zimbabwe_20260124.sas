...
*** 20260124 version has options 0-13 and 99, using weaker condom change intervention parameters and keeping self-testing in the minimal (option 0);
...
ods rtf file = 'C:\Users\rmjlja9\Documents\GitHub\hiv-modelling\Zimbabwe\graphs_20260124.doc' startpage=never;
...
proc export data=icer_sums
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_zimbabwe\hiv_control_zim_20260124_out\icer_sums.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
...
proc export data=icer_sums_2049
	outfile= "C:\Users\rmjlja9\UCL Dropbox\Jennifer Smith\hiv synthesis ssa unified program\output files\hiv_control_zimbabwe\hiv_control_zim_20260124_out\icer_sums_2049.csv" 
	dbms=csv replace; 
	putnames=yes;
run;
