...
libname a "C:\Users\w3sth\Dropbox (UCL)\hiv synthesis ssa unified program\output files\vlm_25\vlm_25_out\";
...
yaxis grid label	= 'prevalence'		labelattrs=(size=12)  values = (0.85  to 1          by 0.05     ) valueattrs=(size=10);
...
series  x=cald y=p50_p_adh_hi_1 / lineattrs = (color=stlg      thickness = 4);
band    x=cald lower=p5_p_adh_hi_1 upper=p95_p_adh_hi_1 / transparency=0.9 fillattrs = (color=stlg) legendlabel= "90% range";
...
series  x=cald y=p50_p_onart_vl1000__1 / lineattrs = (color=stlg thickness = 4);
band    x=cald lower=p5_p_onart_vl1000__1 upper=p95_p_onart_vl1000__1 / transparency=0.9 fillattrs = (color=stlg) legendlabel= "90% range";
...
* Title '';    Title    height=1.5 justify=center "n_vm_this_per (p50 90% range)";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'Number'		labelattrs=(size=12)  values = (0 to 500000       by 100000) valueattrs=(size=10);

series  x=cald y=p50_n_vm_this_per_0 / lineattrs = (color=grey thickness = 4);
band    x=cald lower=p5_n_vm_this_per_0 upper=p95_n_vm_this_per_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

series  x=cald y=p50_n_vm_this_per_1 / lineattrs = (color=darkblue    thickness = 4);
band    x=cald lower=p5_n_vm_this_per_1 upper=p95_n_vm_this_per_1 / transparency=0.9 fillattrs = (color=darkblue   ) legendlabel= "90% range";
...
ods html;
proc sgplot data=d nolegend; 
* Title '';   Title    height=1.5 justify=center "discounted dvis_cost";
xaxis label			= 'Year'		labelattrs=(size=12)  values = (2015 to 2075 by 5)	 	 valueattrs=(size=10); 
yaxis grid label	= 'dvis_cost'		labelattrs=(size=12)  values = (0 to  100         by 10    ) valueattrs=(size=10);

loess   x=cald y=p50_dvis_cost_0 / lineattrs = (color=grey thickness = 4) nomarkers;
band    x=cald lower=p5_dvis_cost_0 upper=p95_dvis_cost_0 / transparency=0.9 fillattrs = (color=grey) legendlabel= "90% range";

loess   x=cald y=p50_dvis_cost_1 / lineattrs = (color=darkblue      thickness = 4) nomarkers;
band    x=cald lower=p5_dvis_cost_1 upper=p95_dvis_cost_1 / transparency=0.9 fillattrs = (color=darkblue     ) legendlabel= "90% range";
