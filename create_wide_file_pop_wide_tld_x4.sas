...
libname b "C:\Users\w3sth\TLO_HMC Dropbox\Andrew Phillips\hiv synthesis ssa unified program\output files\pop_wide_tld\pop_wide_tld_x4_out\";
...
proc print data=i1a; var s_prep_any  s_prep_any_elig  s_prep_elig_hivneg_onprep  s_prep_elig_hivneg s_pop_wide_tld_as_art;
run;
...
proc sort data = k_pwt_x4_a out=k_pwt_x4_b ; 
by run cald option;
run;
...
s_pop_wide_tld_prep_elig  s_pop_wide_tld_prep
...
proc sort data=k_pwt_x4_c out=k_pwt_x4_c ; by run option; run;

proc freq data=k_pwt_x4_c ; tables run; where cald = 2020; run;
...
data    a.l_pwt_x4 ; set k_pwt_x4_c;  
...
ods html;
proc means data=   w_pwt_x4 n p50 p5 p95 min max;  *  w_pwt_x4 ;
...
ods html;
proc means  data=   w_pwt_x4 n median p5 p95 min max ;
...
proc means data=  w_pwt_x4 n mean p5 p95;
var 
...
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_0_to_1 prob_onartvis0_1_to_0 rate_choose_stop_prep_oral
...
pop_wide_tld_selective_hiv pep_efficacy  prob_test_pop_wide_tld_prep death_r_iris_pop_wide_tld low_prep_inj_uptake;
model deaths_averted = 
pref_prep_oral_beta_s1 
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_0_to_1 prob_onartvis0_1_to_0 rate_choose_stop_prep_oral
prob_prep_pop_wide_tld  inc_oral_prep_pref_pop_wide_tld  prep_dependent_prev_vg1000_g   prop_pep  artvis0_lower_adh  pop_wide_prep_adh_effect 
pop_wide_tld_selective_hiv pep_efficacy  prob_test_pop_wide_tld_prep  death_r_iris_pop_wide_tld P_hard_reach_w p_hard_reach_m  low_prep_inj_uptake
;
run;


proc  glm data=  j        ; 
class pref_prep_oral_beta_s1 pref_prep_oral_beta_s1 rate_int_choice
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_0_to_1 prob_onartvis0_1_to_0
prob_prep_pop_wide_tld  inc_oral_prep_pref_pop_wide_tld  prep_dependent_prev_vg1000_g   prop_pep  artvis0_lower_adh  pop_wide_prep_adh_effect 
pop_wide_tld_selective_hiv pep_efficacy  prob_test_pop_wide_tld_prep death_r_iris_pop_wide_tld;
model d_n_death_hiv_50y_2_1 = 
pref_prep_oral_beta_s1 rate_int_choice
rr_return_pop_wide_tld rr_interrupt_pop_wide_tld  prob_tld_if_untested  prob_onartvis0_0_to_1 prob_onartvis0_1_to_0
prob_prep_pop_wide_tld  inc_oral_prep_pref_pop_wide_tld  prep_dependent_prev_vg1000_g   prop_pep  artvis0_lower_adh  pop_wide_prep_adh_effect 
...
proc univariate data=  w_pwt_x4; var d_n_death_hiv_50y_2_1 ; where artvis0_lower_adh = 0; run;
proc freq; tables d_n_death_hiv_50y_2_1 d_n_cd4_lt200_50y_2_1 ;  where artvis0_lower_adh = 0; run;

proc freq data=  w_pwt_x4; tables pop_wide_tld_ce  ; where incidence1549_22 >= 0.5; run;
...
proc univariate  data=  w_pwt_x4; var d_p_vl1000_3y_2_1 d_n_death_hiv_50y_2_1; 
where artvis0_lower_adh=0;
run;
