...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\FSW\c_output_fsw_26_02_21_11am_temp";
...
* n_sw_1549;					n_sw_1549 = s_sw_1549 * sf_2020;
...
* n_tested_sw;					n_tested_sw = s_tested_sw * sf_2020 * 4;
...
* p_newp_this_per_prep;			if s_newp_this_per_hivneg gt 0 then p_newp_this_per_prep = s_newp_this_per_prep / s_newp_this_per_hivneg ;  * newp this per means at least one newp ;
* prop_elig_on_prep;			if s_elig_prep gt 0 then if s_elig_prep then prop_elig_on_prep = s_prep / s_elig_prep ; 
* p_newp_prep;					if (s_m_newp + s_w_newp) gt 0 then p_newp_prep = s_prep_newp / (s_m_newp + s_w_newp) ;  * proportion of all newp for which person is on prep;
* p_newp_prep_hivneg;			if s_newp_hivneg gt 0 then p_newp_prep_hivneg = s_prep_newp / s_newp_hivneg ;  * proportion of all newp in hiv-ve people for which person is on prep;
...
prop_w_1549_sw	prop_w_1564_sw  prop_w_ever_sw prop_sw_hiv prop_sw_program_visit
prop_w_1524_onprep prop_1564_onprep prop_sw_onprep p_prep_adhg80  av_prep_eff_non_res_v
...
incidence1549 incidence1549w  incidence1549m  incidence_sw  p_inf_vlsupp  p_inf_newp  p_inf_ep  p_inf_diag  p_inf_naive p_inf_primary mtct_prop
...
data a.fsw_26_02_21_11am; set y;run;


data y; set a.fsw_26_02_21_11am; run;
...
* &v ;
proc means  noprint data=y; var &v; output out=y_10 mean= &v._10; by run ; where cald = 2010; 
proc means  noprint data=y; var &v; output out=y_21 mean= &v._21; by run ; where cald = 2021; 

proc means noprint data=y; var &v; output out=y_10_20 mean= &v._10_20; by run option ; where 2010.0 <= cald < 2021.0; 
proc means noprint data=y; var &v; output out=y_20_21 mean= &v._20_21; by run option ; where 2020.0 <= cald < 2021.0; 

proc sort data=y_10_20; by run; proc transpose data=y_10_20 out=t_10_20 prefix=&v._10_20_; var &v._10_20; by run;
proc sort data=y_20_21; by run; proc transpose data=y_20_21 out=t_20_21 prefix=&v._20_21_; var &v._20_21; by run;


data &v ; merge  y_10 y_21 t_10_20 t_20_21  ;
