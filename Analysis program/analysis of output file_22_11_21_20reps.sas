...
if run gt  799872568 then delete; * to get exactly 200 runs ;
...
*base;cost_inf_avert_21_26_1= 12.2*1000000; cost_inf_avert_21_41_1= 3.1*1000000; cost_inf_avert_21_71_1 = 1.8*1000000;
...
cost_daly_avert_21_71_1_adults=1.8*1000000;
...
proc freq;table run;where d_dcost_21_71_1 le 0;run;
...
proc print;var run ;where d_ddaly_adults_21_71_1 lt 0 ;run;
...
proc freq;table run;where cost_daly_avert_21_71_1_adults le 500;run;
...
Proc logistic desc;class p_vl1000 (ref="1");
model  ce_21_71  = p_vl1000;run;
Proc logistic desc;class p_circ (ref="1");
...
model  ce_21_71  = incidence1549_21;run;
Proc logistic data=one desc;class p_vl1000 (ref="1");
model  ce_21_71  = p_vl1000_21_scaled;run;
Proc logistic data=one desc;class p_circ (ref="1");
model  ce_21_71  = p_mcirc_1549m_21_scaled;run;
Proc logistic data=one desc;
model  ce_21_71  = incidence1549_21  p_vl1000_21_scaled p_mcirc_1549m_21_scaled;run;
