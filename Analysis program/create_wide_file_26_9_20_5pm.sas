...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_26_9_20_5pm_temp";
...
data a.vmmc_26_9_20_5pm; set y;run;


data y; set a.vmmc_26_9_20_5pm; run;
