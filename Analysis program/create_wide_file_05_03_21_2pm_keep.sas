...
dnon_tb_who3_cost = s_dnon_tb_who3_cost * sf_2020 * discount_adj * 4 / 1000;
...
dcost = dart_cost_y + dadc_cost + dcd4_cost + dvl_cost + dvis_cost + /*dwho3_cost*/ dnon_tb_who3_cost + dcot_cost + dtb_cost+dres_cost + dtest_cost + d_t_adh_int_cost
...
dcost_clin_care = dart_cost_y + dadc_cost + dcd4_cost + dvl_cost + dvis_cost + /*dwho3_cost*/ dnon_tb_who3_cost + dcot_cost + dtb_cost + dres_cost + d_t_adh_int_cost + 
				dswitchline_cost; 
