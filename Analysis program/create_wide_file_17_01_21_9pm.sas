...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\FSW\c_output_fsw_14_01_21_11pm_temp";
...
data a.fsw_14_01_21_11pm; set y;run;


data y; set a.fsw_14_01_21_11pm; run;
...
* &v ;
proc means  noprint data=y; var &v; output out=y_15 mean= &v._15; by run ; where cald = 2015; 
*proc means  noprint data=y; var &v; output out=y_20 mean= &v._20; by run ; where cald = 2020; 
*proc means  noprint data=y; var &v; output out=y_25 mean= &v._25; by run ; where cald = 2025; 

proc means noprint data=y; var &v; output out=y_15_20 mean= &v._15_20; by run option ; where 2015.0 <= cald < 2021.0; 
proc means noprint data=y; var &v; output out=y_20_21 mean= &v._20_21; by run option ; where 2020.0 <= cald < 2021.0; 

proc sort data=y_15_20; by run; proc transpose data=y_15_20 out=t_15_20 prefix=&v._15_20_; var &v._15_20; by run;
proc sort data=y_20_21; by run; proc transpose data=y_20_21 out=t_20_21 prefix=&v._20_21_; var &v._20_21; by run;


data &v ; merge  y_15 t_15_20 t_20_21  ;
