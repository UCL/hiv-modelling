...
s_cost_circ_new= (s_cost_circ_80*(120/90));*For sensitivity analyses change to 60/90 and 120/90;
...
*F=final;
data a.vmmc_25_06_21_10r_20reps_F_120; set y;run;
data y; set a.vmmc_25_06_21_10r_20reps_F_120;run;
...
*libname a "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\";
  ...
  data a.wide_vmmc_25_06_21_1pm_20r_F_120;
