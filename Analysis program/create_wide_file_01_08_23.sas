...
* linked_diag_w;				if s_diag_thisper_sw>0 then p_linked_diag_w = s_linked_diag_w/s_diag_this_period_f;
...
s_tested s_tested_m s_tested_f n_pregnant p_linked_diag_sw p_linked_diag_w
;

proc sort data=y;by run option;run;

proc freq;table p_linked_diag_sw;run;


proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=1 and effect_sw_prog_lossdiag=0.3 and 2030<=cald<2035;run;
proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=1 and effect_sw_prog_lossdiag=0.5 and 2030<=cald<2035;run;
proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=1 and effect_sw_prog_lossdiag=0.7 and 2030<=cald<2035;run;

proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=2 and effect_sw_prog_lossdiag=0.1 and 2030<=cald<2035;run;
proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=2 and effect_sw_prog_lossdiag=0.2 and 2030<=cald<2035;run;
proc means n p50 mean;var p_linked_diag_sw p_linked_diag_w;where option=2 and effect_sw_prog_lossdiag=0.3 and 2030<=cald<2035;run;




proc means n p50 mean;var p_onart_diag_sw;where option=1 and effect_sw_prog_lossdiag=0.3 and 2030<=cald<2035;run;
proc means n p50 mean;var p_onart_diag_sw;where option=1 and effect_sw_prog_lossdiag=0.5 and 2030<=cald<2035;run;
proc means n p50 mean;var p_onart_diag_sw;where option=1 and effect_sw_prog_lossdiag=0.7 and 2030<=cald<2035;run;


proc means n p50 mean;var p_onart_diag_sw;where option=2 and effect_sw_prog_lossdiag=0.1 and 2030<=cald<2035;run;
proc means n p50 mean;var p_onart_diag_sw;where option=2 and effect_sw_prog_lossdiag=0.2 and 2030<=cald<2035;run;
proc means n p50 mean;var p_onart_diag_sw;where option=2 and effect_sw_prog_lossdiag=0.3 and 2030<=cald<2035;run;
...
proc freq;table effect_sw_prog_lossdiag;where option=2 and cald>2023;run;
...
data y; set a.fsw_21_07_23_short;run;
