...
%var(v=n_new_inf1549m); %var(v=n_new_inf1549);%var(v=s_sw_newp); %var(v=d_n_new_inf1549);%var(v=d_n_infection);%var(v=n_infection);
...
n_new_inf1549m n_new_inf1549 d_n_new_inf1549 d_n_infection n_infection;
