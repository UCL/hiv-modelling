...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\fsw\c_output_fsw_5_8_20_11am_temp";
...
data a.fsw_5_8_20_11am; set y;

data y; set a.fsw_5_8_20_11am; run;
...
proc means noprint data=y; var &v; output out=y_15_20 mean= &v._15_20; by run option ; where 2015 <= cald < 2020.50;
...
%var(v=p_vmmc); %var(v=p_vmmc_1519m); %var(v=p_vmmc_2024m);
%var(v=p_vmmc_2529m); %var(v=p_vmmc_3039m); %var(v=p_vmmc_4049m); %var(v=p_vmmc_50plm); %var(v=p_vmmc_1549m);
...
p_hard_reach_m  inc_cat base_rate_sw/solution;run;

proc freq;table sex_age_mixing_matrix_m;run;
