...
model p_diag_w_20 = incidence1549w_20 incidence1549m_20 an_lin_incr_test date_test_rate_plateau rate_testanc_inc incr_test_rate_sympt/solution;run;



proc glm; class sw_init_newp;
model prop_sw_newp0_20 = sw_init_newp/solution;run;
