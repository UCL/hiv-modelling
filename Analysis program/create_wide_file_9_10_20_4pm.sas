...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_9_10_20_4pm_temp";
...
data a.vmmc_9_10_20_4pm; set y;run;


data y; set a.vmmc_9_10_20_4pm; run;
