...
keep cald option_new incidence1549 incidence1564 run;run;
...
%mend var;
%var(v=incidence1564);%var(v=incidence1549); run;

data   wide_outputs; 
merge incidence1564 incidence1549;run;
