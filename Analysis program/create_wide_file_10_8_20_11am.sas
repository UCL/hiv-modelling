...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_7_8_20_11am";
...
s_new_vmmc3039m = s_new_vmmc3034m + s_new_vmmc3539m;
s_new_vmmc4049m = s_new_vmmc4044m + s_new_vmmc4549m;
...
* p_new_vmmc_1014m_u;			if (s_ageg1014m - s_hiv1014m) gt 0 then p_new_vmmc_1014m_u = s_new_vmmc1014m / (s_ageg1014m - s_hiv1014m) ;
