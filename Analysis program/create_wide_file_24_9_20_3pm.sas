...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_24_9_20_3pm_temp";
...
n_mcirc1549_py  n_mcirc1549_3m  n_vmmc1549_py n_vmmc1549_3m  n_new_vmmc1549_py n_new_vmmc1049_py  n_new_inf1549m  n_new_inf1549 d_n_new_inf1549
s_sw_newp;
proc sort data=y;by run option;run;


data a.vmmc_24_9_20_3pm; set y;run;


data y; set a.vmmc_24_9_20_3pm; run;
...
proc means  noprint data=y; var &v; output out=y_40 mean= &v._40; by run ; where cald = 2040; 

proc means noprint data=y; var &v; output out=y_19_20 mean= &v._19_20; by run option ; where 2019.5 <= cald < 2020.50;
...
data &v ; merge  y_20 y_40  t_19_20 t_20_25 t_20_40 t_20_70 ;  
...
%var(v=n_new_inf1549m); %var(v=n_new_inf1549);%var(v=s_sw_newp); %var(v=d_n_new_inf1549);
...
n_new_inf1549m n_new_inf1549 d_n_new_inf1549
s_sw_newp
;
