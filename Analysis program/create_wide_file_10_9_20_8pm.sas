...
***Only runs to 2020 - to calculate rates of vmmc uptake as these were incorrect in last file;
...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_10_9_20_8pm";
...
prop_w_1549_sw	prop_w_ever_sw prop_sw_hiv prop_w_1524_onprep prop_1564_onprep prop_sw_onprep p_prep_adhg80  av_prep_effectiveness_non_res_v
...
data a.vmmc_12_8_20_1pm; set y;run;

data y; set a.vmmc_12_8_20_1pm; run;
