...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_21_10_20_1pm_lowart";
...
data a.vmmc_21_10_20_1pm_lowart; set y;run;


data y; set a.vmmc_21_10_20_1pm_lowart; run;
...
***outputs in 2040;
proc means noprint data=y; var &v; output out=y_40_41 mean= &v._40_41; by run option ; where 2040.0 <= cald < 2041.0; 
