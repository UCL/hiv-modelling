...
data d1;  
  ...
  infile "C:\Users\lovel\TLO_HMC Dropbox\Loveleen bansi-matharu\hiv synthesis ssa unified program\output files\vmmc\c_output_vmmc_19_10_20_1pm_lowart";
...
data a.vmmc_19_10_20_1pm_lowart; set y;run;


data y; set a.vmmc_19_10_20_1pm_lowart; run;
