...
libname a "C:\Users\rmjlja9\OneDrive - University College London\MIHPSA Zimbabwe\Phase 2\2025JAN31_SQMin14to27";								* dont save on Dropbox;
	*This is using last full run, there is also a Min-SQ run set available from Nov 28th;
libname b "C:\Users\rmjlja9\Dropbox (UCL)\hiv synthesis ssa unified program\output files\zimbabwe\mihpsa_p2_SQMin14to27_20250131_out";		* all options in one output;
...
data a.base_31_01_2025_SQMin14to27; set b.out: ;
...
proc contents data=a.base_31_01_2025_SQMin14to27;run;							/* show the contents of the input SAS file */
proc freq data=a.base_31_01_2025_SQMin14to27; table run cald option;run;
...
data a.base_31_01_2025_SQMin14to27;set a.base_31_01_2025_SQMin14to27;
...
proc freq data=a.base_31_01_2025_SQMin14to27; table run option;where cald=2023.75;run;
proc freq data=a.base_31_01_2025_SQMin14to27; table run*option/norow nocol nopercent; where cald=2023.75;run;
proc freq data=a.base_31_01_2025_SQMin14to27; table run cald option;run;
proc freq data=a.base_31_01_2025_SQMin14to27; table option*cald/norow nocol nopercent;run;
...
proc sort data=a.base_31_01_2025_SQMin14to27; 
by run cald option;run;


* calculate the scale factor for the run, based on 1000000 / s_alive in 2019 ;
data sf;
set a.base_31_01_2025_SQMin14to27 ;
*Zimbabwe;
...
proc sort data=a.base_31_01_2025_SQMin14to27; by run;run;
proc sort data=sf; by run;run;

data y; 
merge a.base_31_01_2025_SQMin14to27 sf;
by run ; run;
...
data a.l_base_31_01_2025_SQMin14to27; set y;
if cald=. then delete;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27; table option;run;
...
proc freq data=a.l_base_31_01_2025_SQMin14to27; table p_w1524newpge1_onprep n_w1524_newp_ge1;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27;
...
proc freq data=a.l_base_31_01_2025_SQMin14to27; table incidence1549; where option=1;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27; table n_diag_progsw; where option=0;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27; table n_sw_inprog_ly; where option=0;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27; table n_attend_mens_clinic; where option=0;run;
proc freq data=a.l_base_31_01_2025_SQMin14to27; table n_access_adult_ret_supp; where option=30;run;
